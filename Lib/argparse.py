...
class ColorHelpFormatter(HelpFormatter):
    """TODO Formatter for generating usage messages and argument help strings.
...
class ColorRawDescriptionHelpFormatter(ColorHelpFormatter, RawDescriptionHelpFormatter): pass
class ColorRawTextHelpFormatter(ColorHelpFormatter, RawTextHelpFormatter): pass
class ColorArgumentDefaultsHelpFormatter(ColorHelpFormatter, ArgumentDefaultsHelpFormatter): pass
class ColorMetavarTypeHelpFormatter(ColorHelpFormatter, MetavarTypeHelpFormatter): pass
