...
def no_type_check_decorator(decorator):
    ...
    """
    import warnings
    warnings._deprecated("typing.no_type_check_decorator", remove=(25, 0))
...
ByteString = _DeprecatedGenericAlias(
    collections.abc.ByteString, 0, removal_version=(24, 0)  # Not generic.
)
...
def NamedTuple(typename, fields=_sentinel, /, **kwargs):
    ...
    if fields is _sentinel or fields is None:
        import warnings
        warnings._deprecated(deprecated_thing, message=deprecation_msg, remove=(25, 0))
        fields = kwargs.items()
