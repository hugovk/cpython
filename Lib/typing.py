...
def no_type_check_decorator(decorator):
    ...
    """
    import warnings
    warnings._deprecated("typing.no_type_check_decorator", remove=(3, 25))
...
ByteString = _DeprecatedGenericAlias(
    collections.abc.ByteString, 0, removal_version=(3, 24)  # Not generic.
)
...
def NamedTuple(typename, fields=_sentinel, /, **kwargs):
    ...
    if fields is _sentinel or fields is None:
        import warnings
        warnings._deprecated(deprecated_thing, message=deprecation_msg, remove=(3, 25))
        fields = kwargs.items()
