...
#define TEST_OBJECT_CONVERTER_METHODDEF        \
    {"test_object_converter",                  \
     _PyCFunction_CAST(test_object_converter), \
     METH_FASTCALL,                            \
     test_object_converter__doc__},

static PyObject *
test_object_converter_impl(
    PyObject *module, PyObject *a, PyObject *b, PyObject *c, PyUnicode_Object *d
);
...
cloned_impl(
    ...
    PyDoc_STRVAR(
        test_object_converter_one_arg__doc__,
...
#define TEST_OBJECT_CONVERTER_ONE_ARG_METHODDEF  \
    {"test_object_converter_one_arg",            \
     (PyCFunction)test_object_converter_one_arg, \
     METH_O,                                     \
     test_object_converter_one_arg__doc__},
...
#define TEST_OBJECTS_CONVERTER_METHODDEF        \
    {"test_objects_converter",                  \
     _PyCFunction_CAST(test_objects_converter), \
     METH_FASTCALL,                             \
     test_objects_converter__doc__},
...
test_objects_converter_impl(PyObject *module, PyObject *a, PyObject *b)
    ...
    PyDoc_STRVAR(
        test_object_converter_subclass_of__doc__,
...
#define TEST_OBJECT_CONVERTER_SUBCLASS_OF_METHODDEF        \
    {"test_object_converter_subclass_of",                  \
     _PyCFunction_CAST(test_object_converter_subclass_of), \
     METH_FASTCALL,                                        \
     test_object_converter_subclass_of__doc__},

static PyObject *
test_object_converter_subclass_of_impl(
    PyObject *module,
    PyObject *a,
    PyObject *b,
    PyObject *c,
...
test_object_converter_subclass_of(
    ...
    if (!PyLong_Check(args[0])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 1", "int", args[0]
        );
        goto exit;
    }
    a = args[0];
    if (!PyTuple_Check(args[1])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 2", "tuple", args[1]
        );
        goto exit;
    }
    b = args[1];
    if (!PyList_Check(args[2])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 3", "list", args[2]
        );
        goto exit;
    }
    c = args[2];
    if (!PySet_Check(args[3])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 4", "set", args[3]
        );
        goto exit;
    }
    d = args[3];
    if (!PyFrozenSet_Check(args[4])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 5", "frozenset", args[4]
        );
        goto exit;
    }
    e = args[4];
    if (!PyDict_Check(args[5])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 6", "dict", args[5]
        );
        goto exit;
    }
    f = args[5];
    if (!PyUnicode_Check(args[6])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 7", "str", args[6]
        );
        goto exit;
    }
    g = args[6];
    if (!PyBytes_Check(args[7])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 8", "bytes", args[7]
        );
        goto exit;
    }
    h = args[7];
    if (!PyByteArray_Check(args[8])) {
        _PyArg_BadArgument(
            "test_object_converter_subclass_of", "argument 9", "bytearray", args[8]
        );
        goto exit;
    }
    i = args[8];
    ...
    j = args[9];
    return_value =
        test_object_converter_subclass_of_impl(module, a, b, c, d, e, f, g, h, i, j);
...
test_object_converter_subclass_of_impl(
    ...
    PyDoc_STRVAR(
        test_PyBytesObject_converter__doc__,
...
#define TEST_PYBYTESOBJECT_CONVERTER_METHODDEF  \
    {"test_PyBytesObject_converter",            \
     (PyCFunction)test_PyBytesObject_converter, \
     METH_O,                                    \
     test_PyBytesObject_converter__doc__},
...
test_PyBytesObject_converter_impl(PyObject *module, PyBytesObject *a)
    ...
    PyDoc_STRVAR(
        test_PyByteArrayObject_converter__doc__,
...
#define TEST_PYBYTEARRAYOBJECT_CONVERTER_METHODDEF  \
    {"test_PyByteArrayObject_converter",            \
     (PyCFunction)test_PyByteArrayObject_converter, \
     METH_O,                                        \
     test_PyByteArrayObject_converter__doc__},
...
test_PyByteArrayObject_converter(PyObject *module, PyObject *arg) {
    ...
    if (!PyByteArray_Check(arg)) {
        _PyArg_BadArgument(
            "test_PyByteArrayObject_converter", "argument", "bytearray", arg
        );
        goto exit;
    }
...
#define TEST_UNICODE_CONVERTER_METHODDEF  \
    {"test_unicode_converter",            \
     (PyCFunction)test_unicode_converter, \
     METH_O,                              \
     test_unicode_converter__doc__},
...
#define TEST_BOOL_CONVERTER_METHODDEF        \
    {"test_bool_converter",                  \
     _PyCFunction_CAST(test_bool_converter), \
     METH_FASTCALL,                          \
     test_bool_converter__doc__},
...
test_bool_converter_impl(PyObject *module, int a, int b, int c)
    ...
    PyDoc_STRVAR(
        ...
        "test_char_converter($module, a=b\'A\', b=b\'\\x07\', c=b\'\\x08\', "
        "d=b\'\\t\',\n"
        "                    e=b\'\\n\', f=b\'\\x0b\', g=b\'\\x0c\', h=b\'\\r\', "
        "i=b\'\"\',\n"
        "                    j=b\"\'\", k=b\'?\', l=b\'\\\\\', m=b\'\\x00\', "
        "n=b\'\\xff\', /)\n"
        "--\n"
...
#define TEST_CHAR_CONVERTER_METHODDEF        \
    {"test_char_converter",                  \
     _PyCFunction_CAST(test_char_converter), \
     METH_FASTCALL,                          \
     test_char_converter__doc__},
...
test_char_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (PyBytes_Check(args[0])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 1", "a byte string of length 1", args[0]
        );
        goto exit;
    }
    if (nargs < 2) {
    ...
    if (PyBytes_Check(args[1])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 2", "a byte string of length 1", args[1]
        );
        goto exit;
    }
    if (nargs < 3) {
    ...
    if (PyBytes_Check(args[2])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 3", "a byte string of length 1", args[2]
        );
        goto exit;
    }
    if (nargs < 4) {
    ...
    if (PyBytes_Check(args[3])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 4", "a byte string of length 1", args[3]
        );
        goto exit;
    }
    if (nargs < 5) {
    ...
    if (PyBytes_Check(args[4])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 5", "a byte string of length 1", args[4]
        );
        goto exit;
    }
    if (nargs < 6) {
    ...
    if (PyBytes_Check(args[5])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 6", "a byte string of length 1", args[5]
        );
        goto exit;
    }
    if (nargs < 7) {
    ...
    if (PyBytes_Check(args[6])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 7", "a byte string of length 1", args[6]
        );
        goto exit;
    }
    if (nargs < 8) {
    ...
    if (PyBytes_Check(args[7])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 8", "a byte string of length 1", args[7]
        );
        goto exit;
    }
    if (nargs < 9) {
    ...
    if (PyBytes_Check(args[8])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 9", "a byte string of length 1", args[8]
        );
        goto exit;
    }
    if (nargs < 10) {
    ...
    if (PyBytes_Check(args[9])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 10", "a byte string of length 1", args[9]
        );
        goto exit;
    }
    if (nargs < 11) {
    ...
    if (PyBytes_Check(args[10])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 11", "a byte string of length 1", args[10]
        );
        goto exit;
    }
    if (nargs < 12) {
    ...
    if (PyBytes_Check(args[11])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 12", "a byte string of length 1", args[11]
        );
        goto exit;
    }
    if (nargs < 13) {
    ...
    if (PyBytes_Check(args[12])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 13", "a byte string of length 1", args[12]
        );
        goto exit;
    }
    if (nargs < 14) {
    ...
    if (PyBytes_Check(args[13])) {
        ...
        _PyArg_BadArgument(
            "test_char_converter", "argument 14", "a byte string of length 1", args[13]
        );
        goto exit;
    }
skip_optional:
    return_value =
        test_char_converter_impl(module, a, b, c, d, e, f, g, h, i, j, k, l, m, n);
...
test_char_converter_impl(
    ...
    PyDoc_STRVAR(
        test_unsigned_char_converter__doc__,
...
#define TEST_UNSIGNED_CHAR_CONVERTER_METHODDEF        \
    {"test_unsigned_char_converter",                  \
     _PyCFunction_CAST(test_unsigned_char_converter), \
     METH_FASTCALL,                                   \
     test_unsigned_char_converter__doc__},

static PyObject *
test_unsigned_char_converter_impl(
...
test_unsigned_char_converter(
    ...
    }
    {
        ...
        if (ival == -1 && PyErr_Occurred()) {
            ...
            PyErr_SetString(
                PyExc_OverflowError, "unsigned byte integer is less than minimum"
            );
            goto exit;
        } else if (ival > UCHAR_MAX) {
            PyErr_SetString(
                PyExc_OverflowError, "unsigned byte integer is greater than maximum"
            );
            goto exit;
        } else {
...
#define TEST_SHORT_CONVERTER_METHODDEF        \
    {"test_short_converter",                  \
     _PyCFunction_CAST(test_short_converter), \
     METH_FASTCALL,                           \
     test_short_converter__doc__},
...
test_short_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    }
    {
        ...
        if (ival == -1 && PyErr_Occurred()) {
            ...
            PyErr_SetString(
                PyExc_OverflowError, "signed short integer is less than minimum"
            );
            goto exit;
        } else if (ival > SHRT_MAX) {
            PyErr_SetString(
                PyExc_OverflowError, "signed short integer is greater than maximum"
            );
            goto exit;
        } else {
            a = (short)ival;
...
test_short_converter_impl(PyObject *module, short a)
    ...
    PyDoc_STRVAR(
        test_unsigned_short_converter__doc__,
...
#define TEST_UNSIGNED_SHORT_CONVERTER_METHODDEF        \
    {"test_unsigned_short_converter",                  \
     _PyCFunction_CAST(test_unsigned_short_converter), \
     METH_FASTCALL,                                    \
     test_unsigned_short_converter__doc__},

static PyObject *
test_unsigned_short_converter_impl(
...
#define TEST_INT_CONVERTER_METHODDEF        \
    {"test_int_converter",                  \
     _PyCFunction_CAST(test_int_converter), \
     METH_FASTCALL,                         \
     test_int_converter__doc__},
...
test_int_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!PyUnicode_Check(args[2])) {
        _PyArg_BadArgument(
            "test_int_converter", "argument 3", "a unicode character", args[2]
        );
        goto exit;
    }
...
test_int_converter_impl(PyObject *module, int a, int b, int c, myenum d)
    ...
    PyDoc_STRVAR(
        test_unsigned_int_converter__doc__,
...
#define TEST_UNSIGNED_INT_CONVERTER_METHODDEF        \
    {"test_unsigned_int_converter",                  \
     _PyCFunction_CAST(test_unsigned_int_converter), \
     METH_FASTCALL,                                  \
     test_unsigned_int_converter__doc__},
...
#define TEST_LONG_CONVERTER_METHODDEF        \
    {"test_long_converter",                  \
     _PyCFunction_CAST(test_long_converter), \
     METH_FASTCALL,                          \
     test_long_converter__doc__},
...
#define TEST_UNSIGNED_LONG_CONVERTER_METHODDEF        \
    {"test_unsigned_long_converter",                  \
     _PyCFunction_CAST(test_unsigned_long_converter), \
     METH_FASTCALL,                                   \
     test_unsigned_long_converter__doc__},

static PyObject *
test_unsigned_long_converter_impl(
...
test_unsigned_long_converter(
    ...
    if (!PyLong_Check(args[2])) {
        _PyArg_BadArgument(
            "test_unsigned_long_converter", "argument 3", "int", args[2]
        );
        goto exit;
    }
...
test_unsigned_long_converter_impl(
    ...
    PyDoc_STRVAR(
        test_long_long_converter__doc__,
...
#define TEST_LONG_LONG_CONVERTER_METHODDEF        \
    {"test_long_long_converter",                  \
     _PyCFunction_CAST(test_long_long_converter), \
     METH_FASTCALL,                               \
     test_long_long_converter__doc__},
...
test_long_long_converter_impl(PyObject *module, long long a)
    ...
    PyDoc_STRVAR(
        test_unsigned_long_long_converter__doc__,
...
#define TEST_UNSIGNED_LONG_LONG_CONVERTER_METHODDEF        \
    {"test_unsigned_long_long_converter",                  \
     _PyCFunction_CAST(test_unsigned_long_long_converter), \
     METH_FASTCALL,                                        \
     test_unsigned_long_long_converter__doc__},

static PyObject *
test_unsigned_long_long_converter_impl(
...
test_unsigned_long_long_converter(
    ...
    if (!PyLong_Check(args[2])) {
        _PyArg_BadArgument(
            "test_unsigned_long_long_converter", "argument 3", "int", args[2]
        );
        goto exit;
    }
...
test_unsigned_long_long_converter_impl(
    ...
    PyDoc_STRVAR(
        test_Py_ssize_t_converter__doc__,
...
#define TEST_PY_SSIZE_T_CONVERTER_METHODDEF        \
    {"test_Py_ssize_t_converter",                  \
     _PyCFunction_CAST(test_Py_ssize_t_converter), \
     METH_FASTCALL,                                \
     test_Py_ssize_t_converter__doc__},

static PyObject *
test_Py_ssize_t_converter_impl(
    PyObject *module, Py_ssize_t a, Py_ssize_t b, Py_ssize_t c
);
...
test_Py_ssize_t_converter_impl(
    ...
    PyDoc_STRVAR(
        test_slice_index_converter__doc__,
...
#define TEST_SLICE_INDEX_CONVERTER_METHODDEF        \
    {"test_slice_index_converter",                  \
     _PyCFunction_CAST(test_slice_index_converter), \
     METH_FASTCALL,                                 \
     test_slice_index_converter__doc__},

static PyObject *
test_slice_index_converter_impl(
    PyObject *module, Py_ssize_t a, Py_ssize_t b, Py_ssize_t c
);
...
#define TEST_FLOAT_CONVERTER_METHODDEF        \
    {"test_float_converter",                  \
     _PyCFunction_CAST(test_float_converter), \
     METH_FASTCALL,                           \
     test_float_converter__doc__},
...
#define TEST_DOUBLE_CONVERTER_METHODDEF        \
    {"test_double_converter",                  \
     _PyCFunction_CAST(test_double_converter), \
     METH_FASTCALL,                            \
     test_double_converter__doc__},
...
test_double_converter_impl(PyObject *module, double a)
    ...
    PyDoc_STRVAR(
        test_Py_complex_converter__doc__,
...
#define TEST_PY_COMPLEX_CONVERTER_METHODDEF  \
    {"test_Py_complex_converter",            \
     (PyCFunction)test_Py_complex_converter, \
     METH_O,                                 \
     test_Py_complex_converter__doc__},
...
#define TEST_STR_CONVERTER_METHODDEF        \
    {"test_str_converter",                  \
     _PyCFunction_CAST(test_str_converter), \
     METH_FASTCALL,                         \
     test_str_converter__doc__},

static PyObject *
test_str_converter_impl(
    PyObject *module,
    const char *a,
    const char *b,
    const char *c,
...
test_str_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    return_value = test_str_converter_impl(
        module, a, b, c, d, e, f, f_length, g, g_length, h, h_length
    );
...
test_str_converter_impl(
    ...
    PyDoc_STRVAR(
        test_str_converter_encoding__doc__,
...
#define TEST_STR_CONVERTER_ENCODING_METHODDEF        \
    {"test_str_converter_encoding",                  \
     _PyCFunction_CAST(test_str_converter_encoding), \
     METH_FASTCALL,                                  \
     test_str_converter_encoding__doc__},

static PyObject *
test_str_converter_encoding_impl(
    PyObject *module,
    char *a,
    char *b,
    char *c,
...
test_str_converter_encoding(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args,
            nargs,
            "esesetes#et#:test_str_converter_encoding",
            "idna",
            &a,
            "idna",
            &b,
    ...
    return_value =
        test_str_converter_encoding_impl(module, a, b, c, d, d_length, e, e_length);
...
test_str_converter_encoding_impl(
    ...
    PyDoc_STRVAR(
        test_Py_UNICODE_converter__doc__,
...
static PyObject *
test_Py_UNICODE_converter_impl(
    PyObject *module,
    const wchar_t *a,
    const wchar_t *b,
    const wchar_t *c,
...
test_Py_UNICODE_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args,
            nargs,
            "O&O&O&u#Z#:test_Py_UNICODE_converter",
    ...
    return_value =
        test_Py_UNICODE_converter_impl(module, a, b, c, d, d_length, e, e_length);
...
test_Py_UNICODE_converter_impl(
    ...
    PyDoc_STRVAR(
        test_Py_buffer_converter__doc__,
...
#define TEST_PY_BUFFER_CONVERTER_METHODDEF        \
    {"test_Py_buffer_converter",                  \
     _PyCFunction_CAST(test_Py_buffer_converter), \
     METH_FASTCALL,                               \
     test_Py_buffer_converter__doc__},

static PyObject *
test_Py_buffer_converter_impl(
    PyObject *module,
    Py_buffer *a,
    Py_buffer *b,
    Py_buffer *c,
...
test_Py_buffer_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args, nargs, "y*y*s*z*w*:test_Py_buffer_converter", &a, &b, &c, &d, &e
        )) {
        goto exit;
    }
...
#define TEST_KEYWORDS_METHODDEF        \
    {"test_keywords",                  \
     _PyCFunction_CAST(test_keywords), \
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 1, 1, 1, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
#define TEST_KEYWORDS_OPT_METHODDEF        \
    {"test_keywords_opt",                  \
     _PyCFunction_CAST(test_keywords_opt), \
     METH_FASTCALL | METH_KEYWORDS,        \
     test_keywords_opt__doc__},

static PyObject *
test_keywords_opt_impl(PyObject *module, PyObject *a, PyObject *b, PyObject *c);
...
test_keywords_opt_impl(PyObject *module, PyObject *a, PyObject *b, PyObject *c)
    ...
    PyDoc_STRVAR(
        test_keywords_opt_kwonly__doc__,
...
#define TEST_KEYWORDS_OPT_KWONLY_METHODDEF        \
    {"test_keywords_opt_kwonly",                  \
     _PyCFunction_CAST(test_keywords_opt_kwonly), \
     METH_FASTCALL | METH_KEYWORDS,               \
     test_keywords_opt_kwonly__doc__},
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 1, 2, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
test_keywords_opt_kwonly_impl(
    ...
    PyDoc_STRVAR(
        test_keywords_kwonly_opt__doc__,
...
#define TEST_KEYWORDS_KWONLY_OPT_METHODDEF        \
    {"test_keywords_kwonly_opt",                  \
     _PyCFunction_CAST(test_keywords_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,               \
     test_keywords_kwonly_opt__doc__},

static PyObject *
test_keywords_kwonly_opt_impl(PyObject *module, PyObject *a, PyObject *b, PyObject *c);
...
#define TEST_POSONLY_KEYWORDS_METHODDEF        \
    {"test_posonly_keywords",                  \
     _PyCFunction_CAST(test_posonly_keywords), \
     METH_FASTCALL | METH_KEYWORDS,            \
     test_posonly_keywords__doc__},
...
#define TEST_POSONLY_KWONLY_METHODDEF        \
    {"test_posonly_kwonly",                  \
     _PyCFunction_CAST(test_posonly_kwonly), \
     METH_FASTCALL | METH_KEYWORDS,          \
     test_posonly_kwonly__doc__},
...
test_posonly_kwonly_impl(PyObject *module, PyObject *a, PyObject *c)
    ...
    PyDoc_STRVAR(
        test_posonly_keywords_kwonly__doc__,
...
#define TEST_POSONLY_KEYWORDS_KWONLY_METHODDEF        \
    {"test_posonly_keywords_kwonly",                  \
     _PyCFunction_CAST(test_posonly_keywords_kwonly), \
     METH_FASTCALL | METH_KEYWORDS,                   \
     test_posonly_keywords_kwonly__doc__},

static PyObject *
test_posonly_keywords_kwonly_impl(
    PyObject *module, PyObject *a, PyObject *b, PyObject *c
);
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 2, 2, 1, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
test_posonly_keywords_kwonly_impl(
    ...
    PyDoc_STRVAR(
        test_posonly_keywords_opt__doc__,
...
#define TEST_POSONLY_KEYWORDS_OPT_METHODDEF        \
    {"test_posonly_keywords_opt",                  \
     _PyCFunction_CAST(test_posonly_keywords_opt), \
     METH_FASTCALL | METH_KEYWORDS,                \
     test_posonly_keywords_opt__doc__},

static PyObject *
test_posonly_keywords_opt_impl(
    PyObject *module, PyObject *a, PyObject *b, PyObject *c, PyObject *d
);
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 2, 4, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
test_posonly_keywords_opt_impl(
    ...
    PyDoc_STRVAR(
        test_posonly_keywords_opt2__doc__,
...
#define TEST_POSONLY_KEYWORDS_OPT2_METHODDEF        \
    {"test_posonly_keywords_opt2",                  \
     _PyCFunction_CAST(test_posonly_keywords_opt2), \
     METH_FASTCALL | METH_KEYWORDS,                 \
     test_posonly_keywords_opt2__doc__},

static PyObject *
test_posonly_keywords_opt2_impl(
    PyObject *module, PyObject *a, PyObject *b, PyObject *c
);
...
static PyObject *
test_posonly_keywords_opt2_impl(PyObject *module, PyObject *a, PyObject *b, PyObject *c)
...
#define TEST_POSONLY_OPT_KEYWORDS_OPT_METHODDEF        \
    {"test_posonly_opt_keywords_opt",                  \
     _PyCFunction_CAST(test_posonly_opt_keywords_opt), \
     METH_FASTCALL | METH_KEYWORDS,                    \
     test_posonly_opt_keywords_opt__doc__},

static PyObject *
test_posonly_opt_keywords_opt_impl(
    PyObject *module, PyObject *a, PyObject *b, PyObject *c, PyObject *d
);
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 1, 4, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
test_posonly_opt_keywords_opt_impl(
    ...
    PyDoc_STRVAR(
        test_posonly_kwonly_opt__doc__,
...
#define TEST_POSONLY_KWONLY_OPT_METHODDEF        \
    {"test_posonly_kwonly_opt",                  \
     _PyCFunction_CAST(test_posonly_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,              \
     test_posonly_kwonly_opt__doc__},

static PyObject *
test_posonly_kwonly_opt_impl(
    PyObject *module, PyObject *a, PyObject *b, PyObject *c, PyObject *d
);
...
#define TEST_POSONLY_KWONLY_OPT2_METHODDEF        \
    {"test_posonly_kwonly_opt2",                  \
     _PyCFunction_CAST(test_posonly_kwonly_opt2), \
     METH_FASTCALL | METH_KEYWORDS,               \
     test_posonly_kwonly_opt2__doc__},

static PyObject *
test_posonly_kwonly_opt2_impl(PyObject *module, PyObject *a, PyObject *b, PyObject *c);
...
test_posonly_kwonly_opt2_impl(PyObject *module, PyObject *a, PyObject *b, PyObject *c)
    ...
    PyDoc_STRVAR(
        test_posonly_opt_kwonly_opt__doc__,
...
#define TEST_POSONLY_OPT_KWONLY_OPT_METHODDEF        \
    {"test_posonly_opt_kwonly_opt",                  \
     _PyCFunction_CAST(test_posonly_opt_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,                  \
     test_posonly_opt_kwonly_opt__doc__},

static PyObject *
test_posonly_opt_kwonly_opt_impl(
    PyObject *module, PyObject *a, PyObject *b, PyObject *c, PyObject *d
);
...
test_posonly_opt_kwonly_opt_impl(
    ...
    PyDoc_STRVAR(
        test_posonly_keywords_kwonly_opt__doc__,
...
static PyObject *
test_posonly_keywords_kwonly_opt_impl(
...
#define TEST_POSONLY_KEYWORDS_KWONLY_OPT2_METHODDEF        \
    {"test_posonly_keywords_kwonly_opt2",                  \
     _PyCFunction_CAST(test_posonly_keywords_kwonly_opt2), \
     METH_FASTCALL | METH_KEYWORDS,                        \
     test_posonly_keywords_kwonly_opt2__doc__},
...
test_posonly_keywords_kwonly_opt2_impl(
    ...
    PyDoc_STRVAR(
        test_posonly_keywords_opt_kwonly_opt__doc__,
...
#define TEST_POSONLY_KEYWORDS_OPT_KWONLY_OPT_METHODDEF        \
    {"test_posonly_keywords_opt_kwonly_opt",                  \
     _PyCFunction_CAST(test_posonly_keywords_opt_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,                           \
     test_posonly_keywords_opt_kwonly_opt__doc__},

static PyObject *
test_posonly_keywords_opt_kwonly_opt_impl(
    PyObject *module, PyObject *a, PyObject *b, PyObject *c, PyObject *d, PyObject *e
);
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 2, 3, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
test_posonly_keywords_opt_kwonly_opt_impl(
    ...
    PyDoc_STRVAR(
        test_posonly_keywords_opt2_kwonly_opt__doc__,
...
#define TEST_POSONLY_KEYWORDS_OPT2_KWONLY_OPT_METHODDEF        \
    {"test_posonly_keywords_opt2_kwonly_opt",                  \
     _PyCFunction_CAST(test_posonly_keywords_opt2_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,                            \
     test_posonly_keywords_opt2_kwonly_opt__doc__},
...
test_posonly_keywords_opt2_kwonly_opt_impl(
    ...
    PyDoc_STRVAR(
        test_posonly_opt_keywords_opt_kwonly_opt__doc__,
...
static PyObject *
test_posonly_opt_keywords_opt_kwonly_opt_impl(
    PyObject *module,
    PyObject *a,
    PyObject *b,
    PyObject *c,
...
skip_optional_kwonly:
    return_value =
        test_posonly_opt_keywords_opt_kwonly_opt_impl(module, a, b, c, d, e, f);
...
test_posonly_opt_keywords_opt_kwonly_opt_impl(
    ...
    PyDoc_STRVAR(
        test_keyword_only_parameter__doc__,
...
#define TEST_KEYWORD_ONLY_PARAMETER_METHODDEF        \
    {"test_keyword_only_parameter",                  \
     _PyCFunction_CAST(test_keyword_only_parameter), \
     METH_FASTCALL | METH_KEYWORDS,                  \
     test_keyword_only_parameter__doc__},
...
#undef KWTUPLE
    ...
    if (!PyBytes_Check(args[0])) {
        _PyArg_BadArgument(
            "test_keyword_only_parameter", "argument 'co_lnotab'", "bytes", args[0]
        );
        goto exit;
    }
...
/*[clinic end generated code: output=da39a3ee5e6b4b0d input=5bff3376ee0df0b5]*/
    ...
    static PyObject *test_preprocessor_guarded_condition_a_impl(PyObject *module)
/*[clinic end generated code: output=ad012af18085add6 input=8edb8706a98cda7e]*/
    ...
    static PyObject *test_preprocessor_guarded_elif_condition_b_impl(PyObject *module)
/*[clinic end generated code: output=615f2dee82b138d1 input=53777cebbf7fee32]*/
    ...
    static PyObject *test_preprocessor_guarded_else_impl(PyObject *module)
/*[clinic end generated code: output=13af7670aac51b12 input=6657ab31d74c29fc]*/
    ...
    static PyObject *test_preprocessor_guarded_ifndef_condition_c_impl(PyObject *module)
/*[clinic end generated code: output=ed422e8c895bb0a5 input=e9b50491cea2b668]*/
    ...
    static PyObject *test_preprocessor_guarded_ifndef_not_condition_c_impl(
        PyObject *module
    )
/*[clinic end generated code: output=de6f4c6a67f8c536 input=da74e30e01c6f2c5]*/
    ...
    static PyObject *test_preprocessor_guarded_if_with_continuation_impl(
        PyObject *module
    )
...
#warning "different type of CPP directive"
    ...
    static PyObject *test_preprocessor_guarded_if_e_or_f_impl(PyObject *module)
...
[clinic start generated code]*/
        ...
        PyDoc_STRVAR(
            test_preprocessor_guarded_condition_a__doc__,
...
#define TEST_PREPROCESSOR_GUARDED_CONDITION_A_METHODDEF  \
    {"test_preprocessor_guarded_condition_a",            \
     (PyCFunction)test_preprocessor_guarded_condition_a, \
     METH_NOARGS,                                        \
     test_preprocessor_guarded_condition_a__doc__},
...
PyDoc_STRVAR(
    test_preprocessor_guarded_elif_condition_b__doc__,
...
#define TEST_PREPROCESSOR_GUARDED_ELIF_CONDITION_B_METHODDEF  \
    {"test_preprocessor_guarded_elif_condition_b",            \
     (PyCFunction)test_preprocessor_guarded_elif_condition_b, \
     METH_NOARGS,                                             \
     test_preprocessor_guarded_elif_condition_b__doc__},
...
PyDoc_STRVAR(
    test_preprocessor_guarded_else__doc__,
...
#define TEST_PREPROCESSOR_GUARDED_ELSE_METHODDEF  \
    {"test_preprocessor_guarded_else",            \
     (PyCFunction)test_preprocessor_guarded_else, \
     METH_NOARGS,                                 \
     test_preprocessor_guarded_else__doc__},
...
PyDoc_STRVAR(
    test_preprocessor_guarded_ifndef_not_condition_c__doc__,
...
PyDoc_STRVAR(
    test_preprocessor_guarded_if_with_continuation__doc__,
...
#define TEST_PREPROCESSOR_GUARDED_IF_WITH_CONTINUATION_METHODDEF  \
    {"test_preprocessor_guarded_if_with_continuation",            \
     (PyCFunction)test_preprocessor_guarded_if_with_continuation, \
     METH_NOARGS,                                                 \
     test_preprocessor_guarded_if_with_continuation__doc__},
...
PyDoc_STRVAR(
    test_preprocessor_guarded_if_e_or_f__doc__,
...
#define TEST_PREPROCESSOR_GUARDED_IF_E_OR_F_METHODDEF  \
    {"test_preprocessor_guarded_if_e_or_f",            \
     (PyCFunction)test_preprocessor_guarded_if_e_or_f, \
     METH_NOARGS,                                      \
     test_preprocessor_guarded_if_e_or_f__doc__},
...
PyDoc_STRVAR(
    test_vararg_and_posonly__doc__,
...
#define TEST_VARARG_AND_POSONLY_METHODDEF        \
    {"test_vararg_and_posonly",                  \
     _PyCFunction_CAST(test_vararg_and_posonly), \
     METH_FASTCALL,                              \
     test_vararg_and_posonly__doc__},
...
#undef KWTUPLE
    ...
    args = _PyArg_UnpackKeywordsWithVararg(
        args, nargs, NULL, kwnames, &_parser, 1, 1, 0, 1, argsbuf
    );
    if (!args) {
        goto exit;
    }
...
test_vararg_impl(PyObject *module, PyObject *a, PyObject *args)
    ...
    PyDoc_STRVAR(
        test_vararg_with_default__doc__,
...
#define TEST_VARARG_WITH_DEFAULT_METHODDEF        \
    {"test_vararg_with_default",                  \
     _PyCFunction_CAST(test_vararg_with_default), \
     METH_FASTCALL | METH_KEYWORDS,               \
     test_vararg_with_default__doc__},

static PyObject *
test_vararg_with_default_impl(PyObject *module, PyObject *a, PyObject *args, int b);
...
#undef KWTUPLE
    PyObject *argsbuf[3];
    Py_ssize_t noptargs =
        Py_MIN(nargs, 1) + (kwnames ? PyTuple_GET_SIZE(kwnames) : 0) - 1;
    PyObject *a;
    PyObject *__clinic_args = NULL;
    int b = 0;
...
#define TEST_VARARG_WITH_ONLY_DEFAULTS_METHODDEF        \
    {"test_vararg_with_only_defaults",                  \
     _PyCFunction_CAST(test_vararg_with_only_defaults), \
     METH_FASTCALL | METH_KEYWORDS,                     \
     test_vararg_with_only_defaults__doc__},

static PyObject *
test_vararg_with_only_defaults_impl(
    PyObject *module, PyObject *args, int b, PyObject *c
);
...
#undef KWTUPLE
    ...
    args = _PyArg_UnpackKeywordsWithVararg(
        args, nargs, NULL, kwnames, &_parser, 0, 0, 0, 0, argsbuf
    );
    if (!args) {
        goto exit;
    }
...
#define TEST_PARAMNAME_MODULE_METHODDEF        \
    {"test_paramname_module",                  \
     _PyCFunction_CAST(test_paramname_module), \
     METH_FASTCALL | METH_KEYWORDS,            \
     test_paramname_module__doc__},
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 9, 9, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    __clinic_args = args[0];
    ...
    return_value = mangle1_impl(
        module,
        __clinic_args,
        __clinic_kwnames,
        __clinic_return_value,
        __clinic__keywords,
        __clinic__parser,
        __clinic_argsbuf,
        __clinic_fastargs,
...
#define MANGLE2_METHODDEF           \
    {"mangle2",                     \
     _PyCFunction_CAST(mangle2),    \
     METH_FASTCALL | METH_KEYWORDS, \
     mangle2__doc__},

static PyObject *
mangle2_impl(
    PyObject *module, PyObject *args, PyObject *kwargs, PyObject *return_value
);
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 3, 3, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    __clinic_args = args[0];
    ...
    __clinic_return_value = args[2];
    return_value =
        mangle2_impl(module, __clinic_args, __clinic_kwargs, __clinic_return_value);
...
static PyObject *
mangle2_impl(PyObject *module, PyObject *args, PyObject *kwargs, PyObject *return_value)
...
#define TEST_CLS_WITH_PARAM_METHODDEF             \
    {"cls_with_param",                            \
     _PyCFunction_CAST(Test_cls_with_param),      \
...
Test___init__(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    if ((Py_IS_TYPE(self, base_tp) || Py_TYPE(self)->tp_new == base_tp->tp_new) &&
...
#define TEST_CLS_NO_PARAMS_METHODDEF              \
    {"cls_no_params",                             \
     _PyCFunction_CAST(Test_cls_no_params),       \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     Test_cls_no_params__doc__},
...
Test_cls_no_params_impl(TestObj *self, PyTypeObject *cls)
    ...
    PyDoc_STRVAR(
        Test_metho_not_default_return_converter__doc__,
...
#define TEST_METHO_NOT_DEFAULT_RETURN_CONVERTER_METHODDEF  \
    {"metho_not_default_return_converter",                 \
     (PyCFunction)Test_metho_not_default_return_converter, \
     METH_O,                                               \
     Test_metho_not_default_return_converter__doc__},
...
Test_metho_not_default_return_converter_impl(TestObj *self, PyObject *a)
    ...
    PyDoc_STRVAR(
        Test_an_metho_arg_named_arg__doc__,
...
#define TEST_AN_METHO_ARG_NAMED_ARG_METHODDEF  \
    {"an_metho_arg_named_arg",                 \
     (PyCFunction)Test_an_metho_arg_named_arg, \
     METH_O,                                   \
     Test_an_metho_arg_named_arg__doc__},
...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 1, 1, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
...
#define TEST_STATIC_METHOD_METHODDEF  \
    {"static_method",                 \
     (PyCFunction)Test_static_method, \
...
#define TEST_PROPERTY_GETSETDEF \
    {"property",                \
     (getter)Test_property_get, \
     (setter)Test_property_set, \
     Test_property_DOCSTR},
#else
#define TEST_PROPERTY_GETSETDEF \
    {"property", (getter)Test_property_get, NULL, Test_property_DOCSTR},
#endif

    static PyObject *Test_property_get_impl(TestObj *self);
...
#define TEST_PROPERTY_GETSETDEF {"property", NULL, (setter)Test_property_set, NULL},
    ...
    static int Test_property_set_impl(TestObj *self, PyObject *value);
...
Test_property_set_impl(TestObj *self, PyObject *value)
    ...
    static PyObject *buffer_clear_impl(PyObject *module, int a)
...
#define MANGLED_C_KEYWORD_IDENTIFIER_METHODDEF        \
    {"mangled_c_keyword_identifier",                  \
     _PyCFunction_CAST(mangled_c_keyword_identifier), \
     METH_FASTCALL | METH_KEYWORDS,                   \
     mangled_c_keyword_identifier__doc__},
...
static int
Test___init___impl(TestObj *self, PyObject *a, int group_right_1, PyObject *b);
...
#define TEST__PYARG_PARSESTACKANDKEYWORDS_METHODDEF        \
    {"_pyarg_parsestackandkeywords",                       \
     _PyCFunction_CAST(Test__pyarg_parsestackandkeywords), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,          \
     Test__pyarg_parsestackandkeywords__doc__},

static PyObject *
Test__pyarg_parsestackandkeywords_impl(
    TestObj *self, PyTypeObject *cls, const char *key, Py_ssize_t key_length
);

static PyObject *
Test__pyarg_parsestackandkeywords(
    TestObj *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(
            args, nargs, kwnames, &_parser, &key, &key_length
        )) {
        goto exit;
    }
...
Test__pyarg_parsestackandkeywords_impl(
    ...
    PyDoc_STRVAR(
        fn_with_default_binop_expr__doc__,
...
#define FN_WITH_DEFAULT_BINOP_EXPR_METHODDEF        \
    {"fn_with_default_binop_expr",                  \
     _PyCFunction_CAST(fn_with_default_binop_expr), \
     METH_FASTCALL | METH_KEYWORDS,                 \
     fn_with_default_binop_expr__doc__},
...
fn_with_default_binop_expr_impl(PyObject *module, PyObject *arg)
    ...
    PyDoc_STRVAR(
        docstr_fallback_to_converter_default__doc__,
...
#define TEST_CRITICAL_SECTION_METHODDEF  \
    {"test_critical_section",            \
     (PyCFunction)test_critical_section, \
     METH_NOARGS,                        \
     test_critical_section__doc__},
...
test_critical_section_impl(PyObject *module)
    ...
    PyDoc_STRVAR(
        test_critical_section_meth_o__doc__,
...
#define TEST_CRITICAL_SECTION_METH_O_METHODDEF  \
    {"test_critical_section_meth_o",            \
     (PyCFunction)test_critical_section_meth_o, \
     METH_O,                                    \
     test_critical_section_meth_o__doc__},
...
#define TEST_CRITICAL_SECTION_OBJECT_METHODDEF  \
    {"test_critical_section_object",            \
     (PyCFunction)test_critical_section_object, \
     METH_O,                                    \
     test_critical_section_object__doc__},
...
#define TEST_CRITICAL_SECTION_OBJECT2_METHODDEF        \
    {"test_critical_section_object2",                  \
     _PyCFunction_CAST(test_critical_section_object2), \
     METH_FASTCALL,                                    \
     test_critical_section_object2__doc__},

static PyObject *
test_critical_section_object2_impl(PyObject *module, PyObject *a, PyObject *b);
...
test_critical_section_object2(
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument(
            "test_critical_section_object2", "argument 1", "str", args[0]
        );
        goto exit;
    }
    a = args[0];
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument(
            "test_critical_section_object2", "argument 2", "str", args[1]
        );
        goto exit;
    }
    b = args[1];
