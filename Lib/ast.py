...
if not hasattr(Constant, 'n'):
    ...
    def _n_getter(self):
        ...
        warnings._deprecated(
            "Attribute n", message=_DEPRECATED_VALUE_ALIAS_MESSAGE, remove=(24, 0)
        )
        return self.value
    ...
    def _s_getter(self):
        ...
        import warnings
        warnings._deprecated(
            "Attribute s", message=_DEPRECATED_VALUE_ALIAS_MESSAGE, remove=(24, 0)
        )
        return self.value
...
def _new(cls, *args, **kwargs):
    ...
    if cls in _const_types:
        import warnings
        warnings._deprecated(
            f"ast.{cls.__qualname__}", message=_DEPRECATED_CLASS_MESSAGE, remove=(24, 0)
        )
...
class Ellipsis(Constant, metaclass=_ABC):
    ...
    def __new__(cls, *args, **kwargs):
        if cls is _ast_Ellipsis:
            import warnings
            warnings._deprecated(
                "ast.Ellipsis", message=_DEPRECATED_CLASS_MESSAGE, remove=(24, 0)
            )
            return Constant(..., *args, **kwargs)
        return Constant.__new__(cls, *args, **kwargs)
...
def __getattr__(name):
    if name in _deprecated_globals:
        ...
        import warnings
        warnings._deprecated(
            f"ast.{name}", message=_DEPRECATED_CLASS_MESSAGE, remove=(24, 0)
        )
        return value
