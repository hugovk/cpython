...
#define STRUCT_FOR_STR(NAME, LITERAL) STRUCT_FOR_ASCII_STR(LITERAL) _py_##NAME;
#define STRUCT_FOR_ID(NAME) STRUCT_FOR_ASCII_STR(#NAME) _py_##NAME;
...
#define _Py_ID(NAME) (_Py_SINGLETON(strings.identifiers._py_##NAME._ascii.ob_base))
#define _Py_STR(NAME) (_Py_SINGLETON(strings.literals._py_##NAME._ascii.ob_base))
