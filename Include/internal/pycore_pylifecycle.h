...
extern PyStatus
_Py_HashRandomization_Init(const PyConfig *);
...
extern void
_PyAST_Fini(PyInterpreterState *interp);
extern void
...
_PyArg_Fini(void);
extern void
_Py_FinalizeAllocatedBlocks(_PyRuntimeState *);
...
extern PyStatus
_Py_PreInitializeFromPyArgv(const PyPreConfig *src_config, const struct _PyArgv *args);
extern PyStatus
_Py_PreInitializeFromConfig(const PyConfig *config, const struct _PyArgv *args);
...
extern PyObject *
_PyErr_WriteUnraisableDefaultHook(PyObject *unraisable);
...
PyAPI_FUNC(int)
    _PyInterpreterConfig_InitFromState(PyInterpreterConfig *, PyInterpreterState *);
PyAPI_FUNC(PyObject *) _PyInterpreterConfig_AsDict(PyInterpreterConfig *);
PyAPI_FUNC(int) _PyInterpreterConfig_InitFromDict(PyInterpreterConfig *, PyObject *);
PyAPI_FUNC(int) _PyInterpreterConfig_UpdateFromDict(PyInterpreterConfig *, PyObject *);
