...
extern _PyErr_StackItem *
_PyErr_GetTopmostException(PyThreadState *tstate);
extern PyObject *
_PyErr_GetHandledException(PyThreadState *);
extern void
_PyErr_SetHandledException(PyThreadState *, PyObject *);
extern void
_PyErr_GetExcInfo(PyThreadState *, PyObject **, PyObject **, PyObject **);
...
PyAPI_FUNC(PyObject *) _PyErr_ProgramDecodedTextObject(
    PyObject *filename, int lineno, const char *encoding
);
...
extern void _Py_NO_RETURN
_Py_FatalErrorFormat(const char *func, const char *format, ...);

extern PyObject *
_PyErr_SetImportErrorWithNameFrom(PyObject *, PyObject *, PyObject *, PyObject *);

/* runtime lifecycle */

extern PyStatus
_PyErr_InitTypes(PyInterpreterState *);
extern void
_PyErr_FiniTypes(PyInterpreterState *);
...
static inline void
_PyErr_ClearExcState(_PyErr_StackItem *exc_state) {
...
PyAPI_FUNC(int) _PyErr_ExceptionMatches(PyThreadState *tstate, PyObject *exc);
...
extern void
_PyErr_SetObject(PyThreadState *tstate, PyObject *type, PyObject *value);
...
extern PyObject *
_PyExc_CreateExceptionGroup(const char *msg, PyObject *excs);
...
PyAPI_FUNC(Py_ssize_t)
    _Py_UTF8_Edit_Cost(PyObject *str_a, PyObject *str_b, Py_ssize_t max_cost);
...
Py_DEPRECATED(3.12
) extern void _PyErr_ChainExceptions(PyObject *, PyObject *, PyObject *);
