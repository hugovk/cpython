                ...
                .singletons =                                                          \
                    {                                                                  \
                        ...
                        .hamt_bitmap_node_empty =                                      \
                            {                                                          \
                                .ob_base = _PyVarObject_HEAD_INIT(                     \
                                    &_PyHamt_BitmapNode_Type, 0                        \
                                ),                                                     \
                            },                                                         \
                        .context_token_missing =                                       \
                            {                                                          \
                                .ob_base =                                             \
                                    _PyObject_HEAD_INIT(&_PyContextTokenMissing_Type), \
                            },                                                         \
                    },                                                                 \
            },                                                                         \
                    ...
                    {                                                          \
                        ...
                        .hamt_empty =                                          \
                            {                                                  \
                                ...
                                .h_root = (PyHamtNode *)&_Py_SINGLETON(        \
                                    hamt_bitmap_node_empty                     \
                                ),                                             \
                            },                                                 \
...
#define _PyBytes_CHAR_INIT(CH) {_PyBytes_SIMPLE_INIT((CH), 1)}
...
#define _PyASCIIObject_INIT(LITERAL) \
    {._ascii = _PyUnicode_ASCII_BASE_INIT((LITERAL), 1), ._data = (LITERAL)}
#define INIT_STR(NAME, LITERAL) ._py_##NAME = _PyASCIIObject_INIT(LITERAL)
#define INIT_ID(NAME) ._py_##NAME = _PyASCIIObject_INIT(#NAME)
