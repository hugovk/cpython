...
#define SRC_LOCATION_FROM_AST(n)                                             \
    (_Py_SourceLocation) {                                                   \
        ...
        .col_offset = (n)->col_offset, .end_col_offset = (n)->end_col_offset \
    }
...
typedef struct _symtable_entry {
    ...
    unsigned
        ste_annotations_used : 1; /* true if there are any annotations in this scope */
    ...
    unsigned ste_can_see_class_scope : 1;   /* true if this block can see names bound in
...
extern long
_PyST_GetSymbol(PySTEntryObject *, PyObject *);
extern int
_PyST_GetScope(PySTEntryObject *, PyObject *);
extern int
_PyST_IsFunctionLike(PySTEntryObject *);

extern struct symtable *
_PySymtable_Build(struct _mod *mod, PyObject *filename, _PyFutureFeatures *future);
extern PySTEntryObject *
_PySymtable_Lookup(struct symtable *, void *);
extern int
_PySymtable_LookupOptional(struct symtable *, void *, PySTEntryObject **);

extern void
_PySymtable_Free(struct symtable *);

extern PyObject *
_Py_MaybeMangle(PyObject *privateobj, PySTEntryObject *ste, PyObject *name);
extern PyObject *
_Py_Mangle(PyObject *p, PyObject *name);
...
int
_PyFuture_FromAST(struct _mod *mod, PyObject *filename, _PyFutureFeatures *futures);
