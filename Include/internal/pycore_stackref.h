...
#define PyStackRef_True \
    ((_PyStackRef){.bits = ((uintptr_t)&_Py_TrueStruct) | Py_TAG_DEFERRED})
#define PyStackRef_False \
    ((_PyStackRef){.bits = ((uintptr_t)&_Py_FalseStruct) | Py_TAG_DEFERRED})
#define PyStackRef_None \
    ((_PyStackRef){.bits = ((uintptr_t)&_Py_NoneStruct) | Py_TAG_DEFERRED})
...
#define PyStackRef_FromPyObjectNew(obj) \
    ((_PyStackRef){.bits = (uintptr_t)(Py_NewRef(obj))})
