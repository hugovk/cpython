...
static inline int
_PyObject_GC_MAY_BE_TRACKED(PyObject *obj) {
 ...
 * memory. */
static inline int
_PyObject_GC_IS_SHARED(PyObject *op) {
...
static inline void
_PyObject_GC_SET_SHARED(PyObject *op) {
...
static inline int
_PyObject_GC_IS_SHARED_INLINE(PyObject *op) {
...
static inline void
_PyObject_GC_SET_SHARED_INLINE(PyObject *op) {
...
#define _PyGC_DEBUG_LEAK \
    _PyGC_DEBUG_COLLECTABLE | _PyGC_DEBUG_UNCOLLECTABLE | _PyGC_DEBUG_SAVEALL
...
static inline PyGC_Head *
_PyGCHead_NEXT(PyGC_Head *gc) {
    uintptr_t next = gc->_gc_next & _PyGC_PREV_MASK;
    return (PyGC_Head *)next;
}
static inline void
_PyGCHead_SET_NEXT(PyGC_Head *gc, PyGC_Head *next) {
...
static inline PyGC_Head *
_PyGCHead_PREV(PyGC_Head *gc) {
    uintptr_t prev = (gc->_gc_prev & _PyGC_PREV_MASK);
    return (PyGC_Head *)prev;
}

static inline void
_PyGCHead_SET_PREV(PyGC_Head *gc, PyGC_Head *prev) {
...
static inline void
_PyGC_CLEAR_FINALIZED(PyObject *op) {
#ifdef Py_GIL_DISABLED
...
extern void
_PyGC_InitState(struct _gc_runtime_state *);
...
extern int
_PyGC_VisitFrameStack(struct _PyInterpreterFrame *frame, visitproc visit, void *arg);
extern int
_PyGC_VisitStackRef(union _PyStackRef *ref, visitproc visit, void *arg);
