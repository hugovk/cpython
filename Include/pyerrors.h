...
PyAPI_FUNC(void) PyErr_SetString(
    PyObject *exception, const char *string /* decoded from utf-8 */
);
...
PyAPI_FUNC(PyObject *) PyErr_SetFromErrnoWithFilename(
    PyObject *exc, const char *filename /* decoded from the filesystem encoding */
);
...
PyAPI_FUNC(PyObject *) PyErr_SetFromWindowsErrWithFilename(
    int ierr, const char *filename /* decoded from the filesystem encoding */
);
...
#if !defined(Py_LIMITED_API) || Py_LIMITED_API + 0 >= 0x03040000
PyAPI_FUNC(PyObject *)
    PyErr_SetExcFromWindowsErrWithFilenameObjects(PyObject *, int, PyObject *, PyObject *);
#endif
...
PyAPI_FUNC(int) PyUnicodeEncodeError_SetReason(
    PyObject *exc, const char *reason /* UTF-8 encoded string */
);
