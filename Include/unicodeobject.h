...
PyAPI_FUNC(PyObject *) PyUnicode_FromString(const char *u /* UTF-8 encoded string */
);
...
PyAPI_FUNC(Py_UCS4 *) PyUnicode_AsUCS4(
    PyObject *unicode, Py_UCS4 *buffer, Py_ssize_t buflen, int copy_null
);
...
PyAPI_FUNC(PyObject *) PyUnicode_FromObject(PyObject *obj /* Object */
);
...
PyAPI_FUNC(PyObject *)
    PyUnicode_InternFromString(const char *u /* UTF-8 encoded string */
    );
...
PyAPI_FUNC(PyObject *)
    PyUnicode_BuildEncodingMap(PyObject *string /* 256 character map */
    );
...
PyAPI_FUNC(PyObject *) PyUnicode_AsUTF32String(PyObject *unicode /* Unicode object */
);
...
PyAPI_FUNC(PyObject *) PyUnicode_AsUTF16String(PyObject *unicode /* Unicode object */
);
...
PyAPI_FUNC(PyObject *)
    PyUnicode_AsUnicodeEscapeString(PyObject *unicode /* Unicode object */
    );
...
PyAPI_FUNC(PyObject *)
    PyUnicode_AsRawUnicodeEscapeString(PyObject *unicode /* Unicode object */
    );
...
PyAPI_FUNC(PyObject *) PyUnicode_AsLatin1String(PyObject *unicode /* Unicode object */
);
...
PyAPI_FUNC(PyObject *) PyUnicode_AsASCIIString(PyObject *unicode /* Unicode object */
);
...
PyAPI_FUNC(PyObject *) PyUnicode_AsMBCSString(PyObject *unicode /* Unicode object */
);
...
PyAPI_FUNC(PyObject *) PyUnicode_DecodeLocale(const char *str, const char *errors);
...
PyAPI_FUNC(PyObject *) PyUnicode_EncodeLocale(PyObject *unicode, const char *errors);
#endif
...
PyAPI_FUNC(PyObject *) PyUnicode_DecodeFSDefault(const char *s /* encoded string */
);
...
PyAPI_FUNC(int) PyUnicode_CompareWithASCIIString(
    PyObject *left, const char *right /* ASCII-encoded string */
);
