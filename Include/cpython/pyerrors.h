...
typedef struct {
    PyException_HEAD PyObject *value;
} PyStopIterationObject;

typedef struct {
    PyException_HEAD PyObject *name;
} PyNameErrorObject;

typedef struct {
    PyException_HEAD PyObject *obj;
    PyObject *name;
...
PyAPI_FUNC(PyObject *) PyUnstable_Exc_PrepReraiseStar(PyObject *orig, PyObject *excs);
...
PyAPI_FUNC(void) _Py_NO_RETURN
    _Py_FatalErrorFunc(const char *func, const char *message);
