...
struct tok_state {
    ...
    char *interactive_src_start; /* The start of the source parsed so far in interactive
                                    mode */
    char *interactive_src_end;   /* The end of the source parsed so far in interactive
                                    mode */
    ...
    int (*underflow)(struct tok_state *); /* Function to call when buffer is empty and
...
void
_PyTokenizer_Free(struct tok_state *);
void
_PyToken_Free(struct token *);
void
_PyToken_Init(struct token *);
