...
#define WINREG_HKEYTYPE_CLOSE_METHODDEF  \
    {"Close",                            \
     (PyCFunction)winreg_HKEYType_Close, \
     METH_NOARGS,                        \
     winreg_HKEYType_Close__doc__},
...
#define WINREG_HKEYTYPE_DETACH_METHODDEF  \
    {"Detach",                            \
     (PyCFunction)winreg_HKEYType_Detach, \
     METH_NOARGS,                         \
     winreg_HKEYType_Detach__doc__},
...
PyDoc_STRVAR(
    winreg_HKEYType___enter____doc__,
    "__enter__($self, /)\n"
    "--\n"
    "\n"
);
...
#define WINREG_HKEYTYPE___ENTER___METHODDEF  \
    {"__enter__",                            \
     (PyCFunction)winreg_HKEYType___enter__, \
     METH_NOARGS,                            \
     winreg_HKEYType___enter____doc__},
...
#if (defined(MS_WINDOWS_DESKTOP) || defined(MS_WINDOWS_SYSTEM) || \
     defined(MS_WINDOWS_GAMES)) &&                                \
    (defined(MS_WINDOWS_DESKTOP) || defined(MS_WINDOWS_SYSTEM))

PyDoc_STRVAR(
    winreg_ConnectRegistry__doc__,
...
#define WINREG_CONNECTREGISTRY_METHODDEF        \
    {"ConnectRegistry",                         \
     _PyCFunction_CAST(winreg_ConnectRegistry), \
     METH_FASTCALL,                             \
     winreg_ConnectRegistry__doc__},
...
#endif /* (defined(MS_WINDOWS_DESKTOP) || defined(MS_WINDOWS_SYSTEM) || \
          defined(MS_WINDOWS_GAMES)) && (defined(MS_WINDOWS_DESKTOP) || \
...
#define WINREG_CREATEKEY_METHODDEF        \
    {"CreateKey",                         \
     _PyCFunction_CAST(winreg_CreateKey), \
     METH_FASTCALL,                       \
     winreg_CreateKey__doc__},
...
#define WINREG_CREATEKEYEX_METHODDEF        \
    {"CreateKeyEx",                         \
     _PyCFunction_CAST(winreg_CreateKeyEx), \
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "key", "sub_key", "reserved", "access", NULL
    };
...
#define WINREG_DELETEKEY_METHODDEF        \
    {"DeleteKey",                         \
     _PyCFunction_CAST(winreg_DeleteKey), \
     METH_FASTCALL,                       \
     winreg_DeleteKey__doc__},
...
#define WINREG_DELETEKEYEX_METHODDEF        \
    {"DeleteKeyEx",                         \
     _PyCFunction_CAST(winreg_DeleteKeyEx), \
     METH_FASTCALL | METH_KEYWORDS,         \
     winreg_DeleteKeyEx__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "key", "sub_key", "access", "reserved", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "DeleteKeyEx",
...
#define WINREG_DELETEVALUE_METHODDEF        \
    {"DeleteValue",                         \
     _PyCFunction_CAST(winreg_DeleteValue), \
     METH_FASTCALL,                         \
     winreg_DeleteValue__doc__},
...
#define WINREG_ENUMKEY_METHODDEF        \
    {"EnumKey",                         \
     _PyCFunction_CAST(winreg_EnumKey), \
     METH_FASTCALL,                     \
     winreg_EnumKey__doc__},
...
#define WINREG_ENUMVALUE_METHODDEF        \
    {"EnumValue",                         \
     _PyCFunction_CAST(winreg_EnumValue), \
     METH_FASTCALL,                       \
     winreg_EnumValue__doc__},
...
PyDoc_STRVAR(
    winreg_ExpandEnvironmentStrings__doc__,
...
#define WINREG_LOADKEY_METHODDEF        \
    {"LoadKey",                         \
     _PyCFunction_CAST(winreg_LoadKey), \
     METH_FASTCALL,                     \
     winreg_LoadKey__doc__},
...
#define WINREG_OPENKEY_METHODDEF        \
    {"OpenKey",                         \
     _PyCFunction_CAST(winreg_OpenKey), \
     METH_FASTCALL | METH_KEYWORDS,     \
     winreg_OpenKey__doc__},
...
#define WINREG_OPENKEYEX_METHODDEF        \
    {"OpenKeyEx",                         \
     _PyCFunction_CAST(winreg_OpenKeyEx), \
     METH_FASTCALL | METH_KEYWORDS,       \
     winreg_OpenKeyEx__doc__},
...
#define WINREG_QUERYINFOKEY_METHODDEF  \
    {"QueryInfoKey",                   \
     (PyCFunction)winreg_QueryInfoKey, \
     METH_O,                           \
     winreg_QueryInfoKey__doc__},
...
#define WINREG_QUERYVALUEEX_METHODDEF        \
    {"QueryValueEx",                         \
     _PyCFunction_CAST(winreg_QueryValueEx), \
     METH_FASTCALL,                          \
     winreg_QueryValueEx__doc__},
...
#define WINREG_SAVEKEY_METHODDEF        \
    {"SaveKey",                         \
     _PyCFunction_CAST(winreg_SaveKey), \
     METH_FASTCALL,                     \
     winreg_SaveKey__doc__},
...
#define WINREG_SETVALUE_METHODDEF        \
    {"SetValue",                         \
     _PyCFunction_CAST(winreg_SetValue), \
     METH_FASTCALL,                      \
     winreg_SetValue__doc__},
...
#define WINREG_SETVALUEEX_METHODDEF        \
    {"SetValueEx",                         \
     _PyCFunction_CAST(winreg_SetValueEx), \
     METH_FASTCALL,                        \
     winreg_SetValueEx__doc__},
...
winreg_SetValueEx(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    value = args[4];
    return_value =
        winreg_SetValueEx_impl(module, key, value_name, reserved, type, value);
...
PyDoc_STRVAR(
    winreg_DisableReflectionKey__doc__,
...
#define WINREG_DISABLEREFLECTIONKEY_METHODDEF  \
    {"DisableReflectionKey",                   \
     (PyCFunction)winreg_DisableReflectionKey, \
     METH_O,                                   \
     winreg_DisableReflectionKey__doc__},
...
PyDoc_STRVAR(
    winreg_EnableReflectionKey__doc__,
...
#define WINREG_ENABLEREFLECTIONKEY_METHODDEF  \
    {"EnableReflectionKey",                   \
     (PyCFunction)winreg_EnableReflectionKey, \
     METH_O,                                  \
     winreg_EnableReflectionKey__doc__},
...
PyDoc_STRVAR(
    winreg_QueryReflectionKey__doc__,
...
#define WINREG_QUERYREFLECTIONKEY_METHODDEF  \
    {"QueryReflectionKey",                   \
     (PyCFunction)winreg_QueryReflectionKey, \
     METH_O,                                 \
     winreg_QueryReflectionKey__doc__},
