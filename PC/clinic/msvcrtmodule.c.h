...
#define MSVCRT_LOCKING_METHODDEF        \
    {"locking",                         \
     _PyCFunction_CAST(msvcrt_locking), \
     METH_FASTCALL,                     \
     msvcrt_locking__doc__},
...
#define MSVCRT_SETMODE_METHODDEF        \
    {"setmode",                         \
     _PyCFunction_CAST(msvcrt_setmode), \
     METH_FASTCALL,                     \
     msvcrt_setmode__doc__},
...
#define MSVCRT_GET_OSFHANDLE_METHODDEF  \
    {"get_osfhandle",                   \
     (PyCFunction)msvcrt_get_osfhandle, \
     METH_O,                            \
     msvcrt_get_osfhandle__doc__},
...
msvcrt_get_osfhandle(PyObject *module, PyObject *arg) {
    ...
    if ((_return_value == NULL || _return_value == INVALID_HANDLE_VALUE) &&
        PyErr_Occurred()) {
        goto exit;
    }
...
#define MSVCRT_CRTSETREPORTFILE_METHODDEF        \
    {"CrtSetReportFile",                         \
     _PyCFunction_CAST(msvcrt_CrtSetReportFile), \
     METH_FASTCALL,                              \
     msvcrt_CrtSetReportFile__doc__},
...
PyDoc_STRVAR(
    msvcrt_CrtSetReportMode__doc__,
...
#define MSVCRT_CRTSETREPORTMODE_METHODDEF        \
    {"CrtSetReportMode",                         \
     _PyCFunction_CAST(msvcrt_CrtSetReportMode), \
     METH_FASTCALL,                              \
     msvcrt_CrtSetReportMode__doc__},
...
#define MSVCRT_GETERRORMODE_METHODDEF  \
    {"GetErrorMode",                   \
     (PyCFunction)msvcrt_GetErrorMode, \
     METH_NOARGS,                      \
     msvcrt_GetErrorMode__doc__},
