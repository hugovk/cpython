...
#define WINSOUND_PLAYSOUND_METHODDEF                  \
    {"PlaySound",                                     \
     (PyCFunction)(void (*)(void))winsound_PlaySound, \
...
winsound_PlaySound(PyObject *module, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTupleAndKeywords(
            args, kwargs, "Oi:PlaySound", _keywords, &sound, &flags
        ))
        goto exit;
...
#define WINSOUND_BEEP_METHODDEF                  \
    {"Beep",                                     \
     (PyCFunction)(void (*)(void))winsound_Beep, \
     METH_VARARGS | METH_KEYWORDS,               \
     winsound_Beep__doc__},
...
winsound_Beep(PyObject *module, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTupleAndKeywords(
            args, kwargs, "ii:Beep", _keywords, &frequency, &duration
        ))
        goto exit;
...
#define WINSOUND_MESSAGEBEEP_METHODDEF                  \
    {"MessageBeep",                                     \
     (PyCFunction)(void (*)(void))winsound_MessageBeep, \
     METH_VARARGS | METH_KEYWORDS,                      \
     winsound_MessageBeep__doc__},
...
winsound_MessageBeep(PyObject *module, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|i:MessageBeep", _keywords, &type))
        goto exit;
