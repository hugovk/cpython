...
PyDoc_STRVAR(
    _testconsole_write_input__doc__,
...
#define _TESTCONSOLE_WRITE_INPUT_METHODDEF                  \
    {"write_input",                                         \
     (PyCFunction)(void (*)(void))_testconsole_write_input, \
...
_testconsole_write_input(PyObject *module, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTupleAndKeywords(
            args, kwargs, "Oy*:write_input", _keywords, &file, &s
        ))
        goto exit;
...
#define _TESTCONSOLE_READ_OUTPUT_METHODDEF                  \
    {"read_output",                                         \
     (PyCFunction)(void (*)(void))_testconsole_read_output, \
     METH_VARARGS | METH_KEYWORDS,                          \
     _testconsole_read_output__doc__},
...
_testconsole_read_output(PyObject *module, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:read_output", _keywords, &file))
        goto exit;
