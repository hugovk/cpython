...
typedef struct {
    PyObject_HEAD PyObject *ns_dict;
} _PyNamespaceObject;
...
namespace_repr(PyObject *ns) {
    ...
    name = Py_IS_TYPE(ns, &_PyNamespace_Type) ? "namespace" : Py_TYPE(ns)->tp_name;
...
namespace_richcompare(PyObject *self, PyObject *other, int op) {
    if (PyObject_TypeCheck(self, &_PyNamespace_Type) &&
        ...
        return PyObject_RichCompare(
            ((_PyNamespaceObject *)self)->ns_dict,
            ((_PyNamespaceObject *)other)->ns_dict,
            op
        );
...
namespace_replace(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    if (PyDict_Update(
            ((_PyNamespaceObject *)result)->ns_dict,
            ((_PyNamespaceObject *)self)->ns_dict
        ) < 0) {
        Py_DECREF(result);
        return NULL;
...
static PyMethodDef namespace_methods[] = {
    {"__reduce__", (PyCFunction)namespace_reduce, METH_NOARGS, namespace_reduce__doc__},
    {"__replace__",
     _PyCFunction_CAST(namespace_replace),
