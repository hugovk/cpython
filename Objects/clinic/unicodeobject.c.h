...
#define UNICODE_CAPITALIZE_METHODDEF  \
    {"capitalize",                    \
     (PyCFunction)unicode_capitalize, \
     METH_NOARGS,                     \
     unicode_capitalize__doc__},
...
#define UNICODE_ENCODE_METHODDEF        \
    {"encode",                          \
     _PyCFunction_CAST(unicode_encode), \
...
#define UNICODE_EXPANDTABS_METHODDEF        \
    {"expandtabs",                          \
     _PyCFunction_CAST(unicode_expandtabs), \
     METH_FASTCALL | METH_KEYWORDS,         \
     unicode_expandtabs__doc__},
...
#define UNICODE_REPLACE_METHODDEF        \
    {"replace",                          \
     _PyCFunction_CAST(unicode_replace), \
     METH_FASTCALL | METH_KEYWORDS,      \
     unicode_replace__doc__},
...
#define UNICODE_REMOVEPREFIX_METHODDEF  \
    {"removeprefix",                    \
     (PyCFunction)unicode_removeprefix, \
     METH_O,                            \
     unicode_removeprefix__doc__},
...
#define UNICODE_REMOVESUFFIX_METHODDEF  \
    {"removesuffix",                    \
     (PyCFunction)unicode_removesuffix, \
     METH_O,                            \
     unicode_removesuffix__doc__},
...
#define UNICODE_SPLIT_METHODDEF        \
    {"split",                          \
     _PyCFunction_CAST(unicode_split), \
     METH_FASTCALL | METH_KEYWORDS,    \
     unicode_split__doc__},
...
#define UNICODE_RSPLIT_METHODDEF        \
    {"rsplit",                          \
     _PyCFunction_CAST(unicode_rsplit), \
     METH_FASTCALL | METH_KEYWORDS,     \
     unicode_rsplit__doc__},
...
#define UNICODE_SPLITLINES_METHODDEF        \
    {"splitlines",                          \
     _PyCFunction_CAST(unicode_splitlines), \
     METH_FASTCALL | METH_KEYWORDS,         \
     unicode_splitlines__doc__},
...
#define UNICODE_MAKETRANS_METHODDEF        \
    {"maketrans",                          \
     _PyCFunction_CAST(unicode_maketrans), \
...
#define UNICODE_STARTSWITH_METHODDEF        \
    {"startswith",                          \
     _PyCFunction_CAST(unicode_startswith), \
     METH_FASTCALL,                         \
     unicode_startswith__doc__},
...
#define UNICODE_ENDSWITH_METHODDEF        \
    {"endswith",                          \
     _PyCFunction_CAST(unicode_endswith), \
     METH_FASTCALL,                       \
     unicode_endswith__doc__},
