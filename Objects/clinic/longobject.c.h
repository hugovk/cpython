...
#define INT___GETNEWARGS___METHODDEF  \
    {"__getnewargs__",                \
     (PyCFunction)int___getnewargs__, \
     METH_NOARGS,                     \
     int___getnewargs____doc__},
...
#define INT___ROUND___METHODDEF        \
    {"__round__",                      \
     _PyCFunction_CAST(int___round__), \
     METH_FASTCALL,                    \
     int___round____doc__},
...
#define INT_AS_INTEGER_RATIO_METHODDEF  \
    {"as_integer_ratio",                \
     (PyCFunction)int_as_integer_ratio, \
     METH_NOARGS,                       \
     int_as_integer_ratio__doc__},
...
#define INT_TO_BYTES_METHODDEF        \
    {"to_bytes",                      \
     _PyCFunction_CAST(int_to_bytes), \
     METH_FASTCALL | METH_KEYWORDS,   \
     int_to_bytes__doc__},

static PyObject *
int_to_bytes_impl(
    PyObject *self, Py_ssize_t length, PyObject *byteorder, int is_signed
);
...
#define INT_FROM_BYTES_METHODDEF                 \
    {"from_bytes",                               \
     _PyCFunction_CAST(int_from_bytes),          \
