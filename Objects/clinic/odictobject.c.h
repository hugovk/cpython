...
#define ORDEREDDICT_FROMKEYS_METHODDEF           \
    {"fromkeys",                                 \
     _PyCFunction_CAST(OrderedDict_fromkeys),    \
...
#define ORDEREDDICT_SETDEFAULT_METHODDEF        \
    {"setdefault",                              \
     _PyCFunction_CAST(OrderedDict_setdefault), \
     METH_FASTCALL | METH_KEYWORDS,             \
     OrderedDict_setdefault__doc__},

static PyObject *
OrderedDict_setdefault_impl(
    PyODictObject *self, PyObject *key, PyObject *default_value
);

static PyObject *
OrderedDict_setdefault(
    PyODictObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
PyDoc_STRVAR(
    ...
    "--\n"
    "\n"
    "od.pop(key[,default]) -> v, remove specified key and return the corresponding "
    "value.\n"
    "\n"
...
#define ORDEREDDICT_POP_METHODDEF        \
    {"pop",                              \
     _PyCFunction_CAST(OrderedDict_pop), \
     METH_FASTCALL | METH_KEYWORDS,      \
     OrderedDict_pop__doc__},
...
#define ORDEREDDICT_POPITEM_METHODDEF        \
    {"popitem",                              \
     _PyCFunction_CAST(OrderedDict_popitem), \
     METH_FASTCALL | METH_KEYWORDS,          \
     OrderedDict_popitem__doc__},
...
PyDoc_STRVAR(
    OrderedDict_move_to_end__doc__,
...
#define ORDEREDDICT_MOVE_TO_END_METHODDEF        \
    {"move_to_end",                              \
     _PyCFunction_CAST(OrderedDict_move_to_end), \
     METH_FASTCALL | METH_KEYWORDS,              \
     OrderedDict_move_to_end__doc__},
