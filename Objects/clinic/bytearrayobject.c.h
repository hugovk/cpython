...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 0, 3, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
...
skip_optional_pos:
    return_value =
        bytearray___init___impl((PyByteArrayObject *)self, arg, encoding, errors);
...
PyDoc_STRVAR(
    ...
    "--\n"
    "\n"
    "Return the lowest index in B where subsection \'sub\' is found, such that \'sub\' "
    "is contained within B[start:end].\n"
    "\n"
    "  start\n"
...
#define BYTEARRAY_COUNT_METHODDEF        \
    {"count",                            \
     _PyCFunction_CAST(bytearray_count), \
     METH_FASTCALL,                      \
     bytearray_count__doc__},
...
#define BYTEARRAY_INDEX_METHODDEF        \
    {"index",                            \
     _PyCFunction_CAST(bytearray_index), \
     METH_FASTCALL,                      \
     bytearray_index__doc__},
...
PyDoc_STRVAR(
    bytearray_rfind__doc__,
    "rfind($self, sub[, start[, end]], /)\n"
    "--\n"
    "\n"
    "Return the highest index in B where subsection \'sub\' is found, such that "
    "\'sub\' is contained within B[start:end].\n"
    "\n"
    "  start\n"
    "    Optional start position. Default: start of the bytes.\n"
    "  end\n"
...
#define BYTEARRAY_RFIND_METHODDEF        \
    {"rfind",                            \
     _PyCFunction_CAST(bytearray_rfind), \
     METH_FASTCALL,                      \
     bytearray_rfind__doc__},
...
#define BYTEARRAY_RINDEX_METHODDEF        \
    {"rindex",                            \
     _PyCFunction_CAST(bytearray_rindex), \
     METH_FASTCALL,                       \
     bytearray_rindex__doc__},
...
#define BYTEARRAY_STARTSWITH_METHODDEF        \
    {"startswith",                            \
     _PyCFunction_CAST(bytearray_startswith), \
     METH_FASTCALL,                           \
     bytearray_startswith__doc__},
...
#define BYTEARRAY_ENDSWITH_METHODDEF        \
    {"endswith",                            \
     _PyCFunction_CAST(bytearray_endswith), \
     METH_FASTCALL,                         \
     bytearray_endswith__doc__},
...
#define BYTEARRAY_REMOVEPREFIX_METHODDEF  \
    {"removeprefix",                      \
     (PyCFunction)bytearray_removeprefix, \
     METH_O,                              \
     bytearray_removeprefix__doc__},
...
#define BYTEARRAY_REMOVESUFFIX_METHODDEF  \
    {"removesuffix",                      \
     (PyCFunction)bytearray_removesuffix, \
     METH_O,                              \
     bytearray_removesuffix__doc__},
...
#define BYTEARRAY_TRANSLATE_METHODDEF        \
    {"translate",                            \
     _PyCFunction_CAST(bytearray_translate), \
...
static PyObject *
bytearray_translate(
    PyByteArrayObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define BYTEARRAY_MAKETRANS_METHODDEF        \
    {"maketrans",                            \
     _PyCFunction_CAST(bytearray_maketrans), \
...
#define BYTEARRAY_REPLACE_METHODDEF        \
    {"replace",                            \
     _PyCFunction_CAST(bytearray_replace), \
     METH_FASTCALL,                        \
     bytearray_replace__doc__},
...
#define BYTEARRAY_SPLIT_METHODDEF        \
    {"split",                            \
     _PyCFunction_CAST(bytearray_split), \
     METH_FASTCALL | METH_KEYWORDS,      \
     bytearray_split__doc__},
...
#define BYTEARRAY_RSPLIT_METHODDEF        \
    {"rsplit",                            \
     _PyCFunction_CAST(bytearray_rsplit), \
     METH_FASTCALL | METH_KEYWORDS,       \
     bytearray_rsplit__doc__},
...
#define BYTEARRAY_INSERT_METHODDEF        \
    {"insert",                            \
     _PyCFunction_CAST(bytearray_insert), \
     METH_FASTCALL,                       \
     bytearray_insert__doc__},
...
#define BYTEARRAY_STRIP_METHODDEF        \
    {"strip",                            \
     _PyCFunction_CAST(bytearray_strip), \
     METH_FASTCALL,                      \
     bytearray_strip__doc__},
...
#define BYTEARRAY_LSTRIP_METHODDEF        \
    {"lstrip",                            \
     _PyCFunction_CAST(bytearray_lstrip), \
     METH_FASTCALL,                       \
     bytearray_lstrip__doc__},
...
#define BYTEARRAY_RSTRIP_METHODDEF        \
    {"rstrip",                            \
     _PyCFunction_CAST(bytearray_rstrip), \
     METH_FASTCALL,                       \
     bytearray_rstrip__doc__},
...
#define BYTEARRAY_DECODE_METHODDEF        \
    {"decode",                            \
     _PyCFunction_CAST(bytearray_decode), \
     METH_FASTCALL | METH_KEYWORDS,       \
     bytearray_decode__doc__},

static PyObject *
bytearray_decode_impl(
    PyByteArrayObject *self, const char *encoding, const char *errors
);
...
#define BYTEARRAY_HEX_METHODDEF        \
    {"hex",                            \
     _PyCFunction_CAST(bytearray_hex), \
     METH_FASTCALL | METH_KEYWORDS,    \
     bytearray_hex__doc__},
...
#define BYTEARRAY_REDUCE_EX_METHODDEF        \
    {"__reduce_ex__",                        \
     _PyCFunction_CAST(bytearray_reduce_ex), \
     METH_FASTCALL,                          \
     bytearray_reduce_ex__doc__},
