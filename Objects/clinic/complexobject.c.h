...
#define COMPLEX___GETNEWARGS___METHODDEF  \
    {"__getnewargs__",                    \
     (PyCFunction)complex___getnewargs__, \
     METH_NOARGS,                         \
     complex___getnewargs____doc__},
...
#define COMPLEX___COMPLEX___METHODDEF  \
    {"__complex__",                    \
     (PyCFunction)complex___complex__, \
     METH_NOARGS,                      \
     complex___complex____doc__},
...
#define COMPLEX_FROM_NUMBER_METHODDEF  \
    {"from_number",                    \
     (PyCFunction)complex_from_number, \
     METH_O | METH_CLASS,              \
     complex_from_number__doc__},
