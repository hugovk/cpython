...
static PyObject *
bytes_split(
    PyBytesObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
...
#define BYTES_RSPLIT_METHODDEF        \
    {"rsplit",                        \
     _PyCFunction_CAST(bytes_rsplit), \
     METH_FASTCALL | METH_KEYWORDS,   \
     bytes_rsplit__doc__},
...
#define BYTES_TRANSLATE_METHODDEF        \
    {"translate",                        \
     _PyCFunction_CAST(bytes_translate), \
     METH_FASTCALL | METH_KEYWORDS,      \
     bytes_translate__doc__},
...
#define BYTES_MAKETRANS_METHODDEF        \
    {"maketrans",                        \
     _PyCFunction_CAST(bytes_maketrans), \
...
#define BYTES_REMOVEPREFIX_METHODDEF  \
    {"removeprefix",                  \
     (PyCFunction)bytes_removeprefix, \
     METH_O,                          \
     bytes_removeprefix__doc__},
...
#define BYTES_REMOVESUFFIX_METHODDEF  \
    {"removesuffix",                  \
     (PyCFunction)bytes_removesuffix, \
     METH_O,                          \
     bytes_removesuffix__doc__},
...
#define BYTES_STARTSWITH_METHODDEF        \
    {"startswith",                        \
     _PyCFunction_CAST(bytes_startswith), \
     METH_FASTCALL,                       \
     bytes_startswith__doc__},
...
#define BYTES_ENDSWITH_METHODDEF        \
    {"endswith",                        \
     _PyCFunction_CAST(bytes_endswith), \
     METH_FASTCALL,                     \
     bytes_endswith__doc__},
...
#define BYTES_DECODE_METHODDEF        \
    {"decode",                        \
     _PyCFunction_CAST(bytes_decode), \
     METH_FASTCALL | METH_KEYWORDS,   \
     bytes_decode__doc__},
...
#define BYTES_SPLITLINES_METHODDEF        \
    {"splitlines",                        \
     _PyCFunction_CAST(bytes_splitlines), \
     METH_FASTCALL | METH_KEYWORDS,       \
     bytes_splitlines__doc__},
