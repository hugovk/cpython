...
#define MEMORYVIEW__FROM_FLAGS_METHODDEF         \
    {"_from_flags",                              \
     _PyCFunction_CAST(memoryview__from_flags),  \
...
#define MEMORYVIEW_RELEASE_METHODDEF  \
    {"release",                       \
     (PyCFunction)memoryview_release, \
     METH_NOARGS,                     \
     memoryview_release__doc__},
...
#define MEMORYVIEW_CAST_METHODDEF        \
    {"cast",                             \
     _PyCFunction_CAST(memoryview_cast), \
...
static PyObject *
memoryview_cast(
    PyMemoryViewObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define MEMORYVIEW_TOREADONLY_METHODDEF  \
    {"toreadonly",                       \
     (PyCFunction)memoryview_toreadonly, \
     METH_NOARGS,                        \
     memoryview_toreadonly__doc__},
...
#define MEMORYVIEW_TOBYTES_METHODDEF        \
    {"tobytes",                             \
     _PyCFunction_CAST(memoryview_tobytes), \
     METH_FASTCALL | METH_KEYWORDS,         \
     memoryview_tobytes__doc__},
...
#define MEMORYVIEW_HEX_METHODDEF        \
    {"hex",                             \
     _PyCFunction_CAST(memoryview_hex), \
     METH_FASTCALL | METH_KEYWORDS,     \
     memoryview_hex__doc__},

static PyObject *
memoryview_hex_impl(PyMemoryViewObject *self, PyObject *sep, int bytes_per_sep);
