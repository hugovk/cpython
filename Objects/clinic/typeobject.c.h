...
#define TYPE___INSTANCECHECK___METHODDEF  \
    {"__instancecheck__",                 \
     (PyCFunction)type___instancecheck__, \
     METH_O,                              \
     type___instancecheck____doc__},
...
#define TYPE___SUBCLASSCHECK___METHODDEF  \
    {"__subclasscheck__",                 \
     (PyCFunction)type___subclasscheck__, \
     METH_O,                              \
     type___subclasscheck____doc__},
...
#define TYPE_MRO_METHODDEF {"mro", (PyCFunction)type_mro, METH_NOARGS, type_mro__doc__},
...
#define TYPE___SUBCLASSES___METHODDEF  \
    {"__subclasses__",                 \
     (PyCFunction)type___subclasses__, \
     METH_NOARGS,                      \
     type___subclasses____doc__},
...
#define OBJECT___GETSTATE___METHODDEF  \
    {"__getstate__",                   \
     (PyCFunction)object___getstate__, \
     METH_NOARGS,                      \
     object___getstate____doc__},
...
#define OBJECT___REDUCE_EX___METHODDEF  \
    {"__reduce_ex__",                   \
     (PyCFunction)object___reduce_ex__, \
     METH_O,                            \
     object___reduce_ex____doc__},
