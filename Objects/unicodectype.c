...
Py_UCS4
_PyUnicode_ToTitlecase(Py_UCS4 ch) {
...
int
_PyUnicode_IsTitlecase(Py_UCS4 ch) {
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int
_PyUnicode_ToDecimalDigit(Py_UCS4 ch) {
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int
_PyUnicode_IsDecimalDigit(Py_UCS4 ch) {
...
int
_PyUnicode_IsNumeric(Py_UCS4 ch) {
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
*/
int
_PyUnicode_IsPrintable(Py_UCS4 ch) {
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int
_PyUnicode_IsLowercase(Py_UCS4 ch) {
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int
_PyUnicode_IsUppercase(Py_UCS4 ch) {
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
Py_UCS4
_PyUnicode_ToLowercase(Py_UCS4 ch) {
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
_PyUnicode_ToLowerFull(Py_UCS4 ch, Py_UCS4 *res) {
    ...
    if (ctype->flags & EXTENDED_CASE_MASK) {
        ...
        int i;
        for (i = 0; i < n; i++) res[i] = _PyUnicode_ExtendedCase[index + i];
        return n;
    }
