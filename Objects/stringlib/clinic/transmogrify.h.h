...
#define STRINGLIB_EXPANDTABS_METHODDEF        \
    {"expandtabs",                            \
     _PyCFunction_CAST(stringlib_expandtabs), \
...
#define STRINGLIB_LJUST_METHODDEF        \
    {"ljust",                            \
     _PyCFunction_CAST(stringlib_ljust), \
     METH_FASTCALL,                      \
     stringlib_ljust__doc__},
...
#define STRINGLIB_RJUST_METHODDEF        \
    {"rjust",                            \
     _PyCFunction_CAST(stringlib_rjust), \
     METH_FASTCALL,                      \
     stringlib_rjust__doc__},
...
#define STRINGLIB_CENTER_METHODDEF        \
    {"center",                            \
     _PyCFunction_CAST(stringlib_center), \
     METH_FASTCALL,                       \
     stringlib_center__doc__},
...
stringlib_center(PyObject *self, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (PyBytes_Check(args[1])) {
        ...
        _PyArg_BadArgument(
            "center", "argument 2", "a byte string of length 1", args[1]
        );
        goto exit;
    }
skip_optional:
