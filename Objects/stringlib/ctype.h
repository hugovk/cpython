...
stringlib_lower(PyObject *self, PyObject *Py_UNUSED(ignored)) {
    ...
    if (!newobj)
        return NULL;
    _Py_bytes_lower(STRINGLIB_STR(newobj), STRINGLIB_STR(self), STRINGLIB_LEN(self));
    return newobj;
}
...
stringlib_upper(PyObject *self, PyObject *Py_UNUSED(ignored)) {
    ...
    if (!newobj)
        return NULL;
    _Py_bytes_upper(STRINGLIB_STR(newobj), STRINGLIB_STR(self), STRINGLIB_LEN(self));
    return newobj;
}
...
stringlib_title(PyObject *self, PyObject *Py_UNUSED(ignored)) {
    ...
    if (!newobj)
        return NULL;
    _Py_bytes_title(STRINGLIB_STR(newobj), STRINGLIB_STR(self), STRINGLIB_LEN(self));
    return newobj;
}
...
stringlib_capitalize(PyObject *self, PyObject *Py_UNUSED(ignored)) {
    ...
    _Py_bytes_capitalize(
        STRINGLIB_STR(newobj), STRINGLIB_STR(self), STRINGLIB_LEN(self)
    );
    return newobj;
}
...
stringlib_swapcase(PyObject *self, PyObject *Py_UNUSED(ignored)) {
    ...
    if (!newobj)
        return NULL;
    _Py_bytes_swapcase(STRINGLIB_STR(newobj), STRINGLIB_STR(self), STRINGLIB_LEN(self));
    return newobj;
}
