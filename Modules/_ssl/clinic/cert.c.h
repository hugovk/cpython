...
PyDoc_STRVAR(
    _ssl_Certificate_public_bytes__doc__,
...
#define _SSL_CERTIFICATE_PUBLIC_BYTES_METHODDEF        \
    {"public_bytes",                                   \
     _PyCFunction_CAST(_ssl_Certificate_public_bytes), \
...
static PyObject *
_ssl_Certificate_public_bytes(
    PySSLCertificate *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
...
PyDoc_STRVAR(
    _ssl_Certificate_get_info__doc__,
    "get_info($self, /)\n"
    "--\n"
    "\n"
);
...
#define _SSL_CERTIFICATE_GET_INFO_METHODDEF  \
    {"get_info",                             \
     (PyCFunction)_ssl_Certificate_get_info, \
     METH_NOARGS,                            \
     _ssl_Certificate_get_info__doc__},
