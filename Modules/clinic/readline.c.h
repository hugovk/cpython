...
#define READLINE_PARSE_AND_BIND_METHODDEF  \
    {"parse_and_bind",                     \
     (PyCFunction)readline_parse_and_bind, \
     METH_O,                               \
     readline_parse_and_bind__doc__},
...
#define READLINE_READ_INIT_FILE_METHODDEF        \
    {"read_init_file",                           \
     _PyCFunction_CAST(readline_read_init_file), \
     METH_FASTCALL,                              \
     readline_read_init_file__doc__},
...
PyDoc_STRVAR(
    readline_read_history_file__doc__,
...
#define READLINE_READ_HISTORY_FILE_METHODDEF        \
    {"read_history_file",                           \
     _PyCFunction_CAST(readline_read_history_file), \
     METH_FASTCALL,                                 \
     readline_read_history_file__doc__},
...
PyDoc_STRVAR(
    readline_write_history_file__doc__,
...
#define READLINE_WRITE_HISTORY_FILE_METHODDEF        \
    {"write_history_file",                           \
     _PyCFunction_CAST(readline_write_history_file), \
     METH_FASTCALL,                                  \
     readline_write_history_file__doc__},
...
PyDoc_STRVAR(
    readline_append_history_file__doc__,
...
#define READLINE_APPEND_HISTORY_FILE_METHODDEF        \
    {"append_history_file",                           \
     _PyCFunction_CAST(readline_append_history_file), \
     METH_FASTCALL,                                   \
     readline_append_history_file__doc__},

static PyObject *
readline_append_history_file_impl(
    PyObject *module, int nelements, PyObject *filename_obj
);
...
PyDoc_STRVAR(
    readline_set_history_length__doc__,
...
#define READLINE_SET_HISTORY_LENGTH_METHODDEF  \
    {"set_history_length",                     \
     (PyCFunction)readline_set_history_length, \
     METH_O,                                   \
     readline_set_history_length__doc__},
...
PyDoc_STRVAR(
    readline_get_history_length__doc__,
...
#define READLINE_GET_HISTORY_LENGTH_METHODDEF  \
    {"get_history_length",                     \
     (PyCFunction)readline_get_history_length, \
     METH_NOARGS,                              \
     readline_get_history_length__doc__},
...
PyDoc_STRVAR(
    readline_set_completion_display_matches_hook__doc__,
...
#define READLINE_SET_COMPLETION_DISPLAY_MATCHES_HOOK_METHODDEF        \
    {"set_completion_display_matches_hook",                           \
     _PyCFunction_CAST(readline_set_completion_display_matches_hook), \
     METH_FASTCALL,                                                   \
     readline_set_completion_display_matches_hook__doc__},

static PyObject *
readline_set_completion_display_matches_hook_impl(PyObject *module, PyObject *function);
...
PyDoc_STRVAR(
    readline_set_startup_hook__doc__,
...
#define READLINE_SET_STARTUP_HOOK_METHODDEF        \
    {"set_startup_hook",                           \
     _PyCFunction_CAST(readline_set_startup_hook), \
     METH_FASTCALL,                                \
     readline_set_startup_hook__doc__},
...
#define READLINE_SET_PRE_INPUT_HOOK_METHODDEF        \
    {"set_pre_input_hook",                           \
     _PyCFunction_CAST(readline_set_pre_input_hook), \
     METH_FASTCALL,                                  \
     readline_set_pre_input_hook__doc__},
...
PyDoc_STRVAR(
    readline_get_completion_type__doc__,
...
#define READLINE_GET_COMPLETION_TYPE_METHODDEF  \
    {"get_completion_type",                     \
     (PyCFunction)readline_get_completion_type, \
     METH_NOARGS,                               \
     readline_get_completion_type__doc__},
...
#define READLINE_GET_BEGIDX_METHODDEF  \
    {"get_begidx",                     \
     (PyCFunction)readline_get_begidx, \
     METH_NOARGS,                      \
     readline_get_begidx__doc__},
...
#define READLINE_GET_ENDIDX_METHODDEF  \
    {"get_endidx",                     \
     (PyCFunction)readline_get_endidx, \
     METH_NOARGS,                      \
     readline_get_endidx__doc__},
...
PyDoc_STRVAR(
    readline_set_completer_delims__doc__,
...
#define READLINE_SET_COMPLETER_DELIMS_METHODDEF  \
    {"set_completer_delims",                     \
     (PyCFunction)readline_set_completer_delims, \
     METH_O,                                     \
     readline_set_completer_delims__doc__},

PyDoc_STRVAR(
    readline_remove_history_item__doc__,
...
#define READLINE_REMOVE_HISTORY_ITEM_METHODDEF  \
    {"remove_history_item",                     \
     (PyCFunction)readline_remove_history_item, \
     METH_O,                                    \
     readline_remove_history_item__doc__},
...
PyDoc_STRVAR(
    readline_replace_history_item__doc__,
...
#define READLINE_REPLACE_HISTORY_ITEM_METHODDEF        \
    {"replace_history_item",                           \
     _PyCFunction_CAST(readline_replace_history_item), \
     METH_FASTCALL,                                    \
     readline_replace_history_item__doc__},

static PyObject *
readline_replace_history_item_impl(PyObject *module, int entry_number, PyObject *line);

static PyObject *
readline_replace_history_item(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    int entry_number;
...
#define READLINE_ADD_HISTORY_METHODDEF  \
    {"add_history",                     \
     (PyCFunction)readline_add_history, \
     METH_O,                            \
     readline_add_history__doc__},

PyDoc_STRVAR(
    readline_set_auto_history__doc__,
...
#define READLINE_SET_AUTO_HISTORY_METHODDEF  \
    {"set_auto_history",                     \
     (PyCFunction)readline_set_auto_history, \
     METH_O,                                 \
     readline_set_auto_history__doc__},
...
PyDoc_STRVAR(
    readline_get_completer_delims__doc__,
...
#define READLINE_GET_COMPLETER_DELIMS_METHODDEF  \
    {"get_completer_delims",                     \
     (PyCFunction)readline_get_completer_delims, \
     METH_NOARGS,                                \
     readline_get_completer_delims__doc__},
...
#define READLINE_SET_COMPLETER_METHODDEF        \
    {"set_completer",                           \
     _PyCFunction_CAST(readline_set_completer), \
     METH_FASTCALL,                             \
     readline_set_completer__doc__},
...
#define READLINE_GET_COMPLETER_METHODDEF  \
    {"get_completer",                     \
     (PyCFunction)readline_get_completer, \
     METH_NOARGS,                         \
     readline_get_completer__doc__},
...
#define READLINE_GET_HISTORY_ITEM_METHODDEF  \
    {"get_history_item",                     \
     (PyCFunction)readline_get_history_item, \
     METH_O,                                 \
     readline_get_history_item__doc__},
...
#define READLINE_GET_CURRENT_HISTORY_LENGTH_METHODDEF  \
    {"get_current_history_length",                     \
     (PyCFunction)readline_get_current_history_length, \
     METH_NOARGS,                                      \
     readline_get_current_history_length__doc__},
...
PyDoc_STRVAR(
    readline_get_line_buffer__doc__,
...
#define READLINE_GET_LINE_BUFFER_METHODDEF  \
    {"get_line_buffer",                     \
     (PyCFunction)readline_get_line_buffer, \
     METH_NOARGS,                           \
     readline_get_line_buffer__doc__},
...
#define READLINE_CLEAR_HISTORY_METHODDEF  \
    {"clear_history",                     \
     (PyCFunction)readline_clear_history, \
     METH_NOARGS,                         \
     readline_clear_history__doc__},
...
#define READLINE_INSERT_TEXT_METHODDEF  \
    {"insert_text",                     \
     (PyCFunction)readline_insert_text, \
     METH_O,                            \
     readline_insert_text__doc__},

PyDoc_STRVAR(
    readline_redisplay__doc__,
    "redisplay($module, /)\n"
    "--\n"
    "\n"
...
#define READLINE_REDISPLAY_METHODDEF  \
    {"redisplay",                     \
     (PyCFunction)readline_redisplay, \
     METH_NOARGS,                     \
     readline_redisplay__doc__},
