...
PyDoc_STRVAR(
    _lzma_LZMACompressor_flush__doc__,
    "flush($self, /)\n"
    "--\n"
    "\n"
...
#define _LZMA_LZMACOMPRESSOR_FLUSH_METHODDEF  \
    {"flush",                                 \
     (PyCFunction)_lzma_LZMACompressor_flush, \
     METH_NOARGS,                             \
     _lzma_LZMACompressor_flush__doc__},
...
#define _LZMA_LZMADECOMPRESSOR_DECOMPRESS_METHODDEF        \
    {"decompress",                                         \
     _PyCFunction_CAST(_lzma_LZMADecompressor_decompress), \
...
_lzma_LZMADecompressor_decompress(
    Decompressor *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _LZMA_IS_CHECK_SUPPORTED_METHODDEF  \
    {"is_check_supported",                  \
     (PyCFunction)_lzma_is_check_supported, \
     METH_O,                                \
     _lzma_is_check_supported__doc__},
...
PyDoc_STRVAR(
    _lzma__decode_filter_properties__doc__,
...
#define _LZMA__DECODE_FILTER_PROPERTIES_METHODDEF        \
    {"_decode_filter_properties",                        \
     _PyCFunction_CAST(_lzma__decode_filter_properties), \
     METH_FASTCALL,                                      \
     _lzma__decode_filter_properties__doc__},
...
static PyObject *
_lzma__decode_filter_properties(
    ...
    return_value =
        _lzma__decode_filter_properties_impl(module, filter_id, &encoded_props);
