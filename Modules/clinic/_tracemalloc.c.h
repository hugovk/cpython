...
#define _TRACEMALLOC_IS_TRACING_METHODDEF  \
    {"is_tracing",                         \
     (PyCFunction)_tracemalloc_is_tracing, \
     METH_NOARGS,                          \
     _tracemalloc_is_tracing__doc__},
...
#define _TRACEMALLOC_CLEAR_TRACES_METHODDEF  \
    {"clear_traces",                         \
     (PyCFunction)_tracemalloc_clear_traces, \
     METH_NOARGS,                            \
     _tracemalloc_clear_traces__doc__},
...
#define _TRACEMALLOC__GET_TRACES_METHODDEF  \
    {"_get_traces",                         \
     (PyCFunction)_tracemalloc__get_traces, \
     METH_NOARGS,                           \
     _tracemalloc__get_traces__doc__},
...
PyDoc_STRVAR(
    _tracemalloc__get_object_traceback__doc__,
...
#define _TRACEMALLOC__GET_OBJECT_TRACEBACK_METHODDEF  \
    {"_get_object_traceback",                         \
     (PyCFunction)_tracemalloc__get_object_traceback, \
     METH_O,                                          \
     _tracemalloc__get_object_traceback__doc__},
...
#define _TRACEMALLOC_START_METHODDEF        \
    {"start",                               \
     _PyCFunction_CAST(_tracemalloc_start), \
     METH_FASTCALL,                         \
     _tracemalloc_start__doc__},
...
#define _TRACEMALLOC_GET_TRACEBACK_LIMIT_METHODDEF  \
    {"get_traceback_limit",                         \
     (PyCFunction)_tracemalloc_get_traceback_limit, \
     METH_NOARGS,                                   \
     _tracemalloc_get_traceback_limit__doc__},
...
#define _TRACEMALLOC_GET_TRACEMALLOC_MEMORY_METHODDEF  \
    {"get_tracemalloc_memory",                         \
     (PyCFunction)_tracemalloc_get_tracemalloc_memory, \
     METH_NOARGS,                                      \
     _tracemalloc_get_tracemalloc_memory__doc__},
...
PyDoc_STRVAR(
    _tracemalloc_get_traced_memory__doc__,
...
#define _TRACEMALLOC_GET_TRACED_MEMORY_METHODDEF  \
    {"get_traced_memory",                         \
     (PyCFunction)_tracemalloc_get_traced_memory, \
     METH_NOARGS,                                 \
     _tracemalloc_get_traced_memory__doc__},
...
PyDoc_STRVAR(
    _tracemalloc_reset_peak__doc__,
    "reset_peak($module, /)\n"
    "--\n"
    "\n"
...
#define _TRACEMALLOC_RESET_PEAK_METHODDEF  \
    {"reset_peak",                         \
     (PyCFunction)_tracemalloc_reset_peak, \
     METH_NOARGS,                          \
     _tracemalloc_reset_peak__doc__},
