...
#define EVPXOF_DIGEST_METHODDEF        \
    {"digest",                         \
     _PyCFunction_CAST(EVPXOF_digest), \
...
static PyObject *
EVPXOF_digest(
    EVPobject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
...
#define EVPXOF_HEXDIGEST_METHODDEF        \
    {"hexdigest",                         \
     _PyCFunction_CAST(EVPXOF_hexdigest), \
     METH_FASTCALL | METH_KEYWORDS,       \
     EVPXOF_hexdigest__doc__},
...
#define _HASHLIB_OPENSSL_MD5_METHODDEF        \
    {"openssl_md5",                           \
     _PyCFunction_CAST(_hashlib_openssl_md5), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _hashlib_openssl_md5__doc__},
...
#define _HASHLIB_OPENSSL_SHA1_METHODDEF        \
    {"openssl_sha1",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha1), \
     METH_FASTCALL | METH_KEYWORDS,            \
     _hashlib_openssl_sha1__doc__},
...
#define _HASHLIB_OPENSSL_SHA224_METHODDEF        \
    {"openssl_sha224",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha224), \
     METH_FASTCALL | METH_KEYWORDS,              \
     _hashlib_openssl_sha224__doc__},
...
#define _HASHLIB_OPENSSL_SHA256_METHODDEF        \
    {"openssl_sha256",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha256), \
     METH_FASTCALL | METH_KEYWORDS,              \
     _hashlib_openssl_sha256__doc__},
...
#define _HASHLIB_OPENSSL_SHA384_METHODDEF        \
    {"openssl_sha384",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha384), \
     METH_FASTCALL | METH_KEYWORDS,              \
     _hashlib_openssl_sha384__doc__},
...
#define _HASHLIB_OPENSSL_SHA512_METHODDEF        \
    {"openssl_sha512",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha512), \
     METH_FASTCALL | METH_KEYWORDS,              \
     _hashlib_openssl_sha512__doc__},
...
#define _HASHLIB_OPENSSL_SHA3_224_METHODDEF        \
    {"openssl_sha3_224",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha3_224), \
     METH_FASTCALL | METH_KEYWORDS,                \
     _hashlib_openssl_sha3_224__doc__},
...
PyDoc_STRVAR(
    _hashlib_openssl_sha3_256__doc__,
...
#define _HASHLIB_OPENSSL_SHA3_256_METHODDEF        \
    {"openssl_sha3_256",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha3_256), \
     METH_FASTCALL | METH_KEYWORDS,                \
     _hashlib_openssl_sha3_256__doc__},
...
PyDoc_STRVAR(
    _hashlib_openssl_sha3_384__doc__,
...
#define _HASHLIB_OPENSSL_SHA3_384_METHODDEF        \
    {"openssl_sha3_384",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha3_384), \
     METH_FASTCALL | METH_KEYWORDS,                \
     _hashlib_openssl_sha3_384__doc__},
...
PyDoc_STRVAR(
    _hashlib_openssl_sha3_512__doc__,
...
#define _HASHLIB_OPENSSL_SHA3_512_METHODDEF        \
    {"openssl_sha3_512",                           \
     _PyCFunction_CAST(_hashlib_openssl_sha3_512), \
     METH_FASTCALL | METH_KEYWORDS,                \
     _hashlib_openssl_sha3_512__doc__},
...
PyDoc_STRVAR(
    _hashlib_openssl_shake_128__doc__,
...
#define _HASHLIB_OPENSSL_SHAKE_128_METHODDEF        \
    {"openssl_shake_128",                           \
     _PyCFunction_CAST(_hashlib_openssl_shake_128), \
     METH_FASTCALL | METH_KEYWORDS,                 \
     _hashlib_openssl_shake_128__doc__},
...
#define _HASHLIB_OPENSSL_SHAKE_256_METHODDEF        \
    {"openssl_shake_256",                           \
     _PyCFunction_CAST(_hashlib_openssl_shake_256), \
     METH_FASTCALL | METH_KEYWORDS,                 \
     _hashlib_openssl_shake_256__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "hash_name", "password", "salt", "iterations", "dklen", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "pbkdf2_hmac",
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 4, 5, 0, argsbuf);
    if (!args) {
        goto exit;
    }
...
skip_optional_pos:
    return_value =
        pbkdf2_hmac_impl(module, hash_name, &password, &salt, iterations, dklen_obj);
...
#define _HASHLIB_SCRYPT_METHODDEF        \
    {"scrypt",                           \
     _PyCFunction_CAST(_hashlib_scrypt), \
     METH_FASTCALL | METH_KEYWORDS,      \
     _hashlib_scrypt__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "password", "salt", "n", "r", "p", "maxmem", "dklen", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "scrypt",
...
skip_optional_kwonly:
    return_value = _hashlib_scrypt_impl(
        module, &password, &salt, n_obj, r_obj, p_obj, maxmem, dklen
    );
...
#define _HASHLIB_HMAC_SINGLESHOT_METHODDEF        \
    {"hmac_digest",                               \
     _PyCFunction_CAST(_hashlib_hmac_singleshot), \
     METH_FASTCALL | METH_KEYWORDS,               \
     _hashlib_hmac_singleshot__doc__},
...
#define _HASHLIB_HMAC_NEW_METHODDEF        \
    {"hmac_new",                           \
     _PyCFunction_CAST(_hashlib_hmac_new), \
     METH_FASTCALL | METH_KEYWORDS,        \
     _hashlib_hmac_new__doc__},
...
#define _HASHLIB_HMAC_UPDATE_METHODDEF        \
    {"update",                                \
     _PyCFunction_CAST(_hashlib_HMAC_update), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _hashlib_HMAC_update__doc__},
...
static PyObject *
_hashlib_HMAC_update(
    HMACobject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _HASHLIB_HMAC_DIGEST_METHODDEF  \
    {"digest",                          \
     (PyCFunction)_hashlib_HMAC_digest, \
     METH_NOARGS,                       \
     _hashlib_HMAC_digest__doc__},
...
#define _HASHLIB_HMAC_HEXDIGEST_METHODDEF  \
    {"hexdigest",                          \
     (PyCFunction)_hashlib_HMAC_hexdigest, \
     METH_NOARGS,                          \
     _hashlib_HMAC_hexdigest__doc__},
...
#define _HASHLIB_GET_FIPS_MODE_METHODDEF  \
    {"get_fips_mode",                     \
     (PyCFunction)_hashlib_get_fips_mode, \
     METH_NOARGS,                         \
     _hashlib_get_fips_mode__doc__},
...
#define _HASHLIB_COMPARE_DIGEST_METHODDEF        \
    {"compare_digest",                           \
     _PyCFunction_CAST(_hashlib_compare_digest), \
     METH_FASTCALL,                              \
     _hashlib_compare_digest__doc__},
