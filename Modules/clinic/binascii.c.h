...
#define BINASCII_B2A_UU_METHODDEF        \
    {"b2a_uu",                           \
     _PyCFunction_CAST(binascii_b2a_uu), \
...
#define BINASCII_A2B_BASE64_METHODDEF        \
    {"a2b_base64",                           \
     _PyCFunction_CAST(binascii_a2b_base64), \
     METH_FASTCALL | METH_KEYWORDS,          \
     binascii_a2b_base64__doc__},
...
#define BINASCII_B2A_BASE64_METHODDEF        \
    {"b2a_base64",                           \
     _PyCFunction_CAST(binascii_b2a_base64), \
     METH_FASTCALL | METH_KEYWORDS,          \
     binascii_b2a_base64__doc__},
...
#define BINASCII_CRC_HQX_METHODDEF        \
    {"crc_hqx",                           \
     _PyCFunction_CAST(binascii_crc_hqx), \
     METH_FASTCALL,                       \
     binascii_crc_hqx__doc__},
...
#define BINASCII_B2A_HEX_METHODDEF        \
    {"b2a_hex",                           \
     _PyCFunction_CAST(binascii_b2a_hex), \
     METH_FASTCALL | METH_KEYWORDS,       \
     binascii_b2a_hex__doc__},
...
#define BINASCII_HEXLIFY_METHODDEF        \
    {"hexlify",                           \
     _PyCFunction_CAST(binascii_hexlify), \
     METH_FASTCALL | METH_KEYWORDS,       \
     binascii_hexlify__doc__},
...
#define BINASCII_A2B_QP_METHODDEF        \
    {"a2b_qp",                           \
     _PyCFunction_CAST(binascii_a2b_qp), \
     METH_FASTCALL | METH_KEYWORDS,      \
     binascii_a2b_qp__doc__},
...
#define BINASCII_B2A_QP_METHODDEF        \
    {"b2a_qp",                           \
     _PyCFunction_CAST(binascii_b2a_qp), \
     METH_FASTCALL | METH_KEYWORDS,      \
     binascii_b2a_qp__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "data", "quotetabs", "istext", "header", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "b2a_qp",
