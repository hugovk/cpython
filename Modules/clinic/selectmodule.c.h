...
#define SELECT_POLL_REGISTER_METHODDEF        \
    {"register",                              \
     _PyCFunction_CAST(select_poll_register), \
     METH_FASTCALL,                           \
     select_poll_register__doc__},
...
#define SELECT_POLL_MODIFY_METHODDEF        \
    {"modify",                              \
     _PyCFunction_CAST(select_poll_modify), \
     METH_FASTCALL,                         \
     select_poll_modify__doc__},
...
#define SELECT_POLL_UNREGISTER_METHODDEF  \
    {"unregister",                        \
     (PyCFunction)select_poll_unregister, \
     METH_O,                              \
     select_poll_unregister__doc__},
...
#define SELECT_POLL_POLL_METHODDEF        \
    {"poll",                              \
     _PyCFunction_CAST(select_poll_poll), \
     METH_FASTCALL,                       \
     select_poll_poll__doc__},
...
PyDoc_STRVAR(
    select_devpoll_register__doc__,
    "register($self, fd,\n"
    "         eventmask=select.POLLIN | select.POLLPRI | select.POLLOUT, /)\n"
    "--\n"
    "\n"
...
#define SELECT_DEVPOLL_REGISTER_METHODDEF        \
    {"register",                                 \
     _PyCFunction_CAST(select_devpoll_register), \
     METH_FASTCALL,                              \
     select_devpoll_register__doc__},
...
#define SELECT_DEVPOLL_MODIFY_METHODDEF        \
    {"modify",                                 \
     _PyCFunction_CAST(select_devpoll_modify), \
     METH_FASTCALL,                            \
     select_devpoll_modify__doc__},
...
PyDoc_STRVAR(
    select_devpoll_unregister__doc__,
    "unregister($self, fd, /)\n"
    "--\n"
    "\n"
    "Remove a file descriptor being tracked by the polling object."
...
#define SELECT_DEVPOLL_UNREGISTER_METHODDEF  \
    {"unregister",                           \
     (PyCFunction)select_devpoll_unregister, \
     METH_O,                                 \
     select_devpoll_unregister__doc__},
...
#define SELECT_DEVPOLL_POLL_METHODDEF        \
    {"poll",                                 \
     _PyCFunction_CAST(select_devpoll_poll), \
     METH_FASTCALL,                          \
     select_devpoll_poll__doc__},
...
#define SELECT_DEVPOLL_CLOSE_METHODDEF  \
    {"close",                           \
     (PyCFunction)select_devpoll_close, \
     METH_NOARGS,                       \
     select_devpoll_close__doc__},
...
#define SELECT_DEVPOLL_FILENO_METHODDEF  \
    {"fileno",                           \
     (PyCFunction)select_devpoll_fileno, \
     METH_NOARGS,                        \
     select_devpoll_fileno__doc__},
...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 0, 2, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
...
#define SELECT_EPOLL_FILENO_METHODDEF  \
    {"fileno",                         \
     (PyCFunction)select_epoll_fileno, \
     METH_NOARGS,                      \
     select_epoll_fileno__doc__},
...
#define SELECT_EPOLL_FROMFD_METHODDEF  \
    {"fromfd",                         \
     (PyCFunction)select_epoll_fromfd, \
     METH_O | METH_CLASS,              \
     select_epoll_fromfd__doc__},
...
#define SELECT_EPOLL_REGISTER_METHODDEF        \
    {"register",                               \
     _PyCFunction_CAST(select_epoll_register), \
...
static PyObject *
select_epoll_register(
    pyEpoll_Object *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define SELECT_EPOLL_MODIFY_METHODDEF        \
    {"modify",                               \
     _PyCFunction_CAST(select_epoll_modify), \
     METH_FASTCALL | METH_KEYWORDS,          \
     select_epoll_modify__doc__},
...
PyDoc_STRVAR(
    select_epoll_unregister__doc__,
    "unregister($self, /, fd)\n"
    "--\n"
    "\n"
...
#define SELECT_EPOLL_UNREGISTER_METHODDEF        \
    {"unregister",                               \
     _PyCFunction_CAST(select_epoll_unregister), \
     METH_FASTCALL | METH_KEYWORDS,              \
     select_epoll_unregister__doc__},
...
#define SELECT_EPOLL_POLL_METHODDEF        \
    {"poll",                               \
     _PyCFunction_CAST(select_epoll_poll), \
     METH_FASTCALL | METH_KEYWORDS,        \
     select_epoll_poll__doc__},
...
#define SELECT_EPOLL___ENTER___METHODDEF  \
    {"__enter__",                         \
     (PyCFunction)select_epoll___enter__, \
     METH_NOARGS,                         \
     select_epoll___enter____doc__},
...
#define SELECT_EPOLL___EXIT___METHODDEF        \
    {"__exit__",                               \
     _PyCFunction_CAST(select_epoll___exit__), \
     METH_FASTCALL,                            \
     select_epoll___exit____doc__},
...
#define SELECT_KQUEUE_CLOSE_METHODDEF  \
    {"close",                          \
     (PyCFunction)select_kqueue_close, \
     METH_NOARGS,                      \
     select_kqueue_close__doc__},
...
#define SELECT_KQUEUE_FILENO_METHODDEF  \
    {"fileno",                          \
     (PyCFunction)select_kqueue_fileno, \
     METH_NOARGS,                       \
     select_kqueue_fileno__doc__},
...
#define SELECT_KQUEUE_FROMFD_METHODDEF  \
    {"fromfd",                          \
     (PyCFunction)select_kqueue_fromfd, \
     METH_O | METH_CLASS,               \
     select_kqueue_fromfd__doc__},
...
#define SELECT_KQUEUE_CONTROL_METHODDEF        \
    {"control",                                \
     _PyCFunction_CAST(select_kqueue_control), \
     METH_FASTCALL,                            \
     select_kqueue_control__doc__},
...
static PyObject *
select_kqueue_control(
    kqueue_queue_Object *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    PyObject *changelist;
    int maxevents;
