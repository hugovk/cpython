...
#define _QUEUE_SIMPLEQUEUE_PUT_METHODDEF        \
    {"put",                                     \
     _PyCFunction_CAST(_queue_SimpleQueue_put), \
...
_queue_SimpleQueue_put(
    simplequeueobject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _QUEUE_SIMPLEQUEUE_PUT_NOWAIT_METHODDEF        \
    {"put_nowait",                                     \
     _PyCFunction_CAST(_queue_SimpleQueue_put_nowait), \
     METH_FASTCALL | METH_KEYWORDS,                    \
     _queue_SimpleQueue_put_nowait__doc__},
...
#define _QUEUE_SIMPLEQUEUE_GET_METHODDEF          \
    {"get",                                       \
     _PyCFunction_CAST(_queue_SimpleQueue_get),   \
...
PyDoc_STRVAR(
    _queue_SimpleQueue_get_nowait__doc__,
    "get_nowait($self, /)\n"
    "--\n"
    "\n"
...
#define _QUEUE_SIMPLEQUEUE_GET_NOWAIT_METHODDEF        \
    {"get_nowait",                                     \
     _PyCFunction_CAST(_queue_SimpleQueue_get_nowait), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,      \
     _queue_SimpleQueue_get_nowait__doc__},
...
PyDoc_STRVAR(
    _queue_SimpleQueue_empty__doc__,
    "empty($self, /)\n"
    "--\n"
    "\n"
...
#define _QUEUE_SIMPLEQUEUE_EMPTY_METHODDEF  \
    {"empty",                               \
     (PyCFunction)_queue_SimpleQueue_empty, \
     METH_NOARGS,                           \
     _queue_SimpleQueue_empty__doc__},
...
#define _QUEUE_SIMPLEQUEUE_QSIZE_METHODDEF  \
    {"qsize",                               \
     (PyCFunction)_queue_SimpleQueue_qsize, \
     METH_NOARGS,                           \
     _queue_SimpleQueue_qsize__doc__},
