...
#define _LOCALE_SETLOCALE_METHODDEF        \
    {"setlocale",                          \
     _PyCFunction_CAST(_locale_setlocale), \
     METH_FASTCALL,                        \
     _locale_setlocale__doc__},
...
#define _LOCALE_LOCALECONV_METHODDEF  \
    {"localeconv",                    \
     (PyCFunction)_locale_localeconv, \
     METH_NOARGS,                     \
     _locale_localeconv__doc__},
...
#define _LOCALE_STRCOLL_METHODDEF        \
    {"strcoll",                          \
     _PyCFunction_CAST(_locale_strcoll), \
     METH_FASTCALL,                      \
     _locale_strcoll__doc__},
...
PyDoc_STRVAR(
    _locale__getdefaultlocale__doc__,
...
#define _LOCALE__GETDEFAULTLOCALE_METHODDEF  \
    {"_getdefaultlocale",                    \
     (PyCFunction)_locale__getdefaultlocale, \
     METH_NOARGS,                            \
     _locale__getdefaultlocale__doc__},
...
#define _LOCALE_NL_LANGINFO_METHODDEF  \
    {"nl_langinfo",                    \
     (PyCFunction)_locale_nl_langinfo, \
     METH_O,                           \
     _locale_nl_langinfo__doc__},
...
#define _LOCALE_DGETTEXT_METHODDEF        \
    {"dgettext",                          \
     _PyCFunction_CAST(_locale_dgettext), \
     METH_FASTCALL,                       \
     _locale_dgettext__doc__},
...
#define _LOCALE_DCGETTEXT_METHODDEF        \
    {"dcgettext",                          \
     _PyCFunction_CAST(_locale_dcgettext), \
     METH_FASTCALL,                        \
     _locale_dcgettext__doc__},
...
#define _LOCALE_BINDTEXTDOMAIN_METHODDEF        \
    {"bindtextdomain",                          \
     _PyCFunction_CAST(_locale_bindtextdomain), \
     METH_FASTCALL,                             \
     _locale_bindtextdomain__doc__},

static PyObject *
_locale_bindtextdomain_impl(
    PyObject *module, const char *domain, PyObject *dirname_obj
);
...
PyDoc_STRVAR(
    _locale_bind_textdomain_codeset__doc__,
...
#define _LOCALE_BIND_TEXTDOMAIN_CODESET_METHODDEF        \
    {"bind_textdomain_codeset",                          \
     _PyCFunction_CAST(_locale_bind_textdomain_codeset), \
     METH_FASTCALL,                                      \
     _locale_bind_textdomain_codeset__doc__},
...
static PyObject *
_locale_bind_textdomain_codeset(
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument(
            "bind_textdomain_codeset", "argument 2", "str or None", args[1]
        );
        goto exit;
    }
...
#define _LOCALE_GETENCODING_METHODDEF  \
    {"getencoding",                    \
     (PyCFunction)_locale_getencoding, \
     METH_NOARGS,                      \
     _locale_getencoding__doc__},
