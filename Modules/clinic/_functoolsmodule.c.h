...
#define _FUNCTOOLS_CMP_TO_KEY_METHODDEF        \
    {"cmp_to_key",                             \
     _PyCFunction_CAST(_functools_cmp_to_key), \
...
PyDoc_STRVAR(
    _functools__lru_cache_wrapper_cache_info__doc__,
    "cache_info($self, /)\n"
    "--\n"
    "\n"
...
#define _FUNCTOOLS__LRU_CACHE_WRAPPER_CACHE_INFO_METHODDEF  \
    {"cache_info",                                          \
     (PyCFunction)_functools__lru_cache_wrapper_cache_info, \
     METH_NOARGS,                                           \
     _functools__lru_cache_wrapper_cache_info__doc__},
...
#define _FUNCTOOLS__LRU_CACHE_WRAPPER_CACHE_CLEAR_METHODDEF  \
    {"cache_clear",                                          \
     (PyCFunction)_functools__lru_cache_wrapper_cache_clear, \
     METH_NOARGS,                                            \
     _functools__lru_cache_wrapper_cache_clear__doc__},
...
static PyObject *
_functools__lru_cache_wrapper_cache_clear(
