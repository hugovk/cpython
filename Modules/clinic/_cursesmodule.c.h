...
#define _CURSES_WINDOW_ADDCH_METHODDEF  \
    {"addch",                           \
     (PyCFunction)_curses_window_addch, \
     METH_VARARGS,                      \
     _curses_window_addch__doc__},
...
_curses_window_addch(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.addch requires 1 to 4 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_addch_impl(self, group_left_1, y, x, ch, group_right_1, attr);
...
#define _CURSES_WINDOW_ADDSTR_METHODDEF  \
    {"addstr",                           \
     (PyCFunction)_curses_window_addstr, \
     METH_VARARGS,                       \
     _curses_window_addstr__doc__},
...
_curses_window_addstr(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.addstr requires 1 to 4 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_addstr_impl(self, group_left_1, y, x, str, group_right_1, attr);
...
#define _CURSES_WINDOW_ADDNSTR_METHODDEF  \
    {"addnstr",                           \
     (PyCFunction)_curses_window_addnstr, \
     METH_VARARGS,                        \
     _curses_window_addnstr__doc__},
...
_curses_window_addnstr(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.addnstr requires 2 to 5 arguments"
            );
            goto exit;
    }
    return_value = _curses_window_addnstr_impl(
        self, group_left_1, y, x, str, n, group_right_1, attr
    );
...
#define _CURSES_WINDOW_BKGD_METHODDEF        \
    {"bkgd",                                 \
     _PyCFunction_CAST(_curses_window_bkgd), \
     METH_FASTCALL,                          \
     _curses_window_bkgd__doc__},
...
static PyObject *
_curses_window_bkgd(
    PyCursesWindowObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    PyObject *ch;
    long attr = A_NORMAL;
...
#define _CURSES_WINDOW_ATTROFF_METHODDEF  \
    {"attroff",                           \
     (PyCFunction)_curses_window_attroff, \
     METH_O,                              \
     _curses_window_attroff__doc__},
...
#define _CURSES_WINDOW_ATTRON_METHODDEF  \
    {"attron",                           \
     (PyCFunction)_curses_window_attron, \
     METH_O,                             \
     _curses_window_attron__doc__},
...
#define _CURSES_WINDOW_ATTRSET_METHODDEF  \
    {"attrset",                           \
     (PyCFunction)_curses_window_attrset, \
     METH_O,                              \
     _curses_window_attrset__doc__},
...
#define _CURSES_WINDOW_BKGDSET_METHODDEF        \
    {"bkgdset",                                 \
     _PyCFunction_CAST(_curses_window_bkgdset), \
     METH_FASTCALL,                             \
     _curses_window_bkgdset__doc__},
...
#define _CURSES_WINDOW_BORDER_METHODDEF        \
    {"border",                                 \
     _PyCFunction_CAST(_curses_window_border), \
     METH_FASTCALL,                            \
     _curses_window_border__doc__},
...
_curses_window_box(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.box requires 0 to 2 arguments"
            );
            goto exit;
    }
...
#define _CURSES_WINDOW_DELCH_METHODDEF  \
    {"delch",                           \
     (PyCFunction)_curses_window_delch, \
     METH_VARARGS,                      \
     _curses_window_delch__doc__},
...
_curses_window_delch(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.delch requires 0 to 2 arguments"
            );
            goto exit;
    }
...
#define _CURSES_WINDOW_DERWIN_METHODDEF  \
    {"derwin",                           \
     (PyCFunction)_curses_window_derwin, \
     METH_VARARGS,                       \
     _curses_window_derwin__doc__},
...
_curses_window_derwin(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        case 4:
            if (!PyArg_ParseTuple(
                    args, "iiii:derwin", &nlines, &ncols, &begin_y, &begin_x
                )) {
                goto exit;
            }
            group_left_1 = 1;
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.derwin requires 2 to 4 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_derwin_impl(self, group_left_1, nlines, ncols, begin_y, begin_x);
...
PyDoc_STRVAR(
    _curses_window_echochar__doc__,
...
#define _CURSES_WINDOW_ECHOCHAR_METHODDEF        \
    {"echochar",                                 \
     _PyCFunction_CAST(_curses_window_echochar), \
     METH_FASTCALL,                              \
     _curses_window_echochar__doc__},
...
#define _CURSES_WINDOW_ENCLOSE_METHODDEF        \
    {"enclose",                                 \
     _PyCFunction_CAST(_curses_window_enclose), \
     METH_FASTCALL,                             \
     _curses_window_enclose__doc__},
...
#define _CURSES_WINDOW_GETBKGD_METHODDEF  \
    {"getbkgd",                           \
     (PyCFunction)_curses_window_getbkgd, \
     METH_NOARGS,                         \
     _curses_window_getbkgd__doc__},
...
#define _CURSES_WINDOW_GETCH_METHODDEF  \
    {"getch",                           \
     (PyCFunction)_curses_window_getch, \
     METH_VARARGS,                      \
     _curses_window_getch__doc__},
...
_curses_window_getch(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.getch requires 0 to 2 arguments"
            );
            goto exit;
    }
...
#define _CURSES_WINDOW_GETKEY_METHODDEF  \
    {"getkey",                           \
     (PyCFunction)_curses_window_getkey, \
     METH_VARARGS,                       \
     _curses_window_getkey__doc__},
...
_curses_window_getkey(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.getkey requires 0 to 2 arguments"
            );
            goto exit;
    }
...
#define _CURSES_WINDOW_GET_WCH_METHODDEF  \
    {"get_wch",                           \
     (PyCFunction)_curses_window_get_wch, \
     METH_VARARGS,                        \
     _curses_window_get_wch__doc__},

static PyObject *
_curses_window_get_wch_impl(
    PyCursesWindowObject *self, int group_right_1, int y, int x
);
...
_curses_window_get_wch(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.get_wch requires 0 to 2 arguments"
            );
            goto exit;
    }
...
#define _CURSES_WINDOW_HLINE_METHODDEF  \
    {"hline",                           \
     (PyCFunction)_curses_window_hline, \
     METH_VARARGS,                      \
     _curses_window_hline__doc__},
...
_curses_window_hline(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.hline requires 2 to 5 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_hline_impl(self, group_left_1, y, x, ch, n, group_right_1, attr);
...
#define _CURSES_WINDOW_INSCH_METHODDEF  \
    {"insch",                           \
     (PyCFunction)_curses_window_insch, \
     METH_VARARGS,                      \
     _curses_window_insch__doc__},
...
_curses_window_insch(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.insch requires 1 to 4 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_insch_impl(self, group_left_1, y, x, ch, group_right_1, attr);
...
#define _CURSES_WINDOW_INCH_METHODDEF  \
    {"inch",                           \
     (PyCFunction)_curses_window_inch, \
     METH_VARARGS,                     \
     _curses_window_inch__doc__},
...
_curses_window_inch(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.inch requires 0 to 2 arguments"
            );
            goto exit;
    }
...
#define _CURSES_WINDOW_INSSTR_METHODDEF  \
    {"insstr",                           \
     (PyCFunction)_curses_window_insstr, \
     METH_VARARGS,                       \
     _curses_window_insstr__doc__},
...
_curses_window_insstr(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.insstr requires 1 to 4 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_insstr_impl(self, group_left_1, y, x, str, group_right_1, attr);
...
#define _CURSES_WINDOW_INSNSTR_METHODDEF  \
    {"insnstr",                           \
     (PyCFunction)_curses_window_insnstr, \
     METH_VARARGS,                        \
     _curses_window_insnstr__doc__},
...
_curses_window_insnstr(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.insnstr requires 2 to 5 arguments"
            );
            goto exit;
    }
    return_value = _curses_window_insnstr_impl(
        self, group_left_1, y, x, str, n, group_right_1, attr
    );
...
#define _CURSES_WINDOW_IS_LINETOUCHED_METHODDEF  \
    {"is_linetouched",                           \
     (PyCFunction)_curses_window_is_linetouched, \
     METH_O,                                     \
     _curses_window_is_linetouched__doc__},
...
#define _CURSES_WINDOW_NOUTREFRESH_METHODDEF  \
    {"noutrefresh",                           \
     (PyCFunction)_curses_window_noutrefresh, \
     METH_VARARGS,                            \
     _curses_window_noutrefresh__doc__},
...
_curses_window_noutrefresh(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.noutrefresh requires 0 to 6 arguments"
            );
            goto exit;
    }
    return_value = _curses_window_noutrefresh_impl(
        self, group_right_1, pminrow, pmincol, sminrow, smincol, smaxrow, smaxcol
    );
...
#define _CURSES_WINDOW_OVERLAY_METHODDEF  \
    {"overlay",                           \
     (PyCFunction)_curses_window_overlay, \
     METH_VARARGS,                        \
     _curses_window_overlay__doc__},
...
_curses_window_overlay(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        case 1:
            if (!PyArg_ParseTuple(
                    args, "O!:overlay", clinic_state()->window_type, &destwin
                )) {
                goto exit;
            }
            break;
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.overlay requires 1 to 7 arguments"
            );
            goto exit;
    }
    return_value = _curses_window_overlay_impl(
        self,
        destwin,
        group_right_1,
        sminrow,
...
#define _CURSES_WINDOW_OVERWRITE_METHODDEF  \
    {"overwrite",                           \
     (PyCFunction)_curses_window_overwrite, \
     METH_VARARGS,                          \
     _curses_window_overwrite__doc__},
...
_curses_window_overwrite(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        case 1:
            if (!PyArg_ParseTuple(
                    args, "O!:overwrite", clinic_state()->window_type, &destwin
                )) {
                goto exit;
            }
            break;
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.overwrite requires 1 to 7 arguments"
            );
            goto exit;
    }
    return_value = _curses_window_overwrite_impl(
        self,
        destwin,
        group_right_1,
        sminrow,
...
#define _CURSES_WINDOW_PUTWIN_METHODDEF  \
    {"putwin",                           \
     (PyCFunction)_curses_window_putwin, \
     METH_O,                             \
     _curses_window_putwin__doc__},

PyDoc_STRVAR(
    _curses_window_redrawln__doc__,
...
#define _CURSES_WINDOW_REDRAWLN_METHODDEF        \
    {"redrawln",                                 \
     _PyCFunction_CAST(_curses_window_redrawln), \
     METH_FASTCALL,                              \
     _curses_window_redrawln__doc__},
...
#define _CURSES_WINDOW_REFRESH_METHODDEF  \
    {"refresh",                           \
     (PyCFunction)_curses_window_refresh, \
     METH_VARARGS,                        \
     _curses_window_refresh__doc__},
...
_curses_window_refresh(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.refresh requires 0 to 6 arguments"
            );
            goto exit;
    }
...
#define _CURSES_WINDOW_SETSCRREG_METHODDEF        \
    {"setscrreg",                                 \
     _PyCFunction_CAST(_curses_window_setscrreg), \
     METH_FASTCALL,                               \
     _curses_window_setscrreg__doc__},
...
_curses_window_subwin(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        case 4:
            if (!PyArg_ParseTuple(
                    args, "iiii:subwin", &nlines, &ncols, &begin_y, &begin_x
                )) {
                goto exit;
            }
            group_left_1 = 1;
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.subwin requires 2 to 4 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_subwin_impl(self, group_left_1, nlines, ncols, begin_y, begin_x);
...
#define _CURSES_WINDOW_SCROLL_METHODDEF  \
    {"scroll",                           \
     (PyCFunction)_curses_window_scroll, \
     METH_VARARGS,                       \
     _curses_window_scroll__doc__},
...
_curses_window_scroll(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.scroll requires 0 to 1 arguments"
            );
            goto exit;
    }
...
#define _CURSES_WINDOW_TOUCHLINE_METHODDEF  \
    {"touchline",                           \
     (PyCFunction)_curses_window_touchline, \
     METH_VARARGS,                          \
     _curses_window_touchline__doc__},
...
_curses_window_touchline(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.touchline requires 2 to 3 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_touchline_impl(self, start, count, group_right_1, changed);
...
#define _CURSES_WINDOW_VLINE_METHODDEF  \
    {"vline",                           \
     (PyCFunction)_curses_window_vline, \
     METH_VARARGS,                      \
     _curses_window_vline__doc__},
...
_curses_window_vline(PyCursesWindowObject *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.window.vline requires 2 to 5 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_window_vline_impl(self, group_left_1, y, x, ch, n, group_right_1, attr);
...
#define _CURSES_CAN_CHANGE_COLOR_METHODDEF  \
    {"can_change_color",                    \
     (PyCFunction)_curses_can_change_color, \
     METH_NOARGS,                           \
     _curses_can_change_color__doc__},
...
#define _CURSES_COLOR_CONTENT_METHODDEF  \
    {"color_content",                    \
     (PyCFunction)_curses_color_content, \
     METH_O,                             \
     _curses_color_content__doc__},
...
#define _CURSES_DEF_PROG_MODE_METHODDEF  \
    {"def_prog_mode",                    \
     (PyCFunction)_curses_def_prog_mode, \
     METH_NOARGS,                        \
     _curses_def_prog_mode__doc__},
...
#define _CURSES_DEF_SHELL_MODE_METHODDEF  \
    {"def_shell_mode",                    \
     (PyCFunction)_curses_def_shell_mode, \
     METH_NOARGS,                         \
     _curses_def_shell_mode__doc__},
...
#define _CURSES_DELAY_OUTPUT_METHODDEF  \
    {"delay_output",                    \
     (PyCFunction)_curses_delay_output, \
     METH_O,                            \
     _curses_delay_output__doc__},
...
#define _CURSES_UNGETMOUSE_METHODDEF        \
    {"ungetmouse",                          \
     _PyCFunction_CAST(_curses_ungetmouse), \
     METH_FASTCALL,                         \
     _curses_ungetmouse__doc__},
...
#define _CURSES_HAS_COLORS_METHODDEF  \
    {"has_colors",                    \
     (PyCFunction)_curses_has_colors, \
     METH_NOARGS,                     \
     _curses_has_colors__doc__},
...
#define _CURSES_INIT_COLOR_METHODDEF        \
    {"init_color",                          \
     _PyCFunction_CAST(_curses_init_color), \
     METH_FASTCALL,                         \
     _curses_init_color__doc__},
...
#define _CURSES_INIT_PAIR_METHODDEF        \
    {"init_pair",                          \
     _PyCFunction_CAST(_curses_init_pair), \
     METH_FASTCALL,                        \
     _curses_init_pair__doc__},
...
#define _CURSES_SETUPTERM_METHODDEF        \
    {"setupterm",                          \
     _PyCFunction_CAST(_curses_setupterm), \
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 0, 2, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    if (!noptargs) {
...
#define _CURSES_GET_ESCDELAY_METHODDEF  \
    {"get_escdelay",                    \
     (PyCFunction)_curses_get_escdelay, \
     METH_NOARGS,                       \
     _curses_get_escdelay__doc__},
...
#define _CURSES_SET_ESCDELAY_METHODDEF  \
    {"set_escdelay",                    \
     (PyCFunction)_curses_set_escdelay, \
     METH_O,                            \
     _curses_set_escdelay__doc__},
...
#define _CURSES_GET_TABSIZE_METHODDEF  \
    {"get_tabsize",                    \
     (PyCFunction)_curses_get_tabsize, \
     METH_NOARGS,                      \
     _curses_get_tabsize__doc__},
...
#define _CURSES_SET_TABSIZE_METHODDEF  \
    {"set_tabsize",                    \
     (PyCFunction)_curses_set_tabsize, \
     METH_O,                           \
     _curses_set_tabsize__doc__},
...
PyDoc_STRVAR(
    _curses_is_term_resized__doc__,
...
#define _CURSES_IS_TERM_RESIZED_METHODDEF        \
    {"is_term_resized",                          \
     _PyCFunction_CAST(_curses_is_term_resized), \
     METH_FASTCALL,                              \
     _curses_is_term_resized__doc__},
...
#define _CURSES_MOUSEINTERVAL_METHODDEF  \
    {"mouseinterval",                    \
     (PyCFunction)_curses_mouseinterval, \
     METH_O,                             \
     _curses_mouseinterval__doc__},
...
_curses_newwin(PyObject *module, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        case 4:
            if (!PyArg_ParseTuple(
                    args, "iiii:newwin", &nlines, &ncols, &begin_y, &begin_x
                )) {
                goto exit;
            }
            group_right_1 = 1;
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_curses.newwin requires 2 to 4 arguments"
            );
            goto exit;
    }
    return_value =
        _curses_newwin_impl(module, nlines, ncols, group_right_1, begin_y, begin_x);
...
#define _CURSES_PAIR_CONTENT_METHODDEF  \
    {"pair_content",                    \
     (PyCFunction)_curses_pair_content, \
     METH_O,                            \
     _curses_pair_content__doc__},
...
#define _CURSES_PAIR_NUMBER_METHODDEF  \
    {"pair_number",                    \
     (PyCFunction)_curses_pair_number, \
     METH_O,                           \
     _curses_pair_number__doc__},
...
#define _CURSES_QIFLUSH_METHODDEF        \
    {"qiflush",                          \
     _PyCFunction_CAST(_curses_qiflush), \
     METH_FASTCALL,                      \
     _curses_qiflush__doc__},
...
#define _CURSES_UPDATE_LINES_COLS_METHODDEF  \
    {"update_lines_cols",                    \
     (PyCFunction)_curses_update_lines_cols, \
     METH_NOARGS,                            \
     _curses_update_lines_cols__doc__},
...
PyDoc_STRVAR(
    _curses_reset_prog_mode__doc__,
...
#define _CURSES_RESET_PROG_MODE_METHODDEF  \
    {"reset_prog_mode",                    \
     (PyCFunction)_curses_reset_prog_mode, \
     METH_NOARGS,                          \
     _curses_reset_prog_mode__doc__},
...
PyDoc_STRVAR(
    _curses_reset_shell_mode__doc__,
...
#define _CURSES_RESET_SHELL_MODE_METHODDEF  \
    {"reset_shell_mode",                    \
     (PyCFunction)_curses_reset_shell_mode, \
     METH_NOARGS,                           \
     _curses_reset_shell_mode__doc__},
...
#define _CURSES_RESIZETERM_METHODDEF        \
    {"resizeterm",                          \
     _PyCFunction_CAST(_curses_resizeterm), \
     METH_FASTCALL,                         \
     _curses_resizeterm__doc__},
...
#define _CURSES_RESIZE_TERM_METHODDEF        \
    {"resize_term",                          \
     _PyCFunction_CAST(_curses_resize_term), \
     METH_FASTCALL,                          \
     _curses_resize_term__doc__},
...
#define _CURSES_START_COLOR_METHODDEF  \
    {"start_color",                    \
     (PyCFunction)_curses_start_color, \
     METH_NOARGS,                      \
     _curses_start_color__doc__},
...
PyDoc_STRVAR(
    _curses_use_default_colors__doc__,
...
#define _CURSES_USE_DEFAULT_COLORS_METHODDEF  \
    {"use_default_colors",                    \
     (PyCFunction)_curses_use_default_colors, \
     METH_NOARGS,                             \
     _curses_use_default_colors__doc__},
...
PyDoc_STRVAR(
    _curses_has_extended_color_support__doc__,
...
#define _CURSES_HAS_EXTENDED_COLOR_SUPPORT_METHODDEF  \
    {"has_extended_color_support",                    \
     (PyCFunction)_curses_has_extended_color_support, \
     METH_NOARGS,                                     \
     _curses_has_extended_color_support__doc__},
