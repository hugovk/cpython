...
PyDoc_STRVAR(
    _testmultiphase_StateAccessType_getmodulebydef_bad_def__doc__,
...
#define _TESTMULTIPHASE_STATEACCESSTYPE_GETMODULEBYDEF_BAD_DEF_METHODDEF        \
    {"getmodulebydef_bad_def",                                                  \
     _PyCFunction_CAST(_testmultiphase_StateAccessType_getmodulebydef_bad_def), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,                               \
     _testmultiphase_StateAccessType_getmodulebydef_bad_def__doc__},
...
skip_optional_kwonly:
    return_value = _testmultiphase_StateAccessType_increment_count_clinic_impl(
        self, cls, n, twice
    );
...
PyDoc_STRVAR(
    _testmultiphase_StateAccessType_get_count__doc__,
    "get_count($self, /)\n"
    "--\n"
    "\n"
...
#define _TESTMULTIPHASE_STATEACCESSTYPE_GET_COUNT_METHODDEF        \
    {"get_count",                                                  \
     _PyCFunction_CAST(_testmultiphase_StateAccessType_get_count), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,                  \
     _testmultiphase_StateAccessType_get_count__doc__},
...
static PyObject *
_testmultiphase_StateAccessType_get_count(
    StateAccessTypeObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
