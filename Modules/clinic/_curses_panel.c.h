...
#define _CURSES_PANEL_PANEL_BOTTOM_METHODDEF        \
    {"bottom",                                      \
     _PyCFunction_CAST(_curses_panel_panel_bottom), \
...
static PyObject *
_curses_panel_panel_bottom(
    PyCursesPanelObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
    PyObject *kwnames
...
#define _CURSES_PANEL_PANEL_HIDE_METHODDEF        \
    {"hide",                                      \
     _PyCFunction_CAST(_curses_panel_panel_hide), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _curses_panel_panel_hide__doc__},
...
#define _CURSES_PANEL_PANEL_SHOW_METHODDEF        \
    {"show",                                      \
     _PyCFunction_CAST(_curses_panel_panel_show), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _curses_panel_panel_show__doc__},
...
#define _CURSES_PANEL_PANEL_TOP_METHODDEF         \
    {"top",                                       \
     _PyCFunction_CAST(_curses_panel_panel_top),  \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _curses_panel_panel_top__doc__},
...
#define _CURSES_PANEL_PANEL_ABOVE_METHODDEF  \
    {"above",                                \
     (PyCFunction)_curses_panel_panel_above, \
     METH_NOARGS,                            \
     _curses_panel_panel_above__doc__},
...
PyDoc_STRVAR(
    _curses_panel_panel_below__doc__,
    "below($self, /)\n"
    "--\n"
    "\n"
...
#define _CURSES_PANEL_PANEL_BELOW_METHODDEF  \
    {"below",                                \
     (PyCFunction)_curses_panel_panel_below, \
     METH_NOARGS,                            \
     _curses_panel_panel_below__doc__},
...
PyDoc_STRVAR(
    _curses_panel_panel_hidden__doc__,
    "hidden($self, /)\n"
    "--\n"
    "\n"
...
#define _CURSES_PANEL_PANEL_HIDDEN_METHODDEF  \
    {"hidden",                                \
     (PyCFunction)_curses_panel_panel_hidden, \
     METH_NOARGS,                             \
     _curses_panel_panel_hidden__doc__},
...
_curses_panel_panel_move_impl(
    PyCursesPanelObject *self, PyTypeObject *cls, int y, int x
);

static PyObject *
_curses_panel_panel_move(
    PyCursesPanelObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
#define _CURSES_PANEL_PANEL_WINDOW_METHODDEF  \
    {"window",                                \
     (PyCFunction)_curses_panel_panel_window, \
     METH_NOARGS,                             \
     _curses_panel_panel_window__doc__},
...
#define _CURSES_PANEL_PANEL_REPLACE_METHODDEF        \
    {"replace",                                      \
     _PyCFunction_CAST(_curses_panel_panel_replace), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,    \
     _curses_panel_panel_replace__doc__},

static PyObject *
_curses_panel_panel_replace_impl(
    PyCursesPanelObject *self, PyTypeObject *cls, PyCursesWindowObject *win
);

static PyObject *
_curses_panel_panel_replace(
    PyCursesPanelObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
#undef KWTUPLE
    ...
    if (!PyObject_TypeCheck(args[0], &PyCursesWindow_Type)) {
        _PyArg_BadArgument(
            "replace", "argument 1", (&PyCursesWindow_Type)->tp_name, args[0]
        );
        goto exit;
    }
...
#define _CURSES_PANEL_PANEL_SET_USERPTR_METHODDEF        \
    {"set_userptr",                                      \
     _PyCFunction_CAST(_curses_panel_panel_set_userptr), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,        \
     _curses_panel_panel_set_userptr__doc__},

static PyObject *
_curses_panel_panel_set_userptr_impl(
    PyCursesPanelObject *self, PyTypeObject *cls, PyObject *obj
);

static PyObject *
_curses_panel_panel_set_userptr(
    PyCursesPanelObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
#define _CURSES_PANEL_PANEL_USERPTR_METHODDEF        \
    {"userptr",                                      \
     _PyCFunction_CAST(_curses_panel_panel_userptr), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,    \
     _curses_panel_panel_userptr__doc__},

static PyObject *
_curses_panel_panel_userptr_impl(PyCursesPanelObject *self, PyTypeObject *cls);

static PyObject *
_curses_panel_panel_userptr(
    PyCursesPanelObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
#define _CURSES_PANEL_BOTTOM_PANEL_METHODDEF  \
    {"bottom_panel",                          \
     (PyCFunction)_curses_panel_bottom_panel, \
     METH_NOARGS,                             \
     _curses_panel_bottom_panel__doc__},
...
_curses_panel_new_panel(PyObject *module, PyObject *arg) {
    ...
    if (!PyObject_TypeCheck(arg, &PyCursesWindow_Type)) {
        _PyArg_BadArgument(
            "new_panel", "argument", (&PyCursesWindow_Type)->tp_name, arg
        );
        goto exit;
    }
...
PyDoc_STRVAR(
    _curses_panel_top_panel__doc__,
    "top_panel($module, /)\n"
    "--\n"
    "\n"
...
#define _CURSES_PANEL_TOP_PANEL_METHODDEF  \
    {"top_panel",                          \
     (PyCFunction)_curses_panel_top_panel, \
     METH_NOARGS,                          \
     _curses_panel_top_panel__doc__},
...
#define _CURSES_PANEL_UPDATE_PANELS_METHODDEF  \
    {"update_panels",                          \
     (PyCFunction)_curses_panel_update_panels, \
     METH_NOARGS,                              \
     _curses_panel_update_panels__doc__},
