...
PyDoc_STRVAR(
    _overlapped_CreateIoCompletionPort__doc__,
...
#define _OVERLAPPED_CREATEIOCOMPLETIONPORT_METHODDEF        \
    {"CreateIoCompletionPort",                              \
     _PyCFunction_CAST(_overlapped_CreateIoCompletionPort), \
     METH_FASTCALL,                                         \
     _overlapped_CreateIoCompletionPort__doc__},

static PyObject *
_overlapped_CreateIoCompletionPort_impl(
    PyObject *module,
    HANDLE FileHandle,
...
static PyObject *
_overlapped_CreateIoCompletionPort(
    ...
    return_value = _overlapped_CreateIoCompletionPort_impl(
        module,
        FileHandle,
...
PyDoc_STRVAR(
    _overlapped_GetQueuedCompletionStatus__doc__,
...
static PyObject *
_overlapped_GetQueuedCompletionStatus_impl(
    PyObject *module, HANDLE CompletionPort, DWORD Milliseconds
);

static PyObject *
_overlapped_GetQueuedCompletionStatus(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    ...
    return_value = _overlapped_GetQueuedCompletionStatus_impl(
        module, CompletionPort, Milliseconds
    );
...
PyDoc_STRVAR(
    _overlapped_PostQueuedCompletionStatus__doc__,
...
#define _OVERLAPPED_POSTQUEUEDCOMPLETIONSTATUS_METHODDEF        \
    {"PostQueuedCompletionStatus",                              \
     _PyCFunction_CAST(_overlapped_PostQueuedCompletionStatus), \
     METH_FASTCALL,                                             \
     _overlapped_PostQueuedCompletionStatus__doc__},

static PyObject *
_overlapped_PostQueuedCompletionStatus_impl(
    PyObject *module,
    HANDLE CompletionPort,
    DWORD NumberOfBytes,
    ULONG_PTR CompletionKey,
...
static PyObject *
_overlapped_PostQueuedCompletionStatus(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE CompletionPort;
    ...
    return_value = _overlapped_PostQueuedCompletionStatus_impl(
        module, CompletionPort, NumberOfBytes, CompletionKey, Overlapped
    );
...
PyDoc_STRVAR(
    _overlapped_RegisterWaitWithQueue__doc__,
...
#define _OVERLAPPED_REGISTERWAITWITHQUEUE_METHODDEF        \
    {"RegisterWaitWithQueue",                              \
     _PyCFunction_CAST(_overlapped_RegisterWaitWithQueue), \
     METH_FASTCALL,                                        \
     _overlapped_RegisterWaitWithQueue__doc__},

static PyObject *
_overlapped_RegisterWaitWithQueue_impl(
    PyObject *module,
    HANDLE Object,
    HANDLE CompletionPort,
    OVERLAPPED *Overlapped,
...
static PyObject *
_overlapped_RegisterWaitWithQueue(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE Object;
    ...
    return_value = _overlapped_RegisterWaitWithQueue_impl(
        module, Object, CompletionPort, Overlapped, Milliseconds
    );
...
PyDoc_STRVAR(
    _overlapped_UnregisterWait__doc__,
...
#define _OVERLAPPED_UNREGISTERWAIT_METHODDEF  \
    {"UnregisterWait",                        \
     (PyCFunction)_overlapped_UnregisterWait, \
     METH_O,                                  \
     _overlapped_UnregisterWait__doc__},
...
PyDoc_STRVAR(
    _overlapped_UnregisterWaitEx__doc__,
...
#define _OVERLAPPED_UNREGISTERWAITEX_METHODDEF        \
    {"UnregisterWaitEx",                              \
     _PyCFunction_CAST(_overlapped_UnregisterWaitEx), \
     METH_FASTCALL,                                   \
     _overlapped_UnregisterWaitEx__doc__},

static PyObject *
_overlapped_UnregisterWaitEx_impl(PyObject *module, HANDLE WaitHandle, HANDLE Event);

static PyObject *
_overlapped_UnregisterWaitEx(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE WaitHandle;
...
PyDoc_STRVAR(
    _overlapped_CreateEvent__doc__,
...
#define _OVERLAPPED_CREATEEVENT_METHODDEF        \
    {"CreateEvent",                              \
     _PyCFunction_CAST(_overlapped_CreateEvent), \
     METH_FASTCALL,                              \
     _overlapped_CreateEvent__doc__},

static PyObject *
_overlapped_CreateEvent_impl(
    PyObject *module,
...
_overlapped_CreateEvent(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    return_value = _overlapped_CreateEvent_impl(
        module, EventAttributes, ManualReset, InitialState, Name
    );
...
#define _OVERLAPPED_SETEVENT_METHODDEF  \
    {"SetEvent",                        \
     (PyCFunction)_overlapped_SetEvent, \
     METH_O,                            \
     _overlapped_SetEvent__doc__},
...
#define _OVERLAPPED_RESETEVENT_METHODDEF  \
    {"ResetEvent",                        \
     (PyCFunction)_overlapped_ResetEvent, \
     METH_O,                              \
     _overlapped_ResetEvent__doc__},
...
#define _OVERLAPPED_BINDLOCAL_METHODDEF        \
    {"BindLocal",                              \
     _PyCFunction_CAST(_overlapped_BindLocal), \
     METH_FASTCALL,                            \
     _overlapped_BindLocal__doc__},
...
PyDoc_STRVAR(
    _overlapped_FormatMessage__doc__,
...
#define _OVERLAPPED_FORMATMESSAGE_METHODDEF  \
    {"FormatMessage",                        \
     (PyCFunction)_overlapped_FormatMessage, \
     METH_O,                                 \
     _overlapped_FormatMessage__doc__},
...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 0, 1, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
...
PyDoc_STRVAR(
    _overlapped_Overlapped_cancel__doc__,
    "cancel($self, /)\n"
    "--\n"
    "\n"
...
#define _OVERLAPPED_OVERLAPPED_CANCEL_METHODDEF  \
    {"cancel",                                   \
     (PyCFunction)_overlapped_Overlapped_cancel, \
     METH_NOARGS,                                \
     _overlapped_Overlapped_cancel__doc__},
...
PyDoc_STRVAR(
    _overlapped_Overlapped_getresult__doc__,
...
#define _OVERLAPPED_OVERLAPPED_GETRESULT_METHODDEF        \
    {"getresult",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_getresult), \
     METH_FASTCALL,                                       \
     _overlapped_Overlapped_getresult__doc__},
...
static PyObject *
_overlapped_Overlapped_getresult(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    BOOL wait = FALSE;
...
PyDoc_STRVAR(
    _overlapped_Overlapped_ReadFile__doc__,
...
#define _OVERLAPPED_OVERLAPPED_READFILE_METHODDEF        \
    {"ReadFile",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_ReadFile), \
     METH_FASTCALL,                                      \
     _overlapped_Overlapped_ReadFile__doc__},

static PyObject *
_overlapped_Overlapped_ReadFile_impl(OverlappedObject *self, HANDLE handle, DWORD size);

static PyObject *
_overlapped_Overlapped_ReadFile(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
...
#define _OVERLAPPED_OVERLAPPED_READFILEINTO_METHODDEF        \
    {"ReadFileInto",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_ReadFileInto), \
     METH_FASTCALL,                                          \
     _overlapped_Overlapped_ReadFileInto__doc__},

static PyObject *
_overlapped_Overlapped_ReadFileInto_impl(
    OverlappedObject *self, HANDLE handle, Py_buffer *bufobj
);

static PyObject *
_overlapped_Overlapped_ReadFileInto(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
...
PyDoc_STRVAR(
    _overlapped_Overlapped_WSARecv__doc__,
...
#define _OVERLAPPED_OVERLAPPED_WSARECV_METHODDEF        \
    {"WSARecv",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_WSARecv), \
     METH_FASTCALL,                                     \
     _overlapped_Overlapped_WSARecv__doc__},

static PyObject *
_overlapped_Overlapped_WSARecv_impl(
    OverlappedObject *self, HANDLE handle, DWORD size, DWORD flags
);

static PyObject *
_overlapped_Overlapped_WSARecv(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
...
PyDoc_STRVAR(
    _overlapped_Overlapped_WSARecvInto__doc__,
...
#define _OVERLAPPED_OVERLAPPED_WSARECVINTO_METHODDEF        \
    {"WSARecvInto",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_WSARecvInto), \
     METH_FASTCALL,                                         \
     _overlapped_Overlapped_WSARecvInto__doc__},

static PyObject *
_overlapped_Overlapped_WSARecvInto_impl(
    OverlappedObject *self, HANDLE handle, Py_buffer *bufobj, DWORD flags
);

static PyObject *
_overlapped_Overlapped_WSARecvInto(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
    ...
    return_value =
        _overlapped_Overlapped_WSARecvInto_impl(self, handle, &bufobj, flags);
...
PyDoc_STRVAR(
    _overlapped_Overlapped_WriteFile__doc__,
...
#define _OVERLAPPED_OVERLAPPED_WRITEFILE_METHODDEF        \
    {"WriteFile",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_WriteFile), \
     METH_FASTCALL,                                       \
     _overlapped_Overlapped_WriteFile__doc__},

static PyObject *
_overlapped_Overlapped_WriteFile_impl(
    OverlappedObject *self, HANDLE handle, Py_buffer *bufobj
);

static PyObject *
_overlapped_Overlapped_WriteFile(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
...
PyDoc_STRVAR(
    _overlapped_Overlapped_WSASend__doc__,
...
#define _OVERLAPPED_OVERLAPPED_WSASEND_METHODDEF        \
    {"WSASend",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_WSASend), \
     METH_FASTCALL,                                     \
     _overlapped_Overlapped_WSASend__doc__},

static PyObject *
_overlapped_Overlapped_WSASend_impl(
    OverlappedObject *self, HANDLE handle, Py_buffer *bufobj, DWORD flags
);

static PyObject *
_overlapped_Overlapped_WSASend(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
...
PyDoc_STRVAR(
    _overlapped_Overlapped_AcceptEx__doc__,
...
#define _OVERLAPPED_OVERLAPPED_ACCEPTEX_METHODDEF        \
    {"AcceptEx",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_AcceptEx), \
     METH_FASTCALL,                                      \
     _overlapped_Overlapped_AcceptEx__doc__},

static PyObject *
_overlapped_Overlapped_AcceptEx_impl(
    OverlappedObject *self, HANDLE ListenSocket, HANDLE AcceptSocket
);

static PyObject *
_overlapped_Overlapped_AcceptEx(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE ListenSocket;
    ...
    return_value =
        _overlapped_Overlapped_AcceptEx_impl(self, ListenSocket, AcceptSocket);
...
PyDoc_STRVAR(
    _overlapped_Overlapped_ConnectEx__doc__,
...
#define _OVERLAPPED_OVERLAPPED_CONNECTEX_METHODDEF        \
    {"ConnectEx",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_ConnectEx), \
     METH_FASTCALL,                                       \
     _overlapped_Overlapped_ConnectEx__doc__},

static PyObject *
_overlapped_Overlapped_ConnectEx_impl(
    OverlappedObject *self, HANDLE ConnectSocket, PyObject *AddressObj
);

static PyObject *
_overlapped_Overlapped_ConnectEx(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    ...
    AddressObj = args[1];
    return_value =
        _overlapped_Overlapped_ConnectEx_impl(self, ConnectSocket, AddressObj);
...
PyDoc_STRVAR(
    _overlapped_Overlapped_DisconnectEx__doc__,
...
#define _OVERLAPPED_OVERLAPPED_DISCONNECTEX_METHODDEF        \
    {"DisconnectEx",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_DisconnectEx), \
     METH_FASTCALL,                                          \
     _overlapped_Overlapped_DisconnectEx__doc__},

static PyObject *
_overlapped_Overlapped_DisconnectEx_impl(
    OverlappedObject *self, HANDLE Socket, DWORD flags
);

static PyObject *
_overlapped_Overlapped_DisconnectEx(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE Socket;
...
PyDoc_STRVAR(
    _overlapped_Overlapped_TransmitFile__doc__,
...
#define _OVERLAPPED_OVERLAPPED_TRANSMITFILE_METHODDEF        \
    {"TransmitFile",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_TransmitFile), \
     METH_FASTCALL,                                          \
     _overlapped_Overlapped_TransmitFile__doc__},

static PyObject *
_overlapped_Overlapped_TransmitFile_impl(
...
static PyObject *
_overlapped_Overlapped_TransmitFile(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE Socket;
    ...
    return_value = _overlapped_Overlapped_TransmitFile_impl(
        self, Socket, File, offset, offset_high, count_to_write, count_per_send, flags
    );
...
PyDoc_STRVAR(
    _overlapped_Overlapped_ConnectNamedPipe__doc__,
...
#define _OVERLAPPED_OVERLAPPED_CONNECTNAMEDPIPE_METHODDEF  \
    {"ConnectNamedPipe",                                   \
     (PyCFunction)_overlapped_Overlapped_ConnectNamedPipe, \
     METH_O,                                               \
     _overlapped_Overlapped_ConnectNamedPipe__doc__},

static PyObject *
_overlapped_Overlapped_ConnectNamedPipe_impl(OverlappedObject *self, HANDLE Pipe);
...
PyDoc_STRVAR(
    _overlapped_Overlapped_ConnectPipe__doc__,
...
#define _OVERLAPPED_OVERLAPPED_CONNECTPIPE_METHODDEF  \
    {"ConnectPipe",                                   \
     (PyCFunction)_overlapped_Overlapped_ConnectPipe, \
     METH_O,                                          \
     _overlapped_Overlapped_ConnectPipe__doc__},

static PyObject *
_overlapped_Overlapped_ConnectPipe_impl(OverlappedObject *self, const wchar_t *Address);
...
static PyObject *
_overlapped_WSAConnect_impl(
    PyObject *module, HANDLE ConnectSocket, PyObject *AddressObj
);
...
PyDoc_STRVAR(
    _overlapped_Overlapped_WSASendTo__doc__,
...
#define _OVERLAPPED_OVERLAPPED_WSASENDTO_METHODDEF        \
    {"WSASendTo",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_WSASendTo), \
     METH_FASTCALL,                                       \
     _overlapped_Overlapped_WSASendTo__doc__},

static PyObject *
_overlapped_Overlapped_WSASendTo_impl(
    OverlappedObject *self,
    HANDLE handle,
    Py_buffer *bufobj,
    DWORD flags,
...
static PyObject *
_overlapped_Overlapped_WSASendTo(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
    ...
    AddressObj = args[3];
    return_value =
        _overlapped_Overlapped_WSASendTo_impl(self, handle, &bufobj, flags, AddressObj);
...
PyDoc_STRVAR(
    _overlapped_Overlapped_WSARecvFrom__doc__,
...
#define _OVERLAPPED_OVERLAPPED_WSARECVFROM_METHODDEF        \
    {"WSARecvFrom",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_WSARecvFrom), \
     METH_FASTCALL,                                         \
     _overlapped_Overlapped_WSARecvFrom__doc__},

static PyObject *
_overlapped_Overlapped_WSARecvFrom_impl(
    OverlappedObject *self, HANDLE handle, DWORD size, DWORD flags
);

static PyObject *
_overlapped_Overlapped_WSARecvFrom(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
...
PyDoc_STRVAR(
    _overlapped_Overlapped_WSARecvFromInto__doc__,
...
#define _OVERLAPPED_OVERLAPPED_WSARECVFROMINTO_METHODDEF        \
    {"WSARecvFromInto",                                         \
     _PyCFunction_CAST(_overlapped_Overlapped_WSARecvFromInto), \
     METH_FASTCALL,                                             \
     _overlapped_Overlapped_WSARecvFromInto__doc__},

static PyObject *
_overlapped_Overlapped_WSARecvFromInto_impl(
    OverlappedObject *self, HANDLE handle, Py_buffer *bufobj, DWORD size, DWORD flags
);

static PyObject *
_overlapped_Overlapped_WSARecvFromInto(
    OverlappedObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    HANDLE handle;
...
skip_optional:
    return_value =
        _overlapped_Overlapped_WSARecvFromInto_impl(self, handle, &bufobj, size, flags);
