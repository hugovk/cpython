...
#define DEPR_STAR_NEW_CLONE_METHODDEF        \
    {"cloned",                               \
     _PyCFunction_CAST(depr_star_new_clone), \
...
static PyObject *
depr_star_new_clone(
    PyObject *type, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define DEPR_STAR_INIT_CLONE_METHODDEF        \
    {"cloned",                                \
     _PyCFunction_CAST(depr_star_init_clone), \
     METH_FASTCALL | METH_KEYWORDS,           \
     depr_star_init_clone__doc__},
...
#ifdef _MSC_VER
#pragma message(                                                              \
    "Update the clinic input of '_testclinic.DeprStarInitNoInline.__init__'." \
)
#else
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseTupleAndKeywordsFast(
            args, kwargs, &_parser, &a, &b, &c, &d, &d_length
        )) {
        goto exit;
    }
...
#ifdef _MSC_VER
#pragma message(                                                             \
    "Update the clinic input of '_testclinic.DeprKwdInitNoInline.__init__'." \
)
#else
...
#undef KWTUPLE
    ...
    if (kwargs && PyDict_GET_SIZE(kwargs) &&
        ((nargs < 2) || (nargs < 3 && PyDict_Contains(kwargs, _Py_LATIN1_CHR('c'))))) {
        ...
        if (PyErr_WarnEx(
                ...
                "and 'c' will become positional-only in Python 3.14.",
                1
            )) {
            goto exit;
        }
...
#define DEPR_STAR_POS0_LEN1_METHODDEF        \
    {"depr_star_pos0_len1",                  \
     _PyCFunction_CAST(depr_star_pos0_len1), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_star_pos0_len1__doc__},
...
#define DEPR_STAR_POS0_LEN2_METHODDEF        \
    {"depr_star_pos0_len2",                  \
     _PyCFunction_CAST(depr_star_pos0_len2), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_star_pos0_len2__doc__},
...
PyDoc_STRVAR(
    depr_star_pos0_len3_with_kwd__doc__,
...
#define DEPR_STAR_POS0_LEN3_WITH_KWD_METHODDEF        \
    {"depr_star_pos0_len3_with_kwd",                  \
     _PyCFunction_CAST(depr_star_pos0_len3_with_kwd), \
     METH_FASTCALL | METH_KEYWORDS,                   \
     depr_star_pos0_len3_with_kwd__doc__},
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 3, 3, 1, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
PyDoc_STRVAR(
    depr_star_pos1_len1_opt__doc__,
...
#define DEPR_STAR_POS1_LEN1_OPT_METHODDEF        \
    {"depr_star_pos1_len1_opt",                  \
     _PyCFunction_CAST(depr_star_pos1_len1_opt), \
     METH_FASTCALL | METH_KEYWORDS,              \
     depr_star_pos1_len1_opt__doc__},
...
#define DEPR_STAR_POS1_LEN1_METHODDEF        \
    {"depr_star_pos1_len1",                  \
     _PyCFunction_CAST(depr_star_pos1_len1), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_star_pos1_len1__doc__},
...
PyDoc_STRVAR(
    depr_star_pos1_len2_with_kwd__doc__,
...
#define DEPR_STAR_POS1_LEN2_WITH_KWD_METHODDEF        \
    {"depr_star_pos1_len2_with_kwd",                  \
     _PyCFunction_CAST(depr_star_pos1_len2_with_kwd), \
     METH_FASTCALL | METH_KEYWORDS,                   \
     depr_star_pos1_len2_with_kwd__doc__},
...
#undef KWTUPLE
    ...
    if (nargs > 1 && nargs <= 3) {
        if (PyErr_WarnEx(
                ...
                " 'c' will become keyword-only parameters in Python 3.14.",
                1
            )) {
            goto exit;
        }
...
#define DEPR_STAR_POS2_LEN1_METHODDEF        \
    {"depr_star_pos2_len1",                  \
     _PyCFunction_CAST(depr_star_pos2_len1), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_star_pos2_len1__doc__},
...
#define DEPR_STAR_POS2_LEN2_METHODDEF        \
    {"depr_star_pos2_len2",                  \
     _PyCFunction_CAST(depr_star_pos2_len2), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_star_pos2_len2__doc__},
...
PyDoc_STRVAR(
    depr_star_pos2_len2_with_kwd__doc__,
...
#undef KWTUPLE
    ...
    if (nargs > 2 && nargs <= 4) {
        if (PyErr_WarnEx(
                ...
                " 'd' will become keyword-only parameters in Python 3.14.",
                1
            )) {
            goto exit;
        }
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 4, 4, 1, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
#define DEPR_STAR_NOINLINE_METHODDEF        \
    {"depr_star_noinline",                  \
     _PyCFunction_CAST(depr_star_noinline), \
     METH_FASTCALL | METH_KEYWORDS,         \
     depr_star_noinline__doc__},
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(
            args, nargs, kwnames, &_parser, &a, &b, &c, &d, &d_length
        )) {
        goto exit;
    }
...
#define DEPR_STAR_MULTI_METHODDEF        \
    {"depr_star_multi",                  \
     _PyCFunction_CAST(depr_star_multi), \
     METH_FASTCALL | METH_KEYWORDS,      \
     depr_star_multi__doc__},
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 7, 7, 1, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
#define DEPR_KWD_REQUIRED_1_METHODDEF        \
    {"depr_kwd_required_1",                  \
     _PyCFunction_CAST(depr_kwd_required_1), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_kwd_required_1__doc__},
...
#define DEPR_KWD_REQUIRED_2_METHODDEF        \
    {"depr_kwd_required_2",                  \
     _PyCFunction_CAST(depr_kwd_required_2), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_kwd_required_2__doc__},
...
#undef KWTUPLE
    ...
    if (nargs < 3) {
        if (PyErr_WarnEx(
                ...
                "positional-only in Python 3.14.",
                1
            )) {
            goto exit;
        }
...
#define DEPR_KWD_OPTIONAL_1_METHODDEF        \
    {"depr_kwd_optional_1",                  \
     _PyCFunction_CAST(depr_kwd_optional_1), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_kwd_optional_1__doc__},
...
#define DEPR_KWD_OPTIONAL_2_METHODDEF        \
    {"depr_kwd_optional_2",                  \
     _PyCFunction_CAST(depr_kwd_optional_2), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_kwd_optional_2__doc__},
...
#define DEPR_KWD_OPTIONAL_3_METHODDEF        \
    {"depr_kwd_optional_3",                  \
     _PyCFunction_CAST(depr_kwd_optional_3), \
     METH_FASTCALL | METH_KEYWORDS,          \
     depr_kwd_optional_3__doc__},
...
#undef KWTUPLE
    ...
    if (kwnames && PyTuple_GET_SIZE(kwnames) &&
        ((nargs < 1 && args[0]) || (nargs < 2 && args[1]) || (nargs < 3 && args[2]))) {
        if (PyErr_WarnEx(
                PyExc_DeprecationWarning,
...
PyDoc_STRVAR(
    depr_kwd_required_optional__doc__,
...
#define DEPR_KWD_REQUIRED_OPTIONAL_METHODDEF        \
    {"depr_kwd_required_optional",                  \
     _PyCFunction_CAST(depr_kwd_required_optional), \
     METH_FASTCALL | METH_KEYWORDS,                 \
     depr_kwd_required_optional__doc__},

static PyObject *
depr_kwd_required_optional_impl(
...
#undef KWTUPLE
    ...
    if (kwnames && PyTuple_GET_SIZE(kwnames) &&
        ((nargs < 2) || (nargs < 3 && args[2]))) {
        if (PyErr_WarnEx(
                PyExc_DeprecationWarning,
                "Passing keyword arguments 'b' and 'c' to "
                "depr_kwd_required_optional() is deprecated. Parameters 'b' and "
                "'c' will become positional-only in Python 3.14.",
                1
            )) {
            goto exit;
        }
...
#define DEPR_KWD_NOINLINE_METHODDEF        \
    {"depr_kwd_noinline",                  \
     _PyCFunction_CAST(depr_kwd_noinline), \
     METH_FASTCALL | METH_KEYWORDS,        \
     depr_kwd_noinline__doc__},
...
#undef KWTUPLE
    ...
    if (kwnames && PyTuple_GET_SIZE(kwnames) &&
        ((nargs < 2) || (nargs < 3 && PySequence_Contains(kwnames, _Py_LATIN1_CHR('c')))
        )) {
...
#define DEPR_KWD_MULTI_METHODDEF        \
    {"depr_kwd_multi",                  \
     _PyCFunction_CAST(depr_kwd_multi), \
     METH_FASTCALL | METH_KEYWORDS,     \
     depr_kwd_multi__doc__},
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 8, 8, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    if (nargs < 7) {
        if (PyErr_WarnEx(
                ...
                "'g' will become positional-only in Python 3.16.",
                1
            )) {
            goto exit;
        }
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 6, 6, 1, argsbuf);
    if (!args) {
        goto exit;
    }
    if (nargs < 3) {
        if (PyErr_WarnEx(
                ...
                "deprecated. Parameter 'b' will become positional-only in Python "
                "3.14. Parameter 'c' will become positional-only in Python 3.15.",
                1
            )) {
            goto exit;
        }
