...
"parameters in Python 25.0. Parameters \'e\', \'f\' and \'g\' will become\n"
...
depr_star_multi(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (nargs > 1 && nargs <= 7) {
        if (PyErr_WarnEx(PyExc_DeprecationWarning,
                ...
                "parameters in Python 25.0. Parameters 'e', 'f' and 'g' will "
                "become keyword-only parameters in Python 3.14.", 1))
        {
            goto exit;
        }
...
"only in Python 25.0. Parameters \'e\', \'f\' and \'g\' will become\n"
"positional-only in Python 26.0.\n"
"");
...
depr_kwd_multi(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (nargs < 7) {
        if (PyErr_WarnEx(PyExc_DeprecationWarning,
                ...
                "become positional-only in Python 25.0. Parameters 'e', 'f' and "
                "'g' will become positional-only in Python 26.0.", 1))
        {
            goto exit;
        }
    }
...
"deprecated. Parameter \'b\' will become positional-only in Python 3.14.\n"
"Parameter \'c\' will become positional-only in Python 25.0.\n"
"\n"
"\n"
...
"Python 25.0. Parameter \'f\' will become a keyword-only parameter in\n"
"Python 3.14.\n"
"");
...
depr_multi(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (nargs > 4 && nargs <= 6) {
        if (PyErr_WarnEx(PyExc_DeprecationWarning,
                ...
                "in Python 25.0. Parameter 'f' will become a keyword-only "
                "parameter in Python 3.14.", 1))
        {
            goto exit;
        }
    ...
    if (nargs < 3) {
        if (PyErr_WarnEx(PyExc_DeprecationWarning,
                ...
                "deprecated. Parameter 'b' will become positional-only in Python "
                "3.14. Parameter 'c' will become positional-only in Python 25.0.", 1))
        {
            goto exit;
        }
    }
