...
#define ARRAY_ARRAY___COPY___METHODDEF  \
    {"__copy__",                        \
     (PyCFunction)array_array___copy__, \
     METH_NOARGS,                       \
     array_array___copy____doc__},
...
#define ARRAY_ARRAY___DEEPCOPY___METHODDEF  \
    {"__deepcopy__",                        \
     (PyCFunction)array_array___deepcopy__, \
     METH_O,                                \
     array_array___deepcopy____doc__},
...
#define ARRAY_ARRAY_INDEX_METHODDEF        \
    {"index",                              \
     _PyCFunction_CAST(array_array_index), \
     METH_FASTCALL,                        \
     array_array_index__doc__},
...
#define ARRAY_ARRAY_EXTEND_METHODDEF              \
    {"extend",                                    \
     _PyCFunction_CAST(array_array_extend),       \
...
#define ARRAY_ARRAY_INSERT_METHODDEF        \
    {"insert",                              \
     _PyCFunction_CAST(array_array_insert), \
     METH_FASTCALL,                         \
     array_array_insert__doc__},
...
#define ARRAY_ARRAY_BUFFER_INFO_METHODDEF  \
    {"buffer_info",                        \
     (PyCFunction)array_array_buffer_info, \
     METH_NOARGS,                          \
     array_array_buffer_info__doc__},
...
#define ARRAY_ARRAY_BYTESWAP_METHODDEF  \
    {"byteswap",                        \
     (PyCFunction)array_array_byteswap, \
     METH_NOARGS,                       \
     array_array_byteswap__doc__},
...
#define ARRAY_ARRAY_REVERSE_METHODDEF  \
    {"reverse",                        \
     (PyCFunction)array_array_reverse, \
     METH_NOARGS,                      \
     array_array_reverse__doc__},
...
#define ARRAY_ARRAY_FROMFILE_METHODDEF            \
    {"fromfile",                                  \
     _PyCFunction_CAST(array_array_fromfile),     \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     array_array_fromfile__doc__},
...
#define ARRAY_ARRAY_TOFILE_METHODDEF              \
    {"tofile",                                    \
     _PyCFunction_CAST(array_array_tofile),       \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     array_array_tofile__doc__},
...
#define ARRAY_ARRAY_FROMLIST_METHODDEF  \
    {"fromlist",                        \
     (PyCFunction)array_array_fromlist, \
     METH_O,                            \
     array_array_fromlist__doc__},

PyDoc_STRVAR(
    array_array_tolist__doc__,
    "tolist($self, /)\n"
    "--\n"
    "\n"
...
PyDoc_STRVAR(
    ...
    "--\n"
    "\n"
    "Appends items from the string, interpreting it as an array of machine values, as "
    "if it had been read from a file using the fromfile() method."
);

#define ARRAY_ARRAY_FROMBYTES_METHODDEF  \
    {"frombytes",                        \
     (PyCFunction)array_array_frombytes, \
     METH_O,                             \
     array_array_frombytes__doc__},
...
#define ARRAY_ARRAY_FROMUNICODE_METHODDEF  \
    {"fromunicode",                        \
     (PyCFunction)array_array_fromunicode, \
     METH_O,                               \
     array_array_fromunicode__doc__},
...
#define ARRAY_ARRAY_TOUNICODE_METHODDEF  \
    {"tounicode",                        \
     (PyCFunction)array_array_tounicode, \
     METH_NOARGS,                        \
     array_array_tounicode__doc__},
...
#define ARRAY_ARRAY___SIZEOF___METHODDEF  \
    {"__sizeof__",                        \
     (PyCFunction)array_array___sizeof__, \
     METH_NOARGS,                         \
     array_array___sizeof____doc__},
...
PyDoc_STRVAR(
    array__array_reconstructor__doc__,
...
#define ARRAY__ARRAY_RECONSTRUCTOR_METHODDEF        \
    {"_array_reconstructor",                        \
     _PyCFunction_CAST(array__array_reconstructor), \
     METH_FASTCALL,                                 \
     array__array_reconstructor__doc__},
...
array__array_reconstructor(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument(
            "_array_reconstructor", "argument 2", "a unicode character", args[1]
        );
        goto exit;
    }
    ...
    items = args[3];
    return_value = array__array_reconstructor_impl(
...
PyDoc_STRVAR(
    array_array___reduce_ex____doc__,
...
#define ARRAY_ARRAY___REDUCE_EX___METHODDEF        \
    {"__reduce_ex__",                              \
     _PyCFunction_CAST(array_array___reduce_ex__), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,  \
     array_array___reduce_ex____doc__},
...
#define ARRAY_ARRAYITERATOR___REDUCE___METHODDEF        \
    {"__reduce__",                                      \
     _PyCFunction_CAST(array_arrayiterator___reduce__), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,       \
     array_arrayiterator___reduce____doc__},
...
#define ARRAY_ARRAYITERATOR___SETSTATE___METHODDEF  \
    {"__setstate__",                                \
     (PyCFunction)array_arrayiterator___setstate__, \
     METH_O,                                        \
     array_arrayiterator___setstate____doc__},
