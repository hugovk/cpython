...
PyDoc_STRVAR(
    _asyncio_Future___init____doc__,
    "Future(*, loop=None)\n"
    "--\n"
    "\n"
...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 0, 0, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
...
#define _ASYNCIO_FUTURE_RESULT_METHODDEF  \
    {"result",                            \
     (PyCFunction)_asyncio_Future_result, \
     METH_NOARGS,                         \
     _asyncio_Future_result__doc__},
...
#define _ASYNCIO_FUTURE_EXCEPTION_METHODDEF        \
    {"exception",                                  \
     _PyCFunction_CAST(_asyncio_Future_exception), \
...
#define _ASYNCIO_FUTURE_SET_RESULT_METHODDEF        \
    {"set_result",                                  \
     _PyCFunction_CAST(_asyncio_Future_set_result), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,   \
     _asyncio_Future_set_result__doc__},

static PyObject *
_asyncio_Future_set_result_impl(FutureObj *self, PyTypeObject *cls, PyObject *result);
...
#define _ASYNCIO_FUTURE_SET_EXCEPTION_METHODDEF        \
    {"set_exception",                                  \
     _PyCFunction_CAST(_asyncio_Future_set_exception), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,      \
     _asyncio_Future_set_exception__doc__},

static PyObject *
_asyncio_Future_set_exception_impl(
    FutureObj *self, PyTypeObject *cls, PyObject *exception
);
...
#define _ASYNCIO_FUTURE_ADD_DONE_CALLBACK_METHODDEF        \
    {"add_done_callback",                                  \
     _PyCFunction_CAST(_asyncio_Future_add_done_callback), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,          \
     _asyncio_Future_add_done_callback__doc__},

static PyObject *
_asyncio_Future_add_done_callback_impl(
    FutureObj *self, PyTypeObject *cls, PyObject *fn, PyObject *context
);
...
#define _ASYNCIO_FUTURE_REMOVE_DONE_CALLBACK_METHODDEF        \
    {"remove_done_callback",                                  \
     _PyCFunction_CAST(_asyncio_Future_remove_done_callback), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,             \
     _asyncio_Future_remove_done_callback__doc__},

static PyObject *
_asyncio_Future_remove_done_callback_impl(
    FutureObj *self, PyTypeObject *cls, PyObject *fn
);
...
#define _ASYNCIO_FUTURE_CANCEL_METHODDEF          \
    {"cancel",                                    \
     _PyCFunction_CAST(_asyncio_Future_cancel),   \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _asyncio_Future_cancel__doc__},

static PyObject *
_asyncio_Future_cancel_impl(FutureObj *self, PyTypeObject *cls, PyObject *msg);

static PyObject *
_asyncio_Future_cancel(
    FutureObj *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
PyDoc_STRVAR(
    _asyncio_Future_cancelled__doc__,
    "cancelled($self, /)\n"
    "--\n"
    "\n"
...
#define _ASYNCIO_FUTURE_CANCELLED_METHODDEF  \
    {"cancelled",                            \
     (PyCFunction)_asyncio_Future_cancelled, \
     METH_NOARGS,                            \
     _asyncio_Future_cancelled__doc__},
...
#define _ASYNCIO_FUTURE_DONE_METHODDEF  \
    {"done",                            \
     (PyCFunction)_asyncio_Future_done, \
     METH_NOARGS,                       \
     _asyncio_Future_done__doc__},
...
PyDoc_STRVAR(
    _asyncio_Future_get_loop__doc__,
    "get_loop($self, /)\n"
    "--\n"
    "\n"
...
#define _ASYNCIO_FUTURE_GET_LOOP_METHODDEF        \
    {"get_loop",                                  \
     _PyCFunction_CAST(_asyncio_Future_get_loop), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _asyncio_Future_get_loop__doc__},
...
#define _ASYNCIO_FUTURE__MAKE_CANCELLED_ERROR_METHODDEF  \
    {"_make_cancelled_error",                            \
     (PyCFunction)_asyncio_Future__make_cancelled_error, \
     METH_NOARGS,                                        \
     _asyncio_Future__make_cancelled_error__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "coro", "loop", "name", "context", "eager_start", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "Task",
...
skip_optional_kwonly:
    return_value = _asyncio_Task___init___impl(
        (TaskObj *)self, coro, loop, name, context, eager_start
    );
...
#define _ASYNCIO_TASK__MAKE_CANCELLED_ERROR_METHODDEF  \
    {"_make_cancelled_error",                          \
     (PyCFunction)_asyncio_Task__make_cancelled_error, \
     METH_NOARGS,                                      \
     _asyncio_Task__make_cancelled_error__doc__},
...
#define _ASYNCIO_TASK_CANCEL_METHODDEF        \
    {"cancel",                                \
     _PyCFunction_CAST(_asyncio_Task_cancel), \
...
_asyncio_Task_cancel(
    TaskObj *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _ASYNCIO_TASK_CANCELLING_METHODDEF  \
    {"cancelling",                          \
     (PyCFunction)_asyncio_Task_cancelling, \
     METH_NOARGS,                           \
     _asyncio_Task_cancelling__doc__},
...
#define _ASYNCIO_TASK_UNCANCEL_METHODDEF  \
    {"uncancel",                          \
     (PyCFunction)_asyncio_Task_uncancel, \
     METH_NOARGS,                         \
     _asyncio_Task_uncancel__doc__},
...
#define _ASYNCIO_TASK_GET_STACK_METHODDEF         \
    {"get_stack",                                 \
     _PyCFunction_CAST(_asyncio_Task_get_stack),  \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _asyncio_Task_get_stack__doc__},

static PyObject *
_asyncio_Task_get_stack_impl(TaskObj *self, PyTypeObject *cls, PyObject *limit);
...
PyDoc_STRVAR(
    _asyncio_Task_print_stack__doc__,
...
#define _ASYNCIO_TASK_PRINT_STACK_METHODDEF        \
    {"print_stack",                                \
     _PyCFunction_CAST(_asyncio_Task_print_stack), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,  \
     _asyncio_Task_print_stack__doc__},

static PyObject *
_asyncio_Task_print_stack_impl(
    TaskObj *self, PyTypeObject *cls, PyObject *limit, PyObject *file
);

static PyObject *
_asyncio_Task_print_stack(
    TaskObj *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
#define _ASYNCIO_TASK_SET_RESULT_METHODDEF  \
    {"set_result",                          \
     (PyCFunction)_asyncio_Task_set_result, \
     METH_O,                                \
     _asyncio_Task_set_result__doc__},
...
#define _ASYNCIO_TASK_SET_EXCEPTION_METHODDEF  \
    {"set_exception",                          \
     (PyCFunction)_asyncio_Task_set_exception, \
     METH_O,                                   \
     _asyncio_Task_set_exception__doc__},
...
#define _ASYNCIO_TASK_GET_CORO_METHODDEF  \
    {"get_coro",                          \
     (PyCFunction)_asyncio_Task_get_coro, \
     METH_NOARGS,                         \
     _asyncio_Task_get_coro__doc__},
...
#define _ASYNCIO_TASK_GET_CONTEXT_METHODDEF  \
    {"get_context",                          \
     (PyCFunction)_asyncio_Task_get_context, \
     METH_NOARGS,                            \
     _asyncio_Task_get_context__doc__},
...
#define _ASYNCIO_TASK_GET_NAME_METHODDEF  \
    {"get_name",                          \
     (PyCFunction)_asyncio_Task_get_name, \
     METH_NOARGS,                         \
     _asyncio_Task_get_name__doc__},
...
#define _ASYNCIO_TASK_SET_NAME_METHODDEF  \
    {"set_name",                          \
     (PyCFunction)_asyncio_Task_set_name, \
     METH_O,                              \
     _asyncio_Task_set_name__doc__},
...
#define _ASYNCIO__GET_RUNNING_LOOP_METHODDEF  \
    {"_get_running_loop",                     \
     (PyCFunction)_asyncio__get_running_loop, \
     METH_NOARGS,                             \
     _asyncio__get_running_loop__doc__},
...
PyDoc_STRVAR(
    _asyncio__set_running_loop__doc__,
...
#define _ASYNCIO__SET_RUNNING_LOOP_METHODDEF  \
    {"_set_running_loop",                     \
     (PyCFunction)_asyncio__set_running_loop, \
     METH_O,                                  \
     _asyncio__set_running_loop__doc__},
...
#define _ASYNCIO_GET_EVENT_LOOP_METHODDEF  \
    {"get_event_loop",                     \
     (PyCFunction)_asyncio_get_event_loop, \
     METH_NOARGS,                          \
     _asyncio_get_event_loop__doc__},
...
PyDoc_STRVAR(
    _asyncio_get_running_loop__doc__,
...
#define _ASYNCIO_GET_RUNNING_LOOP_METHODDEF  \
    {"get_running_loop",                     \
     (PyCFunction)_asyncio_get_running_loop, \
     METH_NOARGS,                            \
     _asyncio_get_running_loop__doc__},
...
#define _ASYNCIO__REGISTER_TASK_METHODDEF        \
    {"_register_task",                           \
     _PyCFunction_CAST(_asyncio__register_task), \
     METH_FASTCALL | METH_KEYWORDS,              \
     _asyncio__register_task__doc__},
...
PyDoc_STRVAR(
    _asyncio__register_eager_task__doc__,
...
#define _ASYNCIO__REGISTER_EAGER_TASK_METHODDEF        \
    {"_register_eager_task",                           \
     _PyCFunction_CAST(_asyncio__register_eager_task), \
     METH_FASTCALL | METH_KEYWORDS,                    \
     _asyncio__register_eager_task__doc__},
...
#define _ASYNCIO__UNREGISTER_TASK_METHODDEF        \
    {"_unregister_task",                           \
     _PyCFunction_CAST(_asyncio__unregister_task), \
     METH_FASTCALL | METH_KEYWORDS,                \
     _asyncio__unregister_task__doc__},
...
PyDoc_STRVAR(
    _asyncio__unregister_eager_task__doc__,
...
#define _ASYNCIO__UNREGISTER_EAGER_TASK_METHODDEF        \
    {"_unregister_eager_task",                           \
     _PyCFunction_CAST(_asyncio__unregister_eager_task), \
     METH_FASTCALL | METH_KEYWORDS,                      \
     _asyncio__unregister_eager_task__doc__},
...
static PyObject *
_asyncio__unregister_eager_task(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _ASYNCIO__ENTER_TASK_METHODDEF        \
    {"_enter_task",                           \
     _PyCFunction_CAST(_asyncio__enter_task), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _asyncio__enter_task__doc__},
...
#define _ASYNCIO__LEAVE_TASK_METHODDEF        \
    {"_leave_task",                           \
     _PyCFunction_CAST(_asyncio__leave_task), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _asyncio__leave_task__doc__},
...
PyDoc_STRVAR(
    _asyncio__swap_current_task__doc__,
...
#define _ASYNCIO__SWAP_CURRENT_TASK_METHODDEF        \
    {"_swap_current_task",                           \
     _PyCFunction_CAST(_asyncio__swap_current_task), \
     METH_FASTCALL | METH_KEYWORDS,                  \
     _asyncio__swap_current_task__doc__},

static PyObject *
_asyncio__swap_current_task_impl(PyObject *module, PyObject *loop, PyObject *task);

static PyObject *
_asyncio__swap_current_task(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _ASYNCIO_CURRENT_TASK_METHODDEF        \
    {"current_task",                           \
     _PyCFunction_CAST(_asyncio_current_task), \
     METH_FASTCALL | METH_KEYWORDS,            \
     _asyncio_current_task__doc__},
...
#define _ASYNCIO_ALL_TASKS_METHODDEF        \
    {"all_tasks",                           \
     _PyCFunction_CAST(_asyncio_all_tasks), \
     METH_FASTCALL | METH_KEYWORDS,         \
     _asyncio_all_tasks__doc__},
