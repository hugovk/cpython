...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "path", "mode", "dir_fd", "effective_ids", "follow_symlinks", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "access",
...
skip_optional_kwonly:
    _return_value =
        os_access_impl(module, &path, mode, dir_fd, effective_ids, follow_symlinks);
...
PyDoc_STRVAR(
    ...
    "notation for\n"
    "    numeric modes uses an octal base, which needs to be indicated with a ``0o`` "
    "prefix in\n"
    "    Python.\n"
    "  dir_fd\n"
    "    If not None, it should be a file descriptor open to a directory,\n"
...
#define OS_CHMOD_METHODDEF          \
    {"chmod",                       \
     _PyCFunction_CAST(os_chmod),   \
     METH_FASTCALL | METH_KEYWORDS, \
     os_chmod__doc__},

static PyObject *
os_chmod_impl(
    PyObject *module, path_t *path, int mode, int dir_fd, int follow_symlinks
);
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "path", "mode", "dir_fd", "follow_symlinks", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "chmod",
...
#define OS_SYNC_METHODDEF {"sync", (PyCFunction)os_sync, METH_NOARGS, os_sync__doc__},
...
#define OS_FDATASYNC_METHODDEF        \
    {"fdatasync",                     \
     _PyCFunction_CAST(os_fdatasync), \
     METH_FASTCALL | METH_KEYWORDS,   \
     os_fdatasync__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "path", "uid", "gid", "dir_fd", "follow_symlinks", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "chown",
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "src", "dst", "src_dir_fd", "dst_dir_fd", "follow_symlinks", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "link",
...
#define OS_LISTMOUNTS_METHODDEF        \
    {"listmounts",                     \
     _PyCFunction_CAST(os_listmounts), \
     METH_FASTCALL | METH_KEYWORDS,    \
     os_listmounts__doc__},
...
#define OS__PATH_ISDEVDRIVE_METHODDEF        \
    {"_path_isdevdrive",                     \
     _PyCFunction_CAST(os__path_isdevdrive), \
     METH_FASTCALL | METH_KEYWORDS,          \
     os__path_isdevdrive__doc__},
...
#define OS__GETFULLPATHNAME_METHODDEF  \
    {"_getfullpathname",               \
     (PyCFunction)os__getfullpathname, \
     METH_O,                           \
     os__getfullpathname__doc__},
...
#define OS__GETFINALPATHNAME_METHODDEF  \
    {"_getfinalpathname",               \
     (PyCFunction)os__getfinalpathname, \
     METH_O,                            \
     os__getfinalpathname__doc__},
...
#define OS__GETVOLUMEPATHNAME_METHODDEF        \
    {"_getvolumepathname",                     \
     _PyCFunction_CAST(os__getvolumepathname), \
     METH_FASTCALL | METH_KEYWORDS,            \
     os__getvolumepathname__doc__},
...
#define OS__PATH_SPLITROOT_METHODDEF        \
    {"_path_splitroot",                     \
     _PyCFunction_CAST(os__path_splitroot), \
     METH_FASTCALL | METH_KEYWORDS,         \
     os__path_splitroot__doc__},
...
#define OS__PATH_EXISTS_METHODDEF        \
    {"_path_exists",                     \
     _PyCFunction_CAST(os__path_exists), \
     METH_FASTCALL | METH_KEYWORDS,      \
     os__path_exists__doc__},
...
#define OS__PATH_LEXISTS_METHODDEF        \
    {"_path_lexists",                     \
     _PyCFunction_CAST(os__path_lexists), \
     METH_FASTCALL | METH_KEYWORDS,       \
     os__path_lexists__doc__},
...
#define OS__PATH_ISDIR_METHODDEF        \
    {"_path_isdir",                     \
     _PyCFunction_CAST(os__path_isdir), \
     METH_FASTCALL | METH_KEYWORDS,     \
     os__path_isdir__doc__},
...
#define OS__PATH_ISFILE_METHODDEF        \
    {"_path_isfile",                     \
     _PyCFunction_CAST(os__path_isfile), \
     METH_FASTCALL | METH_KEYWORDS,      \
     os__path_isfile__doc__},
...
#define OS__PATH_ISLINK_METHODDEF        \
    {"_path_islink",                     \
     _PyCFunction_CAST(os__path_islink), \
     METH_FASTCALL | METH_KEYWORDS,      \
     os__path_islink__doc__},
...
#define OS__PATH_ISJUNCTION_METHODDEF        \
    {"_path_isjunction",                     \
     _PyCFunction_CAST(os__path_isjunction), \
     METH_FASTCALL | METH_KEYWORDS,          \
     os__path_isjunction__doc__},
...
#define OS__PATH_SPLITROOT_EX_METHODDEF        \
    {"_path_splitroot_ex",                     \
     _PyCFunction_CAST(os__path_splitroot_ex), \
     METH_FASTCALL | METH_KEYWORDS,            \
     os__path_splitroot_ex__doc__},
...
#define OS__PATH_NORMPATH_METHODDEF        \
    {"_path_normpath",                     \
     _PyCFunction_CAST(os__path_normpath), \
     METH_FASTCALL | METH_KEYWORDS,        \
     os__path_normpath__doc__},
...
#define OS_NICE_METHODDEF {"nice", (PyCFunction)os_nice, METH_O, os_nice__doc__},
...
#define OS_GETPRIORITY_METHODDEF        \
    {"getpriority",                     \
     _PyCFunction_CAST(os_getpriority), \
     METH_FASTCALL | METH_KEYWORDS,     \
     os_getpriority__doc__},
...
#define OS_SETPRIORITY_METHODDEF        \
    {"setpriority",                     \
     _PyCFunction_CAST(os_setpriority), \
     METH_FASTCALL | METH_KEYWORDS,     \
     os_setpriority__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "src", "dst", "src_dir_fd", "dst_dir_fd", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "rename",
...
#define OS_UMASK_METHODDEF {"umask", (PyCFunction)os_umask, METH_O, os_umask__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "path", "times", "ns", "dir_fd", "follow_symlinks", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "utime",
...
#define OS_POSIX_SPAWN_METHODDEF        \
    {"posix_spawn",                     \
     _PyCFunction_CAST(os_posix_spawn), \
     METH_FASTCALL | METH_KEYWORDS,     \
     os_posix_spawn__doc__},
...
#undef KWTUPLE
    ...
    scheduler = args[9];
skip_optional_kwonly:
    return_value = os_posix_spawn_impl(
        module,
        &path,
        argv,
        env,
...
#define OS_POSIX_SPAWNP_METHODDEF        \
    {"posix_spawnp",                     \
     _PyCFunction_CAST(os_posix_spawnp), \
     METH_FASTCALL | METH_KEYWORDS,      \
     os_posix_spawnp__doc__},
...
#undef KWTUPLE
    ...
    scheduler = args[9];
skip_optional_kwonly:
    return_value = os_posix_spawnp_impl(
        module,
        &path,
        argv,
        env,
...
static PyObject *
os_spawnve_impl(
    PyObject *module, int mode, path_t *path, PyObject *argv, PyObject *env
);
...
#define OS_REGISTER_AT_FORK_METHODDEF        \
    {"register_at_fork",                     \
     _PyCFunction_CAST(os_register_at_fork), \
     METH_FASTCALL | METH_KEYWORDS,          \
     os_register_at_fork__doc__},
...
#define NUM_KEYWORDS 3
    static struct {
        ...
        .ob_base = PyVarObject_HEAD_INIT(&PyTuple_Type, NUM_KEYWORDS).ob_item =
            {
                &_Py_ID(before),
                &_Py_ID(after_in_child),
                &_Py_ID(after_in_parent),
            },
    };
#undef NUM_KEYWORDS
#define KWTUPLE (&_kwtuple.ob_base.ob_base)
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "before", "after_in_child", "after_in_parent", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
#define OS_FORK_METHODDEF {"fork", (PyCFunction)os_fork, METH_NOARGS, os_fork__doc__},
...
PyDoc_STRVAR(
    os_sched_get_priority_max__doc__,
...
#define OS_SCHED_GET_PRIORITY_MAX_METHODDEF        \
    {"sched_get_priority_max",                     \
     _PyCFunction_CAST(os_sched_get_priority_max), \
     METH_FASTCALL | METH_KEYWORDS,                \
     os_sched_get_priority_max__doc__},
...
PyDoc_STRVAR(
    os_sched_get_priority_min__doc__,
...
#define OS_SCHED_GET_PRIORITY_MIN_METHODDEF        \
    {"sched_get_priority_min",                     \
     _PyCFunction_CAST(os_sched_get_priority_min), \
     METH_FASTCALL | METH_KEYWORDS,                \
     os_sched_get_priority_min__doc__},
...
#define OS_SCHED_GETSCHEDULER_METHODDEF  \
    {"sched_getscheduler",               \
     (PyCFunction)os_sched_getscheduler, \
     METH_O,                             \
     os_sched_getscheduler__doc__},
...
exit:
    ...
    (defined(HAVE_SCHED_SETPARAM) || defined(HAVE_SCHED_SETSCHEDULER) || \
...
exit:
    return return_value;
          ...
          defined(HAVE_SCHED_SETSCHEDULER) || defined(POSIX_SPAWN_SETSCHEDULER) || \
...
#define OS_SCHED_SETSCHEDULER_METHODDEF        \
    {"sched_setscheduler",                     \
     _PyCFunction_CAST(os_sched_setscheduler), \
     METH_FASTCALL,                            \
     os_sched_setscheduler__doc__},

static PyObject *
os_sched_setscheduler_impl(
    PyObject *module, pid_t pid, int policy, PyObject *param_obj
);
...
#define OS_SCHED_SETPARAM_METHODDEF        \
    {"sched_setparam",                     \
     _PyCFunction_CAST(os_sched_setparam), \
     METH_FASTCALL,                        \
     os_sched_setparam__doc__},
...
PyDoc_STRVAR(
    os_sched_rr_get_interval__doc__,
...
#define OS_SCHED_RR_GET_INTERVAL_METHODDEF  \
    {"sched_rr_get_interval",               \
     (PyCFunction)os_sched_rr_get_interval, \
     METH_O,                                \
     os_sched_rr_get_interval__doc__},
...
#define OS_SCHED_SETAFFINITY_METHODDEF        \
    {"sched_setaffinity",                     \
     _PyCFunction_CAST(os_sched_setaffinity), \
     METH_FASTCALL,                           \
     os_sched_setaffinity__doc__},
...
#define OS_SCHED_GETAFFINITY_METHODDEF  \
    {"sched_getaffinity",               \
     (PyCFunction)os_sched_getaffinity, \
     METH_O,                            \
     os_sched_getaffinity__doc__},
...
#define OS_GETGROUPLIST_METHODDEF        \
    {"getgrouplist",                     \
     _PyCFunction_CAST(os_getgrouplist), \
     METH_FASTCALL,                      \
     os_getgrouplist__doc__},
...
#define OS_INITGROUPS_METHODDEF        \
    {"initgroups",                     \
     _PyCFunction_CAST(os_initgroups), \
     METH_FASTCALL,                    \
     os_initgroups__doc__},
...
#define OS_PLOCK_METHODDEF {"plock", (PyCFunction)os_plock, METH_O, os_plock__doc__},
...
#define OS_WAIT_METHODDEF {"wait", (PyCFunction)os_wait, METH_NOARGS, os_wait__doc__},
...
#define OS_PIDFD_OPEN_METHODDEF        \
    {"pidfd_open",                     \
     _PyCFunction_CAST(os_pidfd_open), \
     METH_FASTCALL | METH_KEYWORDS,    \
     os_pidfd_open__doc__},
...
#endif /* (defined(__linux__) && defined(__NR_pidfd_open) && !(defined(__ANDROID__) && \
          __ANDROID_API__ < 31)) */
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "src", "dst", "target_is_directory", "dir_fd", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "symlink",
...
#define OS_TIMERFD_CREATE_METHODDEF        \
    {"timerfd_create",                     \
     _PyCFunction_CAST(os_timerfd_create), \
     METH_FASTCALL | METH_KEYWORDS,        \
     os_timerfd_create__doc__},
...
#define OS_TIMERFD_SETTIME_METHODDEF        \
    {"timerfd_settime",                     \
     _PyCFunction_CAST(os_timerfd_settime), \
     METH_FASTCALL | METH_KEYWORDS,         \
     os_timerfd_settime__doc__},
...
skip_optional_kwonly:
    return_value =
        os_timerfd_settime_impl(module, fd, flags, initial_double, interval_double);
...
#define OS_TIMERFD_SETTIME_NS_METHODDEF        \
    {"timerfd_settime_ns",                     \
     _PyCFunction_CAST(os_timerfd_settime_ns), \
     METH_FASTCALL | METH_KEYWORDS,            \
     os_timerfd_settime_ns__doc__},
...
#define OS_TIMERFD_GETTIME_METHODDEF  \
    {"timerfd_gettime",               \
     (PyCFunction)os_timerfd_gettime, \
     METH_O,                          \
     os_timerfd_gettime__doc__},
...
#define OS_TIMERFD_GETTIME_NS_METHODDEF  \
    {"timerfd_gettime_ns",               \
     (PyCFunction)os_timerfd_gettime_ns, \
     METH_O,                             \
     os_timerfd_gettime_ns__doc__},
...
#define OS_CLOSERANGE_METHODDEF        \
    {"closerange",                     \
     _PyCFunction_CAST(os_closerange), \
     METH_FASTCALL,                    \
     os_closerange__doc__},
...
#define OS_DUP_METHODDEF {"dup", (PyCFunction)os_dup, METH_O, os_dup__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "out_fd", "in_fd", "offset", "count", "headers", "trailers", "flags", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "sendfile",
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 4, 7, 0, argsbuf);
    if (!args) {
        goto exit;
    }
...
skip_optional_pos:
    return_value = os_sendfile_impl(
        module, out_fd, in_fd, offset, sbytes, headers, trailers, flags
    );
...
skip_optional_pos:
    return_value = os_sendfile_impl(
        module, out_fd, in_fd, offset, count, headers, trailers, flags
    );
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 4, 4, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    out_fd = PyLong_AsInt(args[0]);
...
#define OS__FCOPYFILE_METHODDEF        \
    {"_fcopyfile",                     \
     _PyCFunction_CAST(os__fcopyfile), \
     METH_FASTCALL,                    \
     os__fcopyfile__doc__},
...
#define OS_PIPE_METHODDEF {"pipe", (PyCFunction)os_pipe, METH_NOARGS, os_pipe__doc__},
...
#define OS_PIPE2_METHODDEF {"pipe2", (PyCFunction)os_pipe2, METH_O, os_pipe2__doc__},
...
PyDoc_STRVAR(
    ...
    "sequence\n"
    "of bytes-like objects. Buffers are processed in array order. Entire contents of "
    "first\n"
    "buffer is written before proceeding to second, and so on. The operating system "
    "may\n"
...
static Py_ssize_t
os_pwritev_impl(
    PyObject *module, int fd, PyObject *buffers, Py_off_t offset, int flags
);
...
#define OS_COPY_FILE_RANGE_METHODDEF        \
    {"copy_file_range",                     \
     _PyCFunction_CAST(os_copy_file_range), \
     METH_FASTCALL | METH_KEYWORDS,         \
     os_copy_file_range__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "src", "dst", "count", "offset_src", "offset_dst", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 3, 5, 0, argsbuf);
    if (!args) {
        goto exit;
    }
...
skip_optional_pos:
    return_value =
        os_copy_file_range_impl(module, src, dst, count, offset_src, offset_dst);
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "src", "dst", "count", "offset_src", "offset_dst", "flags", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "splice",
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 3, 6, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    src = PyLong_AsInt(args[0]);
...
skip_optional_pos:
    return_value =
        os_splice_impl(module, src, dst, count, offset_src, offset_dst, flags);
...
#define OS_MAJOR_METHODDEF {"major", (PyCFunction)os_major, METH_O, os_major__doc__},
...
#define OS_MINOR_METHODDEF {"minor", (PyCFunction)os_minor, METH_O, os_minor__doc__},
...
#define OS_POSIX_FALLOCATE_METHODDEF        \
    {"posix_fallocate",                     \
     _PyCFunction_CAST(os_posix_fallocate), \
     METH_FASTCALL,                         \
     os_posix_fallocate__doc__},
...
#define OS_POSIX_FADVISE_METHODDEF        \
    {"posix_fadvise",                     \
     _PyCFunction_CAST(os_posix_fadvise), \
     METH_FASTCALL,                       \
     os_posix_fadvise__doc__},
...
#define OS_WIFCONTINUED_METHODDEF        \
    {"WIFCONTINUED",                     \
     _PyCFunction_CAST(os_WIFCONTINUED), \
     METH_FASTCALL | METH_KEYWORDS,      \
     os_WIFCONTINUED__doc__},
...
#define OS_WIFSTOPPED_METHODDEF        \
    {"WIFSTOPPED",                     \
     _PyCFunction_CAST(os_WIFSTOPPED), \
     METH_FASTCALL | METH_KEYWORDS,    \
     os_WIFSTOPPED__doc__},
...
#define OS_WIFSIGNALED_METHODDEF        \
    {"WIFSIGNALED",                     \
     _PyCFunction_CAST(os_WIFSIGNALED), \
     METH_FASTCALL | METH_KEYWORDS,     \
     os_WIFSIGNALED__doc__},
...
#define OS_WIFEXITED_METHODDEF        \
    {"WIFEXITED",                     \
     _PyCFunction_CAST(os_WIFEXITED), \
     METH_FASTCALL | METH_KEYWORDS,   \
     os_WIFEXITED__doc__},
...
#define OS_WEXITSTATUS_METHODDEF        \
    {"WEXITSTATUS",                     \
     _PyCFunction_CAST(os_WEXITSTATUS), \
     METH_FASTCALL | METH_KEYWORDS,     \
     os_WEXITSTATUS__doc__},
...
#define OS__GETDISKUSAGE_METHODDEF        \
    {"_getdiskusage",                     \
     _PyCFunction_CAST(os__getdiskusage), \
     METH_FASTCALL | METH_KEYWORDS,       \
     os__getdiskusage__doc__},
...
#define OS_STARTFILE_METHODDEF        \
    {"startfile",                     \
     _PyCFunction_CAST(os_startfile), \
     METH_FASTCALL | METH_KEYWORDS,   \
     os_startfile__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "filepath", "operation", "arguments", "cwd", "show_cmd", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "startfile",
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 1, 5, 0, argsbuf);
    if (!args) {
        goto exit;
    }
...
skip_optional_pos:
    return_value =
        os_startfile_impl(module, &filepath, operation, arguments, &cwd, show_cmd);
...
#define OS_DEVICE_ENCODING_METHODDEF        \
    {"device_encoding",                     \
     _PyCFunction_CAST(os_device_encoding), \
     METH_FASTCALL | METH_KEYWORDS,         \
     os_device_encoding__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "path", "attribute", "follow_symlinks", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "getxattr",
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "path", "attribute", "value", "flags", "follow_symlinks", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "setxattr",
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 3, 4, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    if (!path_converter(args[0], &path)) {
...
skip_optional_kwonly:
    return_value =
        os_setxattr_impl(module, &path, &attribute, &value, flags, follow_symlinks);
...
#define OS_LISTXATTR_METHODDEF        \
    {"listxattr",                     \
     _PyCFunction_CAST(os_listxattr), \
     METH_FASTCALL | METH_KEYWORDS,   \
     os_listxattr__doc__},
...
#define OS_MEMFD_CREATE_METHODDEF        \
    {"memfd_create",                     \
     _PyCFunction_CAST(os_memfd_create), \
     METH_FASTCALL | METH_KEYWORDS,      \
     os_memfd_create__doc__},
...
#define OS_EVENTFD_READ_METHODDEF        \
    {"eventfd_read",                     \
     _PyCFunction_CAST(os_eventfd_read), \
     METH_FASTCALL | METH_KEYWORDS,      \
     os_eventfd_read__doc__},
...
#define OS_EVENTFD_WRITE_METHODDEF        \
    {"eventfd_write",                     \
     _PyCFunction_CAST(os_eventfd_write), \
     METH_FASTCALL | METH_KEYWORDS,       \
     os_eventfd_write__doc__},
...
#define OS_GET_TERMINAL_SIZE_METHODDEF        \
    {"get_terminal_size",                     \
     _PyCFunction_CAST(os_get_terminal_size), \
     METH_FASTCALL,                           \
     os_get_terminal_size__doc__},
...
#define OS_GET_INHERITABLE_METHODDEF  \
    {"get_inheritable",               \
     (PyCFunction)os_get_inheritable, \
     METH_O,                          \
     os_get_inheritable__doc__},
...
#define OS_SET_INHERITABLE_METHODDEF        \
    {"set_inheritable",                     \
     _PyCFunction_CAST(os_set_inheritable), \
     METH_FASTCALL,                         \
     os_set_inheritable__doc__},
...
PyDoc_STRVAR(
    os_get_handle_inheritable__doc__,
...
#define OS_GET_HANDLE_INHERITABLE_METHODDEF  \
    {"get_handle_inheritable",               \
     (PyCFunction)os_get_handle_inheritable, \
     METH_O,                                 \
     os_get_handle_inheritable__doc__},
...
#define OS_SET_HANDLE_INHERITABLE_METHODDEF        \
    {"set_handle_inheritable",                     \
     _PyCFunction_CAST(os_set_handle_inheritable), \
     METH_FASTCALL,                                \
     os_set_handle_inheritable__doc__},
...
#define OS_SET_BLOCKING_METHODDEF        \
    {"set_blocking",                     \
     _PyCFunction_CAST(os_set_blocking), \
     METH_FASTCALL,                      \
     os_set_blocking__doc__},
...
#define OS_DIRENTRY_IS_SYMLINK_METHODDEF          \
    {"is_symlink",                                \
     _PyCFunction_CAST(os_DirEntry_is_symlink),   \
...
PyDoc_STRVAR(
    os_DirEntry_is_junction__doc__,
    "is_junction($self, /)\n"
    "--\n"
    "\n"
...
#define OS_DIRENTRY_IS_JUNCTION_METHODDEF  \
    {"is_junction",                        \
     (PyCFunction)os_DirEntry_is_junction, \
     METH_NOARGS,                          \
     os_DirEntry_is_junction__doc__},
...
#define OS_DIRENTRY_STAT_METHODDEF                \
    {"stat",                                      \
     _PyCFunction_CAST(os_DirEntry_stat),         \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     os_DirEntry_stat__doc__},
...
#define OS_DIRENTRY_IS_DIR_METHODDEF              \
    {"is_dir",                                    \
     _PyCFunction_CAST(os_DirEntry_is_dir),       \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     os_DirEntry_is_dir__doc__},
...
#define OS_DIRENTRY_IS_FILE_METHODDEF             \
    {"is_file",                                   \
     _PyCFunction_CAST(os_DirEntry_is_file),      \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     os_DirEntry_is_file__doc__},
...
#define OS_DIRENTRY___FSPATH___METHODDEF  \
    {"__fspath__",                        \
     (PyCFunction)os_DirEntry___fspath__, \
     METH_NOARGS,                         \
     os_DirEntry___fspath____doc__},
...
#define OS_GETRANDOM_METHODDEF        \
    {"getrandom",                     \
     _PyCFunction_CAST(os_getrandom), \
     METH_FASTCALL | METH_KEYWORDS,   \
     os_getrandom__doc__},
...
#define OS__ADD_DLL_DIRECTORY_METHODDEF        \
    {"_add_dll_directory",                     \
     _PyCFunction_CAST(os__add_dll_directory), \
     METH_FASTCALL | METH_KEYWORDS,            \
     os__add_dll_directory__doc__},
...
#endif /* (defined(MS_WINDOWS_DESKTOP) || defined(MS_WINDOWS_APP) || \
          defined(MS_WINDOWS_SYSTEM)) */
...
#define OS__REMOVE_DLL_DIRECTORY_METHODDEF        \
    {"_remove_dll_directory",                     \
     _PyCFunction_CAST(os__remove_dll_directory), \
     METH_FASTCALL | METH_KEYWORDS,               \
     os__remove_dll_directory__doc__},
...
#define OS_WAITSTATUS_TO_EXITCODE_METHODDEF        \
    {"waitstatus_to_exitcode",                     \
     _PyCFunction_CAST(os_waitstatus_to_exitcode), \
     METH_FASTCALL | METH_KEYWORDS,                \
     os_waitstatus_to_exitcode__doc__},
...
PyDoc_STRVAR(
    os__supports_virtual_terminal__doc__,
...
#define OS__SUPPORTS_VIRTUAL_TERMINAL_METHODDEF  \
    {"_supports_virtual_terminal",               \
     (PyCFunction)os__supports_virtual_terminal, \
     METH_NOARGS,                                \
     os__supports_virtual_terminal__doc__},
...
PyDoc_STRVAR(
    os__is_inputhook_installed__doc__,
...
#define OS__IS_INPUTHOOK_INSTALLED_METHODDEF  \
    {"_is_inputhook_installed",               \
     (PyCFunction)os__is_inputhook_installed, \
     METH_NOARGS,                             \
     os__is_inputhook_installed__doc__},
...
#define OS__CREATE_ENVIRON_METHODDEF  \
    {"_create_environ",               \
     (PyCFunction)os__create_environ, \
     METH_NOARGS,                     \
     os__create_environ__doc__},
