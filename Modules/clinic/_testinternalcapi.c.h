...
PyDoc_STRVAR(
    _testinternalcapi_compiler_cleandoc__doc__,
...
#define _TESTINTERNALCAPI_COMPILER_CLEANDOC_METHODDEF        \
    {"compiler_cleandoc",                                    \
     _PyCFunction_CAST(_testinternalcapi_compiler_cleandoc), \
...
static PyObject *
_testinternalcapi_compiler_cleandoc(
...
#define _TESTINTERNALCAPI_NEW_INSTRUCTION_SEQUENCE_METHODDEF  \
    {"new_instruction_sequence",                              \
     (PyCFunction)_testinternalcapi_new_instruction_sequence, \
     METH_NOARGS,                                             \
     _testinternalcapi_new_instruction_sequence__doc__},
...
static PyObject *
_testinternalcapi_new_instruction_sequence(
...
PyDoc_STRVAR(
    _testinternalcapi_compiler_codegen__doc__,
...
#define _TESTINTERNALCAPI_COMPILER_CODEGEN_METHODDEF        \
    {"compiler_codegen",                                    \
     _PyCFunction_CAST(_testinternalcapi_compiler_codegen), \
     METH_FASTCALL | METH_KEYWORDS,                         \
     _testinternalcapi_compiler_codegen__doc__},
...
static PyObject *
_testinternalcapi_compiler_codegen(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "ast", "filename", "optimize", "compile_mode", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
skip_optional_pos:
    return_value = _testinternalcapi_compiler_codegen_impl(
        module, ast, filename, optimize, compile_mode
    );
...
#define _TESTINTERNALCAPI_OPTIMIZE_CFG_METHODDEF        \
    {"optimize_cfg",                                    \
     _PyCFunction_CAST(_testinternalcapi_optimize_cfg), \
     METH_FASTCALL | METH_KEYWORDS,                     \
     _testinternalcapi_optimize_cfg__doc__},
...
static PyObject *
_testinternalcapi_optimize_cfg(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#undef KWTUPLE
    ...
    return_value =
        _testinternalcapi_optimize_cfg_impl(module, instructions, consts, nlocals);
...
#define _TESTINTERNALCAPI_ASSEMBLE_CODE_OBJECT_METHODDEF        \
    {"assemble_code_object",                                    \
     _PyCFunction_CAST(_testinternalcapi_assemble_code_object), \
     METH_FASTCALL | METH_KEYWORDS,                             \
     _testinternalcapi_assemble_code_object__doc__},
...
static PyObject *
_testinternalcapi_assemble_code_object(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "filename", "instructions", "metadata", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
#undef KWTUPLE
    ...
    instructions = args[1];
    metadata = args[2];
    return_value = _testinternalcapi_assemble_code_object_impl(
        module, filename, instructions, metadata
    );
...
#define _TESTINTERNALCAPI_TEST_LONG_NUMBITS_METHODDEF  \
    {"test_long_numbits",                              \
     (PyCFunction)_testinternalcapi_test_long_numbits, \
     METH_NOARGS,                                      \
     _testinternalcapi_test_long_numbits__doc__},
...
#define GH_119213_GETARGS_METHODDEF        \
    {"gh_119213_getargs",                  \
     _PyCFunction_CAST(gh_119213_getargs), \
     METH_FASTCALL | METH_KEYWORDS,        \
     gh_119213_getargs__doc__},
