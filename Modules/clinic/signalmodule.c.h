...
#define SIGNAL_DEFAULT_INT_HANDLER_METHODDEF        \
    {"default_int_handler",                         \
     _PyCFunction_CAST(signal_default_int_handler), \
     METH_FASTCALL,                                 \
     signal_default_int_handler__doc__},

static PyObject *
signal_default_int_handler_impl(PyObject *module, int signalnum, PyObject *frame);
...
#define SIGNAL_RAISE_SIGNAL_METHODDEF  \
    {"raise_signal",                   \
     (PyCFunction)signal_raise_signal, \
     METH_O,                           \
     signal_raise_signal__doc__},
...
#define SIGNAL_SIGINTERRUPT_METHODDEF        \
    {"siginterrupt",                         \
     _PyCFunction_CAST(signal_siginterrupt), \
     METH_FASTCALL,                          \
     signal_siginterrupt__doc__},
...
#define SIGNAL_SET_WAKEUP_FD_METHODDEF        \
    {"set_wakeup_fd",                         \
     _PyCFunction_CAST(signal_set_wakeup_fd), \
     METH_FASTCALL | METH_KEYWORDS,           \
     signal_set_wakeup_fd__doc__},

static PyObject *
signal_set_wakeup_fd_impl(PyObject *module, PyObject *fdobj, int warn_on_full_buffer);
...
#define SIGNAL_SETITIMER_METHODDEF        \
    {"setitimer",                         \
     _PyCFunction_CAST(signal_setitimer), \
     METH_FASTCALL,                       \
     signal_setitimer__doc__},

static PyObject *
signal_setitimer_impl(
    PyObject *module, int which, PyObject *seconds, PyObject *interval
);
...
#define SIGNAL_PTHREAD_SIGMASK_METHODDEF        \
    {"pthread_sigmask",                         \
     _PyCFunction_CAST(signal_pthread_sigmask), \
     METH_FASTCALL,                             \
     signal_pthread_sigmask__doc__},
...
#endif /* ((defined(HAVE_SIGFILLSET) && defined(HAVE_SIGSET_T)) || \
          defined(MS_WINDOWS)) */
...
#define SIGNAL_SIGTIMEDWAIT_METHODDEF        \
    {"sigtimedwait",                         \
     _PyCFunction_CAST(signal_sigtimedwait), \
     METH_FASTCALL,                          \
     signal_sigtimedwait__doc__},

static PyObject *
signal_sigtimedwait_impl(PyObject *module, sigset_t sigset, PyObject *timeout_obj);
...
#define SIGNAL_PTHREAD_KILL_METHODDEF        \
    {"pthread_kill",                         \
     _PyCFunction_CAST(signal_pthread_kill), \
     METH_FASTCALL,                          \
     signal_pthread_kill__doc__},

static PyObject *
signal_pthread_kill_impl(PyObject *module, unsigned long thread_id, int signalnum);
...
PyDoc_STRVAR(
    signal_pidfd_send_signal__doc__,
...
#define SIGNAL_PIDFD_SEND_SIGNAL_METHODDEF        \
    {"pidfd_send_signal",                         \
     _PyCFunction_CAST(signal_pidfd_send_signal), \
     METH_FASTCALL,                               \
     signal_pidfd_send_signal__doc__},

static PyObject *
signal_pidfd_send_signal_impl(
    PyObject *module, int pidfd, int signalnum, PyObject *siginfo, int flags
);
...
skip_optional:
    return_value =
        signal_pidfd_send_signal_impl(module, pidfd, signalnum, siginfo, flags);
