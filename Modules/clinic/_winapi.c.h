...
#define _WINAPI_OVERLAPPED_GETOVERLAPPEDRESULT_METHODDEF  \
    {"GetOverlappedResult",                               \
     (PyCFunction)_winapi_Overlapped_GetOverlappedResult, \
     METH_O,                                              \
     _winapi_Overlapped_GetOverlappedResult__doc__},
...
#define _WINAPI_OVERLAPPED_GETBUFFER_METHODDEF  \
    {"getbuffer",                               \
     (PyCFunction)_winapi_Overlapped_getbuffer, \
     METH_NOARGS,                               \
     _winapi_Overlapped_getbuffer__doc__},
...
#define _WINAPI_OVERLAPPED_CANCEL_METHODDEF  \
    {"cancel",                               \
     (PyCFunction)_winapi_Overlapped_cancel, \
     METH_NOARGS,                            \
     _winapi_Overlapped_cancel__doc__},
...
#define _WINAPI_CLOSEHANDLE_METHODDEF  \
    {"CloseHandle",                    \
     (PyCFunction)_winapi_CloseHandle, \
     METH_O,                           \
     _winapi_CloseHandle__doc__},
...
#define _WINAPI_CONNECTNAMEDPIPE_METHODDEF        \
    {"ConnectNamedPipe",                          \
     _PyCFunction_CAST(_winapi_ConnectNamedPipe), \
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(
            args, nargs, kwnames, &_parser, &handle, &use_overlapped
        )) {
        goto exit;
    }
...
#define _WINAPI_CREATEEVENTW_METHODDEF        \
    {"CreateEventW",                          \
     _PyCFunction_CAST(_winapi_CreateEventW), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _winapi_CreateEventW__doc__},
...
#define NUM_KEYWORDS 4
    static struct {
        ...
        .ob_base = PyVarObject_HEAD_INIT(&PyTuple_Type, NUM_KEYWORDS).ob_item =
            {
                &_Py_ID(security_attributes),
                &_Py_ID(manual_reset),
                &_Py_ID(initial_state),
                &_Py_ID(name),
            },
    };
#undef NUM_KEYWORDS
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "security_attributes", "manual_reset", "initial_state", "name", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
#undef KWTUPLE
    ...
    _return_value = _winapi_CreateEventW_impl(
        module, security_attributes, manual_reset, initial_state, name
    );
...
#define _WINAPI_CREATEFILE_METHODDEF        \
    {"CreateFile",                          \
     _PyCFunction_CAST(_winapi_CreateFile), \
     METH_FASTCALL,                         \
     _winapi_CreateFile__doc__},
...
_winapi_CreateFile(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args,
            nargs,
            "O&kk" F_POINTER "kk" F_HANDLE ":CreateFile",
...
PyDoc_STRVAR(
    _winapi_CreateFileMapping__doc__,
...
#define _WINAPI_CREATEFILEMAPPING_METHODDEF        \
    {"CreateFileMapping",                          \
     _PyCFunction_CAST(_winapi_CreateFileMapping), \
     METH_FASTCALL,                                \
     _winapi_CreateFileMapping__doc__},
...
_winapi_CreateFileMapping(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args,
            nargs,
            "" F_HANDLE "" F_POINTER "kkkO&:CreateFileMapping",
            &file_handle,
            &security_attributes,
            &protect,
            &max_size_high,
    ...
    _return_value = _winapi_CreateFileMapping_impl(
        module,
        file_handle,
        security_attributes,
        protect,
...
#define _WINAPI_CREATEJUNCTION_METHODDEF        \
    {"CreateJunction",                          \
     _PyCFunction_CAST(_winapi_CreateJunction), \
     METH_FASTCALL,                             \
     _winapi_CreateJunction__doc__},
...
#define _WINAPI_CREATEMUTEXW_METHODDEF        \
    {"CreateMutexW",                          \
     _PyCFunction_CAST(_winapi_CreateMutexW), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _winapi_CreateMutexW__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "security_attributes", "initial_owner", "name", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
#undef KWTUPLE
    ...
    _return_value =
        _winapi_CreateMutexW_impl(module, security_attributes, initial_owner, name);
    if ((_return_value == INVALID_HANDLE_VALUE) && PyErr_Occurred()) {
        goto exit;
    }
    if (_return_value == NULL) {
...
#define _WINAPI_CREATENAMEDPIPE_METHODDEF        \
    {"CreateNamedPipe",                          \
     _PyCFunction_CAST(_winapi_CreateNamedPipe), \
     METH_FASTCALL,                              \
     _winapi_CreateNamedPipe__doc__},
...
_winapi_CreateNamedPipe(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args,
            nargs,
            "O&kkkkkk" F_POINTER ":CreateNamedPipe",
            _PyUnicode_WideCharString_Converter,
            &name,
            &open_mode,
            &pipe_mode,
...
#define _WINAPI_CREATEPIPE_METHODDEF        \
    {"CreatePipe",                          \
     _PyCFunction_CAST(_winapi_CreatePipe), \
     METH_FASTCALL,                         \
     _winapi_CreatePipe__doc__},
...
_winapi_CreatePipe(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(args, nargs, "Ok:CreatePipe", &pipe_attrs, &size)) {
        goto exit;
    }
...
#define _WINAPI_CREATEPROCESS_METHODDEF        \
    {"CreateProcess",                          \
     _PyCFunction_CAST(_winapi_CreateProcess), \
     METH_FASTCALL,                            \
     _winapi_CreateProcess__doc__},
...
_winapi_DuplicateHandle(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    _return_value = _winapi_DuplicateHandle_impl(
        module,
        source_process_handle,
        source_handle,
        target_process_handle,
...
#define _WINAPI_EXITPROCESS_METHODDEF  \
    {"ExitProcess",                    \
     (PyCFunction)_winapi_ExitProcess, \
     METH_O,                           \
     _winapi_ExitProcess__doc__},
...
#define _WINAPI_GETCURRENTPROCESS_METHODDEF  \
    {"GetCurrentProcess",                    \
     (PyCFunction)_winapi_GetCurrentProcess, \
     METH_NOARGS,                            \
     _winapi_GetCurrentProcess__doc__},
...
#define _WINAPI_GETEXITCODEPROCESS_METHODDEF  \
    {"GetExitCodeProcess",                    \
     (PyCFunction)_winapi_GetExitCodeProcess, \
     METH_O,                                  \
     _winapi_GetExitCodeProcess__doc__},
...
#define _WINAPI_GETLASTERROR_METHODDEF  \
    {"GetLastError",                    \
     (PyCFunction)_winapi_GetLastError, \
     METH_NOARGS,                       \
     _winapi_GetLastError__doc__},
...
#define _WINAPI_GETLONGPATHNAME_METHODDEF        \
    {"GetLongPathName",                          \
     _PyCFunction_CAST(_winapi_GetLongPathName), \
     METH_FASTCALL | METH_KEYWORDS,              \
     _winapi_GetLongPathName__doc__},
...
#define _WINAPI_GETMODULEFILENAME_METHODDEF  \
    {"GetModuleFileName",                    \
     (PyCFunction)_winapi_GetModuleFileName, \
     METH_O,                                 \
     _winapi_GetModuleFileName__doc__},
...
PyDoc_STRVAR(
    _winapi_GetShortPathName__doc__,
...
#define _WINAPI_GETSHORTPATHNAME_METHODDEF        \
    {"GetShortPathName",                          \
     _PyCFunction_CAST(_winapi_GetShortPathName), \
     METH_FASTCALL | METH_KEYWORDS,               \
     _winapi_GetShortPathName__doc__},
...
#define _WINAPI_GETSTDHANDLE_METHODDEF  \
    {"GetStdHandle",                    \
     (PyCFunction)_winapi_GetStdHandle, \
     METH_O,                            \
     _winapi_GetStdHandle__doc__},
...
#define _WINAPI_MAPVIEWOFFILE_METHODDEF        \
    {"MapViewOfFile",                          \
     _PyCFunction_CAST(_winapi_MapViewOfFile), \
     METH_FASTCALL,                            \
     _winapi_MapViewOfFile__doc__},
...
_winapi_MapViewOfFile(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    _return_value = _winapi_MapViewOfFile_impl(
        module,
        file_map,
        desired_access,
        file_offset_high,
...
#define _WINAPI_UNMAPVIEWOFFILE_METHODDEF  \
    {"UnmapViewOfFile",                    \
     (PyCFunction)_winapi_UnmapViewOfFile, \
     METH_O,                               \
     _winapi_UnmapViewOfFile__doc__},
...
#define _WINAPI_OPENEVENTW_METHODDEF        \
    {"OpenEventW",                          \
     _PyCFunction_CAST(_winapi_OpenEventW), \
     METH_FASTCALL | METH_KEYWORDS,         \
     _winapi_OpenEventW__doc__},
...
#define NUM_KEYWORDS 3
    static struct {
        ...
        .ob_base = PyVarObject_HEAD_INIT(&PyTuple_Type, NUM_KEYWORDS).ob_item =
            {
                &_Py_ID(desired_access),
                &_Py_ID(inherit_handle),
                &_Py_ID(name),
            },
    };
#undef NUM_KEYWORDS
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "desired_access", "inherit_handle", "name", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
#undef KWTUPLE
    ...
    _return_value =
        _winapi_OpenEventW_impl(module, desired_access, inherit_handle, name);
    if ((_return_value == INVALID_HANDLE_VALUE) && PyErr_Occurred()) {
        goto exit;
    }
    if (_return_value == NULL) {
...
#define _WINAPI_OPENMUTEXW_METHODDEF        \
    {"OpenMutexW",                          \
     _PyCFunction_CAST(_winapi_OpenMutexW), \
     METH_FASTCALL | METH_KEYWORDS,         \
     _winapi_OpenMutexW__doc__},
...
#undef KWTUPLE
    ...
    _return_value =
        _winapi_OpenMutexW_impl(module, desired_access, inherit_handle, name);
    if ((_return_value == INVALID_HANDLE_VALUE) && PyErr_Occurred()) {
        goto exit;
    }
    if (_return_value == NULL) {
...
PyDoc_STRVAR(
    _winapi_OpenFileMapping__doc__,
...
#define _WINAPI_OPENFILEMAPPING_METHODDEF        \
    {"OpenFileMapping",                          \
     _PyCFunction_CAST(_winapi_OpenFileMapping), \
     METH_FASTCALL,                              \
     _winapi_OpenFileMapping__doc__},
...
_winapi_OpenFileMapping(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    _return_value =
        _winapi_OpenFileMapping_impl(module, desired_access, inherit_handle, name);
    if ((_return_value == INVALID_HANDLE_VALUE) && PyErr_Occurred()) {
        goto exit;
    }
    if (_return_value == NULL) {
...
#define _WINAPI_OPENPROCESS_METHODDEF        \
    {"OpenProcess",                          \
     _PyCFunction_CAST(_winapi_OpenProcess), \
     METH_FASTCALL,                          \
     _winapi_OpenProcess__doc__},
...
_winapi_OpenProcess(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    _return_value =
        _winapi_OpenProcess_impl(module, desired_access, inherit_handle, process_id);
    if ((_return_value == INVALID_HANDLE_VALUE) && PyErr_Occurred()) {
        goto exit;
    }
    if (_return_value == NULL) {
...
#define _WINAPI_PEEKNAMEDPIPE_METHODDEF        \
    {"PeekNamedPipe",                          \
     _PyCFunction_CAST(_winapi_PeekNamedPipe), \
     METH_FASTCALL,                            \
     _winapi_PeekNamedPipe__doc__},
...
_winapi_PeekNamedPipe(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args, nargs, "" F_HANDLE "|i:PeekNamedPipe", &handle, &size
        )) {
        goto exit;
    }
...
#define _WINAPI_LCMAPSTRINGEX_METHODDEF        \
    {"LCMapStringEx",                          \
     _PyCFunction_CAST(_winapi_LCMapStringEx), \
     METH_FASTCALL | METH_KEYWORDS,            \
     _winapi_LCMapStringEx__doc__},

static PyObject *
_winapi_LCMapStringEx_impl(
    PyObject *module, LPCWSTR locale, DWORD flags, PyObject *src
);

static PyObject *
_winapi_LCMapStringEx(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _WINAPI_READFILE_METHODDEF        \
    {"ReadFile",                          \
     _PyCFunction_CAST(_winapi_ReadFile), \
     METH_FASTCALL | METH_KEYWORDS,       \
     _winapi_ReadFile__doc__},
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(
            args, nargs, kwnames, &_parser, &handle, &size, &use_overlapped
        )) {
        goto exit;
    }
...
#define _WINAPI_RELEASEMUTEX_METHODDEF        \
    {"ReleaseMutex",                          \
     _PyCFunction_CAST(_winapi_ReleaseMutex), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _winapi_ReleaseMutex__doc__},
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(args, nargs, kwnames, &_parser, &mutex)) {
        goto exit;
    }
...
#define _WINAPI_RESETEVENT_METHODDEF        \
    {"ResetEvent",                          \
     _PyCFunction_CAST(_winapi_ResetEvent), \
     METH_FASTCALL | METH_KEYWORDS,         \
     _winapi_ResetEvent__doc__},
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(args, nargs, kwnames, &_parser, &event)) {
        goto exit;
    }
...
#define _WINAPI_SETEVENT_METHODDEF        \
    {"SetEvent",                          \
     _PyCFunction_CAST(_winapi_SetEvent), \
     METH_FASTCALL | METH_KEYWORDS,       \
     _winapi_SetEvent__doc__},
...
#define _WINAPI_SETNAMEDPIPEHANDLESTATE_METHODDEF        \
    {"SetNamedPipeHandleState",                          \
     _PyCFunction_CAST(_winapi_SetNamedPipeHandleState), \
     METH_FASTCALL,                                      \
     _winapi_SetNamedPipeHandleState__doc__},
...
_winapi_SetNamedPipeHandleState(
    ...
    return_value = _winapi_SetNamedPipeHandleState_impl(
        module, named_pipe, mode, max_collection_count, collect_data_timeout
    );
...
#define _WINAPI_TERMINATEPROCESS_METHODDEF        \
    {"TerminateProcess",                          \
     _PyCFunction_CAST(_winapi_TerminateProcess), \
     METH_FASTCALL,                               \
     _winapi_TerminateProcess__doc__},
...
_winapi_TerminateProcess(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args, nargs, "" F_HANDLE "I:TerminateProcess", &handle, &exit_code
        )) {
        goto exit;
    }
...
PyDoc_STRVAR(
    _winapi_VirtualQuerySize__doc__,
...
#define _WINAPI_VIRTUALQUERYSIZE_METHODDEF  \
    {"VirtualQuerySize",                    \
     (PyCFunction)_winapi_VirtualQuerySize, \
     METH_O,                                \
     _winapi_VirtualQuerySize__doc__},
...
#define _WINAPI_WAITNAMEDPIPE_METHODDEF        \
    {"WaitNamedPipe",                          \
     _PyCFunction_CAST(_winapi_WaitNamedPipe), \
     METH_FASTCALL,                            \
     _winapi_WaitNamedPipe__doc__},
...
PyDoc_STRVAR(
    _winapi_BatchedWaitForMultipleObjects__doc__,
...
static PyObject *
_winapi_BatchedWaitForMultipleObjects(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "handle_seq", "wait_all", "milliseconds", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(
            args, nargs, kwnames, &_parser, &handle_seq, &wait_all, &milliseconds
        )) {
        goto exit;
    }
    return_value = _winapi_BatchedWaitForMultipleObjects_impl(
        module, handle_seq, wait_all, milliseconds
    );
...
#define _WINAPI_WAITFORMULTIPLEOBJECTS_METHODDEF        \
    {"WaitForMultipleObjects",                          \
     _PyCFunction_CAST(_winapi_WaitForMultipleObjects), \
     METH_FASTCALL,                                     \
     _winapi_WaitForMultipleObjects__doc__},
...
_winapi_WaitForMultipleObjects(
    ...
    return_value = _winapi_WaitForMultipleObjects_impl(
        module, handle_seq, wait_flag, milliseconds
    );
...
#define _WINAPI_WAITFORSINGLEOBJECT_METHODDEF        \
    {"WaitForSingleObject",                          \
     _PyCFunction_CAST(_winapi_WaitForSingleObject), \
     METH_FASTCALL,                                  \
     _winapi_WaitForSingleObject__doc__},
...
_winapi_WaitForSingleObject(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args, nargs, "" F_HANDLE "k:WaitForSingleObject", &handle, &milliseconds
        )) {
        goto exit;
    }
...
#define _WINAPI_WRITEFILE_METHODDEF        \
    {"WriteFile",                          \
     _PyCFunction_CAST(_winapi_WriteFile), \
     METH_FASTCALL | METH_KEYWORDS,        \
     _winapi_WriteFile__doc__},
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(
            args, nargs, kwnames, &_parser, &handle, &buffer, &use_overlapped
        )) {
        goto exit;
    }
...
#define _WINAPI_GETFILETYPE_METHODDEF        \
    {"GetFileType",                          \
     _PyCFunction_CAST(_winapi_GetFileType), \
     METH_FASTCALL | METH_KEYWORDS,          \
     _winapi_GetFileType__doc__},
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(args, nargs, kwnames, &_parser, &handle)) {
        goto exit;
    }
...
#define _WINAPI__MIMETYPES_READ_WINDOWS_REGISTRY_METHODDEF        \
    {"_mimetypes_read_windows_registry",                          \
     _PyCFunction_CAST(_winapi__mimetypes_read_windows_registry), \
     METH_FASTCALL | METH_KEYWORDS,                               \
     _winapi__mimetypes_read_windows_registry__doc__},
...
static PyObject *
_winapi__mimetypes_read_windows_registry(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
PyDoc_STRVAR(
    _winapi_NeedCurrentDirectoryForExePath__doc__,
...
#define _WINAPI_NEEDCURRENTDIRECTORYFOREXEPATH_METHODDEF  \
    {"NeedCurrentDirectoryForExePath",                    \
     (PyCFunction)_winapi_NeedCurrentDirectoryForExePath, \
     METH_O,                                              \
     _winapi_NeedCurrentDirectoryForExePath__doc__},
...
#define _WINAPI_COPYFILE2_METHODDEF        \
    {"CopyFile2",                          \
     _PyCFunction_CAST(_winapi_CopyFile2), \
     METH_FASTCALL | METH_KEYWORDS,        \
     _winapi_CopyFile2__doc__},
...
#define NUM_KEYWORDS 4
    static struct {
        ...
        .ob_base = PyVarObject_HEAD_INIT(&PyTuple_Type, NUM_KEYWORDS).ob_item =
            {
                &_Py_ID(existing_file_name),
                &_Py_ID(new_file_name),
                &_Py_ID(flags),
                &_Py_ID(progress_routine),
            },
    };
#undef NUM_KEYWORDS
#define KWTUPLE (&_kwtuple.ob_base.ob_base)
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "existing_file_name", "new_file_name", "flags", "progress_routine", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
#undef KWTUPLE
    ...
    return_value = _winapi_CopyFile2_impl(
        module, existing_file_name, new_file_name, flags, progress_routine
    );
