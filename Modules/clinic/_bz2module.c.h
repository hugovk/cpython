...
#define _BZ2_BZ2COMPRESSOR_COMPRESS_METHODDEF  \
    {"compress",                               \
     (PyCFunction)_bz2_BZ2Compressor_compress, \
     METH_O,                                   \
     _bz2_BZ2Compressor_compress__doc__},
...
#define _BZ2_BZ2COMPRESSOR_FLUSH_METHODDEF  \
    {"flush",                               \
     (PyCFunction)_bz2_BZ2Compressor_flush, \
     METH_NOARGS,                           \
     _bz2_BZ2Compressor_flush__doc__},
...
#define _BZ2_BZ2DECOMPRESSOR_DECOMPRESS_METHODDEF        \
    {"decompress",                                       \
     _PyCFunction_CAST(_bz2_BZ2Decompressor_decompress), \
...
_bz2_BZ2Decompressor_decompress(
    BZ2Decompressor *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
