...
#define _HEAPQ_HEAPPUSH_METHODDEF        \
    {"heappush",                         \
     _PyCFunction_CAST(_heapq_heappush), \
     METH_FASTCALL,                      \
     _heapq_heappush__doc__},
...
#define _HEAPQ_HEAPREPLACE_METHODDEF        \
    {"heapreplace",                         \
     _PyCFunction_CAST(_heapq_heapreplace), \
     METH_FASTCALL,                         \
     _heapq_heapreplace__doc__},
...
#define _HEAPQ_HEAPPUSHPOP_METHODDEF        \
    {"heappushpop",                         \
     _PyCFunction_CAST(_heapq_heappushpop), \
     METH_FASTCALL,                         \
     _heapq_heappushpop__doc__},
...
#define _HEAPQ__HEAPPOP_MAX_METHODDEF  \
    {"_heappop_max",                   \
     (PyCFunction)_heapq__heappop_max, \
     METH_O,                           \
     _heapq__heappop_max__doc__},
...
#define _HEAPQ__HEAPREPLACE_MAX_METHODDEF        \
    {"_heapreplace_max",                         \
     _PyCFunction_CAST(_heapq__heapreplace_max), \
     METH_FASTCALL,                              \
     _heapq__heapreplace_max__doc__},
...
#define _HEAPQ__HEAPIFY_MAX_METHODDEF  \
    {"_heapify_max",                   \
     (PyCFunction)_heapq__heapify_max, \
     METH_O,                           \
     _heapq__heapify_max__doc__},
