...
#define _GDBM_GDBM_SETDEFAULT_METHODDEF        \
    {"setdefault",                             \
     _PyCFunction_CAST(_gdbm_gdbm_setdefault), \
     METH_FASTCALL,                            \
     _gdbm_gdbm_setdefault__doc__},
...
#define _GDBM_GDBM_KEYS_METHODDEF                 \
    {"keys",                                      \
     _PyCFunction_CAST(_gdbm_gdbm_keys),          \
...
#define _GDBM_GDBM_FIRSTKEY_METHODDEF             \
    {"firstkey",                                  \
     _PyCFunction_CAST(_gdbm_gdbm_firstkey),      \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _gdbm_gdbm_firstkey__doc__},
...
#define _GDBM_GDBM_NEXTKEY_METHODDEF              \
    {"nextkey",                                   \
     _PyCFunction_CAST(_gdbm_gdbm_nextkey),       \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _gdbm_gdbm_nextkey__doc__},
...
#define _GDBM_GDBM_REORGANIZE_METHODDEF           \
    {"reorganize",                                \
     _PyCFunction_CAST(_gdbm_gdbm_reorganize),    \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _gdbm_gdbm_reorganize__doc__},
...
#define _GDBM_GDBM_SYNC_METHODDEF                 \
    {"sync",                                      \
     _PyCFunction_CAST(_gdbm_gdbm_sync),          \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _gdbm_gdbm_sync__doc__},
...
#define _GDBM_GDBM_CLEAR_METHODDEF                \
    {"clear",                                     \
     _PyCFunction_CAST(_gdbm_gdbm_clear),         \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _gdbm_gdbm_clear__doc__},
