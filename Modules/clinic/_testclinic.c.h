...
#define TEST_EMPTY_FUNCTION_METHODDEF  \
    {"test_empty_function",            \
     (PyCFunction)test_empty_function, \
     METH_NOARGS,                      \
     test_empty_function__doc__},
...
#define OBJECTS_CONVERTER_METHODDEF        \
    {"objects_converter",                  \
     _PyCFunction_CAST(objects_converter), \
     METH_FASTCALL,                        \
     objects_converter__doc__},
...
#define BYTES_OBJECT_CONVERTER_METHODDEF  \
    {"bytes_object_converter",            \
     (PyCFunction)bytes_object_converter, \
     METH_O,                              \
     bytes_object_converter__doc__},
...
PyDoc_STRVAR(
    byte_array_object_converter__doc__,
...
#define BYTE_ARRAY_OBJECT_CONVERTER_METHODDEF  \
    {"byte_array_object_converter",            \
     (PyCFunction)byte_array_object_converter, \
     METH_O,                                   \
     byte_array_object_converter__doc__},
...
#define BOOL_CONVERTER_METHODDEF        \
    {"bool_converter",                  \
     _PyCFunction_CAST(bool_converter), \
     METH_FASTCALL,                     \
     bool_converter__doc__},
...
#define CHAR_CONVERTER_METHODDEF        \
    {"char_converter",                  \
     _PyCFunction_CAST(char_converter), \
     METH_FASTCALL,                     \
     char_converter__doc__},
...
char_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (PyBytes_Check(args[0])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 1", "a byte string of length 1", args[0]
        );
        goto exit;
    }
    if (nargs < 2) {
    ...
    if (PyBytes_Check(args[1])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 2", "a byte string of length 1", args[1]
        );
        goto exit;
    }
    if (nargs < 3) {
    ...
    if (PyBytes_Check(args[2])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 3", "a byte string of length 1", args[2]
        );
        goto exit;
    }
    if (nargs < 4) {
    ...
    if (PyBytes_Check(args[3])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 4", "a byte string of length 1", args[3]
        );
        goto exit;
    }
    if (nargs < 5) {
    ...
    if (PyBytes_Check(args[4])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 5", "a byte string of length 1", args[4]
        );
        goto exit;
    }
    if (nargs < 6) {
    ...
    if (PyBytes_Check(args[5])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 6", "a byte string of length 1", args[5]
        );
        goto exit;
    }
    if (nargs < 7) {
    ...
    if (PyBytes_Check(args[6])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 7", "a byte string of length 1", args[6]
        );
        goto exit;
    }
    if (nargs < 8) {
    ...
    if (PyBytes_Check(args[7])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 8", "a byte string of length 1", args[7]
        );
        goto exit;
    }
    if (nargs < 9) {
    ...
    if (PyBytes_Check(args[8])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 9", "a byte string of length 1", args[8]
        );
        goto exit;
    }
    if (nargs < 10) {
    ...
    if (PyBytes_Check(args[9])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 10", "a byte string of length 1", args[9]
        );
        goto exit;
    }
    if (nargs < 11) {
    ...
    if (PyBytes_Check(args[10])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 11", "a byte string of length 1", args[10]
        );
        goto exit;
    }
    if (nargs < 12) {
    ...
    if (PyBytes_Check(args[11])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 12", "a byte string of length 1", args[11]
        );
        goto exit;
    }
    if (nargs < 13) {
    ...
    if (PyBytes_Check(args[12])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 13", "a byte string of length 1", args[12]
        );
        goto exit;
    }
    if (nargs < 14) {
    ...
    if (PyBytes_Check(args[13])) {
        ...
        _PyArg_BadArgument(
            "char_converter", "argument 14", "a byte string of length 1", args[13]
        );
        goto exit;
    }
skip_optional:
    return_value =
        char_converter_impl(module, a, b, c, d, e, f, g, h, i, j, k, l, m, n);
...
#define UNSIGNED_CHAR_CONVERTER_METHODDEF        \
    {"unsigned_char_converter",                  \
     _PyCFunction_CAST(unsigned_char_converter), \
     METH_FASTCALL,                              \
     unsigned_char_converter__doc__},
...
#define SHORT_CONVERTER_METHODDEF        \
    {"short_converter",                  \
     _PyCFunction_CAST(short_converter), \
     METH_FASTCALL,                      \
     short_converter__doc__},
...
PyDoc_STRVAR(
    unsigned_short_converter__doc__,
...
#define UNSIGNED_SHORT_CONVERTER_METHODDEF        \
    {"unsigned_short_converter",                  \
     _PyCFunction_CAST(unsigned_short_converter), \
     METH_FASTCALL,                               \
     unsigned_short_converter__doc__},
...
#define INT_CONVERTER_METHODDEF        \
    {"int_converter",                  \
     _PyCFunction_CAST(int_converter), \
     METH_FASTCALL,                    \
     int_converter__doc__},
...
int_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!PyUnicode_Check(args[2])) {
        _PyArg_BadArgument(
            "int_converter", "argument 3", "a unicode character", args[2]
        );
        goto exit;
    }
...
#define UNSIGNED_INT_CONVERTER_METHODDEF        \
    {"unsigned_int_converter",                  \
     _PyCFunction_CAST(unsigned_int_converter), \
     METH_FASTCALL,                             \
     unsigned_int_converter__doc__},
...
#define LONG_CONVERTER_METHODDEF        \
    {"long_converter",                  \
     _PyCFunction_CAST(long_converter), \
     METH_FASTCALL,                     \
     long_converter__doc__},
...
PyDoc_STRVAR(
    unsigned_long_converter__doc__,
...
#define LONG_LONG_CONVERTER_METHODDEF        \
    {"long_long_converter",                  \
     _PyCFunction_CAST(long_long_converter), \
     METH_FASTCALL,                          \
     long_long_converter__doc__},
...
PyDoc_STRVAR(
    unsigned_long_long_converter__doc__,
...
#define UNSIGNED_LONG_LONG_CONVERTER_METHODDEF        \
    {"unsigned_long_long_converter",                  \
     _PyCFunction_CAST(unsigned_long_long_converter), \
     METH_FASTCALL,                                   \
     unsigned_long_long_converter__doc__},
...
unsigned_long_long_converter(
    ...
    if (!PyLong_Check(args[2])) {
        _PyArg_BadArgument(
            "unsigned_long_long_converter", "argument 3", "int", args[2]
        );
        goto exit;
    }
...
#define PY_SSIZE_T_CONVERTER_METHODDEF        \
    {"py_ssize_t_converter",                  \
     _PyCFunction_CAST(py_ssize_t_converter), \
     METH_FASTCALL,                           \
     py_ssize_t_converter__doc__},
...
#define SLICE_INDEX_CONVERTER_METHODDEF        \
    {"slice_index_converter",                  \
     _PyCFunction_CAST(slice_index_converter), \
     METH_FASTCALL,                            \
     slice_index_converter__doc__},
...
#define SIZE_T_CONVERTER_METHODDEF        \
    {"size_t_converter",                  \
     _PyCFunction_CAST(size_t_converter), \
     METH_FASTCALL,                       \
     size_t_converter__doc__},
...
#define FLOAT_CONVERTER_METHODDEF        \
    {"float_converter",                  \
     _PyCFunction_CAST(float_converter), \
     METH_FASTCALL,                      \
     float_converter__doc__},
...
#define DOUBLE_CONVERTER_METHODDEF        \
    {"double_converter",                  \
     _PyCFunction_CAST(double_converter), \
     METH_FASTCALL,                       \
     double_converter__doc__},
...
#define STR_CONVERTER_METHODDEF        \
    {"str_converter",                  \
     _PyCFunction_CAST(str_converter), \
     METH_FASTCALL,                    \
     str_converter__doc__},
...
str_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(args, nargs, "|sys#:str_converter", &a, &b, &c, &c_length)) {
        goto exit;
    }
...
#define STR_CONVERTER_ENCODING_METHODDEF        \
    {"str_converter_encoding",                  \
     _PyCFunction_CAST(str_converter_encoding), \
     METH_FASTCALL,                             \
     str_converter_encoding__doc__},
...
#define PY_BUFFER_CONVERTER_METHODDEF        \
    {"py_buffer_converter",                  \
     _PyCFunction_CAST(py_buffer_converter), \
     METH_FASTCALL,                          \
     py_buffer_converter__doc__},
...
py_buffer_converter(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(args, nargs, "z*w*:py_buffer_converter", &a, &b)) {
        goto exit;
    }
...
#define KEYWORDS_KWONLY_METHODDEF        \
    {"keywords_kwonly",                  \
     _PyCFunction_CAST(keywords_kwonly), \
     METH_FASTCALL | METH_KEYWORDS,      \
     keywords_kwonly__doc__},
...
#define KEYWORDS_OPT_METHODDEF        \
    {"keywords_opt",                  \
     _PyCFunction_CAST(keywords_opt), \
     METH_FASTCALL | METH_KEYWORDS,   \
     keywords_opt__doc__},
...
#define KEYWORDS_OPT_KWONLY_METHODDEF        \
    {"keywords_opt_kwonly",                  \
     _PyCFunction_CAST(keywords_opt_kwonly), \
     METH_FASTCALL | METH_KEYWORDS,          \
     keywords_opt_kwonly__doc__},
...
#define KEYWORDS_KWONLY_OPT_METHODDEF        \
    {"keywords_kwonly_opt",                  \
     _PyCFunction_CAST(keywords_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,          \
     keywords_kwonly_opt__doc__},
...
#define POSONLY_KEYWORDS_METHODDEF        \
    {"posonly_keywords",                  \
     _PyCFunction_CAST(posonly_keywords), \
     METH_FASTCALL | METH_KEYWORDS,       \
     posonly_keywords__doc__},
...
#define POSONLY_KWONLY_METHODDEF        \
    {"posonly_kwonly",                  \
     _PyCFunction_CAST(posonly_kwonly), \
     METH_FASTCALL | METH_KEYWORDS,     \
     posonly_kwonly__doc__},
...
PyDoc_STRVAR(
    posonly_keywords_kwonly__doc__,
...
#define POSONLY_KEYWORDS_KWONLY_METHODDEF        \
    {"posonly_keywords_kwonly",                  \
     _PyCFunction_CAST(posonly_keywords_kwonly), \
     METH_FASTCALL | METH_KEYWORDS,              \
     posonly_keywords_kwonly__doc__},
...
#define POSONLY_KEYWORDS_OPT_METHODDEF        \
    {"posonly_keywords_opt",                  \
     _PyCFunction_CAST(posonly_keywords_opt), \
     METH_FASTCALL | METH_KEYWORDS,           \
     posonly_keywords_opt__doc__},
...
PyDoc_STRVAR(
    posonly_opt_keywords_opt__doc__,
...
#define POSONLY_OPT_KEYWORDS_OPT_METHODDEF        \
    {"posonly_opt_keywords_opt",                  \
     _PyCFunction_CAST(posonly_opt_keywords_opt), \
     METH_FASTCALL | METH_KEYWORDS,               \
     posonly_opt_keywords_opt__doc__},
...
#define POSONLY_KWONLY_OPT_METHODDEF        \
    {"posonly_kwonly_opt",                  \
     _PyCFunction_CAST(posonly_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,         \
     posonly_kwonly_opt__doc__},
...
#define POSONLY_KEYWORDS_KWONLY_OPT_METHODDEF        \
    {"posonly_keywords_kwonly_opt",                  \
     _PyCFunction_CAST(posonly_keywords_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,                  \
     posonly_keywords_kwonly_opt__doc__},
...
PyDoc_STRVAR(
    posonly_keywords_opt_kwonly_opt__doc__,
...
#define POSONLY_KEYWORDS_OPT_KWONLY_OPT_METHODDEF        \
    {"posonly_keywords_opt_kwonly_opt",                  \
     _PyCFunction_CAST(posonly_keywords_opt_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,                      \
     posonly_keywords_opt_kwonly_opt__doc__},
...
#define POSONLY_OPT_KEYWORDS_OPT_KWONLY_OPT_METHODDEF        \
    {"posonly_opt_keywords_opt_kwonly_opt",                  \
     _PyCFunction_CAST(posonly_opt_keywords_opt_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,                          \
     posonly_opt_keywords_opt_kwonly_opt__doc__},
...
#define KEYWORD_ONLY_PARAMETER_METHODDEF        \
    {"keyword_only_parameter",                  \
     _PyCFunction_CAST(keyword_only_parameter), \
     METH_FASTCALL | METH_KEYWORDS,             \
     keyword_only_parameter__doc__},
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 0, 0, 1, argsbuf);
    if (!args) {
        goto exit;
    }
    a = args[0];
...
#define POSONLY_VARPOS_METHODDEF        \
    {"posonly_varpos",                  \
     _PyCFunction_CAST(posonly_varpos), \
     METH_FASTCALL,                     \
     posonly_varpos__doc__},
...
#define POSONLY_POSKW_VARPOS_METHODDEF        \
    {"posonly_poskw_varpos",                  \
     _PyCFunction_CAST(posonly_poskw_varpos), \
     METH_FASTCALL | METH_KEYWORDS,           \
     posonly_poskw_varpos__doc__},
...
#undef KWTUPLE
    ...
    args = _PyArg_UnpackKeywordsWithVararg(
        args, nargs, NULL, kwnames, &_parser, 2, 2, 0, 2, argsbuf
    );
    if (!args) {
        goto exit;
    }
...
#define POSKW_VARPOS_METHODDEF        \
    {"poskw_varpos",                  \
     _PyCFunction_CAST(poskw_varpos), \
     METH_FASTCALL | METH_KEYWORDS,   \
     poskw_varpos__doc__},
...
PyDoc_STRVAR(
    poskw_varpos_kwonly_opt__doc__,
...
#define POSKW_VARPOS_KWONLY_OPT_METHODDEF        \
    {"poskw_varpos_kwonly_opt",                  \
     _PyCFunction_CAST(poskw_varpos_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,              \
     poskw_varpos_kwonly_opt__doc__},
...
PyDoc_STRVAR(
    poskw_varpos_kwonly_opt2__doc__,
...
#define POSKW_VARPOS_KWONLY_OPT2_METHODDEF        \
    {"poskw_varpos_kwonly_opt2",                  \
     _PyCFunction_CAST(poskw_varpos_kwonly_opt2), \
     METH_FASTCALL | METH_KEYWORDS,               \
     poskw_varpos_kwonly_opt2__doc__},
...
#define VARPOS_KWONLY_OPT_METHODDEF        \
    {"varpos_kwonly_opt",                  \
     _PyCFunction_CAST(varpos_kwonly_opt), \
     METH_FASTCALL | METH_KEYWORDS,        \
     varpos_kwonly_opt__doc__},
...
#define VARPOS_KWONLY_REQ_OPT_METHODDEF        \
    {"varpos_kwonly_req_opt",                  \
     _PyCFunction_CAST(varpos_kwonly_req_opt), \
     METH_FASTCALL | METH_KEYWORDS,            \
     varpos_kwonly_req_opt__doc__},
...
#undef KWTUPLE
    ...
    args = _PyArg_UnpackKeywordsWithVararg(
        args, nargs, NULL, kwnames, &_parser, 0, 0, 1, 0, argsbuf
    );
    if (!args) {
        goto exit;
    }
...
#define GH_32092_OOB_METHODDEF        \
    {"gh_32092_oob",                  \
     _PyCFunction_CAST(gh_32092_oob), \
     METH_FASTCALL | METH_KEYWORDS,   \
     gh_32092_oob__doc__},
...
#undef KWTUPLE
    PyObject *argsbuf[5];
    Py_ssize_t noptargs =
        Py_MIN(nargs, 2) + (kwnames ? PyTuple_GET_SIZE(kwnames) : 0) - 2;
    PyObject *pos1;
    PyObject *pos2;
...
#define GH_32092_KW_PASS_METHODDEF        \
    {"gh_32092_kw_pass",                  \
     _PyCFunction_CAST(gh_32092_kw_pass), \
     METH_FASTCALL | METH_KEYWORDS,       \
     gh_32092_kw_pass__doc__},
...
#define GH_99233_REFCOUNT_METHODDEF        \
    {"gh_99233_refcount",                  \
     _PyCFunction_CAST(gh_99233_refcount), \
     METH_FASTCALL,                        \
     gh_99233_refcount__doc__},
...
#define GH_99240_DOUBLE_FREE_METHODDEF        \
    {"gh_99240_double_free",                  \
     _PyCFunction_CAST(gh_99240_double_free), \
     METH_FASTCALL,                           \
     gh_99240_double_free__doc__},
...
gh_99240_double_free(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args, nargs, "eses:gh_99240_double_free", "idna", &a, "idna", &b
        )) {
        goto exit;
    }
...
PyDoc_STRVAR(
    null_or_tuple_for_varargs__doc__,
...
#define NULL_OR_TUPLE_FOR_VARARGS_METHODDEF        \
    {"null_or_tuple_for_varargs",                  \
     _PyCFunction_CAST(null_or_tuple_for_varargs), \
     METH_FASTCALL | METH_KEYWORDS,                \
     null_or_tuple_for_varargs__doc__},
...
#define CLONE_WITH_CONV_F1_METHODDEF        \
    {"clone_with_conv_f1",                  \
     _PyCFunction_CAST(clone_with_conv_f1), \
     METH_FASTCALL | METH_KEYWORDS,         \
     clone_with_conv_f1__doc__},
...
#define CLONE_WITH_CONV_F2_METHODDEF        \
    {"clone_with_conv_f2",                  \
     _PyCFunction_CAST(clone_with_conv_f2), \
     METH_FASTCALL | METH_KEYWORDS,         \
     clone_with_conv_f2__doc__},
...
PyDoc_STRVAR(
    _testclinic_TestClass_get_defining_class__doc__,
...
#define _TESTCLINIC_TESTCLASS_GET_DEFINING_CLASS_METHODDEF        \
    {"get_defining_class",                                        \
     _PyCFunction_CAST(_testclinic_TestClass_get_defining_class), \
...
static PyObject *
_testclinic_TestClass_get_defining_class(
    PyObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
PyDoc_STRVAR(
    _testclinic_TestClass_get_defining_class_arg__doc__,
...
#define _TESTCLINIC_TESTCLASS_GET_DEFINING_CLASS_ARG_METHODDEF        \
    {"get_defining_class_arg",                                        \
     _PyCFunction_CAST(_testclinic_TestClass_get_defining_class_arg), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,                     \
     _testclinic_TestClass_get_defining_class_arg__doc__},
...
#define _TESTCLINIC_TESTCLASS_DEFCLASS_VARPOS_METHODDEF        \
    {"defclass_varpos",                                        \
     _PyCFunction_CAST(_testclinic_TestClass_defclass_varpos), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,              \
     _testclinic_TestClass_defclass_varpos__doc__},
...
static PyObject *
_testclinic_TestClass_defclass_varpos(
    PyObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
#define _TESTCLINIC_TESTCLASS_DEFCLASS_POSONLY_VARPOS_METHODDEF        \
    {"defclass_posonly_varpos",                                        \
     _PyCFunction_CAST(_testclinic_TestClass_defclass_posonly_varpos), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,                      \
     _testclinic_TestClass_defclass_posonly_varpos__doc__},
...
#undef KWTUPLE
    ...
    b = args[1];
    __clinic_args = args[2];
    return_value = _testclinic_TestClass_defclass_posonly_varpos_impl(
        self, cls, a, b, __clinic_args
    );
