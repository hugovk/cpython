...
#define UNICODEDATA_UCD_DECIMAL_METHODDEF        \
    {"decimal",                                  \
     _PyCFunction_CAST(unicodedata_UCD_decimal), \
     METH_FASTCALL,                              \
     unicodedata_UCD_decimal__doc__},

static PyObject *
unicodedata_UCD_decimal_impl(PyObject *self, int chr, PyObject *default_value);
...
#define UNICODEDATA_UCD_DIGIT_METHODDEF        \
    {"digit",                                  \
     _PyCFunction_CAST(unicodedata_UCD_digit), \
     METH_FASTCALL,                            \
     unicodedata_UCD_digit__doc__},
...
PyDoc_STRVAR(
    unicodedata_UCD_numeric__doc__,
...
#define UNICODEDATA_UCD_NUMERIC_METHODDEF        \
    {"numeric",                                  \
     _PyCFunction_CAST(unicodedata_UCD_numeric), \
     METH_FASTCALL,                              \
     unicodedata_UCD_numeric__doc__},

static PyObject *
unicodedata_UCD_numeric_impl(PyObject *self, int chr, PyObject *default_value);
...
PyDoc_STRVAR(
    unicodedata_UCD_category__doc__,
    "category($self, chr, /)\n"
    "--\n"
    "\n"
...
#define UNICODEDATA_UCD_CATEGORY_METHODDEF  \
    {"category",                            \
     (PyCFunction)unicodedata_UCD_category, \
     METH_O,                                \
     unicodedata_UCD_category__doc__},
...
#define UNICODEDATA_UCD_BIDIRECTIONAL_METHODDEF  \
    {"bidirectional",                            \
     (PyCFunction)unicodedata_UCD_bidirectional, \
     METH_O,                                     \
     unicodedata_UCD_bidirectional__doc__},
...
PyDoc_STRVAR(
    unicodedata_UCD_combining__doc__,
    "combining($self, chr, /)\n"
    "--\n"
    "\n"
...
#define UNICODEDATA_UCD_COMBINING_METHODDEF  \
    {"combining",                            \
     (PyCFunction)unicodedata_UCD_combining, \
     METH_O,                                 \
     unicodedata_UCD_combining__doc__},
...
#define UNICODEDATA_UCD_MIRRORED_METHODDEF  \
    {"mirrored",                            \
     (PyCFunction)unicodedata_UCD_mirrored, \
     METH_O,                                \
     unicodedata_UCD_mirrored__doc__},
...
#define UNICODEDATA_UCD_EAST_ASIAN_WIDTH_METHODDEF  \
    {"east_asian_width",                            \
     (PyCFunction)unicodedata_UCD_east_asian_width, \
     METH_O,                                        \
     unicodedata_UCD_east_asian_width__doc__},
...
#define UNICODEDATA_UCD_DECOMPOSITION_METHODDEF  \
    {"decomposition",                            \
     (PyCFunction)unicodedata_UCD_decomposition, \
     METH_O,                                     \
     unicodedata_UCD_decomposition__doc__},
...
#define UNICODEDATA_UCD_IS_NORMALIZED_METHODDEF        \
    {"is_normalized",                                  \
     _PyCFunction_CAST(unicodedata_UCD_is_normalized), \
     METH_FASTCALL,                                    \
     unicodedata_UCD_is_normalized__doc__},

static PyObject *
unicodedata_UCD_is_normalized_impl(PyObject *self, PyObject *form, PyObject *input);
...
#define UNICODEDATA_UCD_NORMALIZE_METHODDEF        \
    {"normalize",                                  \
     _PyCFunction_CAST(unicodedata_UCD_normalize), \
     METH_FASTCALL,                                \
     unicodedata_UCD_normalize__doc__},

static PyObject *
unicodedata_UCD_normalize_impl(PyObject *self, PyObject *form, PyObject *input);
...
#define UNICODEDATA_UCD_NAME_METHODDEF        \
    {"name",                                  \
     _PyCFunction_CAST(unicodedata_UCD_name), \
     METH_FASTCALL,                           \
     unicodedata_UCD_name__doc__},
...
#define UNICODEDATA_UCD_LOOKUP_METHODDEF  \
    {"lookup",                            \
     (PyCFunction)unicodedata_UCD_lookup, \
     METH_O,                              \
     unicodedata_UCD_lookup__doc__},

static PyObject *
unicodedata_UCD_lookup_impl(PyObject *self, const char *name, Py_ssize_t name_length);
