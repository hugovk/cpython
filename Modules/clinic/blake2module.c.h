...
skip_optional_kwonly:
    return_value = py_blake2b_new_impl(
        type,
        data,
        digest_size,
        &key,
...
skip_optional_kwonly:
    return_value = py_blake2s_new_impl(
        type,
        data,
        digest_size,
        &key,
...
#define _BLAKE2_BLAKE2B_COPY_METHODDEF  \
    {"copy",                            \
     (PyCFunction)_blake2_blake2b_copy, \
     METH_NOARGS,                       \
     _blake2_blake2b_copy__doc__},
...
#define _BLAKE2_BLAKE2B_UPDATE_METHODDEF  \
    {"update",                            \
     (PyCFunction)_blake2_blake2b_update, \
     METH_O,                              \
     _blake2_blake2b_update__doc__},

PyDoc_STRVAR(
    _blake2_blake2b_digest__doc__,
    "digest($self, /)\n"
    "--\n"
    "\n"
...
#define _BLAKE2_BLAKE2B_DIGEST_METHODDEF  \
    {"digest",                            \
     (PyCFunction)_blake2_blake2b_digest, \
     METH_NOARGS,                         \
     _blake2_blake2b_digest__doc__},
...
PyDoc_STRVAR(
    _blake2_blake2b_hexdigest__doc__,
    "hexdigest($self, /)\n"
    "--\n"
    "\n"
...
#define _BLAKE2_BLAKE2B_HEXDIGEST_METHODDEF  \
    {"hexdigest",                            \
     (PyCFunction)_blake2_blake2b_hexdigest, \
     METH_NOARGS,                            \
     _blake2_blake2b_hexdigest__doc__},
