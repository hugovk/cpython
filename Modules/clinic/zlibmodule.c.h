...
#define ZLIB_COMPRESS_METHODDEF        \
    {"compress",                       \
     _PyCFunction_CAST(zlib_compress), \
...
#define ZLIB_DECOMPRESS_METHODDEF        \
    {"decompress",                       \
     _PyCFunction_CAST(zlib_decompress), \
     METH_FASTCALL | METH_KEYWORDS,      \
     zlib_decompress__doc__},
...
#define ZLIB_COMPRESSOBJ_METHODDEF        \
    {"compressobj",                       \
     _PyCFunction_CAST(zlib_compressobj), \
     METH_FASTCALL | METH_KEYWORDS,       \
     zlib_compressobj__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "level", "method", "wbits", "memLevel", "strategy", "zdict", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "compressobj",
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 0, 6, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    if (!noptargs) {
...
skip_optional_pos:
    return_value =
        zlib_compressobj_impl(module, level, method, wbits, memLevel, strategy, &zdict);
...
#define ZLIB_DECOMPRESSOBJ_METHODDEF        \
    {"decompressobj",                       \
     _PyCFunction_CAST(zlib_decompressobj), \
     METH_FASTCALL | METH_KEYWORDS,         \
     zlib_decompressobj__doc__},
...
#define ZLIB_COMPRESS_COMPRESS_METHODDEF          \
    {"compress",                                  \
     _PyCFunction_CAST(zlib_Compress_compress),   \
...
#define ZLIB_DECOMPRESS_DECOMPRESS_METHODDEF        \
    {"decompress",                                  \
     _PyCFunction_CAST(zlib_Decompress_decompress), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,   \
     zlib_Decompress_decompress__doc__},
...
#define ZLIB_COMPRESS_FLUSH_METHODDEF             \
    {"flush",                                     \
     _PyCFunction_CAST(zlib_Compress_flush),      \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     zlib_Compress_flush__doc__},
...
#define ZLIB_COMPRESS_COPY_METHODDEF              \
    {"copy",                                      \
     _PyCFunction_CAST(zlib_Compress_copy),       \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     zlib_Compress_copy__doc__},
...
#define ZLIB_COMPRESS___COPY___METHODDEF          \
    {"__copy__",                                  \
     _PyCFunction_CAST(zlib_Compress___copy__),   \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     zlib_Compress___copy____doc__},
...
PyDoc_STRVAR(
    zlib_Compress___deepcopy____doc__,
...
#define ZLIB_COMPRESS___DEEPCOPY___METHODDEF        \
    {"__deepcopy__",                                \
     _PyCFunction_CAST(zlib_Compress___deepcopy__), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,   \
     zlib_Compress___deepcopy____doc__},
...
#define ZLIB_DECOMPRESS_COPY_METHODDEF            \
    {"copy",                                      \
     _PyCFunction_CAST(zlib_Decompress_copy),     \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     zlib_Decompress_copy__doc__},
...
#define ZLIB_DECOMPRESS___COPY___METHODDEF        \
    {"__copy__",                                  \
     _PyCFunction_CAST(zlib_Decompress___copy__), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     zlib_Decompress___copy____doc__},
...
#define ZLIB_DECOMPRESS___DEEPCOPY___METHODDEF        \
    {"__deepcopy__",                                  \
     _PyCFunction_CAST(zlib_Decompress___deepcopy__), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,     \
     zlib_Decompress___deepcopy____doc__},
...
#define ZLIB_DECOMPRESS_FLUSH_METHODDEF           \
    {"flush",                                     \
     _PyCFunction_CAST(zlib_Decompress_flush),    \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     zlib_Decompress_flush__doc__},
...
#define ZLIB_ZLIBDECOMPRESSOR_DECOMPRESS_METHODDEF        \
    {"decompress",                                        \
     _PyCFunction_CAST(zlib_ZlibDecompressor_decompress), \
     METH_FASTCALL | METH_KEYWORDS,                       \
     zlib_ZlibDecompressor_decompress__doc__},
...
static PyObject *
zlib_ZlibDecompressor_decompress(
    ZlibDecompressor *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
