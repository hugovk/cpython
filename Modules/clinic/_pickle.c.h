...
#define _PICKLE_PICKLER_CLEAR_MEMO_METHODDEF  \
    {"clear_memo",                            \
     (PyCFunction)_pickle_Pickler_clear_memo, \
     METH_NOARGS,                             \
     _pickle_Pickler_clear_memo__doc__},
...
#define _PICKLE_PICKLER_DUMP_METHODDEF            \
    {"dump",                                      \
     _PyCFunction_CAST(_pickle_Pickler_dump),     \
...
PyDoc_STRVAR(
    _pickle_Pickler___sizeof____doc__,
    "__sizeof__($self, /)\n"
    "--\n"
    "\n"
...
#define _PICKLE_PICKLER___SIZEOF___METHODDEF  \
    {"__sizeof__",                            \
     (PyCFunction)_pickle_Pickler___sizeof__, \
     METH_NOARGS,                             \
     _pickle_Pickler___sizeof____doc__},
...
PyDoc_STRVAR(
    _pickle_Pickler___init____doc__,
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "file", "protocol", "fix_imports", "buffer_callback", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "Pickler",
...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 1, 4, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
...
skip_optional_pos:
    return_value = _pickle_Pickler___init___impl(
        (PicklerObject *)self, file, protocol, fix_imports, buffer_callback
    );
...
#define _PICKLE_PICKLERMEMOPROXY_CLEAR_METHODDEF  \
    {"clear",                                     \
     (PyCFunction)_pickle_PicklerMemoProxy_clear, \
     METH_NOARGS,                                 \
     _pickle_PicklerMemoProxy_clear__doc__},
...
_pickle_PicklerMemoProxy_clear(
    PicklerMemoProxyObject *self, PyObject *Py_UNUSED(ignored)
) {
...
#define _PICKLE_PICKLERMEMOPROXY_COPY_METHODDEF  \
    {"copy",                                     \
     (PyCFunction)_pickle_PicklerMemoProxy_copy, \
     METH_NOARGS,                                \
     _pickle_PicklerMemoProxy_copy__doc__},
...
PyDoc_STRVAR(
    _pickle_PicklerMemoProxy___reduce____doc__,
    "__reduce__($self, /)\n"
    "--\n"
    "\n"
...
#define _PICKLE_PICKLERMEMOPROXY___REDUCE___METHODDEF  \
    {"__reduce__",                                     \
     (PyCFunction)_pickle_PicklerMemoProxy___reduce__, \
     METH_NOARGS,                                      \
     _pickle_PicklerMemoProxy___reduce____doc__},
...
#define _PICKLE_UNPICKLER_PERSISTENT_LOAD_METHODDEF        \
    {"persistent_load",                                    \
     _PyCFunction_CAST(_pickle_Unpickler_persistent_load), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,          \
     _pickle_Unpickler_persistent_load__doc__},
...
static PyObject *
_pickle_Unpickler_persistent_load(
...
#define _PICKLE_UNPICKLER_LOAD_METHODDEF          \
    {"load",                                      \
     _PyCFunction_CAST(_pickle_Unpickler_load),   \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _pickle_Unpickler_load__doc__},
...
#define _PICKLE_UNPICKLER_FIND_CLASS_METHODDEF        \
    {"find_class",                                    \
     _PyCFunction_CAST(_pickle_Unpickler_find_class), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,     \
     _pickle_Unpickler_find_class__doc__},
...
#undef KWTUPLE
    ...
    global_name = args[1];
    return_value =
        _pickle_Unpickler_find_class_impl(self, cls, module_name, global_name);
...
PyDoc_STRVAR(
    _pickle_Unpickler___sizeof____doc__,
    "__sizeof__($self, /)\n"
    "--\n"
    "\n"
    "Returns size in memory, in bytes."
...
#define _PICKLE_UNPICKLER___SIZEOF___METHODDEF  \
    {"__sizeof__",                              \
     (PyCFunction)_pickle_Unpickler___sizeof__, \
     METH_NOARGS,                               \
     _pickle_Unpickler___sizeof____doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "file", "fix_imports", "encoding", "errors", "buffers", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "Unpickler",
...
skip_optional_kwonly:
    return_value = _pickle_Unpickler___init___impl(
        (UnpicklerObject *)self, file, fix_imports, encoding, errors, buffers
    );
...
PyDoc_STRVAR(
    _pickle_UnpicklerMemoProxy_clear__doc__,
    "clear($self, /)\n"
    "--\n"
    "\n"
    "Remove all items from memo."
...
#define _PICKLE_UNPICKLERMEMOPROXY_CLEAR_METHODDEF  \
    {"clear",                                       \
     (PyCFunction)_pickle_UnpicklerMemoProxy_clear, \
     METH_NOARGS,                                   \
     _pickle_UnpicklerMemoProxy_clear__doc__},
...
_pickle_UnpicklerMemoProxy_clear(
    UnpicklerMemoProxyObject *self, PyObject *Py_UNUSED(ignored)
) {
    return _pickle_UnpicklerMemoProxy_clear_impl(self);
}

PyDoc_STRVAR(
    _pickle_UnpicklerMemoProxy_copy__doc__,
    "copy($self, /)\n"
    "--\n"
    "\n"
    "Copy the memo to a new object."
...
#define _PICKLE_UNPICKLERMEMOPROXY_COPY_METHODDEF  \
    {"copy",                                       \
     (PyCFunction)_pickle_UnpicklerMemoProxy_copy, \
     METH_NOARGS,                                  \
     _pickle_UnpicklerMemoProxy_copy__doc__},
...
PyDoc_STRVAR(
    _pickle_UnpicklerMemoProxy___reduce____doc__,
    "__reduce__($self, /)\n"
    "--\n"
    "\n"
...
#define _PICKLE_UNPICKLERMEMOPROXY___REDUCE___METHODDEF  \
    {"__reduce__",                                       \
     (PyCFunction)_pickle_UnpicklerMemoProxy___reduce__, \
     METH_NOARGS,                                        \
     _pickle_UnpicklerMemoProxy___reduce____doc__},
...
#define _PICKLE_DUMP_METHODDEF        \
    {"dump",                          \
     _PyCFunction_CAST(_pickle_dump), \
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "obj", "file", "protocol", "fix_imports", "buffer_callback", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "dump",
...
#define _PICKLE_DUMPS_METHODDEF        \
    {"dumps",                          \
     _PyCFunction_CAST(_pickle_dumps), \
     METH_FASTCALL | METH_KEYWORDS,    \
     _pickle_dumps__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "obj", "protocol", "fix_imports", "buffer_callback", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "dumps",
...
skip_optional_kwonly:
    return_value =
        _pickle_dumps_impl(module, obj, protocol, fix_imports, buffer_callback);
...
#define _PICKLE_LOAD_METHODDEF        \
    {"load",                          \
     _PyCFunction_CAST(_pickle_load), \
     METH_FASTCALL | METH_KEYWORDS,   \
     _pickle_load__doc__},
...
skip_optional_kwonly:
    return_value =
        _pickle_load_impl(module, file, fix_imports, encoding, errors, buffers);
...
#define _PICKLE_LOADS_METHODDEF        \
    {"loads",                          \
     _PyCFunction_CAST(_pickle_loads), \
     METH_FASTCALL | METH_KEYWORDS,    \
     _pickle_loads__doc__},
...
skip_optional_kwonly:
    return_value =
        _pickle_loads_impl(module, data, fix_imports, encoding, errors, buffers);
