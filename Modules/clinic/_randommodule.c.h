...
#define _RANDOM_RANDOM_RANDOM_METHODDEF  \
    {"random",                           \
     (PyCFunction)_random_Random_random, \
     METH_NOARGS,                        \
     _random_Random_random__doc__},
...
#define _RANDOM_RANDOM_SEED_METHODDEF        \
    {"seed",                                 \
     _PyCFunction_CAST(_random_Random_seed), \
     METH_FASTCALL,                          \
     _random_Random_seed__doc__},
...
PyDoc_STRVAR(
    _random_Random_getstate__doc__,
    "getstate($self, /)\n"
    "--\n"
    "\n"
...
#define _RANDOM_RANDOM_GETSTATE_METHODDEF  \
    {"getstate",                           \
     (PyCFunction)_random_Random_getstate, \
     METH_NOARGS,                          \
     _random_Random_getstate__doc__},
...
PyDoc_STRVAR(
    _random_Random_setstate__doc__,
    "setstate($self, state, /)\n"
    "--\n"
    "\n"
...
#define _RANDOM_RANDOM_SETSTATE_METHODDEF  \
    {"setstate",                           \
     (PyCFunction)_random_Random_setstate, \
     METH_O,                               \
     _random_Random_setstate__doc__},
...
#define _RANDOM_RANDOM_GETRANDBITS_METHODDEF  \
    {"getrandbits",                           \
     (PyCFunction)_random_Random_getrandbits, \
     METH_O,                                  \
     _random_Random_getrandbits__doc__},
