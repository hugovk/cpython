...
#define _OPCODE_STACK_EFFECT_METHODDEF        \
    {"stack_effect",                          \
     _PyCFunction_CAST(_opcode_stack_effect), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _opcode_stack_effect__doc__},

static int
_opcode_stack_effect_impl(
    PyObject *module, int opcode, PyObject *oparg, PyObject *jump
);
...
#define _OPCODE_IS_VALID_METHODDEF        \
    {"is_valid",                          \
     _PyCFunction_CAST(_opcode_is_valid), \
     METH_FASTCALL | METH_KEYWORDS,       \
     _opcode_is_valid__doc__},
...
#define _OPCODE_HAS_ARG_METHODDEF        \
    {"has_arg",                          \
     _PyCFunction_CAST(_opcode_has_arg), \
     METH_FASTCALL | METH_KEYWORDS,      \
     _opcode_has_arg__doc__},
...
#define _OPCODE_HAS_CONST_METHODDEF        \
    {"has_const",                          \
     _PyCFunction_CAST(_opcode_has_const), \
     METH_FASTCALL | METH_KEYWORDS,        \
     _opcode_has_const__doc__},
...
#define _OPCODE_HAS_NAME_METHODDEF        \
    {"has_name",                          \
     _PyCFunction_CAST(_opcode_has_name), \
     METH_FASTCALL | METH_KEYWORDS,       \
     _opcode_has_name__doc__},
...
#define _OPCODE_HAS_JUMP_METHODDEF        \
    {"has_jump",                          \
     _PyCFunction_CAST(_opcode_has_jump), \
     METH_FASTCALL | METH_KEYWORDS,       \
     _opcode_has_jump__doc__},
...
#define _OPCODE_HAS_FREE_METHODDEF        \
    {"has_free",                          \
     _PyCFunction_CAST(_opcode_has_free), \
     METH_FASTCALL | METH_KEYWORDS,       \
     _opcode_has_free__doc__},
...
#define _OPCODE_HAS_LOCAL_METHODDEF        \
    {"has_local",                          \
     _PyCFunction_CAST(_opcode_has_local), \
     METH_FASTCALL | METH_KEYWORDS,        \
     _opcode_has_local__doc__},
...
#define _OPCODE_HAS_EXC_METHODDEF        \
    {"has_exc",                          \
     _PyCFunction_CAST(_opcode_has_exc), \
     METH_FASTCALL | METH_KEYWORDS,      \
     _opcode_has_exc__doc__},
...
PyDoc_STRVAR(
    _opcode_get_specialization_stats__doc__,
...
#define _OPCODE_GET_SPECIALIZATION_STATS_METHODDEF  \
    {"get_specialization_stats",                    \
     (PyCFunction)_opcode_get_specialization_stats, \
     METH_NOARGS,                                   \
     _opcode_get_specialization_stats__doc__},
...
#define _OPCODE_GET_NB_OPS_METHODDEF  \
    {"get_nb_ops",                    \
     (PyCFunction)_opcode_get_nb_ops, \
     METH_NOARGS,                     \
     _opcode_get_nb_ops__doc__},
...
#define _OPCODE_GET_INTRINSIC1_DESCS_METHODDEF  \
    {"get_intrinsic1_descs",                    \
     (PyCFunction)_opcode_get_intrinsic1_descs, \
     METH_NOARGS,                               \
     _opcode_get_intrinsic1_descs__doc__},
...
PyDoc_STRVAR(
    _opcode_get_intrinsic2_descs__doc__,
...
#define _OPCODE_GET_INTRINSIC2_DESCS_METHODDEF  \
    {"get_intrinsic2_descs",                    \
     (PyCFunction)_opcode_get_intrinsic2_descs, \
     METH_NOARGS,                               \
     _opcode_get_intrinsic2_descs__doc__},
...
#define _OPCODE_GET_SPECIAL_METHOD_NAMES_METHODDEF  \
    {"get_special_method_names",                    \
     (PyCFunction)_opcode_get_special_method_names, \
     METH_NOARGS,                                   \
     _opcode_get_special_method_names__doc__},
...
#define _OPCODE_GET_EXECUTOR_METHODDEF        \
    {"get_executor",                          \
     _PyCFunction_CAST(_opcode_get_executor), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _opcode_get_executor__doc__},
