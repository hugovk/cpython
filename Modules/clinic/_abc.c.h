...
#define _ABC__RESET_REGISTRY_METHODDEF  \
    {"_reset_registry",                 \
     (PyCFunction)_abc__reset_registry, \
     METH_O,                            \
     _abc__reset_registry__doc__},

PyDoc_STRVAR(
    _abc__reset_caches__doc__,
...
#define _ABC__RESET_CACHES_METHODDEF  \
    {"_reset_caches",                 \
     (PyCFunction)_abc__reset_caches, \
     METH_O,                          \
     _abc__reset_caches__doc__},

PyDoc_STRVAR(
    _abc__get_dump__doc__,
...
PyDoc_STRVAR(
    _abc__abc_register__doc__,
    "_abc_register($module, self, subclass, /)\n"
    "--\n"
    "\n"
    "Internal ABC helper for subclasss registration. Should be never used outside abc "
    "module."
);

#define _ABC__ABC_REGISTER_METHODDEF        \
    {"_abc_register",                       \
     _PyCFunction_CAST(_abc__abc_register), \
     METH_FASTCALL,                         \
     _abc__abc_register__doc__},
...
#define _ABC__ABC_INSTANCECHECK_METHODDEF        \
    {"_abc_instancecheck",                       \
     _PyCFunction_CAST(_abc__abc_instancecheck), \
     METH_FASTCALL,                              \
     _abc__abc_instancecheck__doc__},
...
PyDoc_STRVAR(
    _abc__abc_subclasscheck__doc__,
...
#define _ABC__ABC_SUBCLASSCHECK_METHODDEF        \
    {"_abc_subclasscheck",                       \
     _PyCFunction_CAST(_abc__abc_subclasscheck), \
     METH_FASTCALL,                              \
     _abc__abc_subclasscheck__doc__},
...
#define _ABC_GET_CACHE_TOKEN_METHODDEF  \
    {"get_cache_token",                 \
     (PyCFunction)_abc_get_cache_token, \
     METH_NOARGS,                       \
     _abc_get_cache_token__doc__},
