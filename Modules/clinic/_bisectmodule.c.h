...
#define _BISECT_BISECT_RIGHT_METHODDEF        \
    {"bisect_right",                          \
     _PyCFunction_CAST(_bisect_bisect_right), \
...
#define _BISECT_INSORT_RIGHT_METHODDEF        \
    {"insort_right",                          \
     _PyCFunction_CAST(_bisect_insort_right), \
     METH_FASTCALL | METH_KEYWORDS,           \
     _bisect_insort_right__doc__},
...
#define _BISECT_BISECT_LEFT_METHODDEF        \
    {"bisect_left",                          \
     _PyCFunction_CAST(_bisect_bisect_left), \
     METH_FASTCALL | METH_KEYWORDS,          \
     _bisect_bisect_left__doc__},
...
#define _BISECT_INSORT_LEFT_METHODDEF        \
    {"insort_left",                          \
     _PyCFunction_CAST(_bisect_insort_left), \
     METH_FASTCALL | METH_KEYWORDS,          \
     _bisect_insort_left__doc__},
