...
#define SHA256TYPE_COPY_METHODDEF                 \
    {"copy",                                      \
     _PyCFunction_CAST(SHA256Type_copy),          \
...
#define SHA512TYPE_COPY_METHODDEF                 \
    {"copy",                                      \
     _PyCFunction_CAST(SHA512Type_copy),          \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     SHA512Type_copy__doc__},
...
#define SHA256TYPE_HEXDIGEST_METHODDEF  \
    {"hexdigest",                       \
     (PyCFunction)SHA256Type_hexdigest, \
     METH_NOARGS,                       \
     SHA256Type_hexdigest__doc__},
...
#define SHA512TYPE_HEXDIGEST_METHODDEF  \
    {"hexdigest",                       \
     (PyCFunction)SHA512Type_hexdigest, \
     METH_NOARGS,                       \
     SHA512Type_hexdigest__doc__},
...
#define _SHA2_SHA256_METHODDEF        \
    {"sha256",                        \
     _PyCFunction_CAST(_sha2_sha256), \
...
#define _SHA2_SHA224_METHODDEF        \
    {"sha224",                        \
     _PyCFunction_CAST(_sha2_sha224), \
     METH_FASTCALL | METH_KEYWORDS,   \
     _sha2_sha224__doc__},
...
#define _SHA2_SHA512_METHODDEF        \
    {"sha512",                        \
     _PyCFunction_CAST(_sha2_sha512), \
     METH_FASTCALL | METH_KEYWORDS,   \
     _sha2_sha512__doc__},
...
#define _SHA2_SHA384_METHODDEF        \
    {"sha384",                        \
     _PyCFunction_CAST(_sha2_sha384), \
     METH_FASTCALL | METH_KEYWORDS,   \
     _sha2_sha384__doc__},
