...
PyDoc_STRVAR(
    pyexpat_xmlparser_SetReparseDeferralEnabled__doc__,
...
#define PYEXPAT_XMLPARSER_SETREPARSEDEFERRALENABLED_METHODDEF  \
    {"SetReparseDeferralEnabled",                              \
     (PyCFunction)pyexpat_xmlparser_SetReparseDeferralEnabled, \
     METH_O,                                                   \
     pyexpat_xmlparser_SetReparseDeferralEnabled__doc__},
...
static PyObject *
pyexpat_xmlparser_GetReparseDeferralEnabled(
    xmlparseobject *self, PyObject *Py_UNUSED(ignored)
) {
...
#define PYEXPAT_XMLPARSER_PARSE_METHODDEF         \
    {"Parse",                                     \
     _PyCFunction_CAST(pyexpat_xmlparser_Parse),  \
...
PyDoc_STRVAR(
    pyexpat_xmlparser_ParseFile__doc__,
    "ParseFile($self, file, /)\n"
    "--\n"
    "\n"
...
#define PYEXPAT_XMLPARSER_PARSEFILE_METHODDEF        \
    {"ParseFile",                                    \
     _PyCFunction_CAST(pyexpat_xmlparser_ParseFile), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,    \
     pyexpat_xmlparser_ParseFile__doc__},
...
#define PYEXPAT_XMLPARSER_SETBASE_METHODDEF  \
    {"SetBase",                              \
     (PyCFunction)pyexpat_xmlparser_SetBase, \
     METH_O,                                 \
     pyexpat_xmlparser_SetBase__doc__},
...
PyDoc_STRVAR(
    pyexpat_xmlparser_GetBase__doc__,
    "GetBase($self, /)\n"
    "--\n"
    "\n"
...
#define PYEXPAT_XMLPARSER_GETBASE_METHODDEF  \
    {"GetBase",                              \
     (PyCFunction)pyexpat_xmlparser_GetBase, \
     METH_NOARGS,                            \
     pyexpat_xmlparser_GetBase__doc__},
...
#define PYEXPAT_XMLPARSER_GETINPUTCONTEXT_METHODDEF  \
    {"GetInputContext",                              \
     (PyCFunction)pyexpat_xmlparser_GetInputContext, \
     METH_NOARGS,                                    \
     pyexpat_xmlparser_GetInputContext__doc__},
...
PyDoc_STRVAR(
    ...
    "--\n"
    "\n"
    "Create a parser for parsing an external entity based on the information passed to "
    "the ExternalEntityRefHandler."
);

#define PYEXPAT_XMLPARSER_EXTERNALENTITYPARSERCREATE_METHODDEF        \
    {"ExternalEntityParserCreate",                                    \
     _PyCFunction_CAST(pyexpat_xmlparser_ExternalEntityParserCreate), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,                     \
     pyexpat_xmlparser_ExternalEntityParserCreate__doc__},
...
#undef KWTUPLE
    ...
    if (args[0] == Py_None) {
        ...
        _PyArg_BadArgument(
            "ExternalEntityParserCreate", "argument 1", "str or None", args[0]
        );
        goto exit;
    }
    if (nargs < 2) {
...
skip_optional_posonly:
    return_value =
        pyexpat_xmlparser_ExternalEntityParserCreate_impl(self, cls, context, encoding);
...
PyDoc_STRVAR(
    pyexpat_xmlparser_SetParamEntityParsing__doc__,
...
#define PYEXPAT_XMLPARSER_SETPARAMENTITYPARSING_METHODDEF  \
    {"SetParamEntityParsing",                              \
     (PyCFunction)pyexpat_xmlparser_SetParamEntityParsing, \
     METH_O,                                               \
     pyexpat_xmlparser_SetParamEntityParsing__doc__},
...
#define PYEXPAT_XMLPARSER_USEFOREIGNDTD_METHODDEF        \
    {"UseForeignDTD",                                    \
     _PyCFunction_CAST(pyexpat_xmlparser_UseForeignDTD), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,        \
     pyexpat_xmlparser_UseForeignDTD__doc__},
...
#define PYEXPAT_PARSERCREATE_METHODDEF        \
    {"ParserCreate",                          \
     _PyCFunction_CAST(pyexpat_ParserCreate), \
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "encoding", "namespace_separator", "intern", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "ParserCreate",
...
#undef KWTUPLE
    ...
    if (args[0]) {
        if (args[0] == Py_None) {
            ...
            _PyArg_BadArgument(
                "ParserCreate", "argument 'encoding'", "str or None", args[0]
            );
            goto exit;
        }
        if (!--noptargs) {
    ...
    if (args[1]) {
        if (args[1] == Py_None) {
            ...
            namespace_separator =
                PyUnicode_AsUTF8AndSize(args[1], &namespace_separator_length);
            ...
            _PyArg_BadArgument(
                "ParserCreate", "argument 'namespace_separator'", "str or None", args[1]
            );
            goto exit;
        }
        if (!--noptargs) {
...
skip_optional_pos:
    return_value =
        pyexpat_ParserCreate_impl(module, encoding, namespace_separator, intern);
...
#define PYEXPAT_ERRORSTRING_METHODDEF  \
    {"ErrorString",                    \
     (PyCFunction)pyexpat_ErrorString, \
     METH_O,                           \
     pyexpat_ErrorString__doc__},
