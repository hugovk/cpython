...
#define MY_INT_SUM_METHODDEF                  \
    {"my_int_sum",                            \
     (PyCFunction)(void (*)(void))my_int_sum, \
     METH_FASTCALL,                           \
     my_int_sum__doc__},
...
my_int_sum(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (nargs != 2) {
        PyErr_Format(
            PyExc_TypeError, "my_int_sum expected 2 arguments, got %zd", nargs
        );
        goto exit;
    }
...
#define MY_FLOAT_SUM_METHODDEF                  \
    {"my_float_sum",                            \
     (PyCFunction)(void (*)(void))my_float_sum, \
     METH_FASTCALL,                             \
     my_float_sum__doc__},
...
my_float_sum(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (nargs != 2) {
        PyErr_Format(
            PyExc_TypeError, "my_float_sum expected 2 arguments, got %zd", nargs
        );
        goto exit;
    }
...
#define MY_DOUBLE_SUM_METHODDEF                  \
    {"my_double_sum",                            \
     (PyCFunction)(void (*)(void))my_double_sum, \
     METH_FASTCALL,                              \
     my_double_sum__doc__},
...
my_double_sum(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (nargs != 2) {
        PyErr_Format(
            PyExc_TypeError, "my_double_sum expected 2 arguments, got %zd", nargs
        );
        goto exit;
    }
...
#define GET_FILE_DESCRIPTOR_METHODDEF  \
    {"get_file_descriptor",            \
     (PyCFunction)get_file_descriptor, \
     METH_O,                           \
     get_file_descriptor__doc__},
