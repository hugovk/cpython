...
grp_getgrgid(PyObject *module, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O:getgrgid", _keywords, &id))
        goto exit;
...
#define GRP_GETGRNAM_METHODDEF                  \
    {"getgrnam",                                \
     (PyCFunction)(void (*)(void))grp_getgrnam, \
     METH_VARARGS | METH_KEYWORDS,              \
     grp_getgrnam__doc__},
...
grp_getgrnam(PyObject *module, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "U:getgrnam", _keywords, &name))
        goto exit;
