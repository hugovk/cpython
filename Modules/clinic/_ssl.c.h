...
#define _SSL__SSLSOCKET_DO_HANDSHAKE_METHODDEF  \
    {"do_handshake",                            \
     (PyCFunction)_ssl__SSLSocket_do_handshake, \
     METH_NOARGS,                               \
     _ssl__SSLSocket_do_handshake__doc__},
...
#define _SSL__TEST_DECODE_CERT_METHODDEF  \
    {"_test_decode_cert",                 \
     (PyCFunction)_ssl__test_decode_cert, \
     METH_O,                              \
     _ssl__test_decode_cert__doc__},
...
PyDoc_STRVAR(
    _ssl__SSLSocket_getpeercert__doc__,
...
#define _SSL__SSLSOCKET_GETPEERCERT_METHODDEF        \
    {"getpeercert",                                  \
     _PyCFunction_CAST(_ssl__SSLSocket_getpeercert), \
     METH_FASTCALL,                                  \
     _ssl__SSLSocket_getpeercert__doc__},
...
static PyObject *
_ssl__SSLSocket_getpeercert(
    PySSLSocket *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    int binary_mode = 0;
...
#define _SSL__SSLSOCKET_GET_VERIFIED_CHAIN_METHODDEF  \
    {"get_verified_chain",                            \
     (PyCFunction)_ssl__SSLSocket_get_verified_chain, \
     METH_NOARGS,                                     \
     _ssl__SSLSocket_get_verified_chain__doc__},
...
PyDoc_STRVAR(
    _ssl__SSLSocket_get_unverified_chain__doc__,
...
#define _SSL__SSLSOCKET_GET_UNVERIFIED_CHAIN_METHODDEF  \
    {"get_unverified_chain",                            \
     (PyCFunction)_ssl__SSLSocket_get_unverified_chain, \
     METH_NOARGS,                                       \
     _ssl__SSLSocket_get_unverified_chain__doc__},
...
#define _SSL__SSLSOCKET_SHARED_CIPHERS_METHODDEF  \
    {"shared_ciphers",                            \
     (PyCFunction)_ssl__SSLSocket_shared_ciphers, \
     METH_NOARGS,                                 \
     _ssl__SSLSocket_shared_ciphers__doc__},
...
#define _SSL__SSLSOCKET_CIPHER_METHODDEF  \
    {"cipher",                            \
     (PyCFunction)_ssl__SSLSocket_cipher, \
     METH_NOARGS,                         \
     _ssl__SSLSocket_cipher__doc__},
...
PyDoc_STRVAR(
    _ssl__SSLSocket_version__doc__,
    "version($self, /)\n"
    "--\n"
    "\n"
);
...
#define _SSL__SSLSOCKET_VERSION_METHODDEF  \
    {"version",                            \
     (PyCFunction)_ssl__SSLSocket_version, \
     METH_NOARGS,                          \
     _ssl__SSLSocket_version__doc__},
...
#define _SSL__SSLSOCKET_SELECTED_ALPN_PROTOCOL_METHODDEF  \
    {"selected_alpn_protocol",                            \
     (PyCFunction)_ssl__SSLSocket_selected_alpn_protocol, \
     METH_NOARGS,                                         \
     _ssl__SSLSocket_selected_alpn_protocol__doc__},
...
static PyObject *
_ssl__SSLSocket_selected_alpn_protocol(
    PySSLSocket *self, PyObject *Py_UNUSED(ignored)
) {
    PyObject *return_value = NULL;
...
#define _SSL__SSLSOCKET_COMPRESSION_METHODDEF  \
    {"compression",                            \
     (PyCFunction)_ssl__SSLSocket_compression, \
     METH_NOARGS,                              \
     _ssl__SSLSocket_compression__doc__},
...
#define _SSL__SSLSOCKET_CONTEXT_GETSETDEF \
    {"context",                           \
     (getter)_ssl__SSLSocket_context_get, \
     (setter)_ssl__SSLSocket_context_set, \
...
#else
#define _SSL__SSLSOCKET_CONTEXT_GETSETDEF \
    {"context", NULL, (setter)_ssl__SSLSocket_context_set, NULL},
#endif
...
static int
_ssl__SSLSocket_context_set(
    PySSLSocket *self, PyObject *value, void *Py_UNUSED(context)
) {
    int return_value;
...
PyDoc_STRVAR(
    _ssl__SSLSocket_server_side__doc__, "Whether this is a server-side socket."
);
...
#define _SSL__SSLSOCKET_SERVER_SIDE_GETSETDEF \
    {"server_side",                           \
     (getter)_ssl__SSLSocket_server_side_get, \
     (setter)_ssl__SSLSocket_server_side_set, \
     _ssl__SSLSocket_server_side_DOCSTR},
#else
#define _SSL__SSLSOCKET_SERVER_SIDE_GETSETDEF \
    {"server_side",                           \
     (getter)_ssl__SSLSocket_server_side_get, \
...
PyDoc_STRVAR(
    _ssl__SSLSocket_server_hostname__doc__,
...
#define _SSL__SSLSOCKET_SERVER_HOSTNAME_GETSETDEF \
    {"server_hostname",                           \
     (getter)_ssl__SSLSocket_server_hostname_get, \
     (setter)_ssl__SSLSocket_server_hostname_set, \
     _ssl__SSLSocket_server_hostname_DOCSTR},
#else
#define _SSL__SSLSOCKET_SERVER_HOSTNAME_GETSETDEF \
    {"server_hostname",                           \
     (getter)_ssl__SSLSocket_server_hostname_get, \
...
#define _SSL__SSLSOCKET_OWNER_GETSETDEF \
    {"owner",                           \
     (getter)_ssl__SSLSocket_owner_get, \
     (setter)_ssl__SSLSocket_owner_set, \
     _ssl__SSLSocket_owner_DOCSTR},
#else
#define _SSL__SSLSOCKET_OWNER_GETSETDEF \
    {"owner", (getter)_ssl__SSLSocket_owner_get, NULL, _ssl__SSLSocket_owner_DOCSTR},
#endif
...
#else
#define _SSL__SSLSOCKET_OWNER_GETSETDEF \
    {"owner", NULL, (setter)_ssl__SSLSocket_owner_set, NULL},
#endif
...
PyDoc_STRVAR(
    _ssl__SSLSocket_pending__doc__,
    "pending($self, /)\n"
    "--\n"
    "\n"
...
#define _SSL__SSLSOCKET_PENDING_METHODDEF  \
    {"pending",                            \
     (PyCFunction)_ssl__SSLSocket_pending, \
     METH_NOARGS,                          \
     _ssl__SSLSocket_pending__doc__},
...
#define _SSL__SSLSOCKET_READ_METHODDEF  \
    {"read",                            \
     (PyCFunction)_ssl__SSLSocket_read, \
     METH_VARARGS,                      \
     _ssl__SSLSocket_read__doc__},
...
_ssl__SSLSocket_read(PySSLSocket *self, PyObject *args) {
    ...
    switch (PyTuple_GET_SIZE(args)) {
        ...
        default:
            PyErr_SetString(
                PyExc_TypeError, "_ssl._SSLSocket.read requires 1 to 2 arguments"
            );
            goto exit;
    }
    Py_BEGIN_CRITICAL_SECTION(self);
...
PyDoc_STRVAR(
    _ssl__SSLSocket_shutdown__doc__,
    "shutdown($self, /)\n"
    "--\n"
    "\n"
...
#define _SSL__SSLSOCKET_SHUTDOWN_METHODDEF  \
    {"shutdown",                            \
     (PyCFunction)_ssl__SSLSocket_shutdown, \
     METH_NOARGS,                           \
     _ssl__SSLSocket_shutdown__doc__},
...
PyDoc_STRVAR(
    _ssl__SSLSocket_get_channel_binding__doc__,
...
#define _SSL__SSLSOCKET_GET_CHANNEL_BINDING_METHODDEF        \
    {"get_channel_binding",                                  \
     _PyCFunction_CAST(_ssl__SSLSocket_get_channel_binding), \
...
_ssl__SSLSocket_get_channel_binding(
    PySSLSocket *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _SSL__SSLSOCKET_VERIFY_CLIENT_POST_HANDSHAKE_METHODDEF  \
    {"verify_client_post_handshake",                            \
     (PyCFunction)_ssl__SSLSocket_verify_client_post_handshake, \
     METH_NOARGS,                                               \
     _ssl__SSLSocket_verify_client_post_handshake__doc__},
...
#define _SSL__SSLSOCKET_SESSION_GETSETDEF \
    {"session",                           \
     (getter)_ssl__SSLSocket_session_get, \
     (setter)_ssl__SSLSocket_session_set, \
...
#else
#define _SSL__SSLSOCKET_SESSION_GETSETDEF \
    {"session", NULL, (setter)_ssl__SSLSocket_session_set, NULL},
#endif
...
#define _SSL__SSLSOCKET_SESSION_REUSED_GETSETDEF \
    {"session_reused",                           \
     (getter)_ssl__SSLSocket_session_reused_get, \
...
PyDoc_STRVAR(
    _ssl__SSLContext_set_ciphers__doc__,
...
#define _SSL__SSLCONTEXT_SET_CIPHERS_METHODDEF  \
    {"set_ciphers",                             \
     (PyCFunction)_ssl__SSLContext_set_ciphers, \
     METH_O,                                    \
     _ssl__SSLContext_set_ciphers__doc__},
...
PyDoc_STRVAR(
    _ssl__SSLContext_get_ciphers__doc__,
    "get_ciphers($self, /)\n"
    "--\n"
    "\n"
);
...
#define _SSL__SSLCONTEXT_GET_CIPHERS_METHODDEF  \
    {"get_ciphers",                             \
     (PyCFunction)_ssl__SSLContext_get_ciphers, \
     METH_NOARGS,                               \
     _ssl__SSLContext_get_ciphers__doc__},
...
PyDoc_STRVAR(
    _ssl__SSLContext__set_alpn_protocols__doc__,
...
#define _SSL__SSLCONTEXT_VERIFY_MODE_GETSETDEF \
    {"verify_mode",                            \
     (getter)_ssl__SSLContext_verify_mode_get, \
     (setter)_ssl__SSLContext_verify_mode_set, \
...
#else
#define _SSL__SSLCONTEXT_VERIFY_MODE_GETSETDEF \
    {"verify_mode", NULL, (setter)_ssl__SSLContext_verify_mode_set, NULL},
#endif
...
static int
_ssl__SSLContext_verify_mode_set(
    PySSLContext *self, PyObject *value, void *Py_UNUSED(context)
) {
    int return_value;
...
#define _SSL__SSLCONTEXT_VERIFY_FLAGS_GETSETDEF \
    {"verify_flags",                            \
     (getter)_ssl__SSLContext_verify_flags_get, \
     (setter)_ssl__SSLContext_verify_flags_set, \
     _ssl__SSLContext_verify_flags_DOCSTR},
#else
#define _SSL__SSLCONTEXT_VERIFY_FLAGS_GETSETDEF \
    {"verify_flags",                            \
     (getter)_ssl__SSLContext_verify_flags_get, \
...
#else
#define _SSL__SSLCONTEXT_VERIFY_FLAGS_GETSETDEF \
    {"verify_flags", NULL, (setter)_ssl__SSLContext_verify_flags_set, NULL},
#endif
...
#define _SSL__SSLCONTEXT_MINIMUM_VERSION_GETSETDEF \
    {"minimum_version",                            \
     (getter)_ssl__SSLContext_minimum_version_get, \
...
#else
#define _SSL__SSLCONTEXT_MINIMUM_VERSION_GETSETDEF \
    {"minimum_version", NULL, (setter)_ssl__SSLContext_minimum_version_set, NULL},
#endif
...
#define _SSL__SSLCONTEXT_MAXIMUM_VERSION_GETSETDEF \
    {"maximum_version",                            \
     (getter)_ssl__SSLContext_maximum_version_get, \
     (setter)_ssl__SSLContext_maximum_version_set, \
...
#else
#define _SSL__SSLCONTEXT_MAXIMUM_VERSION_GETSETDEF \
    {"maximum_version", NULL, (setter)_ssl__SSLContext_maximum_version_set, NULL},
#endif
...
#define _SSL__SSLCONTEXT_NUM_TICKETS_GETSETDEF \
    {"num_tickets",                            \
     (getter)_ssl__SSLContext_num_tickets_get, \
     (setter)_ssl__SSLContext_num_tickets_set, \
...
#else
#define _SSL__SSLCONTEXT_NUM_TICKETS_GETSETDEF \
    {"num_tickets", NULL, (setter)_ssl__SSLContext_num_tickets_set, NULL},
#endif
...
#define _SSL__SSLCONTEXT_SECURITY_LEVEL_GETSETDEF \
    {"security_level",                            \
     (getter)_ssl__SSLContext_security_level_get, \
     (setter)_ssl__SSLContext_security_level_set, \
...
#define _SSL__SSLCONTEXT_OPTIONS_GETSETDEF \
    {"options",                            \
     (getter)_ssl__SSLContext_options_get, \
     (setter)_ssl__SSLContext_options_set, \
...
#else
#define _SSL__SSLCONTEXT_OPTIONS_GETSETDEF \
    {"options", NULL, (setter)_ssl__SSLContext_options_set, NULL},
#endif
...
#define _SSL__SSLCONTEXT__HOST_FLAGS_GETSETDEF \
    {"_host_flags",                            \
     (getter)_ssl__SSLContext__host_flags_get, \
     (setter)_ssl__SSLContext__host_flags_set, \
     _ssl__SSLContext__host_flags_DOCSTR},
#else
#define _SSL__SSLCONTEXT__HOST_FLAGS_GETSETDEF \
    {"_host_flags",                            \
     (getter)_ssl__SSLContext__host_flags_get, \
...
#else
#define _SSL__SSLCONTEXT__HOST_FLAGS_GETSETDEF \
    {"_host_flags", NULL, (setter)_ssl__SSLContext__host_flags_set, NULL},
#endif
...
static int
_ssl__SSLContext__host_flags_set(
    PySSLContext *self, PyObject *value, void *Py_UNUSED(context)
) {
    int return_value;
...
#define _SSL__SSLCONTEXT_CHECK_HOSTNAME_GETSETDEF \
    {"check_hostname",                            \
     (getter)_ssl__SSLContext_check_hostname_get, \
     (setter)_ssl__SSLContext_check_hostname_set, \
     _ssl__SSLContext_check_hostname_DOCSTR},
#else
#define _SSL__SSLCONTEXT_CHECK_HOSTNAME_GETSETDEF \
    {"check_hostname",                            \
     (getter)_ssl__SSLContext_check_hostname_get, \
...
#else
#define _SSL__SSLCONTEXT_CHECK_HOSTNAME_GETSETDEF \
    {"check_hostname", NULL, (setter)_ssl__SSLContext_check_hostname_set, NULL},
#endif
...
#define _SSL__SSLCONTEXT_PROTOCOL_GETSETDEF \
    {"protocol",                            \
     (getter)_ssl__SSLContext_protocol_get, \
     (setter)_ssl__SSLContext_protocol_set, \
     _ssl__SSLContext_protocol_DOCSTR},
#else
#define _SSL__SSLCONTEXT_PROTOCOL_GETSETDEF \
    {"protocol",                            \
     (getter)_ssl__SSLContext_protocol_get, \
...
#define _SSL__SSLCONTEXT_LOAD_CERT_CHAIN_METHODDEF        \
    {"load_cert_chain",                                   \
     _PyCFunction_CAST(_ssl__SSLContext_load_cert_chain), \
     METH_FASTCALL | METH_KEYWORDS,                       \
     _ssl__SSLContext_load_cert_chain__doc__},
...
_ssl__SSLContext_load_cert_chain(
    PySSLContext *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
skip_optional_pos:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value =
        _ssl__SSLContext_load_cert_chain_impl(self, certfile, keyfile, password);
    Py_END_CRITICAL_SECTION();
...
skip_optional_pos:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value =
        _ssl__SSLContext_load_verify_locations_impl(self, cafile, capath, cadata);
    Py_END_CRITICAL_SECTION();
...
#define _SSL__SSLCONTEXT_LOAD_DH_PARAMS_METHODDEF  \
    {"load_dh_params",                             \
     (PyCFunction)_ssl__SSLContext_load_dh_params, \
     METH_O,                                       \
     _ssl__SSLContext_load_dh_params__doc__},
...
#define _SSL__SSLCONTEXT__WRAP_SOCKET_METHODDEF        \
    {"_wrap_socket",                                   \
     _PyCFunction_CAST(_ssl__SSLContext__wrap_socket), \
     METH_FASTCALL | METH_KEYWORDS,                    \
     _ssl__SSLContext__wrap_socket__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "sock", "server_side", "server_hostname", "owner", "session", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "_wrap_socket",
...
#undef KWTUPLE
    ...
    if (!PyObject_TypeCheck(args[0], get_state_ctx(self)->Sock_Type)) {
        _PyArg_BadArgument(
            "_wrap_socket",
            "argument 'sock'",
            (get_state_ctx(self)->Sock_Type)->tp_name,
            args[0]
        );
        goto exit;
    }
...
skip_optional_kwonly:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value = _ssl__SSLContext__wrap_socket_impl(
        self, sock, server_side, hostname_obj, owner, session
    );
    Py_END_CRITICAL_SECTION();
...
#define _SSL__SSLCONTEXT__WRAP_BIO_METHODDEF        \
    {"_wrap_bio",                                   \
     _PyCFunction_CAST(_ssl__SSLContext__wrap_bio), \
     METH_FASTCALL | METH_KEYWORDS,                 \
     _ssl__SSLContext__wrap_bio__doc__},
...
#undef KWTUPLE
    ...
    if (!PyObject_TypeCheck(args[0], get_state_ctx(self)->PySSLMemoryBIO_Type)) {
        _PyArg_BadArgument(
            "_wrap_bio",
            "argument 'incoming'",
            (get_state_ctx(self)->PySSLMemoryBIO_Type)->tp_name,
            args[0]
        );
        goto exit;
    }
...
skip_optional_kwonly:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value = _ssl__SSLContext__wrap_bio_impl(
        self, incoming, outgoing, server_side, hostname_obj, owner, session
    );
    Py_END_CRITICAL_SECTION();
...
PyDoc_STRVAR(
    _ssl__SSLContext_session_stats__doc__,
    "session_stats($self, /)\n"
    "--\n"
    "\n"
);
...
#define _SSL__SSLCONTEXT_SESSION_STATS_METHODDEF  \
    {"session_stats",                             \
     (PyCFunction)_ssl__SSLContext_session_stats, \
     METH_NOARGS,                                 \
     _ssl__SSLContext_session_stats__doc__},
...
PyDoc_STRVAR(
    _ssl__SSLContext_set_default_verify_paths__doc__,
...
#define _SSL__SSLCONTEXT_SET_DEFAULT_VERIFY_PATHS_METHODDEF  \
    {"set_default_verify_paths",                             \
     (PyCFunction)_ssl__SSLContext_set_default_verify_paths, \
     METH_NOARGS,                                            \
     _ssl__SSLContext_set_default_verify_paths__doc__},
...
_ssl__SSLContext_set_default_verify_paths(
    PySSLContext *self, PyObject *Py_UNUSED(ignored)
) {
    PyObject *return_value = NULL;
...
PyDoc_STRVAR(
    _ssl__SSLContext_set_ecdh_curve__doc__,
...
#define _SSL__SSLCONTEXT_SET_ECDH_CURVE_METHODDEF  \
    {"set_ecdh_curve",                             \
     (PyCFunction)_ssl__SSLContext_set_ecdh_curve, \
     METH_O,                                       \
     _ssl__SSLContext_set_ecdh_curve__doc__},
...
#define _SSL__SSLCONTEXT_SNI_CALLBACK_GETSETDEF \
    {"sni_callback",                            \
     (getter)_ssl__SSLContext_sni_callback_get, \
     (setter)_ssl__SSLContext_sni_callback_set, \
     _ssl__SSLContext_sni_callback_DOCSTR},
#else
#define _SSL__SSLCONTEXT_SNI_CALLBACK_GETSETDEF \
    {"sni_callback",                            \
     (getter)_ssl__SSLContext_sni_callback_get, \
...
#else
#define _SSL__SSLCONTEXT_SNI_CALLBACK_GETSETDEF \
    {"sni_callback", NULL, (setter)_ssl__SSLContext_sni_callback_set, NULL},
#endif
...
static int
_ssl__SSLContext_sni_callback_set(
    PySSLContext *self, PyObject *value, void *Py_UNUSED(context)
) {
    int return_value;
...
#define _SSL__SSLCONTEXT_CERT_STORE_STATS_METHODDEF  \
    {"cert_store_stats",                             \
     (PyCFunction)_ssl__SSLContext_cert_store_stats, \
     METH_NOARGS,                                    \
     _ssl__SSLContext_cert_store_stats__doc__},
...
#define _SSL__SSLCONTEXT_GET_CA_CERTS_METHODDEF        \
    {"get_ca_certs",                                   \
     _PyCFunction_CAST(_ssl__SSLContext_get_ca_certs), \
     METH_FASTCALL | METH_KEYWORDS,                    \
     _ssl__SSLContext_get_ca_certs__doc__},
...
#define _SSL__SSLCONTEXT_SET_PSK_CLIENT_CALLBACK_METHODDEF        \
    {"set_psk_client_callback",                                   \
     _PyCFunction_CAST(_ssl__SSLContext_set_psk_client_callback), \
     METH_FASTCALL | METH_KEYWORDS,                               \
     _ssl__SSLContext_set_psk_client_callback__doc__},
...
static PyObject *
_ssl__SSLContext_set_psk_client_callback(
    PySSLContext *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _SSL__SSLCONTEXT_SET_PSK_SERVER_CALLBACK_METHODDEF        \
    {"set_psk_server_callback",                                   \
     _PyCFunction_CAST(_ssl__SSLContext_set_psk_server_callback), \
     METH_FASTCALL | METH_KEYWORDS,                               \
     _ssl__SSLContext_set_psk_server_callback__doc__},
...
static PyObject *
_ssl__SSLContext_set_psk_server_callback(
    PySSLContext *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
skip_optional_pos:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value =
        _ssl__SSLContext_set_psk_server_callback_impl(self, callback, identity_hint);
    Py_END_CRITICAL_SECTION();
...
#define _SSL_MEMORYBIO_PENDING_GETSETDEF \
    {"pending",                          \
     (getter)_ssl_MemoryBIO_pending_get, \
     (setter)_ssl_MemoryBIO_pending_set, \
...
#define _SSL_MEMORYBIO_EOF_GETSETDEF \
    {"eof",                          \
     (getter)_ssl_MemoryBIO_eof_get, \
     (setter)_ssl_MemoryBIO_eof_set, \
     _ssl_MemoryBIO_eof_DOCSTR},
#else
#define _SSL_MEMORYBIO_EOF_GETSETDEF \
    {"eof", (getter)_ssl_MemoryBIO_eof_get, NULL, _ssl_MemoryBIO_eof_DOCSTR},
#endif
...
#define _SSL_MEMORYBIO_READ_METHODDEF        \
    {"read",                                 \
     _PyCFunction_CAST(_ssl_MemoryBIO_read), \
     METH_FASTCALL,                          \
     _ssl_MemoryBIO_read__doc__},
...
PyDoc_STRVAR(
    _ssl_MemoryBIO_write_eof__doc__,
    "write_eof($self, /)\n"
    "--\n"
    "\n"
...
#define _SSL_MEMORYBIO_WRITE_EOF_METHODDEF  \
    {"write_eof",                           \
     (PyCFunction)_ssl_MemoryBIO_write_eof, \
     METH_NOARGS,                           \
     _ssl_MemoryBIO_write_eof__doc__},
...
#define _SSL_SSLSESSION_TIME_GETSETDEF \
    {"time",                           \
     (getter)_ssl_SSLSession_time_get, \
     (setter)_ssl_SSLSession_time_set, \
     _ssl_SSLSession_time_DOCSTR},
#else
#define _SSL_SSLSESSION_TIME_GETSETDEF \
    {"time", (getter)_ssl_SSLSession_time_get, NULL, _ssl_SSLSession_time_DOCSTR},
#endif
...
#define _SSL_SSLSESSION_TIMEOUT_GETSETDEF \
    {"timeout",                           \
     (getter)_ssl_SSLSession_timeout_get, \
     (setter)_ssl_SSLSession_timeout_set, \
...
#define _ssl_SSLSession_ticket_lifetime_hint_DOCSTR \
    _ssl_SSLSession_ticket_lifetime_hint__doc__
#else
...
#define _SSL_SSLSESSION_TICKET_LIFETIME_HINT_GETSETDEF \
    {"ticket_lifetime_hint",                           \
     (getter)_ssl_SSLSession_ticket_lifetime_hint_get, \
     (setter)_ssl_SSLSession_ticket_lifetime_hint_set, \
     _ssl_SSLSession_ticket_lifetime_hint_DOCSTR},
#else
#define _SSL_SSLSESSION_TICKET_LIFETIME_HINT_GETSETDEF \
    {"ticket_lifetime_hint",                           \
     (getter)_ssl_SSLSession_ticket_lifetime_hint_get, \
...
#define _SSL_SSLSESSION_ID_GETSETDEF \
    {"id",                           \
     (getter)_ssl_SSLSession_id_get, \
     (setter)_ssl_SSLSession_id_set, \
     _ssl_SSLSession_id_DOCSTR},
#else
#define _SSL_SSLSESSION_ID_GETSETDEF \
    {"id", (getter)_ssl_SSLSession_id_get, NULL, _ssl_SSLSession_id_DOCSTR},
#endif
...
#define _SSL_SSLSESSION_HAS_TICKET_GETSETDEF \
    {"has_ticket",                           \
     (getter)_ssl_SSLSession_has_ticket_get, \
     (setter)_ssl_SSLSession_has_ticket_set, \
     _ssl_SSLSession_has_ticket_DOCSTR},
#else
#define _SSL_SSLSESSION_HAS_TICKET_GETSETDEF \
    {"has_ticket",                           \
     (getter)_ssl_SSLSession_has_ticket_get, \
...
#define _SSL_GET_DEFAULT_VERIFY_PATHS_METHODDEF  \
    {"get_default_verify_paths",                 \
     (PyCFunction)_ssl_get_default_verify_paths, \
     METH_NOARGS,                                \
     _ssl_get_default_verify_paths__doc__},
...
#define _SSL_TXT2OBJ_METHODDEF        \
    {"txt2obj",                       \
     _PyCFunction_CAST(_ssl_txt2obj), \
     METH_FASTCALL | METH_KEYWORDS,   \
     _ssl_txt2obj__doc__},
...
#define _SSL_ENUM_CERTIFICATES_METHODDEF        \
    {"enum_certificates",                       \
     _PyCFunction_CAST(_ssl_enum_certificates), \
     METH_FASTCALL | METH_KEYWORDS,             \
     _ssl_enum_certificates__doc__},
...
#undef KWTUPLE
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument(
            "enum_certificates", "argument 'store_name'", "str", args[0]
        );
        goto exit;
    }
...
#define _SSL_ENUM_CRLS_METHODDEF        \
    {"enum_crls",                       \
     _PyCFunction_CAST(_ssl_enum_crls), \
     METH_FASTCALL | METH_KEYWORDS,     \
     _ssl_enum_crls__doc__},
