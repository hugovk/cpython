...
#define _DBM_DBM_KEYS_METHODDEF                   \
    {"keys",                                      \
     _PyCFunction_CAST(_dbm_dbm_keys),            \
...
#define _DBM_DBM_GET_METHODDEF                    \
    {"get",                                       \
     _PyCFunction_CAST(_dbm_dbm_get),             \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _dbm_dbm_get__doc__},
...
#undef KWTUPLE
    ...
    if (!_PyArg_ParseStackAndKeywords(
            args, nargs, kwnames, &_parser, &key, &key_length, &default_value
        )) {
        goto exit;
    }
...
#define _DBM_DBM_SETDEFAULT_METHODDEF             \
    {"setdefault",                                \
     _PyCFunction_CAST(_dbm_dbm_setdefault),      \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _dbm_dbm_setdefault__doc__},
...
#define _DBM_DBM_CLEAR_METHODDEF                  \
    {"clear",                                     \
     _PyCFunction_CAST(_dbm_dbm_clear),           \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _dbm_dbm_clear__doc__},
