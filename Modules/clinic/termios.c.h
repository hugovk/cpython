...
#define TERMIOS_TCSETATTR_METHODDEF                  \
    {"tcsetattr",                                    \
     (PyCFunction)(void (*)(void))termios_tcsetattr, \
     METH_FASTCALL,                                  \
     termios_tcsetattr__doc__},
...
#define TERMIOS_TCSENDBREAK_METHODDEF                  \
    {"tcsendbreak",                                    \
     (PyCFunction)(void (*)(void))termios_tcsendbreak, \
     METH_FASTCALL,                                    \
     termios_tcsendbreak__doc__},
...
termios_tcsendbreak(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (nargs != 2) {
        PyErr_Format(
            PyExc_TypeError, "tcsendbreak expected 2 arguments, got %zd", nargs
        );
        goto exit;
    }
    fd = PyObject_AsFileDescriptor(args[0]);
...
#define TERMIOS_TCFLUSH_METHODDEF                  \
    {"tcflush",                                    \
     (PyCFunction)(void (*)(void))termios_tcflush, \
     METH_FASTCALL,                                \
     termios_tcflush__doc__},
...
#define TERMIOS_TCFLOW_METHODDEF                  \
    {"tcflow",                                    \
     (PyCFunction)(void (*)(void))termios_tcflow, \
     METH_FASTCALL,                               \
     termios_tcflow__doc__},
...
#define TERMIOS_TCGETWINSIZE_METHODDEF  \
    {"tcgetwinsize",                    \
     (PyCFunction)termios_tcgetwinsize, \
     METH_O,                            \
     termios_tcgetwinsize__doc__},
...
#define TERMIOS_TCSETWINSIZE_METHODDEF                  \
    {"tcsetwinsize",                                    \
     (PyCFunction)(void (*)(void))termios_tcsetwinsize, \
     METH_FASTCALL,                                     \
     termios_tcsetwinsize__doc__},
...
termios_tcsetwinsize(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (nargs != 2) {
        PyErr_Format(
            PyExc_TypeError, "tcsetwinsize expected 2 arguments, got %zd", nargs
        );
        goto exit;
    }
    fd = PyObject_AsFileDescriptor(args[0]);
