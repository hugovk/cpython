...
#define STRUCT_UNPACK_FROM_METHODDEF        \
    {"unpack_from",                         \
     _PyCFunction_CAST(Struct_unpack_from), \
...
static PyObject *
Struct_unpack_from(
    PyStructObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define CALCSIZE_METHODDEF {"calcsize", (PyCFunction)calcsize, METH_O, calcsize__doc__},
