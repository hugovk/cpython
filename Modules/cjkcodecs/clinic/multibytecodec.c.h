...
#define _MULTIBYTECODEC_MULTIBYTECODEC_ENCODE_METHODDEF        \
    {"encode",                                                 \
     _PyCFunction_CAST(_multibytecodec_MultibyteCodec_encode), \
...
#define _MULTIBYTECODEC_MULTIBYTECODEC_DECODE_METHODDEF        \
    {"decode",                                                 \
     _PyCFunction_CAST(_multibytecodec_MultibyteCodec_decode), \
     METH_FASTCALL | METH_KEYWORDS,                            \
     _multibytecodec_MultibyteCodec_decode__doc__},
...
#define _MULTIBYTECODEC_MULTIBYTEINCREMENTALENCODER_ENCODE_METHODDEF        \
    {"encode",                                                              \
     _PyCFunction_CAST(_multibytecodec_MultibyteIncrementalEncoder_encode), \
     METH_FASTCALL | METH_KEYWORDS,                                         \
     _multibytecodec_MultibyteIncrementalEncoder_encode__doc__},
...
skip_optional_pos:
    return_value =
        _multibytecodec_MultibyteIncrementalEncoder_encode_impl(self, input, final);
...
#define _MULTIBYTECODEC_MULTIBYTEINCREMENTALENCODER_GETSTATE_METHODDEF  \
    {"getstate",                                                        \
     (PyCFunction)_multibytecodec_MultibyteIncrementalEncoder_getstate, \
     METH_NOARGS,                                                       \
     _multibytecodec_MultibyteIncrementalEncoder_getstate__doc__},
...
static PyObject *
_multibytecodec_MultibyteIncrementalEncoder_getstate(
    MultibyteIncrementalEncoderObject *self, PyObject *Py_UNUSED(ignored)
) {
...
static PyObject *
_multibytecodec_MultibyteIncrementalEncoder_setstate(
    MultibyteIncrementalEncoderObject *self, PyObject *arg
) {
    PyObject *return_value = NULL;
    ...
    return_value =
        _multibytecodec_MultibyteIncrementalEncoder_setstate_impl(self, statelong);
...
PyDoc_STRVAR(
    _multibytecodec_MultibyteIncrementalEncoder_reset__doc__,
    "reset($self, /)\n"
    "--\n"
    "\n"
);
...
#define _MULTIBYTECODEC_MULTIBYTEINCREMENTALENCODER_RESET_METHODDEF  \
    {"reset",                                                        \
     (PyCFunction)_multibytecodec_MultibyteIncrementalEncoder_reset, \
     METH_NOARGS,                                                    \
     _multibytecodec_MultibyteIncrementalEncoder_reset__doc__},
...
#define _MULTIBYTECODEC_MULTIBYTEINCREMENTALDECODER_DECODE_METHODDEF        \
    {"decode",                                                              \
     _PyCFunction_CAST(_multibytecodec_MultibyteIncrementalDecoder_decode), \
     METH_FASTCALL | METH_KEYWORDS,                                         \
     _multibytecodec_MultibyteIncrementalDecoder_decode__doc__},
...
skip_optional_pos:
    return_value =
        _multibytecodec_MultibyteIncrementalDecoder_decode_impl(self, &input, final);
...
PyDoc_STRVAR(
    _multibytecodec_MultibyteIncrementalDecoder_getstate__doc__,
    "getstate($self, /)\n"
    "--\n"
    "\n"
);
...
#define _MULTIBYTECODEC_MULTIBYTEINCREMENTALDECODER_GETSTATE_METHODDEF  \
    {"getstate",                                                        \
     (PyCFunction)_multibytecodec_MultibyteIncrementalDecoder_getstate, \
     METH_NOARGS,                                                       \
     _multibytecodec_MultibyteIncrementalDecoder_getstate__doc__},
...
static PyObject *
_multibytecodec_MultibyteIncrementalDecoder_getstate(
    MultibyteIncrementalDecoderObject *self, PyObject *Py_UNUSED(ignored)
) {
    return _multibytecodec_MultibyteIncrementalDecoder_getstate_impl(self);
}

PyDoc_STRVAR(
    _multibytecodec_MultibyteIncrementalDecoder_setstate__doc__,
    "setstate($self, state, /)\n"
    "--\n"
    "\n"
);
...
#define _MULTIBYTECODEC_MULTIBYTEINCREMENTALDECODER_SETSTATE_METHODDEF  \
    {"setstate",                                                        \
     (PyCFunction)_multibytecodec_MultibyteIncrementalDecoder_setstate, \
     METH_O,                                                            \
     _multibytecodec_MultibyteIncrementalDecoder_setstate__doc__},
...
static PyObject *
_multibytecodec_MultibyteIncrementalDecoder_setstate(
    MultibyteIncrementalDecoderObject *self, PyObject *arg
) {
    PyObject *return_value = NULL;
    PyObject *state;
    ...
    state = arg;
    return_value =
        _multibytecodec_MultibyteIncrementalDecoder_setstate_impl(self, state);
...
PyDoc_STRVAR(
    _multibytecodec_MultibyteIncrementalDecoder_reset__doc__,
    "reset($self, /)\n"
    "--\n"
    "\n"
);
...
#define _MULTIBYTECODEC_MULTIBYTEINCREMENTALDECODER_RESET_METHODDEF  \
    {"reset",                                                        \
     (PyCFunction)_multibytecodec_MultibyteIncrementalDecoder_reset, \
     METH_NOARGS,                                                    \
     _multibytecodec_MultibyteIncrementalDecoder_reset__doc__},
...
#define _MULTIBYTECODEC_MULTIBYTESTREAMREADER_READ_METHODDEF        \
    {"read",                                                        \
     _PyCFunction_CAST(_multibytecodec_MultibyteStreamReader_read), \
     METH_FASTCALL,                                                 \
     _multibytecodec_MultibyteStreamReader_read__doc__},
...
static PyObject *
_multibytecodec_MultibyteStreamReader_read(
    MultibyteStreamReaderObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
...
PyDoc_STRVAR(
    _multibytecodec_MultibyteStreamReader_readline__doc__,
...
#define _MULTIBYTECODEC_MULTIBYTESTREAMREADER_READLINE_METHODDEF        \
    {"readline",                                                        \
     _PyCFunction_CAST(_multibytecodec_MultibyteStreamReader_readline), \
     METH_FASTCALL,                                                     \
     _multibytecodec_MultibyteStreamReader_readline__doc__},
...
static PyObject *
_multibytecodec_MultibyteStreamReader_readline(
    MultibyteStreamReaderObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    PyObject *sizeobj = Py_None;
...
PyDoc_STRVAR(
    _multibytecodec_MultibyteStreamReader_readlines__doc__,
...
#define _MULTIBYTECODEC_MULTIBYTESTREAMREADER_READLINES_METHODDEF        \
    {"readlines",                                                        \
     _PyCFunction_CAST(_multibytecodec_MultibyteStreamReader_readlines), \
     METH_FASTCALL,                                                      \
     _multibytecodec_MultibyteStreamReader_readlines__doc__},
...
static PyObject *
_multibytecodec_MultibyteStreamReader_readlines(
    MultibyteStreamReaderObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
...
skip_optional:
    return_value =
        _multibytecodec_MultibyteStreamReader_readlines_impl(self, sizehintobj);
...
#define _MULTIBYTECODEC_MULTIBYTESTREAMREADER_RESET_METHODDEF  \
    {"reset",                                                  \
     (PyCFunction)_multibytecodec_MultibyteStreamReader_reset, \
     METH_NOARGS,                                              \
     _multibytecodec_MultibyteStreamReader_reset__doc__},
...
static PyObject *
_multibytecodec_MultibyteStreamReader_reset(
    MultibyteStreamReaderObject *self, PyObject *Py_UNUSED(ignored)
) {
...
#define _MULTIBYTECODEC_MULTIBYTESTREAMWRITER_WRITE_METHODDEF        \
    {"write",                                                        \
     _PyCFunction_CAST(_multibytecodec_MultibyteStreamWriter_write), \
...
PyDoc_STRVAR(
    _multibytecodec_MultibyteStreamWriter_writelines__doc__,
...
#define _MULTIBYTECODEC_MULTIBYTESTREAMWRITER_WRITELINES_METHODDEF        \
    {"writelines",                                                        \
     _PyCFunction_CAST(_multibytecodec_MultibyteStreamWriter_writelines), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,                         \
     _multibytecodec_MultibyteStreamWriter_writelines__doc__},
...
#undef KWTUPLE
    ...
    lines = args[0];
    return_value =
        _multibytecodec_MultibyteStreamWriter_writelines_impl(self, cls, lines);
...
#define _MULTIBYTECODEC_MULTIBYTESTREAMWRITER_RESET_METHODDEF        \
    {"reset",                                                        \
     _PyCFunction_CAST(_multibytecodec_MultibyteStreamWriter_reset), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,                    \
     _multibytecodec_MultibyteStreamWriter_reset__doc__},
...
static PyObject *
_multibytecodec_MultibyteStreamWriter_reset(
    MultibyteStreamWriterObject *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
#define _MULTIBYTECODEC___CREATE_CODEC_METHODDEF  \
    {"__create_codec",                            \
     (PyCFunction)_multibytecodec___create_codec, \
     METH_O,                                      \
     _multibytecodec___create_codec__doc__},
