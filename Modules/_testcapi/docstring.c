...
PyDoc_STRVAR(docstring_no_signature, "This docstring has no signature.");
...
static PyMethodDef test_methods[] = {
    {"docstring_empty", (PyCFunction)test_with_docstring, METH_VARARGS, docstring_empty
    },
    {"docstring_no_signature",
     (PyCFunction)test_with_docstring,
     METH_VARARGS,
     docstring_no_signature},
    ...
    {"docstring_with_signature_with_defaults",
     ...
     METH_VARARGS,
     docstring_with_signature_with_defaults},
    {"no_docstring", (PyCFunction)test_with_docstring, METH_VARARGS},
    {"test_with_docstring",
     test_with_docstring,
     METH_VARARGS,
    ...
    {"func_with_unrepresentable_signature",
     (PyCFunction)test_with_docstring,
     METH_VARARGS,
     PyDoc_STR("func_with_unrepresentable_signature($module, /, a, b=<x>)\n"
               "--\n\n"
...
static PyMethodDef DocStringNoSignatureTest_methods[] = {
    {"meth_noargs",
     ...
     METH_NOARGS,
     docstring_no_signature},
    {"meth_o", (PyCFunction)test_with_docstring, METH_O, docstring_no_signature},
    {"meth_noargs_class",
     (PyCFunction)test_with_docstring,
...
static PyMethodDef DocStringUnrepresentableSignatureTest_methods[] = {
    {"meth",
     (PyCFunction)test_with_docstring,
     METH_VARARGS,
     PyDoc_STR("meth($self, /, a, b=<x>)\n"
               "--\n\n"
               "This docstring has a signature with unrepresentable default.")},
    {"classmeth",
     (PyCFunction)test_with_docstring,
     METH_VARARGS | METH_CLASS,
     PyDoc_STR("classmeth($type, /, a, b=<x>)\n"
               "--\n\n"
               "This docstring has a signature with unrepresentable default.")},
    {"staticmeth",
     (PyCFunction)test_with_docstring,
     METH_VARARGS | METH_STATIC,
     PyDoc_STR("staticmeth(a, b=<x>)\n"
               "--\n\n"
               "This docstring has a signature with unrepresentable default.")},
    {"with_default",
     (PyCFunction)test_with_docstring,
