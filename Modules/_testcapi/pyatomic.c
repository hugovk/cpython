...
#define IMPL_TEST_ADD(suffix, dtype)                                           \
    static PyObject *test_atomic_add_##suffix(PyObject *self, PyObject *obj) { \
        dtype x = 0;                                                           \
...
#define IMPL_TEST_COMPARE_EXCHANGE(suffix, dtype)                     \
    static PyObject *test_atomic_compare_exchange_##suffix(           \
...
#define IMPL_TEST_EXCHANGE(suffix, dtype)                                           \
    static PyObject *test_atomic_exchange_##suffix(PyObject *self, PyObject *obj) { \
        dtype x = (dtype)0;                                                         \
        dtype y = (dtype)1;                                                         \
        dtype z = (dtype)2;                                                         \
...
#define IMPL_TEST_LOAD_STORE(suffix, dtype)                                           \
    static PyObject *test_atomic_load_store_##suffix(PyObject *self, PyObject *obj) { \
        dtype x = (dtype)0;                                                           \
        dtype y = (dtype)1;                                                           \
        dtype z = (dtype)2;                                                           \
...
#define IMPL_TEST_AND_OR(suffix, dtype)                                           \
    static PyObject *test_atomic_and_or_##suffix(PyObject *self, PyObject *obj) { \
        dtype x = (dtype)0;                                                       \
        dtype y = (dtype)1;                                                       \
        dtype z = (dtype)3;                                                       \
...
static PyMethodDef test_methods[] = {
    FOR_ARITHMETIC_TYPES(BIND_TEST_ADD) FOR_ALL_TYPES(BIND_TEST_COMPARE_EXCHANGE)
        FOR_ALL_TYPES(BIND_TEST_EXCHANGE) FOR_ALL_TYPES(BIND_TEST_LOAD_STORE)
    ...
    {"test_atomic_load_store_int_release_acquire",
     test_atomic_load_store_int_release_acquire,
     METH_NOARGS},
    {NULL, NULL} /* sentinel */
};
