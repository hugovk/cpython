...
#define _TESTCAPI_ERR_SET_RAISED_METHODDEF  \
    {"err_set_raised",                      \
     (PyCFunction)_testcapi_err_set_raised, \
     METH_O,                                \
     _testcapi_err_set_raised__doc__},

PyDoc_STRVAR(
    _testcapi_exception_print__doc__,
...
#define _TESTCAPI_EXCEPTION_PRINT_METHODDEF        \
    {"exception_print",                            \
     _PyCFunction_CAST(_testcapi_exception_print), \
     METH_FASTCALL,                                \
     _testcapi_exception_print__doc__},
...
#define _TESTCAPI_MAKE_EXCEPTION_WITH_DOC_METHODDEF        \
    {"make_exception_with_doc",                            \
     _PyCFunction_CAST(_testcapi_make_exception_with_doc), \
...
#undef KWTUPLE
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument(
            "make_exception_with_doc", "argument 'name'", "str", args[0]
        );
        goto exit;
    }
    ...
    if (args[1]) {
        if (!PyUnicode_Check(args[1])) {
            _PyArg_BadArgument(
                "make_exception_with_doc", "argument 'doc'", "str", args[1]
            );
            goto exit;
        }
...
skip_optional_pos:
    return_value =
        _testcapi_make_exception_with_doc_impl(module, name, doc, base, dict);
...
PyDoc_STRVAR(
    _testcapi_exc_set_object__doc__,
...
#define _TESTCAPI_EXC_SET_OBJECT_METHODDEF        \
    {"exc_set_object",                            \
     _PyCFunction_CAST(_testcapi_exc_set_object), \
     METH_FASTCALL,                               \
     _testcapi_exc_set_object__doc__},
...
PyDoc_STRVAR(
    _testcapi_exc_set_object_fetch__doc__,
...
#define _TESTCAPI_EXC_SET_OBJECT_FETCH_METHODDEF        \
    {"exc_set_object_fetch",                            \
     _PyCFunction_CAST(_testcapi_exc_set_object_fetch), \
     METH_FASTCALL,                                     \
     _testcapi_exc_set_object_fetch__doc__},
...
static PyObject *
_testcapi_exc_set_object_fetch(
...
PyDoc_STRVAR(
    _testcapi_err_setstring__doc__,
...
#define _TESTCAPI_ERR_SETSTRING_METHODDEF        \
    {"err_setstring",                            \
     _PyCFunction_CAST(_testcapi_err_setstring), \
     METH_FASTCALL,                              \
     _testcapi_err_setstring__doc__},
...
_testcapi_err_setstring(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(
            args, nargs, "Oz#:err_setstring", &exc, &value, &value_length
        )) {
        goto exit;
    }
...
PyDoc_STRVAR(
    _testcapi_err_setfromerrnowithfilename__doc__,
...
#define _TESTCAPI_ERR_SETFROMERRNOWITHFILENAME_METHODDEF        \
    {"err_setfromerrnowithfilename",                            \
     _PyCFunction_CAST(_testcapi_err_setfromerrnowithfilename), \
     METH_FASTCALL,                                             \
     _testcapi_err_setfromerrnowithfilename__doc__},
...
static PyObject *
_testcapi_err_setfromerrnowithfilename(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    int error;
    ...
    if (!_PyArg_ParseStack(
            args,
            nargs,
            "iOz#:err_setfromerrnowithfilename",
            &error,
            &exc,
            &value,
            &value_length
    ...
    return_value = _testcapi_err_setfromerrnowithfilename_impl(
        module, error, exc, value, value_length
    );
...
#define _TESTCAPI_RAISE_EXCEPTION_METHODDEF        \
    {"raise_exception",                            \
     _PyCFunction_CAST(_testcapi_raise_exception), \
     METH_FASTCALL,                                \
     _testcapi_raise_exception__doc__},
...
PyDoc_STRVAR(
    _testcapi_raise_memoryerror__doc__,
...
#define _TESTCAPI_RAISE_MEMORYERROR_METHODDEF  \
    {"raise_memoryerror",                      \
     (PyCFunction)_testcapi_raise_memoryerror, \
     METH_NOARGS,                              \
     _testcapi_raise_memoryerror__doc__},
...
#define _TESTCAPI_FATAL_ERROR_METHODDEF        \
    {"fatal_error",                            \
     _PyCFunction_CAST(_testcapi_fatal_error), \
     METH_FASTCALL,                            \
     _testcapi_fatal_error__doc__},
...
_testcapi_fatal_error(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!_PyArg_ParseStack(args, nargs, "y|p:fatal_error", &message, &release_gil)) {
        goto exit;
    }
...
#define _TESTCAPI_SET_EXC_INFO_METHODDEF        \
    {"set_exc_info",                            \
     _PyCFunction_CAST(_testcapi_set_exc_info), \
     METH_FASTCALL,                             \
     _testcapi_set_exc_info__doc__},
...
PyDoc_STRVAR(
    _testcapi_set_exception__doc__,
...
#define _TESTCAPI_SET_EXCEPTION_METHODDEF  \
    {"set_exception",                      \
     (PyCFunction)_testcapi_set_exception, \
     METH_O,                               \
     _testcapi_set_exception__doc__},
...
#define _TESTCAPI_TRACEBACK_PRINT_METHODDEF        \
    {"traceback_print",                            \
     _PyCFunction_CAST(_testcapi_traceback_print), \
     METH_FASTCALL,                                \
     _testcapi_traceback_print__doc__},
...
PyDoc_STRVAR(
    _testcapi_unstable_exc_prep_reraise_star__doc__,
...
#define _TESTCAPI_UNSTABLE_EXC_PREP_RERAISE_STAR_METHODDEF        \
    {"unstable_exc_prep_reraise_star",                            \
     _PyCFunction_CAST(_testcapi_unstable_exc_prep_reraise_star), \
     METH_FASTCALL,                                               \
     _testcapi_unstable_exc_prep_reraise_star__doc__},
...
static PyObject *
_testcapi_unstable_exc_prep_reraise_star(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    PyObject *orig;
