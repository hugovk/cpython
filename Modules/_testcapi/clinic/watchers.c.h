...
#define _TESTCAPI_WATCH_DICT_METHODDEF        \
    {"watch_dict",                            \
     _PyCFunction_CAST(_testcapi_watch_dict), \
     METH_FASTCALL,                           \
     _testcapi_watch_dict__doc__},
...
#define _TESTCAPI_UNWATCH_DICT_METHODDEF        \
    {"unwatch_dict",                            \
     _PyCFunction_CAST(_testcapi_unwatch_dict), \
     METH_FASTCALL,                             \
     _testcapi_unwatch_dict__doc__},
...
#define _TESTCAPI_WATCH_TYPE_METHODDEF        \
    {"watch_type",                            \
     _PyCFunction_CAST(_testcapi_watch_type), \
     METH_FASTCALL,                           \
     _testcapi_watch_type__doc__},
...
#define _TESTCAPI_UNWATCH_TYPE_METHODDEF        \
    {"unwatch_type",                            \
     _PyCFunction_CAST(_testcapi_unwatch_type), \
     METH_FASTCALL,                             \
     _testcapi_unwatch_type__doc__},
...
PyDoc_STRVAR(
    _testcapi_set_func_defaults_via_capi__doc__,
...
#define _TESTCAPI_SET_FUNC_DEFAULTS_VIA_CAPI_METHODDEF        \
    {"set_func_defaults_via_capi",                            \
     _PyCFunction_CAST(_testcapi_set_func_defaults_via_capi), \
     METH_FASTCALL,                                           \
     _testcapi_set_func_defaults_via_capi__doc__},
...
static PyObject *
_testcapi_set_func_defaults_via_capi(
...
PyDoc_STRVAR(
    _testcapi_set_func_kwdefaults_via_capi__doc__,
...
#define _TESTCAPI_SET_FUNC_KWDEFAULTS_VIA_CAPI_METHODDEF        \
    {"set_func_kwdefaults_via_capi",                            \
     _PyCFunction_CAST(_testcapi_set_func_kwdefaults_via_capi), \
     METH_FASTCALL,                                             \
     _testcapi_set_func_kwdefaults_via_capi__doc__},
...
static PyObject *
_testcapi_set_func_kwdefaults_via_capi(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    PyObject *func;
