...
PyDoc_STRVAR(
    _testcapi_pyobject_fastcalldict__doc__,
...
#define _TESTCAPI_PYOBJECT_FASTCALLDICT_METHODDEF        \
    {"pyobject_fastcalldict",                            \
     _PyCFunction_CAST(_testcapi_pyobject_fastcalldict), \
     METH_FASTCALL,                                      \
     _testcapi_pyobject_fastcalldict__doc__},
...
_testcapi_pyobject_fastcalldict(
    ...
    return_value =
        _testcapi_pyobject_fastcalldict_impl(module, func, func_args, __clinic_kwargs);
...
PyDoc_STRVAR(
    _testcapi_pyobject_vectorcall__doc__,
...
#define _TESTCAPI_PYOBJECT_VECTORCALL_METHODDEF        \
    {"pyobject_vectorcall",                            \
     _PyCFunction_CAST(_testcapi_pyobject_vectorcall), \
     METH_FASTCALL,                                    \
     _testcapi_pyobject_vectorcall__doc__},
...
_testcapi_pyobject_vectorcall(
    ...
    return_value =
        _testcapi_pyobject_vectorcall_impl(module, func, func_args, __clinic_kwnames);
...
PyDoc_STRVAR(
    _testcapi_pyvectorcall_call__doc__,
...
#define _TESTCAPI_PYVECTORCALL_CALL_METHODDEF        \
    {"pyvectorcall_call",                            \
     _PyCFunction_CAST(_testcapi_pyvectorcall_call), \
     METH_FASTCALL,                                  \
     _testcapi_pyvectorcall_call__doc__},
...
skip_optional:
    return_value =
        _testcapi_pyvectorcall_call_impl(module, func, argstuple, __clinic_kwargs);
...
PyDoc_STRVAR(
    _testcapi_VectorCallClass_set_vectorcall__doc__,
...
PyDoc_STRVAR(
    _testcapi_make_vectorcall_class__doc__,
...
#define _TESTCAPI_MAKE_VECTORCALL_CLASS_METHODDEF        \
    {"make_vectorcall_class",                            \
     _PyCFunction_CAST(_testcapi_make_vectorcall_class), \
     METH_FASTCALL,                                      \
     _testcapi_make_vectorcall_class__doc__},
...
static PyObject *
_testcapi_make_vectorcall_class(
    PyObject *module, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    ...
    if (!PyObject_TypeCheck(args[0], &PyType_Type)) {
        _PyArg_BadArgument(
            "make_vectorcall_class", "argument 1", (&PyType_Type)->tp_name, args[0]
        );
        goto exit;
    }
...
PyDoc_STRVAR(
    _testcapi_has_vectorcall_flag__doc__,
...
#define _TESTCAPI_HAS_VECTORCALL_FLAG_METHODDEF  \
    {"has_vectorcall_flag",                      \
     (PyCFunction)_testcapi_has_vectorcall_flag, \
     METH_O,                                     \
     _testcapi_has_vectorcall_flag__doc__},
...
_testcapi_has_vectorcall_flag(PyObject *module, PyObject *arg) {
    ...
    if (!PyObject_TypeCheck(arg, &PyType_Type)) {
        _PyArg_BadArgument(
            "has_vectorcall_flag", "argument", (&PyType_Type)->tp_name, arg
        );
        goto exit;
    }
    type = (PyTypeObject *)arg;
