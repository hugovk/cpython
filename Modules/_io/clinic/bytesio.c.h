...
#define _IO_BYTESIO_READABLE_METHODDEF  \
    {"readable",                        \
     (PyCFunction)_io_BytesIO_readable, \
     METH_NOARGS,                       \
     _io_BytesIO_readable__doc__},
...
#define _IO_BYTESIO_WRITABLE_METHODDEF  \
    {"writable",                        \
     (PyCFunction)_io_BytesIO_writable, \
     METH_NOARGS,                       \
     _io_BytesIO_writable__doc__},
...
#define _IO_BYTESIO_SEEKABLE_METHODDEF  \
    {"seekable",                        \
     (PyCFunction)_io_BytesIO_seekable, \
     METH_NOARGS,                       \
     _io_BytesIO_seekable__doc__},
...
#define _IO_BYTESIO_GETBUFFER_METHODDEF           \
    {"getbuffer",                                 \
     _PyCFunction_CAST(_io_BytesIO_getbuffer),    \
...
#define _IO_BYTESIO_GETVALUE_METHODDEF  \
    {"getvalue",                        \
     (PyCFunction)_io_BytesIO_getvalue, \
     METH_NOARGS,                       \
     _io_BytesIO_getvalue__doc__},
...
#define _IO_BYTESIO_READ_METHODDEF        \
    {"read",                              \
     _PyCFunction_CAST(_io_BytesIO_read), \
     METH_FASTCALL,                       \
     _io_BytesIO_read__doc__},
...
#define _IO_BYTESIO_READ1_METHODDEF        \
    {"read1",                              \
     _PyCFunction_CAST(_io_BytesIO_read1), \
     METH_FASTCALL,                        \
     _io_BytesIO_read1__doc__},
...
#define _IO_BYTESIO_READLINE_METHODDEF        \
    {"readline",                              \
     _PyCFunction_CAST(_io_BytesIO_readline), \
     METH_FASTCALL,                           \
     _io_BytesIO_readline__doc__},
...
#define _IO_BYTESIO_READLINES_METHODDEF        \
    {"readlines",                              \
     _PyCFunction_CAST(_io_BytesIO_readlines), \
     METH_FASTCALL,                            \
     _io_BytesIO_readlines__doc__},
...
#define _IO_BYTESIO_READINTO_METHODDEF  \
    {"readinto",                        \
     (PyCFunction)_io_BytesIO_readinto, \
     METH_O,                            \
     _io_BytesIO_readinto__doc__},
...
#define _IO_BYTESIO_TRUNCATE_METHODDEF        \
    {"truncate",                              \
     _PyCFunction_CAST(_io_BytesIO_truncate), \
     METH_FASTCALL,                           \
     _io_BytesIO_truncate__doc__},
...
#define _IO_BYTESIO_SEEK_METHODDEF        \
    {"seek",                              \
     _PyCFunction_CAST(_io_BytesIO_seek), \
     METH_FASTCALL,                       \
     _io_BytesIO_seek__doc__},
...
#define _IO_BYTESIO_WRITELINES_METHODDEF  \
    {"writelines",                        \
     (PyCFunction)_io_BytesIO_writelines, \
     METH_O,                              \
     _io_BytesIO_writelines__doc__},
