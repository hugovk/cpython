...
PyDoc_STRVAR(
    ...
    "\n"
    "* os.SEEK_SET or 0 -- start of stream (the default); offset should be zero or "
    "positive\n"
...
#define _IO__IOBASE_SEEK_METHODDEF                \
    {"seek",                                      \
     _PyCFunction_CAST(_io__IOBase_seek),         \
...
#define _IO__IOBASE_TRUNCATE_METHODDEF            \
    {"truncate",                                  \
     _PyCFunction_CAST(_io__IOBase_truncate),     \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io__IOBase_truncate__doc__},
...
#define _IO__IOBASE_SEEKABLE_METHODDEF  \
    {"seekable",                        \
     (PyCFunction)_io__IOBase_seekable, \
     METH_NOARGS,                       \
     _io__IOBase_seekable__doc__},
...
#define _IO__IOBASE_READABLE_METHODDEF  \
    {"readable",                        \
     (PyCFunction)_io__IOBase_readable, \
     METH_NOARGS,                       \
     _io__IOBase_readable__doc__},
...
#define _IO__IOBASE_WRITABLE_METHODDEF  \
    {"writable",                        \
     (PyCFunction)_io__IOBase_writable, \
     METH_NOARGS,                       \
     _io__IOBase_writable__doc__},
...
#define _IO__IOBASE_FILENO_METHODDEF              \
    {"fileno",                                    \
     _PyCFunction_CAST(_io__IOBase_fileno),       \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io__IOBase_fileno__doc__},
...
#define _IO__IOBASE_READLINE_METHODDEF        \
    {"readline",                              \
     _PyCFunction_CAST(_io__IOBase_readline), \
     METH_FASTCALL,                           \
     _io__IOBase_readline__doc__},
...
#define _IO__IOBASE_READLINES_METHODDEF        \
    {"readlines",                              \
     _PyCFunction_CAST(_io__IOBase_readlines), \
     METH_FASTCALL,                            \
     _io__IOBase_readlines__doc__},
...
#define _IO__IOBASE_WRITELINES_METHODDEF  \
    {"writelines",                        \
     (PyCFunction)_io__IOBase_writelines, \
     METH_O,                              \
     _io__IOBase_writelines__doc__},

PyDoc_STRVAR(
    _io__RawIOBase_read__doc__,
    "read($self, size=-1, /)\n"
    "--\n"
    "\n"
);
...
#define _IO__RAWIOBASE_READ_METHODDEF        \
    {"read",                                 \
     _PyCFunction_CAST(_io__RawIOBase_read), \
     METH_FASTCALL,                          \
     _io__RawIOBase_read__doc__},
...
#define _IO__RAWIOBASE_READALL_METHODDEF  \
    {"readall",                           \
     (PyCFunction)_io__RawIOBase_readall, \
     METH_NOARGS,                         \
     _io__RawIOBase_readall__doc__},
