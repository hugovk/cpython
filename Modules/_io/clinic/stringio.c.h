...
#define _IO_STRINGIO_GETVALUE_METHODDEF  \
    {"getvalue",                         \
     (PyCFunction)_io_StringIO_getvalue, \
     METH_NOARGS,                        \
     _io_StringIO_getvalue__doc__},
...
#define _IO_STRINGIO_READ_METHODDEF        \
    {"read",                               \
     _PyCFunction_CAST(_io_StringIO_read), \
     METH_FASTCALL,                        \
     _io_StringIO_read__doc__},
...
#define _IO_STRINGIO_READLINE_METHODDEF        \
    {"readline",                               \
     _PyCFunction_CAST(_io_StringIO_readline), \
     METH_FASTCALL,                            \
     _io_StringIO_readline__doc__},
...
#define _IO_STRINGIO_TRUNCATE_METHODDEF        \
    {"truncate",                               \
     _PyCFunction_CAST(_io_StringIO_truncate), \
     METH_FASTCALL,                            \
     _io_StringIO_truncate__doc__},
...
#define _IO_STRINGIO_SEEK_METHODDEF        \
    {"seek",                               \
     _PyCFunction_CAST(_io_StringIO_seek), \
     METH_FASTCALL,                        \
     _io_StringIO_seek__doc__},
...
static int
_io_StringIO___init___impl(stringio *self, PyObject *value, PyObject *newline_obj);
...
#define _IO_STRINGIO_READABLE_METHODDEF  \
    {"readable",                         \
     (PyCFunction)_io_StringIO_readable, \
     METH_NOARGS,                        \
     _io_StringIO_readable__doc__},
...
#define _IO_STRINGIO_WRITABLE_METHODDEF  \
    {"writable",                         \
     (PyCFunction)_io_StringIO_writable, \
     METH_NOARGS,                        \
     _io_StringIO_writable__doc__},
...
#define _IO_STRINGIO_SEEKABLE_METHODDEF  \
    {"seekable",                         \
     (PyCFunction)_io_StringIO_seekable, \
     METH_NOARGS,                        \
     _io_StringIO_seekable__doc__},
...
PyDoc_STRVAR(
    _io_StringIO___getstate____doc__,
    "__getstate__($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_STRINGIO___GETSTATE___METHODDEF  \
    {"__getstate__",                         \
     (PyCFunction)_io_StringIO___getstate__, \
     METH_NOARGS,                            \
     _io_StringIO___getstate____doc__},
...
PyDoc_STRVAR(
    _io_StringIO___setstate____doc__,
...
#define _IO_STRINGIO___SETSTATE___METHODDEF  \
    {"__setstate__",                         \
     (PyCFunction)_io_StringIO___setstate__, \
     METH_O,                                 \
     _io_StringIO___setstate____doc__},
...
#define _IO_STRINGIO_CLOSED_GETSETDEF \
    {"closed",                        \
     (getter)_io_StringIO_closed_get, \
     (setter)_io_StringIO_closed_set, \
     _io_StringIO_closed_DOCSTR},
#else
#define _IO_STRINGIO_CLOSED_GETSETDEF \
    {"closed", (getter)_io_StringIO_closed_get, NULL, _io_StringIO_closed_DOCSTR},
#endif
...
#define _IO_STRINGIO_LINE_BUFFERING_GETSETDEF \
    {"line_buffering",                        \
     (getter)_io_StringIO_line_buffering_get, \
     (setter)_io_StringIO_line_buffering_set, \
...
#define _IO_STRINGIO_NEWLINES_GETSETDEF \
    {"newlines",                        \
     (getter)_io_StringIO_newlines_get, \
     (setter)_io_StringIO_newlines_set, \
     _io_StringIO_newlines_DOCSTR},
#else
#define _IO_STRINGIO_NEWLINES_GETSETDEF \
    {"newlines", (getter)_io_StringIO_newlines_get, NULL, _io_StringIO_newlines_DOCSTR},
#endif
