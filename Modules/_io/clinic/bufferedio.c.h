...
PyDoc_STRVAR(
    _io__BufferedIOBase_readinto__doc__,
...
#define _IO__BUFFEREDIOBASE_READINTO_METHODDEF  \
    {"readinto",                                \
     (PyCFunction)_io__BufferedIOBase_readinto, \
     METH_O,                                    \
     _io__BufferedIOBase_readinto__doc__},
...
#define _IO__BUFFEREDIOBASE_READINTO1_METHODDEF  \
    {"readinto1",                                \
     (PyCFunction)_io__BufferedIOBase_readinto1, \
     METH_O,                                     \
     _io__BufferedIOBase_readinto1__doc__},
...
_io__BufferedIOBase_readinto1(PyObject *self, PyObject *arg) {
    ...
    if (PyObject_GetBuffer(arg, &buffer, PyBUF_WRITABLE) < 0) {
        _PyArg_BadArgument(
            "readinto1", "argument", "read-write bytes-like object", arg
        );
        goto exit;
    }
    Py_BEGIN_CRITICAL_SECTION(self);
...
#define _IO__BUFFEREDIOBASE_DETACH_METHODDEF        \
    {"detach",                                      \
     _PyCFunction_CAST(_io__BufferedIOBase_detach), \
...
#define _IO__BUFFEREDIOBASE_READ_METHODDEF        \
    {"read",                                      \
     _PyCFunction_CAST(_io__BufferedIOBase_read), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io__BufferedIOBase_read__doc__},
...
PyDoc_STRVAR(
    _io__BufferedIOBase_read1__doc__,
    "read1($self, size=-1, /)\n"
    "--\n"
    "\n"
    "Read and return up to size bytes, with at most one read() call to the underlying "
    "raw stream.\n"
    "\n"
    "Return an empty bytes object on EOF.\n"
...
#define _IO__BUFFEREDIOBASE_READ1_METHODDEF        \
    {"read1",                                      \
     _PyCFunction_CAST(_io__BufferedIOBase_read1), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,  \
     _io__BufferedIOBase_read1__doc__},
...
#define _IO__BUFFEREDIOBASE_WRITE_METHODDEF        \
    {"write",                                      \
     _PyCFunction_CAST(_io__BufferedIOBase_write), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,  \
     _io__BufferedIOBase_write__doc__},
...
PyDoc_STRVAR(
    _io__Buffered___sizeof____doc__,
    "__sizeof__($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO__BUFFERED___SIZEOF___METHODDEF  \
    {"__sizeof__",                          \
     (PyCFunction)_io__Buffered___sizeof__, \
     METH_NOARGS,                           \
     _io__Buffered___sizeof____doc__},
...
PyDoc_STRVAR(
    _io__Buffered__dealloc_warn__doc__,
...
#define _IO__BUFFERED__DEALLOC_WARN_METHODDEF  \
    {"_dealloc_warn",                          \
     (PyCFunction)_io__Buffered__dealloc_warn, \
     METH_O,                                   \
     _io__Buffered__dealloc_warn__doc__},

PyDoc_STRVAR(
    _io__Buffered_simple_flush__doc__,
    "flush($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO__BUFFERED_SIMPLE_FLUSH_METHODDEF  \
    {"flush",                                 \
     (PyCFunction)_io__Buffered_simple_flush, \
     METH_NOARGS,                             \
     _io__Buffered_simple_flush__doc__},
...
#define _IO__BUFFERED_CLOSED_GETSETDEF \
    {"closed",                         \
     (getter)_io__Buffered_closed_get, \
     (setter)_io__Buffered_closed_set, \
     _io__Buffered_closed_DOCSTR},
#else
#define _IO__BUFFERED_CLOSED_GETSETDEF \
    {"closed", (getter)_io__Buffered_closed_get, NULL, _io__Buffered_closed_DOCSTR},
#endif
...
#define _IO__BUFFERED_CLOSE_METHODDEF  \
    {"close",                          \
     (PyCFunction)_io__Buffered_close, \
     METH_NOARGS,                      \
     _io__Buffered_close__doc__},
...
#define _IO__BUFFERED_DETACH_METHODDEF  \
    {"detach",                          \
     (PyCFunction)_io__Buffered_detach, \
     METH_NOARGS,                       \
     _io__Buffered_detach__doc__},
...
#define _IO__BUFFERED_SEEKABLE_METHODDEF  \
    {"seekable",                          \
     (PyCFunction)_io__Buffered_seekable, \
     METH_NOARGS,                         \
     _io__Buffered_seekable__doc__},
...
#define _IO__BUFFERED_READABLE_METHODDEF  \
    {"readable",                          \
     (PyCFunction)_io__Buffered_readable, \
     METH_NOARGS,                         \
     _io__Buffered_readable__doc__},
...
#define _IO__BUFFERED_WRITABLE_METHODDEF  \
    {"writable",                          \
     (PyCFunction)_io__Buffered_writable, \
     METH_NOARGS,                         \
     _io__Buffered_writable__doc__},
...
#define _IO__BUFFERED_NAME_GETSETDEF \
    {"name",                         \
     (getter)_io__Buffered_name_get, \
     (setter)_io__Buffered_name_set, \
     _io__Buffered_name_DOCSTR},
#else
#define _IO__BUFFERED_NAME_GETSETDEF \
    {"name", (getter)_io__Buffered_name_get, NULL, _io__Buffered_name_DOCSTR},
#endif
...
#define _IO__BUFFERED_MODE_GETSETDEF \
    {"mode",                         \
     (getter)_io__Buffered_mode_get, \
     (setter)_io__Buffered_mode_set, \
     _io__Buffered_mode_DOCSTR},
#else
#define _IO__BUFFERED_MODE_GETSETDEF \
...
#define _IO__BUFFERED_FILENO_METHODDEF  \
    {"fileno",                          \
     (PyCFunction)_io__Buffered_fileno, \
     METH_NOARGS,                       \
     _io__Buffered_fileno__doc__},
...
#define _IO__BUFFERED_ISATTY_METHODDEF  \
    {"isatty",                          \
     (PyCFunction)_io__Buffered_isatty, \
     METH_NOARGS,                       \
     _io__Buffered_isatty__doc__},
...
#define _IO__BUFFERED_FLUSH_METHODDEF  \
    {"flush",                          \
     (PyCFunction)_io__Buffered_flush, \
     METH_NOARGS,                      \
     _io__Buffered_flush__doc__},
...
#define _IO__BUFFERED_PEEK_METHODDEF        \
    {"peek",                                \
     _PyCFunction_CAST(_io__Buffered_peek), \
     METH_FASTCALL,                         \
     _io__Buffered_peek__doc__},
...
#define _IO__BUFFERED_READ_METHODDEF        \
    {"read",                                \
     _PyCFunction_CAST(_io__Buffered_read), \
     METH_FASTCALL,                         \
     _io__Buffered_read__doc__},
...
#define _IO__BUFFERED_READ1_METHODDEF        \
    {"read1",                                \
     _PyCFunction_CAST(_io__Buffered_read1), \
     METH_FASTCALL,                          \
     _io__Buffered_read1__doc__},
...
#define _IO__BUFFERED_READINTO_METHODDEF  \
    {"readinto",                          \
     (PyCFunction)_io__Buffered_readinto, \
     METH_O,                              \
     _io__Buffered_readinto__doc__},
...
PyDoc_STRVAR(
    _io__Buffered_readinto1__doc__,
    "readinto1($self, buffer, /)\n"
    "--\n"
    "\n"
);
...
#define _IO__BUFFERED_READINTO1_METHODDEF  \
    {"readinto1",                          \
     (PyCFunction)_io__Buffered_readinto1, \
     METH_O,                               \
     _io__Buffered_readinto1__doc__},
...
#define _IO__BUFFERED_READLINE_METHODDEF        \
    {"readline",                                \
     _PyCFunction_CAST(_io__Buffered_readline), \
     METH_FASTCALL,                             \
     _io__Buffered_readline__doc__},
...
#define _IO__BUFFERED_SEEK_METHODDEF        \
    {"seek",                                \
     _PyCFunction_CAST(_io__Buffered_seek), \
     METH_FASTCALL,                         \
     _io__Buffered_seek__doc__},
...
#define _IO__BUFFERED_TRUNCATE_METHODDEF          \
    {"truncate",                                  \
     _PyCFunction_CAST(_io__Buffered_truncate),   \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io__Buffered_truncate__doc__},
...
PyDoc_STRVAR(
    _io_BufferedReader___init____doc__,
...
PyDoc_STRVAR(
    _io_BufferedWriter___init____doc__,
...
#define _IO_BUFFEREDWRITER_WRITE_METHODDEF  \
    {"write",                               \
     (PyCFunction)_io_BufferedWriter_write, \
     METH_O,                                \
     _io_BufferedWriter_write__doc__},
...
PyDoc_STRVAR(
    _io_BufferedRWPair___init____doc__,
...
skip_optional:
    return_value =
        _io_BufferedRWPair___init___impl((rwpair *)self, reader, writer, buffer_size);
