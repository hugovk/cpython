...
#define _IO__TEXTIOBASE_DETACH_METHODDEF          \
    {"detach",                                    \
     _PyCFunction_CAST(_io__TextIOBase_detach),   \
...
#define _IO__TEXTIOBASE_READLINE_METHODDEF        \
    {"readline",                                  \
     _PyCFunction_CAST(_io__TextIOBase_readline), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io__TextIOBase_readline__doc__},
...
#define _IO__TEXTIOBASE_WRITE_METHODDEF           \
    {"write",                                     \
     _PyCFunction_CAST(_io__TextIOBase_write),    \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io__TextIOBase_write__doc__},
...
PyDoc_STRVAR(
    _io__TextIOBase_encoding__doc__,
...
#define _IO__TEXTIOBASE_ENCODING_GETSETDEF \
    {"encoding",                           \
     (getter)_io__TextIOBase_encoding_get, \
     (setter)_io__TextIOBase_encoding_set, \
...
PyDoc_STRVAR(
    _io__TextIOBase_newlines__doc__,
...
#define _IO__TEXTIOBASE_NEWLINES_GETSETDEF \
    {"newlines",                           \
     (getter)_io__TextIOBase_newlines_get, \
     (setter)_io__TextIOBase_newlines_set, \
...
#define _IO__TEXTIOBASE_ERRORS_GETSETDEF \
    {"errors",                           \
     (getter)_io__TextIOBase_errors_get, \
     (setter)_io__TextIOBase_errors_set, \
     _io__TextIOBase_errors_DOCSTR},
#else
#define _IO__TEXTIOBASE_ERRORS_GETSETDEF \
    {"errors", (getter)_io__TextIOBase_errors_get, NULL, _io__TextIOBase_errors_DOCSTR},
#endif
...
PyDoc_STRVAR(
    _io_IncrementalNewlineDecoder___init____doc__,
...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 2, 3, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
    ...
    errors = fastargs[2];
skip_optional_pos:
    return_value = _io_IncrementalNewlineDecoder___init___impl(
        (nldecoder_object *)self, decoder, translate, errors
    );
...
#define _IO_INCREMENTALNEWLINEDECODER_DECODE_METHODDEF        \
    {"decode",                                                \
     _PyCFunction_CAST(_io_IncrementalNewlineDecoder_decode), \
...
_io_IncrementalNewlineDecoder_decode(
    nldecoder_object *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
PyDoc_STRVAR(
    _io_IncrementalNewlineDecoder_getstate__doc__,
    "getstate($self, /)\n"
    "--\n"
    "\n"
);
...
_io_IncrementalNewlineDecoder_getstate(
    nldecoder_object *self, PyObject *Py_UNUSED(ignored)
) {
    return _io_IncrementalNewlineDecoder_getstate_impl(self);
}

PyDoc_STRVAR(
    _io_IncrementalNewlineDecoder_setstate__doc__,
    "setstate($self, state, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_INCREMENTALNEWLINEDECODER_SETSTATE_METHODDEF  \
    {"setstate",                                          \
     (PyCFunction)_io_IncrementalNewlineDecoder_setstate, \
     METH_O,                                              \
     _io_IncrementalNewlineDecoder_setstate__doc__},

PyDoc_STRVAR(
    _io_IncrementalNewlineDecoder_reset__doc__,
    "reset($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_INCREMENTALNEWLINEDECODER_RESET_METHODDEF  \
    {"reset",                                          \
     (PyCFunction)_io_IncrementalNewlineDecoder_reset, \
     METH_NOARGS,                                      \
     _io_IncrementalNewlineDecoder_reset__doc__},
        ...
        .ob_base = PyVarObject_HEAD_INIT(&PyTuple_Type, NUM_KEYWORDS).ob_item =
            {
                ...
                &_Py_ID(errors),
                &_Py_ID(newline),
                &_Py_ID(line_buffering),
                &_Py_ID(write_through),
            },
    };
#undef NUM_KEYWORDS
#define KWTUPLE (&_kwtuple.ob_base.ob_base)
...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 1, 6, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
    ...
    if (fastargs[1]) {
        if (fastargs[1] == Py_None) {
            ...
            _PyArg_BadArgument(
                "TextIOWrapper", "argument 'encoding'", "str or None", fastargs[1]
            );
            goto exit;
        }
        if (!--noptargs) {
    ...
    if (fastargs[3]) {
        if (fastargs[3] == Py_None) {
            ...
            _PyArg_BadArgument(
                "TextIOWrapper", "argument 'newline'", "str or None", fastargs[3]
            );
            goto exit;
        }
        if (!--noptargs) {
...
skip_optional_pos:
    return_value = _io_TextIOWrapper___init___impl(
        (textio *)self, buffer, encoding, errors, newline, line_buffering, write_through
    );
...
#define _IO_TEXTIOWRAPPER_RECONFIGURE_METHODDEF        \
    {"reconfigure",                                    \
     _PyCFunction_CAST(_io_TextIOWrapper_reconfigure), \
     METH_FASTCALL | METH_KEYWORDS,                    \
     _io_TextIOWrapper_reconfigure__doc__},
...
_io_TextIOWrapper_reconfigure(
    textio *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "encoding", "errors", "newline", "line_buffering", "write_through", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "reconfigure",
...
skip_optional_kwonly:
    ...
    return_value = _io_TextIOWrapper_reconfigure_impl(
        self, encoding, errors, newline_obj, line_buffering_obj, write_through_obj
    );
...
PyDoc_STRVAR(
    _io_TextIOWrapper_detach__doc__,
    "detach($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_TEXTIOWRAPPER_DETACH_METHODDEF  \
    {"detach",                              \
     (PyCFunction)_io_TextIOWrapper_detach, \
     METH_NOARGS,                           \
     _io_TextIOWrapper_detach__doc__},
...
#define _IO_TEXTIOWRAPPER_WRITE_METHODDEF  \
    {"write",                              \
     (PyCFunction)_io_TextIOWrapper_write, \
     METH_O,                               \
     _io_TextIOWrapper_write__doc__},
...
#define _IO_TEXTIOWRAPPER_READ_METHODDEF        \
    {"read",                                    \
     _PyCFunction_CAST(_io_TextIOWrapper_read), \
     METH_FASTCALL,                             \
     _io_TextIOWrapper_read__doc__},
...
#define _IO_TEXTIOWRAPPER_READLINE_METHODDEF        \
    {"readline",                                    \
     _PyCFunction_CAST(_io_TextIOWrapper_readline), \
     METH_FASTCALL,                                 \
     _io_TextIOWrapper_readline__doc__},
...
#define _IO_TEXTIOWRAPPER_SEEK_METHODDEF        \
    {"seek",                                    \
     _PyCFunction_CAST(_io_TextIOWrapper_seek), \
     METH_FASTCALL,                             \
     _io_TextIOWrapper_seek__doc__},
...
PyDoc_STRVAR(
    _io_TextIOWrapper_truncate__doc__,
...
#define _IO_TEXTIOWRAPPER_TRUNCATE_METHODDEF        \
    {"truncate",                                    \
     _PyCFunction_CAST(_io_TextIOWrapper_truncate), \
     METH_FASTCALL,                                 \
     _io_TextIOWrapper_truncate__doc__},
...
PyDoc_STRVAR(
    _io_TextIOWrapper_fileno__doc__,
    "fileno($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_TEXTIOWRAPPER_FILENO_METHODDEF  \
    {"fileno",                              \
     (PyCFunction)_io_TextIOWrapper_fileno, \
     METH_NOARGS,                           \
     _io_TextIOWrapper_fileno__doc__},
...
PyDoc_STRVAR(
    _io_TextIOWrapper_seekable__doc__,
    "seekable($self, /)\n"
    "--\n"
    "\n"
);
...
PyDoc_STRVAR(
    _io_TextIOWrapper_readable__doc__,
    "readable($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_TEXTIOWRAPPER_READABLE_METHODDEF  \
    {"readable",                              \
     (PyCFunction)_io_TextIOWrapper_readable, \
     METH_NOARGS,                             \
     _io_TextIOWrapper_readable__doc__},
...
PyDoc_STRVAR(
    _io_TextIOWrapper_writable__doc__,
    "writable($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_TEXTIOWRAPPER_WRITABLE_METHODDEF  \
    {"writable",                              \
     (PyCFunction)_io_TextIOWrapper_writable, \
     METH_NOARGS,                             \
     _io_TextIOWrapper_writable__doc__},
...
PyDoc_STRVAR(
    _io_TextIOWrapper_isatty__doc__,
    "isatty($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_TEXTIOWRAPPER_ISATTY_METHODDEF  \
    {"isatty",                              \
     (PyCFunction)_io_TextIOWrapper_isatty, \
     METH_NOARGS,                           \
     _io_TextIOWrapper_isatty__doc__},
...
PyDoc_STRVAR(
    _io_TextIOWrapper_flush__doc__,
    "flush($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_TEXTIOWRAPPER_FLUSH_METHODDEF  \
    {"flush",                              \
     (PyCFunction)_io_TextIOWrapper_flush, \
     METH_NOARGS,                          \
     _io_TextIOWrapper_flush__doc__},
...
PyDoc_STRVAR(
    _io_TextIOWrapper_close__doc__,
    "close($self, /)\n"
    "--\n"
    "\n"
);
...
#define _IO_TEXTIOWRAPPER_CLOSE_METHODDEF  \
    {"close",                              \
     (PyCFunction)_io_TextIOWrapper_close, \
     METH_NOARGS,                          \
     _io_TextIOWrapper_close__doc__},
...
#define _IO_TEXTIOWRAPPER_NAME_GETSETDEF \
    {"name",                             \
     (getter)_io_TextIOWrapper_name_get, \
     (setter)_io_TextIOWrapper_name_set, \
     _io_TextIOWrapper_name_DOCSTR},
#else
#define _IO_TEXTIOWRAPPER_NAME_GETSETDEF \
    {"name", (getter)_io_TextIOWrapper_name_get, NULL, _io_TextIOWrapper_name_DOCSTR},
#endif
...
#define _IO_TEXTIOWRAPPER_CLOSED_GETSETDEF \
    {"closed",                             \
     (getter)_io_TextIOWrapper_closed_get, \
     (setter)_io_TextIOWrapper_closed_set, \
...
#define _IO_TEXTIOWRAPPER_NEWLINES_GETSETDEF \
    {"newlines",                             \
     (getter)_io_TextIOWrapper_newlines_get, \
     (setter)_io_TextIOWrapper_newlines_set, \
     _io_TextIOWrapper_newlines_DOCSTR},
#else
#define _IO_TEXTIOWRAPPER_NEWLINES_GETSETDEF \
    {"newlines",                             \
     (getter)_io_TextIOWrapper_newlines_get, \
...
#define _IO_TEXTIOWRAPPER_ERRORS_GETSETDEF \
    {"errors",                             \
     (getter)_io_TextIOWrapper_errors_get, \
     (setter)_io_TextIOWrapper_errors_set, \
...
#define _IO_TEXTIOWRAPPER__CHUNK_SIZE_GETSETDEF \
    {"_CHUNK_SIZE",                             \
     (getter)_io_TextIOWrapper__CHUNK_SIZE_get, \
     (setter)_io_TextIOWrapper__CHUNK_SIZE_set, \
     _io_TextIOWrapper__CHUNK_SIZE_DOCSTR},
#else
#define _IO_TEXTIOWRAPPER__CHUNK_SIZE_GETSETDEF \
    {"_CHUNK_SIZE",                             \
     (getter)_io_TextIOWrapper__CHUNK_SIZE_get, \
...
#else
#define _IO_TEXTIOWRAPPER__CHUNK_SIZE_GETSETDEF \
    {"_CHUNK_SIZE", NULL, (setter)_io_TextIOWrapper__CHUNK_SIZE_set, NULL},
#endif
...
_io_TextIOWrapper__CHUNK_SIZE_set(
    textio *self, PyObject *value, void *Py_UNUSED(context)
) {
    int return_value;
