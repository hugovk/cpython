...
#define _IO__WINDOWSCONSOLEIO_CLOSE_METHODDEF        \
    {"close",                                        \
     _PyCFunction_CAST(_io__WindowsConsoleIO_close), \
...
#undef KWTUPLE
    ...
    if (fastargs[1]) {
        if (!PyUnicode_Check(fastargs[1])) {
            _PyArg_BadArgument(
                "_WindowsConsoleIO", "argument 'mode'", "str", fastargs[1]
            );
            goto exit;
        }
    ...
    opener = fastargs[3];
skip_optional_pos:
    return_value = _io__WindowsConsoleIO___init___impl(
        (winconsoleio *)self, nameobj, mode, closefd, opener
    );
...
#define _IO__WINDOWSCONSOLEIO_FILENO_METHODDEF  \
    {"fileno",                                  \
     (PyCFunction)_io__WindowsConsoleIO_fileno, \
     METH_NOARGS,                               \
     _io__WindowsConsoleIO_fileno__doc__},
...
#define _IO__WINDOWSCONSOLEIO_READABLE_METHODDEF  \
    {"readable",                                  \
     (PyCFunction)_io__WindowsConsoleIO_readable, \
     METH_NOARGS,                                 \
     _io__WindowsConsoleIO_readable__doc__},
...
#define _IO__WINDOWSCONSOLEIO_WRITABLE_METHODDEF  \
    {"writable",                                  \
     (PyCFunction)_io__WindowsConsoleIO_writable, \
     METH_NOARGS,                                 \
     _io__WindowsConsoleIO_writable__doc__},
...
#define _IO__WINDOWSCONSOLEIO_READINTO_METHODDEF        \
    {"readinto",                                        \
     _PyCFunction_CAST(_io__WindowsConsoleIO_readinto), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,       \
     _io__WindowsConsoleIO_readinto__doc__},
...
static PyObject *
_io__WindowsConsoleIO_readinto(
    winconsoleio *self,
    PyTypeObject *cls,
    PyObject *const *args,
    Py_ssize_t nargs,
...
PyDoc_STRVAR(
    _io__WindowsConsoleIO_readall__doc__,
    "readall($self, /)\n"
    "--\n"
    "\n"
...
#define _IO__WINDOWSCONSOLEIO_READALL_METHODDEF  \
    {"readall",                                  \
     (PyCFunction)_io__WindowsConsoleIO_readall, \
     METH_NOARGS,                                \
     _io__WindowsConsoleIO_readall__doc__},
...
#define _IO__WINDOWSCONSOLEIO_READ_METHODDEF        \
    {"read",                                        \
     _PyCFunction_CAST(_io__WindowsConsoleIO_read), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,   \
     _io__WindowsConsoleIO_read__doc__},
...
#define _IO__WINDOWSCONSOLEIO_WRITE_METHODDEF        \
    {"write",                                        \
     _PyCFunction_CAST(_io__WindowsConsoleIO_write), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,    \
     _io__WindowsConsoleIO_write__doc__},
...
PyDoc_STRVAR(
    _io__WindowsConsoleIO_isatty__doc__,
    "isatty($self, /)\n"
    "--\n"
    "\n"
    "Always True."
