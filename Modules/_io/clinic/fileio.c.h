...
#define _IO_FILEIO_CLOSE_METHODDEF                \
    {"close",                                     \
     _PyCFunction_CAST(_io_FileIO_close),         \
...
skip_optional_pos:
    return_value =
        _io_FileIO___init___impl((fileio *)self, nameobj, mode, closefd, opener);
...
#define _IO_FILEIO_READABLE_METHODDEF  \
    {"readable",                       \
     (PyCFunction)_io_FileIO_readable, \
     METH_NOARGS,                      \
     _io_FileIO_readable__doc__},
...
#define _IO_FILEIO_WRITABLE_METHODDEF  \
    {"writable",                       \
     (PyCFunction)_io_FileIO_writable, \
     METH_NOARGS,                      \
     _io_FileIO_writable__doc__},
...
#define _IO_FILEIO_SEEKABLE_METHODDEF  \
    {"seekable",                       \
     (PyCFunction)_io_FileIO_seekable, \
     METH_NOARGS,                      \
     _io_FileIO_seekable__doc__},
...
#define _IO_FILEIO_READINTO_METHODDEF             \
    {"readinto",                                  \
     _PyCFunction_CAST(_io_FileIO_readinto),      \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io_FileIO_readinto__doc__},
...
#undef KWTUPLE
    ...
    if (PyObject_GetBuffer(args[0], &buffer, PyBUF_WRITABLE) < 0) {
        _PyArg_BadArgument(
            "readinto", "argument 1", "read-write bytes-like object", args[0]
        );
        goto exit;
    }
...
#define _IO_FILEIO_READALL_METHODDEF  \
    {"readall",                       \
     (PyCFunction)_io_FileIO_readall, \
     METH_NOARGS,                     \
     _io_FileIO_readall__doc__},
...
#define _IO_FILEIO_READ_METHODDEF                 \
    {"read",                                      \
     _PyCFunction_CAST(_io_FileIO_read),          \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io_FileIO_read__doc__},
...
#define _IO_FILEIO_WRITE_METHODDEF                \
    {"write",                                     \
     _PyCFunction_CAST(_io_FileIO_write),         \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io_FileIO_write__doc__},
...
#define _IO_FILEIO_TRUNCATE_METHODDEF             \
    {"truncate",                                  \
     _PyCFunction_CAST(_io_FileIO_truncate),      \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _io_FileIO_truncate__doc__},
