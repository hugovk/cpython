...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 1, 8, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
...
skip_optional_kwonly:
    return_value = pysqlite_connection_init_impl(
        (pysqlite_Connection *)self,
        database,
        timeout,
        detect_types,
...
PyDoc_STRVAR(
    pysqlite_connection_cursor__doc__,
...
#define PYSQLITE_CONNECTION_CURSOR_METHODDEF        \
    {"cursor",                                      \
     _PyCFunction_CAST(pysqlite_connection_cursor), \
...
#define PYSQLITE_CONNECTION_CLOSE_METHODDEF  \
    {"close",                                \
     (PyCFunction)pysqlite_connection_close, \
     METH_NOARGS,                            \
     pysqlite_connection_close__doc__},
...
PyDoc_STRVAR(
    pysqlite_connection_commit__doc__,
    "commit($self, /)\n"
    "--\n"
    "\n"
...
#define PYSQLITE_CONNECTION_COMMIT_METHODDEF  \
    {"commit",                                \
     (PyCFunction)pysqlite_connection_commit, \
     METH_NOARGS,                             \
     pysqlite_connection_commit__doc__},
...
PyDoc_STRVAR(
    pysqlite_connection_rollback__doc__,
    "rollback($self, /)\n"
    "--\n"
    "\n"
...
#define PYSQLITE_CONNECTION_ROLLBACK_METHODDEF  \
    {"rollback",                                \
     (PyCFunction)pysqlite_connection_rollback, \
     METH_NOARGS,                               \
     pysqlite_connection_rollback__doc__},
...
skip_optional_kwonly:
    return_value = pysqlite_connection_create_function_impl(
        self, cls, name, narg, func, deterministic
    );
...
#define CREATE_WINDOW_FUNCTION_METHODDEF          \
    {"create_window_function",                    \
     _PyCFunction_CAST(create_window_function),   \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     create_window_function__doc__},
...
#undef KWTUPLE
    ...
    return_value =
        create_window_function_impl(self, cls, name, num_params, aggregate_class);
...
#define PYSQLITE_CONNECTION_CREATE_AGGREGATE_METHODDEF        \
    {"create_aggregate",                                      \
     _PyCFunction_CAST(pysqlite_connection_create_aggregate), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,             \
     pysqlite_connection_create_aggregate__doc__},
...
#undef KWTUPLE
    ...
    aggregate_class = args[2];
    return_value = pysqlite_connection_create_aggregate_impl(
        self, cls, name, n_arg, aggregate_class
    );
...
PyDoc_STRVAR(
    pysqlite_connection_set_authorizer__doc__,
...
#define PYSQLITE_CONNECTION_SET_AUTHORIZER_METHODDEF        \
    {"set_authorizer",                                      \
     _PyCFunction_CAST(pysqlite_connection_set_authorizer), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,           \
     pysqlite_connection_set_authorizer__doc__},
...
#ifdef _MSC_VER
#pragma message(                                                             \
    "Update the clinic input of '_sqlite3.Connection.set_progress_handler'." \
)
#else
...
#undef KWTUPLE
    ...
    return_value =
        pysqlite_connection_set_progress_handler_impl(self, cls, callable, n);
...
#define PYSQLITE_CONNECTION_SET_TRACE_CALLBACK_METHODDEF        \
    {"set_trace_callback",                                      \
     _PyCFunction_CAST(pysqlite_connection_set_trace_callback), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,               \
     pysqlite_connection_set_trace_callback__doc__},
...
PyDoc_STRVAR(
    pysqlite_connection_enable_load_extension__doc__,
...
#define PYSQLITE_CONNECTION_LOAD_EXTENSION_METHODDEF        \
    {"load_extension",                                      \
     _PyCFunction_CAST(pysqlite_connection_load_extension), \
     METH_FASTCALL | METH_KEYWORDS,                         \
     pysqlite_connection_load_extension__doc__},
...
static PyObject *
pysqlite_connection_load_extension(
    pysqlite_Connection *self,
    PyObject *const *args,
    Py_ssize_t nargs,
    PyObject *kwnames
...
#undef KWTUPLE
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument(
            "load_extension", "argument 'entrypoint'", "str or None", args[1]
        );
        goto exit;
    }
skip_optional_kwonly:
    return_value =
        pysqlite_connection_load_extension_impl(self, extension_name, entrypoint);
...
PyDoc_STRVAR(
    pysqlite_connection_execute__doc__,
...
#define PYSQLITE_CONNECTION_EXECUTE_METHODDEF        \
    {"execute",                                      \
     _PyCFunction_CAST(pysqlite_connection_execute), \
     METH_FASTCALL,                                  \
     pysqlite_connection_execute__doc__},
...
pysqlite_connection_execute(
    pysqlite_Connection *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    PyObject *sql;
...
PyDoc_STRVAR(
    pysqlite_connection_executemany__doc__,
...
#define PYSQLITE_CONNECTION_EXECUTEMANY_METHODDEF        \
    {"executemany",                                      \
     _PyCFunction_CAST(pysqlite_connection_executemany), \
     METH_FASTCALL,                                      \
     pysqlite_connection_executemany__doc__},
...
#define PYSQLITE_CONNECTION_EXECUTESCRIPT_METHODDEF  \
    {"executescript",                                \
     (PyCFunction)pysqlite_connection_executescript, \
     METH_O,                                         \
     pysqlite_connection_executescript__doc__},

PyDoc_STRVAR(
    pysqlite_connection_interrupt__doc__,
    "interrupt($self, /)\n"
    "--\n"
    "\n"
...
#define PYSQLITE_CONNECTION_INTERRUPT_METHODDEF  \
    {"interrupt",                                \
     (PyCFunction)pysqlite_connection_interrupt, \
     METH_NOARGS,                                \
     pysqlite_connection_interrupt__doc__},
...
PyDoc_STRVAR(
    pysqlite_connection_iterdump__doc__,
...
#define PYSQLITE_CONNECTION_ITERDUMP_METHODDEF        \
    {"iterdump",                                      \
     _PyCFunction_CAST(pysqlite_connection_iterdump), \
     METH_FASTCALL | METH_KEYWORDS,                   \
     pysqlite_connection_iterdump__doc__},
...
#define PYSQLITE_CONNECTION_BACKUP_METHODDEF        \
    {"backup",                                      \
     _PyCFunction_CAST(pysqlite_connection_backup), \
     METH_FASTCALL | METH_KEYWORDS,                 \
     pysqlite_connection_backup__doc__},
...
#undef KWTUPLE
    ...
    if (!PyObject_TypeCheck(args[0], clinic_state()->ConnectionType)) {
        _PyArg_BadArgument(
            "backup",
            "argument 'target'",
            (clinic_state()->ConnectionType)->tp_name,
            args[0]
        );
        goto exit;
    }
...
skip_optional_kwonly:
    return_value =
        pysqlite_connection_backup_impl(self, target, pages, progress, name, sleep);
...
PyDoc_STRVAR(
    pysqlite_connection_create_collation__doc__,
...
#define PYSQLITE_CONNECTION_CREATE_COLLATION_METHODDEF        \
    {"create_collation",                                      \
     _PyCFunction_CAST(pysqlite_connection_create_collation), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,             \
     pysqlite_connection_create_collation__doc__},
...
PyDoc_STRVAR(
    pysqlite_connection_enter__doc__,
    "__enter__($self, /)\n"
    "--\n"
    "\n"
...
#define PYSQLITE_CONNECTION_ENTER_METHODDEF  \
    {"__enter__",                            \
     (PyCFunction)pysqlite_connection_enter, \
     METH_NOARGS,                            \
     pysqlite_connection_enter__doc__},
...
#define PYSQLITE_CONNECTION_EXIT_METHODDEF        \
    {"__exit__",                                  \
     _PyCFunction_CAST(pysqlite_connection_exit), \
     METH_FASTCALL,                               \
     pysqlite_connection_exit__doc__},
...
#define GETLIMIT_METHODDEF {"getlimit", (PyCFunction)getlimit, METH_O, getlimit__doc__},
