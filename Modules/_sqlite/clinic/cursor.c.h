...
pysqlite_cursor_init(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyObject_TypeCheck(
            PyTuple_GET_ITEM(args, 0), clinic_state()->ConnectionType
        )) {
        _PyArg_BadArgument(
            "Cursor",
            "argument 1",
...
#define PYSQLITE_CURSOR_EXECUTE_METHODDEF        \
    {"execute",                                  \
     _PyCFunction_CAST(pysqlite_cursor_execute), \
     METH_FASTCALL,                              \
     pysqlite_cursor_execute__doc__},

static PyObject *
pysqlite_cursor_execute_impl(
    pysqlite_Cursor *self, PyObject *sql, PyObject *parameters
);

static PyObject *
pysqlite_cursor_execute(
    pysqlite_Cursor *self, PyObject *const *args, Py_ssize_t nargs
) {
...
#define PYSQLITE_CURSOR_EXECUTEMANY_METHODDEF        \
    {"executemany",                                  \
     _PyCFunction_CAST(pysqlite_cursor_executemany), \
     METH_FASTCALL,                                  \
     pysqlite_cursor_executemany__doc__},
...
PyDoc_STRVAR(
    pysqlite_cursor_executescript__doc__,
...
#define PYSQLITE_CURSOR_EXECUTESCRIPT_METHODDEF  \
    {"executescript",                            \
     (PyCFunction)pysqlite_cursor_executescript, \
     METH_O,                                     \
     pysqlite_cursor_executescript__doc__},
...
PyDoc_STRVAR(
    pysqlite_cursor_fetchone__doc__,
    "fetchone($self, /)\n"
    "--\n"
    "\n"
...
#define PYSQLITE_CURSOR_FETCHONE_METHODDEF  \
    {"fetchone",                            \
     (PyCFunction)pysqlite_cursor_fetchone, \
     METH_NOARGS,                           \
     pysqlite_cursor_fetchone__doc__},
...
#define PYSQLITE_CURSOR_FETCHMANY_METHODDEF        \
    {"fetchmany",                                  \
     _PyCFunction_CAST(pysqlite_cursor_fetchmany), \
...
pysqlite_cursor_fetchmany(
    pysqlite_Cursor *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define PYSQLITE_CURSOR_FETCHALL_METHODDEF  \
    {"fetchall",                            \
     (PyCFunction)pysqlite_cursor_fetchall, \
     METH_NOARGS,                           \
     pysqlite_cursor_fetchall__doc__},
...
PyDoc_STRVAR(
    pysqlite_cursor_setinputsizes__doc__,
...
#define PYSQLITE_CURSOR_SETINPUTSIZES_METHODDEF  \
    {"setinputsizes",                            \
     (PyCFunction)pysqlite_cursor_setinputsizes, \
     METH_O,                                     \
     pysqlite_cursor_setinputsizes__doc__},
...
#define PYSQLITE_CURSOR_SETOUTPUTSIZE_METHODDEF        \
    {"setoutputsize",                                  \
     _PyCFunction_CAST(pysqlite_cursor_setoutputsize), \
     METH_FASTCALL,                                    \
     pysqlite_cursor_setoutputsize__doc__},
...
#define PYSQLITE_CURSOR_CLOSE_METHODDEF  \
    {"close",                            \
     (PyCFunction)pysqlite_cursor_close, \
     METH_NOARGS,                        \
     pysqlite_cursor_close__doc__},
