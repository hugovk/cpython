...
PyDoc_STRVAR(
    _testlimitedcapi_test_long_api__doc__,
...
PyDoc_STRVAR(
    _testlimitedcapi_test_longlong_api__doc__,
...
#define _TESTLIMITEDCAPI_TEST_LONGLONG_API_METHODDEF  \
    {"test_longlong_api",                             \
     (PyCFunction)_testlimitedcapi_test_longlong_api, \
     METH_NOARGS,                                     \
     _testlimitedcapi_test_longlong_api__doc__},
...
PyDoc_STRVAR(
    _testlimitedcapi_test_long_and_overflow__doc__,
...
#define _TESTLIMITEDCAPI_TEST_LONG_AND_OVERFLOW_METHODDEF  \
    {"test_long_and_overflow",                             \
     (PyCFunction)_testlimitedcapi_test_long_and_overflow, \
     METH_NOARGS,                                          \
     _testlimitedcapi_test_long_and_overflow__doc__},
...
static PyObject *
_testlimitedcapi_test_long_and_overflow(
...
PyDoc_STRVAR(
    _testlimitedcapi_test_long_long_and_overflow__doc__,
...
#define _TESTLIMITEDCAPI_TEST_LONG_LONG_AND_OVERFLOW_METHODDEF  \
    {"test_long_long_and_overflow",                             \
     (PyCFunction)_testlimitedcapi_test_long_long_and_overflow, \
     METH_NOARGS,                                               \
     _testlimitedcapi_test_long_long_and_overflow__doc__},
...
static PyObject *
_testlimitedcapi_test_long_long_and_overflow(
    PyObject *module, PyObject *Py_UNUSED(ignored)
) {
...
PyDoc_STRVAR(
    _testlimitedcapi_test_long_as_size_t__doc__,
...
#define _TESTLIMITEDCAPI_TEST_LONG_AS_SIZE_T_METHODDEF  \
    {"test_long_as_size_t",                             \
     (PyCFunction)_testlimitedcapi_test_long_as_size_t, \
     METH_NOARGS,                                       \
     _testlimitedcapi_test_long_as_size_t__doc__},
...
PyDoc_STRVAR(
    _testlimitedcapi_test_long_as_unsigned_long_long_mask__doc__,
...
#define _TESTLIMITEDCAPI_TEST_LONG_AS_UNSIGNED_LONG_LONG_MASK_METHODDEF  \
    {"test_long_as_unsigned_long_long_mask",                             \
     (PyCFunction)_testlimitedcapi_test_long_as_unsigned_long_long_mask, \
     METH_NOARGS,                                                        \
     _testlimitedcapi_test_long_as_unsigned_long_long_mask__doc__},
...
static PyObject *
_testlimitedcapi_test_long_as_unsigned_long_long_mask(
    PyObject *module, PyObject *Py_UNUSED(ignored)
) {
...
PyDoc_STRVAR(
    _testlimitedcapi_test_long_as_double__doc__,
...
#define _TESTLIMITEDCAPI_TEST_LONG_AS_DOUBLE_METHODDEF  \
    {"test_long_as_double",                             \
     (PyCFunction)_testlimitedcapi_test_long_as_double, \
     METH_NOARGS,                                       \
     _testlimitedcapi_test_long_as_double__doc__},
...
#define _TESTLIMITEDCAPI_PYLONG_ASINT_METHODDEF  \
    {"PyLong_AsInt",                             \
     (PyCFunction)_testlimitedcapi_PyLong_AsInt, \
     METH_O,                                     \
     _testlimitedcapi_PyLong_AsInt__doc__},
