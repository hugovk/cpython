...
#define _POSIXSHMEM_SHM_OPEN_METHODDEF                  \
    {"shm_open",                                        \
     (PyCFunction)(void (*)(void))_posixshmem_shm_open, \
...
_posixshmem_shm_open(PyObject *module, PyObject *args, PyObject *kwargs) {
    ...
    if (!PyArg_ParseTupleAndKeywords(
            args, kwargs, "Ui|i:shm_open", _keywords, &path, &flags, &mode
        ))
        goto exit;
...
#define _POSIXSHMEM_SHM_UNLINK_METHODDEF  \
    {"shm_unlink",                        \
     (PyCFunction)_posixshmem_shm_unlink, \
     METH_O,                              \
     _posixshmem_shm_unlink__doc__},
