...
#define _MULTIPROCESSING_SEMLOCK_ACQUIRE_METHODDEF        \
    {"acquire",                                           \
     _PyCFunction_CAST(_multiprocessing_SemLock_acquire), \
...
static PyObject *
_multiprocessing_SemLock_acquire(
    SemLockObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
...
#define _MULTIPROCESSING_SEMLOCK_RELEASE_METHODDEF  \
    {"release",                                     \
     (PyCFunction)_multiprocessing_SemLock_release, \
     METH_NOARGS,                                   \
     _multiprocessing_SemLock_release__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "kind", "value", "maxvalue", "name", "unlink", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "SemLock",
...
#undef KWTUPLE
    ...
    fastargs = _PyArg_UnpackKeywords(
        _PyTuple_CAST(args)->ob_item, nargs, kwargs, NULL, &_parser, 5, 5, 0, argsbuf
    );
    if (!fastargs) {
        goto exit;
    }
    ...
    return_value =
        _multiprocessing_SemLock_impl(type, kind, value, maxvalue, name, unlink);
...
PyDoc_STRVAR(
    _multiprocessing_SemLock__rebuild__doc__,
...
#define _MULTIPROCESSING_SEMLOCK__REBUILD_METHODDEF        \
    {"_rebuild",                                           \
     _PyCFunction_CAST(_multiprocessing_SemLock__rebuild), \
...
static PyObject *
_multiprocessing_SemLock__rebuild(
    PyTypeObject *type, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
    SEM_HANDLE handle;
    int kind;
    ...
    return_value =
        _multiprocessing_SemLock__rebuild_impl(type, handle, kind, maxvalue, name);
...
#define _MULTIPROCESSING_SEMLOCK__COUNT_METHODDEF  \
    {"_count",                                     \
     (PyCFunction)_multiprocessing_SemLock__count, \
     METH_NOARGS,                                  \
     _multiprocessing_SemLock__count__doc__},
...
#define _MULTIPROCESSING_SEMLOCK__IS_MINE_METHODDEF  \
    {"_is_mine",                                     \
     (PyCFunction)_multiprocessing_SemLock__is_mine, \
     METH_NOARGS,                                    \
     _multiprocessing_SemLock__is_mine__doc__},
...
#define _MULTIPROCESSING_SEMLOCK__GET_VALUE_METHODDEF  \
    {"_get_value",                                     \
     (PyCFunction)_multiprocessing_SemLock__get_value, \
     METH_NOARGS,                                      \
     _multiprocessing_SemLock__get_value__doc__},
...
#define _MULTIPROCESSING_SEMLOCK__IS_ZERO_METHODDEF  \
    {"_is_zero",                                     \
     (PyCFunction)_multiprocessing_SemLock__is_zero, \
     METH_NOARGS,                                    \
     _multiprocessing_SemLock__is_zero__doc__},
...
#define _MULTIPROCESSING_SEMLOCK__AFTER_FORK_METHODDEF  \
    {"_after_fork",                                     \
     (PyCFunction)_multiprocessing_SemLock__after_fork, \
     METH_NOARGS,                                       \
     _multiprocessing_SemLock__after_fork__doc__},
...
static PyObject *
_multiprocessing_SemLock__after_fork(
    SemLockObject *self, PyObject *Py_UNUSED(ignored)
) {
...
#define _MULTIPROCESSING_SEMLOCK___ENTER___METHODDEF  \
    {"__enter__",                                     \
     (PyCFunction)_multiprocessing_SemLock___enter__, \
     METH_NOARGS,                                     \
     _multiprocessing_SemLock___enter____doc__},
...
#define _MULTIPROCESSING_SEMLOCK___EXIT___METHODDEF        \
    {"__exit__",                                           \
     _PyCFunction_CAST(_multiprocessing_SemLock___exit__), \
     METH_FASTCALL,                                        \
     _multiprocessing_SemLock___exit____doc__},
...
static PyObject *
_multiprocessing_SemLock___exit__(
    SemLockObject *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
...
skip_optional:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value =
        _multiprocessing_SemLock___exit___impl(self, exc_type, exc_value, exc_tb);
    Py_END_CRITICAL_SECTION();
