...
#define _SRE_ASCII_ISCASED_METHODDEF  \
    {"ascii_iscased",                 \
     (PyCFunction)_sre_ascii_iscased, \
     METH_O,                          \
     _sre_ascii_iscased__doc__},
...
#define _SRE_UNICODE_ISCASED_METHODDEF  \
    {"unicode_iscased",                 \
     (PyCFunction)_sre_unicode_iscased, \
     METH_O,                            \
     _sre_unicode_iscased__doc__},
...
#define _SRE_ASCII_TOLOWER_METHODDEF  \
    {"ascii_tolower",                 \
     (PyCFunction)_sre_ascii_tolower, \
     METH_O,                          \
     _sre_ascii_tolower__doc__},
...
#define _SRE_UNICODE_TOLOWER_METHODDEF  \
    {"unicode_tolower",                 \
     (PyCFunction)_sre_unicode_tolower, \
     METH_O,                            \
     _sre_unicode_tolower__doc__},
...
#define _SRE_SRE_PATTERN_MATCH_METHODDEF          \
    {"match",                                     \
     _PyCFunction_CAST(_sre_SRE_Pattern_match),   \
...
PyDoc_STRVAR(
    _sre_SRE_Pattern_fullmatch__doc__,
...
#define _SRE_SRE_PATTERN_FULLMATCH_METHODDEF        \
    {"fullmatch",                                   \
     _PyCFunction_CAST(_sre_SRE_Pattern_fullmatch), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,   \
     _sre_SRE_Pattern_fullmatch__doc__},
...
#define _SRE_SRE_PATTERN_SEARCH_METHODDEF         \
    {"search",                                    \
     _PyCFunction_CAST(_sre_SRE_Pattern_search),  \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _sre_SRE_Pattern_search__doc__},
...
#define _SRE_SRE_PATTERN_FINDALL_METHODDEF        \
    {"findall",                                   \
     _PyCFunction_CAST(_sre_SRE_Pattern_findall), \
...
_sre_SRE_Pattern_findall(
    PatternObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
PyDoc_STRVAR(
    _sre_SRE_Pattern_finditer__doc__,
...
#define _SRE_SRE_PATTERN_FINDITER_METHODDEF        \
    {"finditer",                                   \
     _PyCFunction_CAST(_sre_SRE_Pattern_finditer), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS,  \
     _sre_SRE_Pattern_finditer__doc__},
...
PyDoc_STRVAR(
    _sre_SRE_Pattern_scanner__doc__,
...
#define _SRE_SRE_PATTERN_SCANNER_METHODDEF        \
    {"scanner",                                   \
     _PyCFunction_CAST(_sre_SRE_Pattern_scanner), \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _sre_SRE_Pattern_scanner__doc__},
...
#define _SRE_SRE_PATTERN_SPLIT_METHODDEF        \
    {"split",                                   \
     _PyCFunction_CAST(_sre_SRE_Pattern_split), \
     METH_FASTCALL | METH_KEYWORDS,             \
     _sre_SRE_Pattern_split__doc__},
...
#define _SRE_SRE_PATTERN_SUB_METHODDEF            \
    {"sub",                                       \
     _PyCFunction_CAST(_sre_SRE_Pattern_sub),     \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _sre_SRE_Pattern_sub__doc__},
...
#define _SRE_SRE_PATTERN_SUBN_METHODDEF           \
    {"subn",                                      \
     _PyCFunction_CAST(_sre_SRE_Pattern_subn),    \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _sre_SRE_Pattern_subn__doc__},
...
PyDoc_STRVAR(
    _sre_SRE_Pattern___copy____doc__,
    "__copy__($self, /)\n"
    "--\n"
    "\n"
);
...
#define _SRE_SRE_PATTERN___COPY___METHODDEF  \
    {"__copy__",                             \
     (PyCFunction)_sre_SRE_Pattern___copy__, \
     METH_NOARGS,                            \
     _sre_SRE_Pattern___copy____doc__},
...
#define _SRE_SRE_PATTERN___DEEPCOPY___METHODDEF  \
    {"__deepcopy__",                             \
     (PyCFunction)_sre_SRE_Pattern___deepcopy__, \
     METH_O,                                     \
     _sre_SRE_Pattern___deepcopy____doc__},
...
#define _SRE_COMPILE_METHODDEF        \
    {"compile",                       \
     _PyCFunction_CAST(_sre_compile), \
     METH_FASTCALL | METH_KEYWORDS,   \
     _sre_compile__doc__},
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "pattern", "flags", "code", "groups", "groupindex", "indexgroup", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "compile",
...
#undef KWTUPLE
    ...
    args =
        _PyArg_UnpackKeywords(args, nargs, NULL, kwnames, &_parser, 6, 6, 0, argsbuf);
    if (!args) {
        goto exit;
    }
    pattern = args[0];
...
PyDoc_STRVAR(
    _sre_SRE_Match_expand__doc__,
    "expand($self, /, template)\n"
    "--\n"
    "\n"
    "Return the string obtained by doing backslash substitution on the string "
    "template, as done by the sub() method."
);

#define _SRE_SRE_MATCH_EXPAND_METHODDEF        \
    {"expand",                                 \
     _PyCFunction_CAST(_sre_SRE_Match_expand), \
     METH_FASTCALL | METH_KEYWORDS,            \
     _sre_SRE_Match_expand__doc__},
...
_sre_SRE_Match_expand(
    MatchObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames
) {
    PyObject *return_value = NULL;
#if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
...
#define _SRE_SRE_MATCH_GROUPS_METHODDEF        \
    {"groups",                                 \
     _PyCFunction_CAST(_sre_SRE_Match_groups), \
     METH_FASTCALL | METH_KEYWORDS,            \
     _sre_SRE_Match_groups__doc__},
...
#define _SRE_SRE_MATCH_GROUPDICT_METHODDEF        \
    {"groupdict",                                 \
     _PyCFunction_CAST(_sre_SRE_Match_groupdict), \
     METH_FASTCALL | METH_KEYWORDS,               \
     _sre_SRE_Match_groupdict__doc__},
...
#define _SRE_SRE_MATCH_START_METHODDEF        \
    {"start",                                 \
     _PyCFunction_CAST(_sre_SRE_Match_start), \
     METH_FASTCALL,                           \
     _sre_SRE_Match_start__doc__},
...
#define _SRE_SRE_MATCH_END_METHODDEF        \
    {"end",                                 \
     _PyCFunction_CAST(_sre_SRE_Match_end), \
     METH_FASTCALL,                         \
     _sre_SRE_Match_end__doc__},
...
#define _SRE_SRE_MATCH_SPAN_METHODDEF        \
    {"span",                                 \
     _PyCFunction_CAST(_sre_SRE_Match_span), \
     METH_FASTCALL,                          \
     _sre_SRE_Match_span__doc__},
...
PyDoc_STRVAR(
    _sre_SRE_Match___copy____doc__,
    "__copy__($self, /)\n"
    "--\n"
    "\n"
);
...
#define _SRE_SRE_MATCH___COPY___METHODDEF  \
    {"__copy__",                           \
     (PyCFunction)_sre_SRE_Match___copy__, \
     METH_NOARGS,                          \
     _sre_SRE_Match___copy____doc__},
...
#define _SRE_SRE_MATCH___DEEPCOPY___METHODDEF  \
    {"__deepcopy__",                           \
     (PyCFunction)_sre_SRE_Match___deepcopy__, \
     METH_O,                                   \
     _sre_SRE_Match___deepcopy____doc__},
...
#define _SRE_SRE_SCANNER_MATCH_METHODDEF          \
    {"match",                                     \
     _PyCFunction_CAST(_sre_SRE_Scanner_match),   \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _sre_SRE_Scanner_match__doc__},
...
PyDoc_STRVAR(
    _sre_SRE_Scanner_search__doc__,
    "search($self, /)\n"
    "--\n"
    "\n"
);
...
#define _SRE_SRE_SCANNER_SEARCH_METHODDEF         \
    {"search",                                    \
     _PyCFunction_CAST(_sre_SRE_Scanner_search),  \
     METH_METHOD | METH_FASTCALL | METH_KEYWORDS, \
     _sre_SRE_Scanner_search__doc__},
