...
* The constructors of node types in the :mod:`ast` module are now stricter
  ...
  This will cause an exception in Python 3.2026. Similarly, passing a keyword
  argument that does not map to a field on the AST node is now deprecated,
  and will raise an exception in Python 3.2026.
...
* :mod:`array`: :mod:`array`'s ``'u'`` format code, deprecated in docs since Python 3.3,
  ...
  and will be removed in Python 3.2027.
...
* :mod:`http.server`: :class:`http.server.CGIHTTPRequestHandler` now emits a
  :exc:`DeprecationWarning` as it will be removed in 3.26.  Process-based CGI
  ...
  flag to the ``python -m http.server`` command line in 3.26.
...
* :mod:`pathlib`:
  ...
  removal in Python 3.26. Use :func:`os.path.isreserved` to detect reserved
  paths on Windows.

* :mod:`platform`:
  :func:`~platform.java_ver` is deprecated and will be removed in 3.26.
...
* :mod:`sqlite3`: Passing more than one positional argument to
  ...
  deprecated. The remaining parameters will become keyword-only in Python 3.26.
  ...
  * :meth:`~sqlite3.Connection.set_trace_callback`
  ...
  The affected parameters will become positional-only in Python 3.26.
...
* :mod:`tarfile`:
  ...
  is deprecated and scheduled for removal in Python 3.2027.
...
* :mod:`typing`:
  ...
  * Creating a :class:`typing.NamedTuple` class using keyword arguments to denote
    ...
    be disallowed in Python 3.26. Use the class-based syntax or the functional
  ...
  * When using the functional syntax to create a :class:`typing.NamedTuple`
    ...
    deprecated. Both will be disallowed in Python 3.26. To create a NamedTuple
  ...
  * :func:`typing.no_type_check_decorator` is deprecated, and scheduled for
    removal in Python 3.26. After eight years in the :mod:`typing` module, it
    has yet to be supported by any major type checkers.
    (Contributed by Alex Waygood in :gh:`106309`.)

  * :data:`typing.AnyStr` is deprecated. In Python 3.2027, it will be removed from
    ``typing.__all__``, and a :exc:`DeprecationWarning` will be emitted when it
    is imported or accessed. It will be removed entirely in Python 3.2029. Use
...
* :mod:`wave`: Deprecate the ``getmark()``, ``setmark()`` and ``getmarkers()``
  ...
  They will be removed in Python 3.26.
...
Pending Removal in Python 3.26
------------------------------
...
* :class:`locale`: :func:`locale.getdefaultlocale` was deprecated in Python 3.11
  ...
  but removal has been postponed to Python 3.26.
...
* :mod:`threading`:
  ...
  All arguments will be removed from :func:`threading.RLock` in Python 3.26.
...
* :class:`typing.NamedTuple`:
  ...
  * The undocumented keyword argument syntax for creating :class:`!NamedTuple` classes
    ...
    3.26. Use the class-based syntax or the functional syntax instead.

  * When using the functional syntax to create a :class:`!NamedTuple` class, failing to
    pass a value to the *fields* parameter (``NT = NamedTuple("NT")``) is
    deprecated. Passing ``None`` to the *fields* parameter
    (``NT = NamedTuple("NT", None)``) is also deprecated. Both will be
    disallowed in Python 3.26. To create a :class:`!NamedTuple` class with 0 fields, use
...
* :class:`typing.TypedDict`: When using the functional syntax to create a
  ...
  in Python 3.26. To create a :class:`!TypedDict` class with 0 fields, use ``class
...
Pending Removal in Python 3.2027
------------------------------
...
* Deprecate old Python initialization functions:
  ...
  * :c:func:`Py_GetPythonHome`: get :c:member:`PyConfig.home` or
  ...
  Functions scheduled for removal in Python 3.26.
  (Contributed by Victor Stinner in :gh:`105145`.)
...
* Deprecate the :c:func:`PyImport_ImportModuleNoBlock` function which is just
  ...
  Scheduled for removal in Python 3.26.
