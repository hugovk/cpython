...
* :mod:`array`: :mod:`array`'s ``'u'`` format code, deprecated in docs since Python 3.3,
  ...
  and will be removed in Python 3.27.
...
* :mod:`tarfile`:
  ...
  is deprecated and scheduled for removal in Python 3.27.
...
* :mod:`typing`:
  ...
  * :data:`typing.AnyStr` is deprecated. In Python 3.27, it will be removed from
...
Pending Removal in Python 3.27
------------------------------
