...
AST nodes is deprecated and will become an error in Python 3.26. Omitting a
required argument to an AST node is deprecated and will become an error in
Python 3.26. Patch by Jelle Zijlstra.
...
:func:`platform.java_ver` is deprecated and will be removed in 3.26. It was
