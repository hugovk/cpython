...
in 3.2026.  Its design is old and the web world has long since moved beyond
CGI.
...
parameters will become keyword-only in Python 3.26. Patch by Erlend E.
Aasland.
...
TypedDict("TD", None)``. Both will be disallowed in Python 3.26. To create a
...
This will be disallowed in Python 3.26. Use the class-based syntax or the
...
3.26: ``NT = NamedTuple("NT")`` and ``NT = NamedTuple("NT", None)``. To
...
They will be removed in Python 3.26. Patch by Victor Stinner.
