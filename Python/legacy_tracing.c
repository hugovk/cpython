...
static PyObject *
sys_profile_start(
    _PyLegacyEventHandler *self, PyObject *const *args, size_t nargsf, PyObject *kwnames
) {
    assert(kwnames == NULL);
...
call_trace_func(_PyLegacyEventHandler *self, PyObject *arg) {
    ...
    if (frame == NULL) {
        PyErr_SetString(
            PyExc_SystemError, "Missing frame when calling trace function."
        );
        return NULL;
    }
...
static PyObject *
trace_line(
    PyThreadState *tstate, _PyLegacyEventHandler *self, PyFrameObject *frame, int line
) {
...
PyTypeObject _PyLegacyEventHandler_Type = {
    PyVarObject_HEAD_INIT(&PyType_Type, 0) "sys.legacy_event_handler",
...
static int
set_callbacks(
    int tool, vectorcallfunc vectorcall, int legacy_event, int event1, int event2
) {
...
static Py_ssize_t
setup_profile(
    PyThreadState *tstate, Py_tracefunc func, PyObject *arg, PyObject **old_profileobj
) {
    *old_profileobj = NULL;
    ...
    if (!tstate->interp->sys_profile_initialized) {
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_PROFILE_ID,
                (vectorcallfunc)sys_profile_start,
                PyTrace_CALL,
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_PROFILE_ID,
                (vectorcallfunc)sys_profile_throw,
                PyTrace_CALL,
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_PROFILE_ID,
                (vectorcallfunc)sys_profile_return,
                PyTrace_RETURN,
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_PROFILE_ID,
                (vectorcallfunc)sys_profile_unwind,
                PyTrace_RETURN,
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_PROFILE_ID,
                (vectorcallfunc)sys_profile_call_or_return,
                PyTrace_C_CALL,
...
static Py_ssize_t
setup_tracing(
    PyThreadState *tstate, Py_tracefunc func, PyObject *arg, PyObject **old_traceobj
) {
    *old_traceobj = NULL;
    /* Setup PEP 669 monitoring callbacks and events. */
    if (!tstate->interp->sys_trace_initialized) {
        ...
        if (set_callbacks(
                ...
                (vectorcallfunc)sys_trace_start,
                PyTrace_CALL,
                PY_MONITORING_EVENT_PY_START,
                PY_MONITORING_EVENT_PY_RESUME
            )) {
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_TRACE_ID,
                (vectorcallfunc)sys_trace_throw,
                PyTrace_CALL,
                PY_MONITORING_EVENT_PY_THROW,
                -1
            )) {
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_TRACE_ID,
                (vectorcallfunc)sys_trace_return,
                PyTrace_RETURN,
                PY_MONITORING_EVENT_PY_RETURN,
                -1
            )) {
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_TRACE_ID,
                (vectorcallfunc)sys_trace_yield,
                PyTrace_RETURN,
                PY_MONITORING_EVENT_PY_YIELD,
                -1
            )) {
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_TRACE_ID,
                (vectorcallfunc)sys_trace_exception_func,
                PyTrace_EXCEPTION,
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_TRACE_ID,
                (vectorcallfunc)sys_trace_line_func,
                PyTrace_LINE,
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_TRACE_ID,
                (vectorcallfunc)sys_trace_unwind,
                PyTrace_RETURN,
                PY_MONITORING_EVENT_PY_UNWIND,
                -1
            )) {
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_TRACE_ID,
                (vectorcallfunc)sys_trace_jump_func,
                PyTrace_LINE,
        ...
        if (set_callbacks(
                PY_MONITORING_SYS_TRACE_ID,
                (vectorcallfunc)sys_trace_instruction_func,
                PyTrace_OPCODE,
