...
pop_1_error:
    ...
    switch (opcode) {
        ...
        tier1 op(_MAYBE_INSTRUMENT, (--)) {
            if (tstate->tracing == 0) {
                uintptr_t global_version =
                    ...
                    ~_PY_EVAL_EVENTS_MASK;
                uintptr_t code_version = FT_ATOMIC_LOAD_UINTPTR_ACQUIRE(
        ...
        macro(RESUME) =
            _MAYBE_INSTRUMENT + _QUICKEN_RESUME + _CHECK_PERIODIC_IF_NOT_YIELD_FROM;
        ...
        op(_MONITOR_RESUME, (--)) {
            int err = _Py_call_instrumentation(tstate, oparg > 0, frame, this_instr);
            ERROR_IF(err, error);
        ...
        macro(INSTRUMENTED_RESUME) =
            _MAYBE_INSTRUMENT + _CHECK_PERIODIC_IF_NOT_YIELD_FROM + _MONITOR_RESUME;
        ...
        pure inst(POP_TOP, (value--)) { DECREF_INPUTS(); }

        pure inst(PUSH_NULL, (--res)) { res = PyStackRef_NULL; }
        ...
        tier1 inst(INSTRUMENTED_END_FOR, (receiver, value-- receiver)) {
            ...
            if (PyStackRef_GenCheck(receiver)) {
                int err = monitor_stop_iteration(
                    tstate, frame, this_instr, PyStackRef_AsPyObjectBorrow(value)
                );
                if (err) {
                    ERROR_NO_POP();
                }
        ...
        pure inst(UNARY_NOT, (value-- res)) {
            ...
            res = PyStackRef_Is(value, PyStackRef_False) ? PyStackRef_True
                                                         : PyStackRef_False;
            DEAD(value);
        }
        ...
        macro(TO_BOOL_ALWAYS_TRUE) =
            unused / 1 + _GUARD_TYPE_VERSION + _REPLACE_WITH_TRUE;
        ...
        pure op(_BINARY_OP_MULTIPLY_INT, (left, right-- res)) {
            ...
            PyObject *res_o =
                _PyLong_Multiply((PyLongObject *)left_o, (PyLongObject *)right_o);
        ...
        pure op(_BINARY_OP_ADD_INT, (left, right-- res)) {
            ...
            STAT_INC(BINARY_OP, hit);
            PyObject *res_o =
                _PyLong_Add((PyLongObject *)left_o, (PyLongObject *)right_o);
            PyStackRef_CLOSE_SPECIALIZED(right, (destructor)PyObject_Free);
            PyStackRef_CLOSE_SPECIALIZED(left, (destructor)PyObject_Free);
            INPUTS_DEAD();
            ERROR_IF(res_o == NULL, error);
        ...
        pure op(_BINARY_OP_SUBTRACT_INT, (left, right-- res)) {
            ...
            STAT_INC(BINARY_OP, hit);
            PyObject *res_o =
                _PyLong_Subtract((PyLongObject *)left_o, (PyLongObject *)right_o);
            PyStackRef_CLOSE_SPECIALIZED(right, (destructor)PyObject_Free);
            PyStackRef_CLOSE_SPECIALIZED(left, (destructor)PyObject_Free);
            INPUTS_DEAD();
            ERROR_IF(res_o == NULL, error);
        ...
        macro(BINARY_OP_ADD_INT) = _GUARD_BOTH_INT + unused / 1 + _BINARY_OP_ADD_INT;
        ...
        specializing op(
            _SPECIALIZE_BINARY_SUBSCR, (counter / 1, container, sub-- container, sub)
        ) {
        ...
        specializing op(
            _SPECIALIZE_BINARY_SLICE, (container, start, stop-- container, start, stop)
        ) {
// Placeholder until we implement BINARY_SLICE specialization
        ...
        op(_BINARY_SLICE, (container, start, stop-- res)) {
            PyObject *slice = _PyBuildSlice_ConsumeRefs(
                PyStackRef_AsPyObjectSteal(start), PyStackRef_AsPyObjectSteal(stop)
            );
            PyObject *res_o;
        ...
        specializing op(
            ...
            (v, container, start, stop-- v, container, start, stop)
        ) {
// Placeholder until we implement STORE_SLICE specialization
        ...
        op(_STORE_SLICE, (v, container, start, stop--)) {
            ...
            if (slice == NULL) {
                ...
                err = PyObject_SetItem(
                    PyStackRef_AsPyObjectBorrow(container),
                    slice,
        ...
        op(_BINARY_SUBSCR_INIT_CALL,
           (container, sub-- new_frame : _PyInterpreterFrame *)) {
            PyTypeObject *tp = Py_TYPE(PyStackRef_AsPyObjectBorrow(container));
            PyHeapTypeObject *ht = (PyHeapTypeObject *)tp;
            PyObject *getitem = ht->_spec_cache.getitem;
            new_frame = _PyFrame_PushUnchecked(
                tstate, PyStackRef_FromPyObjectNew(getitem), 2, frame
            );
        ...
        macro(BINARY_SUBSCR_GETITEM) = unused / 1 +  // Skip over the counter
                                       _CHECK_PEP_523 + _BINARY_SUBSCR_CHECK_FUNC +
                                       _BINARY_SUBSCR_INIT_CALL + _PUSH_FRAME;

        inst(LIST_APPEND, (list, unused[oparg - 1], v-- list, unused[oparg - 1])) {
            int err = _PyList_AppendTakeRef(
        ...
        inst(SET_ADD, (set, unused[oparg - 1], v-- set, unused[oparg - 1])) {
            int err = PySet_Add(
                PyStackRef_AsPyObjectBorrow(set), PyStackRef_AsPyObjectBorrow(v)
            );
            DECREF_INPUTS();
            ERROR_IF(err, error);
        }
        ...
        specializing op(
            _SPECIALIZE_STORE_SUBSCR, (counter / 1, container, sub-- container, sub)
        ) {
#if ENABLE_SPECIALIZATION
            if (ADAPTIVE_COUNTER_TRIGGERS(counter)) {
                next_instr = this_instr;
        ...
        inst(DELETE_SUBSCR, (container, sub--)) {
            /* del container[sub] */
            int err = PyObject_DelItem(
                PyStackRef_AsPyObjectBorrow(container), PyStackRef_AsPyObjectBorrow(sub)
            );
            DECREF_INPUTS();
            ERROR_IF(err, error);
        }
        ...
        inst(CALL_INTRINSIC_1, (value-- res)) {
            ...
            PyObject *res_o = _PyIntrinsics_UnaryFunctions[oparg].func(
                tstate, PyStackRef_AsPyObjectBorrow(value)
            );
            DECREF_INPUTS();
            ERROR_IF(res_o == NULL, error);
            res = PyStackRef_FromPyObjectSteal(res_o);
        ...
        tier1 op(_RETURN_VALUE_EVENT, (val-- val)) {
            int err = _Py_call_instrumentation_arg(
                ...
                frame,
                this_instr,
                PyStackRef_AsPyObjectBorrow(val)
            );
            ERROR_IF(err, error);
        }

        macro(INSTRUMENTED_RETURN_VALUE) = _RETURN_VALUE_EVENT + RETURN_VALUE;

        macro(RETURN_CONST) = LOAD_CONST + RETURN_VALUE;

        macro(INSTRUMENTED_RETURN_CONST) =
            LOAD_CONST + _RETURN_VALUE_EVENT + RETURN_VALUE;
        ...
        inst(GET_ANEXT, (aiter-- aiter, awaitable)) {
            PyObject *awaitable_o =
                _PyEval_GetANext(PyStackRef_AsPyObjectBorrow(aiter));
            if (awaitable_o == NULL) {
                ERROR_NO_POP();
            }
        ...
        specializing op(
            _SPECIALIZE_SEND, (counter / 1, receiver, unused-- receiver, unused)
        ) {
#if ENABLE_SPECIALIZATION
            if (ADAPTIVE_COUNTER_TRIGGERS(counter)) {
                next_instr = this_instr;
        ...
        op(_SEND_GEN_FRAME,
           (receiver, v-- receiver, gen_frame : _PyInterpreterFrame *)) {
        ...
        macro(SEND_GEN) = unused / 1 + _CHECK_PEP_523 + _SEND_GEN_FRAME + _PUSH_FRAME;
...
// or throw() call.
        ...
        macro(INSTRUMENTED_YIELD_VALUE) = _YIELD_VALUE_EVENT + YIELD_VALUE;
        ...
        inst(POP_EXCEPT, (exc_value--)) {
            ...
            Py_XSETREF(
                ...
                PyStackRef_Is(exc_value, PyStackRef_None)
                    ? NULL
                    : PyStackRef_AsPyObjectSteal(exc_value)
            );
        }
        ...
        tier1 inst(RERAISE, (values[oparg], exc_st-- values[oparg])) {
            ...
            if (oparg) {
                ...
                if (PyLong_Check(lasti)) {
                    frame->instr_ptr =
                        _PyCode_CODE(_PyFrame_GetCode(frame)) + PyLong_AsLong(lasti);
                    assert(!_PyErr_Occurred(tstate));
                } else {
        ...
        tier1 inst(
            CLEANUP_THROW, (sub_iter_st, last_sent_val_st, exc_value_st-- none, value)
        ) {
            ...
            if (matches) {
                ...
                value = PyStackRef_FromPyObjectNew(
                    ((PyStopIterationObject *)exc_value)->value
                );
                DECREF_INPUTS();
            } else {
        ...
        inst(LOAD_BUILD_CLASS, (--bc)) {
            PyObject *bc_o;
            int err =
                PyMapping_GetOptionalItem(BUILTINS(), &_Py_ID(__build_class__), &bc_o);
            ERROR_IF(err < 0, error);
            if (bc_o == NULL) {
        ...
        inst(UNPACK_EX, (seq-- left[oparg & 0xFF], unused, right[oparg >> 8])) {
            ...
            int res = _PyEval_UnpackIterableStackRef(
                tstate, seq, oparg & 0xFF, oparg >> 8, top
            );
            DECREF_INPUTS();
            ERROR_IF(res == 0, error);
        }
        ...
        op(_STORE_ATTR, (v, owner--)) {
            ...
            int err = PyObject_SetAttr(
                PyStackRef_AsPyObjectBorrow(owner), name, PyStackRef_AsPyObjectBorrow(v)
            );
            DECREF_INPUTS();
            ERROR_IF(err, error);
        }
        ...
        inst(LOAD_LOCALS, (--locals)) {
            PyObject *l = LOCALS();
            if (l == NULL) {
                _PyErr_SetString(tstate, PyExc_SystemError, "no locals found");
                ERROR_IF(true, error);
            }
        ...
        inst(LOAD_FROM_DICT_OR_GLOBALS, (mod_or_class_dict-- v)) {
            PyObject *name = GETITEM(FRAME_CO_NAMES, oparg);
            PyObject *v_o;
            int err = PyMapping_GetOptionalItem(
                PyStackRef_AsPyObjectBorrow(mod_or_class_dict), name, &v_o
            );
            DECREF_INPUTS();
            ERROR_IF(err < 0, error);
            if (v_o == NULL) {
                if (PyDict_CheckExact(GLOBALS()) && PyDict_CheckExact(BUILTINS())) {
                    v_o = _PyDict_LoadGlobal(
        ...
        // res[1] because we need a pointer to res to pass it to
        ...
        macro(LOAD_GLOBAL) = _SPECIALIZE_LOAD_GLOBAL + counter / 1 +
                             globals_version / 1 + builtins_version / 1 + _LOAD_GLOBAL;
        ...
        op(_GUARD_GLOBALS_VERSION_PUSH_KEYS,
           (version / 1 --globals_keys : PyDictKeysObject *)) {
            PyDictObject *dict = (PyDictObject *)GLOBALS();
            DEOPT_IF(!PyDict_CheckExact(dict));
            DEOPT_IF(dict->ma_keys->dk_version != version);
        ...
        op(_GUARD_BUILTINS_VERSION_PUSH_KEYS,
           (version / 1 --builtins_keys : PyDictKeysObject *)) {
        ...
        op(_LOAD_GLOBAL_MODULE_FROM_KEYS,
           (index / 1, globals_keys : PyDictKeysObject * --res, null if (oparg & 1))) {
        ...
        op(_LOAD_GLOBAL_BUILTINS_FROM_KEYS,
           (index / 1, builtins_keys : PyDictKeysObject * --res, null if (oparg & 1))) {
        ...
        macro(LOAD_GLOBAL_MODULE) = unused / 1 +  // Skip over the counter
        ...
        inst(LOAD_FROM_DICT_OR_DEREF, (class_dict_st-- value)) {
            ...
            if (!value_o) {
                PyCellObject *cell =
                    (PyCellObject *)PyStackRef_AsPyObjectBorrow(GETLOCAL(oparg));
        ...
        inst(
            LIST_EXTEND,
            (list_st, unused[oparg - 1], iterable_st-- list_st, unused[oparg - 1])
        ) {
            PyObject *list = PyStackRef_AsPyObjectBorrow(list_st);
            ...
            if (none_val == NULL) {
                ...
                if (matches && (Py_TYPE(iterable)->tp_iter == NULL &&
        ...
        inst(SET_UPDATE, (set, unused[oparg - 1], iterable-- set, unused[oparg - 1])) {
            int err = _PySet_Update(
                PyStackRef_AsPyObjectBorrow(set), PyStackRef_AsPyObjectBorrow(iterable)
            );
            DECREF_INPUTS();
            ERROR_IF(err < 0, error);
        }
        ...
        inst(BUILD_MAP, (values[oparg * 2]-- map)) {
            ...
            PyObject *map_o = _PyDict_FromItems(values_o, 2, values_o + 1, 2, oparg);
        ...
        inst(SETUP_ANNOTATIONS, (--)) {
            ...
            int err = PyMapping_GetOptionalItem(
                LOCALS(), &_Py_ID(__annotations__), &ann_dict
            );
            ERROR_IF(err < 0, error);
            if (ann_dict == NULL) {
                ann_dict = PyDict_New();
        ...
        inst(
            ...
            (unused / 1, unused, unused, unused-- unused, unused if (oparg & 1))
        ) {
        ...
        specializing op(
            ...
            if (ADAPTIVE_COUNTER_TRIGGERS(counter)) {
                ...
                _Py_Specialize_LoadSuperAttr(
                    global_super_st, class_st, next_instr, load_method
                );
                DISPATCH_SAME_OPARG();
            }
        ...
        tier1 op(
            _LOAD_SUPER_ATTR,
            (global_super_st, class_st, self_st-- attr, null if (oparg & 1))
        ) {
        ...
        inst(
            LOAD_SUPER_ATTR_ATTR,
            (unused / 1, global_super_st, class_st, self_st-- attr_st, unused if (0))
        ) {
            PyObject *global_super = PyStackRef_AsPyObjectBorrow(global_super_st);
            PyObject *class = PyStackRef_AsPyObjectBorrow(class_st);
            PyObject *self = PyStackRef_AsPyObjectBorrow(self_st);
        ...
        inst(
            LOAD_SUPER_ATTR_METHOD,
            (unused / 1, global_super_st, class_st, self_st-- attr, self_or_null)
        ) {
            PyObject *global_super = PyStackRef_AsPyObjectBorrow(global_super_st);
            PyObject *class = PyStackRef_AsPyObjectBorrow(class_st);
            PyObject *self = PyStackRef_AsPyObjectBorrow(self_st);
            ...
            int method_found = 0;
            PyObject *attr_o = _PySuper_Lookup(
                cls,
                self,
                name,
        ...
        op(_LOAD_ATTR, (owner-- attr, self_or_null if (oparg & 1))) {
            ...
            if (oparg & 1) {
                ...
                attr_o = NULL;
                int is_meth = _PyObject_GetMethod(
                    PyStackRef_AsPyObjectBorrow(owner), name, &attr_o
                );
                if (is_meth) {
        ...
        split op(
            _LOAD_ATTR_INSTANCE_VALUE, (offset / 1, owner-- attr, null if (oparg & 1))
        ) {
            PyObject *owner_o = PyStackRef_AsPyObjectBorrow(owner);
        ...
        macro(LOAD_ATTR_INSTANCE_VALUE) =
            ...
            _LOAD_ATTR_INSTANCE_VALUE + unused / 5;  // Skip over rest of cache
        ...
        macro(LOAD_ATTR_MODULE) =
            unused / 1 + _CHECK_ATTR_MODULE + _LOAD_ATTR_MODULE + unused / 5;
        ...
        macro(LOAD_ATTR_WITH_HINT) = unused / 1 + _GUARD_TYPE_VERSION +
                                     _CHECK_ATTR_WITH_HINT + _LOAD_ATTR_WITH_HINT +
                                     unused / 5;
        ...
        macro(LOAD_ATTR_SLOT) = unused / 1 + _GUARD_TYPE_VERSION +
        ...
        macro(LOAD_ATTR_CLASS) =
            unused / 1 + _CHECK_ATTR_CLASS + unused / 2 + _LOAD_ATTR_CLASS;

        macro(LOAD_ATTR_CLASS_WITH_METACLASS_CHECK) =
            unused / 1 + _CHECK_ATTR_CLASS + _GUARD_TYPE_VERSION + _LOAD_ATTR_CLASS;

        op(_LOAD_ATTR_PROPERTY_FRAME,
           (fget / 4, owner-- new_frame : _PyInterpreterFrame *)) {
            assert((oparg & 1) == 0);
            assert(Py_IS_TYPE(fget, &PyFunction_Type));
            PyFunctionObject *f = (PyFunctionObject *)fget;
            PyCodeObject *code = (PyCodeObject *)f->func_code;
            DEOPT_IF(
                (code->co_flags & (CO_VARKEYWORDS | CO_VARARGS | CO_OPTIMIZED)) !=
                CO_OPTIMIZED
            );
            ...
            STAT_INC(LOAD_ATTR, hit);
            new_frame = _PyFrame_PushUnchecked(
                tstate, PyStackRef_FromPyObjectNew(fget), 1, frame
            );
            new_frame->localsplus[0] = owner;
            DEAD(owner);
        }

        macro(LOAD_ATTR_PROPERTY) = unused / 1 + _CHECK_PEP_523 + _GUARD_TYPE_VERSION +
                                    unused / 2 + _LOAD_ATTR_PROPERTY_FRAME +
        ...
        inst(
            ...
            _PyInterpreterFrame *new_frame =
                _PyFrame_PushUnchecked(tstate, PyStackRef_FromPyObjectNew(f), 2, frame);
        ...
        macro(STORE_ATTR_INSTANCE_VALUE) = unused / 1 + _GUARD_TYPE_VERSION +
                                           _GUARD_DORV_NO_DICT +
        ...
        op(_STORE_ATTR_WITH_HINT, (hint / 1, value, owner--)) {
            ...
            // old_value should be DECREFed after GC track checking is done, if not, it
            // could raise a segmentation fault, when dict only holds the strong
            // reference to value in ep->me_value.
        ...
        macro(STORE_ATTR_WITH_HINT) =
            unused / 1 + _GUARD_TYPE_VERSION + _STORE_ATTR_WITH_HINT;
        ...
        macro(STORE_ATTR_SLOT) = unused / 1 + _GUARD_TYPE_VERSION + _STORE_ATTR_SLOT;
        ...
        specializing op(
            _SPECIALIZE_COMPARE_OP, (counter / 1, left, right-- left, right)
        ) {
#if ENABLE_SPECIALIZATION
            if (ADAPTIVE_COUNTER_TRIGGERS(counter)) {
                next_instr = this_instr;
        ...
        macro(COMPARE_OP_FLOAT) = _GUARD_BOTH_FLOAT + unused / 1 + _COMPARE_OP_FLOAT;

        macro(COMPARE_OP_INT) = _GUARD_BOTH_INT + unused / 1 + _COMPARE_OP_INT;

        macro(COMPARE_OP_STR) = _GUARD_BOTH_UNICODE + unused / 1 + _COMPARE_OP_STR;
        ...
        op(_COMPARE_OP_FLOAT, (left, right-- res)) {
            ...
            // 1 if NaN, 2 if <, 4 if >, 8 if ==; this matches low four bits of the
            // oparg
        ...
        op(_COMPARE_OP_INT, (left, right-- res)) {
            ...
            STAT_INC(COMPARE_OP, hit);
            assert(
                _PyLong_DigitCount((PyLongObject *)left_o) <= 1 &&
        ...
        op(_COMPARE_OP_STR, (left, right-- res)) {
            ...
            assert(eq == 0 || eq == 1);
            assert(
                (oparg & 0xf) == COMPARISON_NOT_EQUALS ||
                (oparg & 0xf) == COMPARISON_EQUALS
            );
            assert(COMPARISON_NOT_EQUALS + 1 == COMPARISON_EQUALS);
            res = ((COMPARISON_NOT_EQUALS + eq) & oparg) ? PyStackRef_True
                                                         : PyStackRef_False;
            // It's always a bool, so we don't care about oparg & 16.
        }
        ...
        inst(IS_OP, (left, right-- b)) {
            ...
            int res = Py_Is(
                          PyStackRef_AsPyObjectBorrow(left),
                          PyStackRef_AsPyObjectBorrow(right)
                      ) ^
                      oparg;
#else
        ...
        specializing op(
            _SPECIALIZE_CONTAINS_OP, (counter / 1, left, right-- left, right)
        ) {
#if ENABLE_SPECIALIZATION
            if (ADAPTIVE_COUNTER_TRIGGERS(counter)) {
                next_instr = this_instr;
        ...
        inst(CHECK_EG_MATCH, (exc_value_st, match_type_st-- rest, match)) {
            ...
            int res =
                _PyEval_ExceptionGroupMatch(exc_value, match_type, &match_o, &rest_o);
            DECREF_INPUTS();
            ERROR_IF(res < 0, error);
        ...
        inst(IMPORT_NAME, (level, fromlist-- res)) {
            PyObject *name = GETITEM(FRAME_CO_NAMES, oparg);
            PyObject *res_o = _PyEval_ImportName(
                tstate,
                frame,
                name,
        ...
        inst(IMPORT_FROM, (from-- from, res)) {
            PyObject *name = GETITEM(FRAME_CO_NAMES, oparg);
            PyObject *res_o =
                _PyEval_ImportFrom(tstate, PyStackRef_AsPyObjectBorrow(from), name);
            ERROR_IF(res_o == NULL, error);
            res = PyStackRef_FromPyObjectSteal(res_o);
        }

        tier1 inst(JUMP_FORWARD, (--)) { JUMPBY(oparg); }
        ...
        tier1 op(_JUMP_BACKWARD, (the_counter / 1 --)) {
            ...
            if (backoff_counter_triggers(counter) &&
                ...
                int optimized =
                    _PyOptimizer_Optimize(frame, start, stack_pointer, &executor, 0);
        ...
        macro(JUMP_BACKWARD) = _CHECK_PERIODIC + _JUMP_BACKWARD;
        ...
        inst(MATCH_CLASS, (subject, type, names-- attrs)) {
            ...
            PyObject *attrs_o = _PyEval_MatchClass(
                tstate,
                PyStackRef_AsPyObjectBorrow(subject),
                PyStackRef_AsPyObjectBorrow(type),
                oparg,
        ...
        inst(MATCH_KEYS, (subject, keys-- subject, keys, values_or_none)) {
            ...
            PyObject *values_or_none_o = _PyEval_MatchKeys(
                tstate,
                PyStackRef_AsPyObjectBorrow(subject),
        ...
        inst(GET_YIELD_FROM_ITER, (iterable-- iter)) {
            ...
            if (PyCoro_CheckExact(iterable_o)) {
                ...
                if (!(_PyFrame_GetCode(frame)->co_flags &
        ...
        replaced op(_FOR_ITER, (iter-- iter, next)) {
            ...
            if (next_o == NULL) {
                ...
                assert(
                    next_instr[oparg].op.code == END_FOR ||
                    next_instr[oparg].op.code == INSTRUMENTED_END_FOR
                );
                PyStackRef_CLOSE(iter);
                STACK_SHRINK(1);
                /* Jump forward oparg, then skip following END_FOR and POP_TOP
                 * instruction */
                JUMPBY(oparg + 2);
                DISPATCH();
            }
        ...
        macro(FOR_ITER_LIST) = unused / 1 +  // Skip over the counter
                               _ITER_CHECK_LIST + _ITER_JUMP_LIST + _ITER_NEXT_LIST;
        ...
        macro(FOR_ITER_TUPLE) = unused / 1 +  // Skip over the counter
                                _ITER_CHECK_TUPLE + _ITER_JUMP_TUPLE + _ITER_NEXT_TUPLE;

        op(_ITER_CHECK_RANGE, (iter-- iter)) {
            _PyRangeIterObject *r =
                (_PyRangeIterObject *)PyStackRef_AsPyObjectBorrow(iter);
        ...
        macro(FOR_ITER_RANGE) = unused / 1 +  // Skip over the counter
        ...
        op(_FOR_ITER_GEN_FRAME, (iter-- iter, gen_frame : _PyInterpreterFrame *)) {
            ...
            frame->return_offset =
                (uint16_t)(1 + INLINE_CACHE_ENTRIES_FOR_ITER + oparg);
        }

        macro(FOR_ITER_GEN) =
            unused / 1 + _CHECK_PEP_523 + _FOR_ITER_GEN_FRAME + _PUSH_FRAME;
        ...
        inst(LOAD_SPECIAL, (owner-- attr, self_or_null)) {
            ...
            PyObject *attr_o =
                _PyObject_LookupSpecialMethod(owner_o, name, &self_or_null_o);
            if (attr_o == NULL) {
                if (!_PyErr_Occurred(tstate)) {
                    _PyErr_Format(
                        tstate,
            ...
            self_or_null = self_or_null_o == NULL
                               ? PyStackRef_NULL
                               : PyStackRef_FromPyObjectSteal(self_or_null_o);
        }
        ...
        inst(
            ...
            /* At the top of the stack are 4 values:
               ...
               - exit_func: FIFTH = the context.__exit__ function or context.__exit__
               bound method We call FOURTH(type(TOP), TOP, GetTraceback(TOP)). Then we
               push the __exit__ return value.
            */
            PyObject *exc, *tb;
            ...
            PyObject *stack[5] = {
                NULL, PyStackRef_AsPyObjectBorrow(exit_self), exc, val_o, tb
            };
        ...
        split op(
            _LOAD_ATTR_METHOD_WITH_VALUES, (descr / 4, owner-- attr, self if (1))
        ) {
            assert(oparg & 1);
        ...
        macro(LOAD_ATTR_METHOD_WITH_VALUES) =
            unused / 1 + _GUARD_TYPE_VERSION + _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT +
        ...
        macro(LOAD_ATTR_METHOD_NO_DICT) =
            unused / 1 + _GUARD_TYPE_VERSION + unused / 2 + _LOAD_ATTR_METHOD_NO_DICT;

        op(_LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES,
           (descr / 4, owner-- attr, unused if (0))) {
            assert((oparg & 1) == 0);
            STAT_INC(LOAD_ATTR, hit);
            assert(descr != NULL);
            DECREF_INPUTS();
        ...
        macro(LOAD_ATTR_NONDESCRIPTOR_NO_DICT) = unused / 1 + _GUARD_TYPE_VERSION +
                                                 unused / 2 +
        ...
        macro(LOAD_ATTR_METHOD_LAZY_DICT) = unused / 1 + _GUARD_TYPE_VERSION +
                                            _CHECK_ATTR_METHOD_LAZY_DICT + unused / 1 +
        ...
        specializing op(
            ...
            if (ADAPTIVE_COUNTER_TRIGGERS(counter)) {
                next_instr = this_instr;
                _Py_Specialize_Call(
                    callable[0], next_instr, oparg + !PyStackRef_IsNull(self_or_null[0])
                );
                DISPATCH_SAME_OPARG();
            }
        ...
        op(_DO_CALL, (callable[1], self_or_null[1], args[oparg]-- res)) {
            ...
            if (Py_TYPE(callable_o) == &PyFunction_Type &&
                ...
                _PyInterpreterFrame *new_frame = _PyEvalFramePushAndInit(
                    tstate, callable[0], locals, args, total_args, NULL, frame
                );
            ...
            PyObject *res_o = PyObject_Vectorcall(
                callable_o, args_o, total_args | PY_VECTORCALL_ARGUMENTS_OFFSET, NULL
            );
        ...
        op(_MONITOR_CALL,
           (func[1], maybe_self[1], args[oparg]-- func[1], maybe_self[1], args[oparg])
        ) {
            ...
            SYNC_SP();
            int err = _Py_call_instrumentation_2args(
                tstate, PY_MONITORING_EVENT_CALL, frame, this_instr, function, arg0
            );
            ERROR_IF(err, error);
        }
        ...
        macro(CALL) = _SPECIALIZE_CALL + unused / 2 + _MAYBE_EXPAND_METHOD + _DO_CALL +
                      _CHECK_PERIODIC;
        macro(INSTRUMENTED_CALL) = unused / 3 + _MAYBE_EXPAND_METHOD + _MONITOR_CALL +
                                   _DO_CALL + _CHECK_PERIODIC;

        op(_PY_FRAME_GENERAL,
           (callable[1],
            self_or_null[1],
            args[oparg]-- new_frame : _PyInterpreterFrame *)) {
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
        ...
        op(_CHECK_FUNCTION_VERSION,
           (func_version / 2,
            callable[1],
            self_or_null[1],
            unused[oparg]-- callable[1],
            self_or_null[1],
            unused[oparg])) {
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
        ...
        macro(CALL_PY_GENERAL) = unused / 1 +  // Skip over the counter
                                 _CHECK_PEP_523 + _CHECK_FUNCTION_VERSION +
                                 _PY_FRAME_GENERAL + _SAVE_RETURN_OFFSET + _PUSH_FRAME;

        op(_CHECK_METHOD_VERSION,
           (func_version / 2,
            callable[1],
            null[1],
            unused[oparg]-- callable[1],
        ...
        op(_EXPAND_METHOD,
           (callable[1], null[1], unused[oparg]-- method[1], self[1], unused[oparg])) {
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
            assert(PyStackRef_IsNull(null[0]));
            DEAD(null);
            assert(Py_TYPE(callable_o) == &PyMethod_Type);
            self[0] =
                PyStackRef_FromPyObjectNew(((PyMethodObject *)callable_o)->im_self);
            _PyStackRef temp = callable[0];
            method[0] =
                PyStackRef_FromPyObjectNew(((PyMethodObject *)callable_o)->im_func);
        ...
        macro(CALL_BOUND_METHOD_GENERAL) =
            unused / 1 +  // Skip over the counter
            _CHECK_PEP_523 + _CHECK_METHOD_VERSION + _EXPAND_METHOD +
            flush +  // so that self is in the argument array
            _PY_FRAME_GENERAL + _SAVE_RETURN_OFFSET + _PUSH_FRAME;

        op(_CHECK_IS_NOT_PY_CALLABLE,
           (callable[1],
            unused[1],
            unused[oparg]-- callable[1],
            unused[1],
        ...
        macro(CALL_NON_PY_GENERAL) = unused / 1 +  // Skip over the counter
                                     unused / 2 + _CHECK_IS_NOT_PY_CALLABLE +
                                     _CALL_NON_PY_GENERAL + _CHECK_PERIODIC;

        op(_CHECK_CALL_BOUND_METHOD_EXACT_ARGS,
           (callable[1], null[1], unused[oparg]-- callable[1], null[1], unused[oparg])
        ) {
            EXIT_IF(!PyStackRef_IsNull(null[0]));
            EXIT_IF(
                Py_TYPE(PyStackRef_AsPyObjectBorrow(callable[0])) != &PyMethod_Type
            );
        }

        op(_INIT_CALL_BOUND_METHOD_EXACT_ARGS,
           (callable[1], null[1], unused[oparg]-- func[1], self[1], unused[oparg])) {
            DEAD(null);
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
            STAT_INC(CALL, hit);
            self[0] =
        ...
        replicate(5) pure op(
            ...
            STAT_INC(CALL, hit);
            new_frame =
                _PyFrame_PushUnchecked(tstate, callable[0], oparg + has_self, frame);
        ...
        op(_PUSH_FRAME, (new_frame : _PyInterpreterFrame * --)) {
            ...
            assert(
                new_frame->previous == frame || new_frame->previous->previous == frame
            );
        ...
        macro(CALL_BOUND_METHOD_EXACT_ARGS) =
            unused / 1 +  // Skip over the counter
            _CHECK_PEP_523 + _CHECK_CALL_BOUND_METHOD_EXACT_ARGS +
            _INIT_CALL_BOUND_METHOD_EXACT_ARGS + flush +  // In case the following deopt
            _CHECK_FUNCTION_VERSION + _CHECK_FUNCTION_EXACT_ARGS + _CHECK_STACK_SPACE +
            _INIT_CALL_PY_EXACT_ARGS + _SAVE_RETURN_OFFSET + _PUSH_FRAME;

        macro(CALL_PY_EXACT_ARGS) = unused / 1 +  // Skip over the counter
                                    _CHECK_PEP_523 + _CHECK_FUNCTION_VERSION +
                                    _CHECK_FUNCTION_EXACT_ARGS + _CHECK_STACK_SPACE +
                                    _INIT_CALL_PY_EXACT_ARGS + _SAVE_RETURN_OFFSET +
                                    _PUSH_FRAME;
        ...
        macro(CALL_STR_1) = unused / 1 + unused / 2 + _CALL_STR_1 + _CHECK_PERIODIC;
        ...
        macro(CALL_TUPLE_1) = unused / 1 + unused / 2 + _CALL_TUPLE_1 + _CHECK_PERIODIC;

        op(_CHECK_AND_ALLOCATE_OBJECT,
           (type_version / 2,
            callable[1],
            null[1],
            args[oparg]-- init[1],
            ...
            DEOPT_IF(!_PyThreadState_HasStackSpace(
                tstate, code->co_framesize + _Py_InitCleanup.co_framesize
            ));
            STAT_INC(CALL, hit);
        ...
        op(_CREATE_INIT_FRAME,
           (init[1], self[1], args[oparg]-- init_frame : _PyInterpreterFrame *)) {
        ...
        macro(CALL_ALLOC_AND_ENTER_INIT) = unused / 1 + _CHECK_PEP_523 +
        ...
        op(_CALL_BUILTIN_CLASS, (callable[1], self_or_null[1], args[oparg]-- res)) {
            ...
            PyObject *res_o =
                tp->tp_vectorcall((PyObject *)tp, args_o, total_args, NULL);
            STACKREFS_TO_PYOBJECTS_CLEANUP(args_o);
            /* Free the arguments. */
            for (int i = 0; i < total_args; i++) {
                PyStackRef_CLOSE(args[i]);
        ...
        macro(CALL_BUILTIN_CLASS) =
            unused / 1 + unused / 2 + _CALL_BUILTIN_CLASS + _CHECK_PERIODIC;
        ...
        op(_CALL_BUILTIN_O, (callable[1], self_or_null[1], args[oparg]-- res)) {
            ...
            PyObject *res_o = _PyCFunction_TrampolineCall(
                ...
                PyStackRef_AsPyObjectBorrow(arg)
            );
        ...
        op(_CALL_BUILTIN_FAST, (callable[1], self_or_null[1], args[oparg]-- res)) {
            ...
            PyObject *res_o = ((PyCFunctionFast)(void (*)(void)
            )cfunc)(PyCFunction_GET_SELF(callable_o), args_o, total_args);
            STACKREFS_TO_PYOBJECTS_CLEANUP(args_o);
            assert((res_o != NULL) ^ (_PyErr_Occurred(tstate) != NULL));
        ...
        macro(CALL_BUILTIN_FAST) =
            unused / 1 + unused / 2 + _CALL_BUILTIN_FAST + _CHECK_PERIODIC;

        op(_CALL_BUILTIN_FAST_WITH_KEYWORDS,
           (callable[1], self_or_null[1], args[oparg]-- res)) {
            ...
            DEOPT_IF(!PyCFunction_CheckExact(callable_o));
            DEOPT_IF(
                PyCFunction_GET_FLAGS(callable_o) != (METH_FASTCALL | METH_KEYWORDS)
            );
            STAT_INC(CALL, hit);
            ...
            PyObject *res_o =
                cfunc(PyCFunction_GET_SELF(callable_o), args_o, total_args, NULL);
            STACKREFS_TO_PYOBJECTS_CLEANUP(args_o);
        ...
        macro(CALL_BUILTIN_FAST_WITH_KEYWORDS) = unused / 1 + unused / 2 +
                                                 _CALL_BUILTIN_FAST_WITH_KEYWORDS +
                                                 _CHECK_PERIODIC;

        inst(
            CALL_LEN,
            (unused / 1, unused / 2, callable[1], self_or_null[1], args[oparg]-- res)
        ) {
            /* len(o) */
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
        ...
        inst(
            ...
            int retval = PyObject_IsInstance(
                PyStackRef_AsPyObjectBorrow(inst_stackref),
                PyStackRef_AsPyObjectBorrow(cls_stackref)
            );
            if (retval < 0) {
                ERROR_NO_POP();
            }
        ...
        inst(CALL_LIST_APPEND, (unused / 1, unused / 2, callable, self, arg--)) {
            ...
            STAT_INC(CALL, hit);
            int err = _PyList_AppendTakeRef(
                (PyListObject *)self_o, PyStackRef_AsPyObjectSteal(arg)
            );
        ...
        op(_CALL_METHOD_DESCRIPTOR_O,
           (callable[1], self_or_null[1], args[oparg]-- res)) {
            ...
            EXIT_IF(!Py_IS_TYPE(
                PyStackRef_AsPyObjectBorrow(self_stackref), method->d_common.d_type
            ));
            STAT_INC(CALL, hit);
        ...
        macro(CALL_METHOD_DESCRIPTOR_O) =
            unused / 1 + unused / 2 + _CALL_METHOD_DESCRIPTOR_O + _CHECK_PERIODIC;
        ...
        macro(CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS) =
            unused / 1 + unused / 2 + _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS +
            _CHECK_PERIODIC;

        op(_CALL_METHOD_DESCRIPTOR_NOARGS,
           (callable[1], self_or_null[1], args[oparg]-- res)) {
            assert(oparg == 0 || oparg == 1);
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
        ...
        macro(CALL_METHOD_DESCRIPTOR_NOARGS) =
            unused / 1 + unused / 2 + _CALL_METHOD_DESCRIPTOR_NOARGS + _CHECK_PERIODIC;

        op(_CALL_METHOD_DESCRIPTOR_FAST,
           (callable[1], self_or_null[1], args[oparg]-- res)) {
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
            ...
            PyCFunctionFast cfunc = (PyCFunctionFast)(void (*)(void))meth->ml_meth;
        ...
        macro(CALL_METHOD_DESCRIPTOR_FAST) =
            unused / 1 + unused / 2 + _CALL_METHOD_DESCRIPTOR_FAST + _CHECK_PERIODIC;
        ...
        inst(INSTRUMENTED_CALL_KW, (counter / 1, version / 2 --)) {
            ...
            int err = _Py_call_instrumentation_2args(
                tstate, PY_MONITORING_EVENT_CALL, frame, this_instr, function, arg
            );
            ERROR_IF(err, error);
            PAUSE_ADAPTIVE_COUNTER(this_instr[1].counter);
        ...
        op(_DO_CALL_KW, (callable[1], self_or_null[1], args[oparg], kwnames-- res)) {
            ...
            if (Py_TYPE(callable_o) == &PyFunction_Type &&
                ...
                PyObject *locals = code_flags & CO_OPTIMIZED
                                       ...
                                       : Py_NewRef(PyFunction_GET_GLOBALS(callable_o));
                _PyInterpreterFrame *new_frame = _PyEvalFramePushAndInit(
                    tstate, callable[0], locals, args, positional_args, kwnames_o, frame
                );
        ...
        op(_PY_FRAME_KW,
           (callable[1],
            self_or_null[1],
            args[oparg],
            kwnames-- new_frame : _PyInterpreterFrame *)) {
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
        ...
        macro(CALL_KW_PY) = unused / 1 +  // Skip over the counter
                            _CHECK_PEP_523 + _CHECK_FUNCTION_VERSION_KW + _PY_FRAME_KW +
                            _SAVE_RETURN_OFFSET + _PUSH_FRAME;

        op(_CHECK_METHOD_VERSION_KW,
           (func_version / 2,
            callable[1],
            null[1],
            unused[oparg],
        ...
        macro(CALL_KW_BOUND_METHOD) = unused / 1 +  // Skip over the counter
                                      _CHECK_PEP_523 + _CHECK_METHOD_VERSION_KW +
                                      _EXPAND_METHOD_KW +
                                      flush +  // so that self is in the argument array
                                      _PY_FRAME_KW + _SAVE_RETURN_OFFSET + _PUSH_FRAME;
        ...
        macro(CALL_KW) =
            _SPECIALIZE_CALL_KW + unused / 2 + _MAYBE_EXPAND_METHOD_KW + _DO_CALL_KW;

        op(_CHECK_IS_NOT_PY_CALLABLE_KW,
           (callable[1],
            unused[1],
            unused[oparg],
            kwnames-- callable[1],
        ...
        op(_CALL_KW_NON_PY,
           (callable[1], self_or_null[1], args[oparg], kwnames-- res)) {
#if TIER_ONE
            assert(opcode != INSTRUMENTED_CALL);
#endif
            PyObject *callable_o = PyStackRef_AsPyObjectBorrow(callable[0]);
        ...
        macro(CALL_KW_NON_PY) = unused / 1 +  // Skip over the counter
                                unused / 2 + _CHECK_IS_NOT_PY_CALLABLE_KW +
                                _CALL_KW_NON_PY + _CHECK_PERIODIC;

        inst(INSTRUMENTED_CALL_FUNCTION_EX, (--)) {
            GO_TO_INSTRUCTION(CALL_FUNCTION_EX);
        }

        op(_MAKE_CALLARGS_A_TUPLE,
           (func,
            unused,
            callargs,
            kwargs_in if (oparg & 1)-- func,
            unused,
            tuple,
            kwargs_out if (oparg & 1))) {
            PyObject *callargs_o = PyStackRef_AsPyObjectBorrow(callargs);
            if (PyTuple_CheckExact(callargs_o)) {
                tuple = callargs;
                DEAD(callargs);
            } else {
                int err = _Py_Check_ArgsIterable(
                    tstate, PyStackRef_AsPyObjectBorrow(func), callargs_o
                );
                if (err < 0) {
                    ERROR_NO_POP();
                }
        ...
        op(_DO_CALL_FUNCTION_EX,
           (func_st, unused, callargs_st, kwargs_st if (oparg & 1)-- result)) {
            ...
            if (opcode == INSTRUMENTED_CALL_FUNCTION_EX) {
                ...
                if (Py_TYPE(func) == &PyFunction_Type &&
                    ...
                    int code_flags =
                        ((PyCodeObject *)PyFunction_GET_CODE(func))->co_flags;
                    PyObject *locals = code_flags & CO_OPTIMIZED
                                           ? NULL
        ...
        macro(CALL_FUNCTION_EX) =
            _MAKE_CALLARGS_A_TUPLE + _DO_CALL_FUNCTION_EX + _CHECK_PERIODIC;
        ...
        inst(MAKE_FUNCTION, (codeobj_st-- func)) {
            ...
            _PyFunction_SetVersion(func_obj, ((PyCodeObject *)codeobj)->co_version);
        ...
        inst(FORMAT_WITH_SPEC, (value, fmt_spec-- res)) {
            PyObject *res_o = PyObject_Format(
                PyStackRef_AsPyObjectBorrow(value),
        ...
        inst(INSTRUMENTED_LINE, (--)) {
            ...
            if (tstate->tracing) {
                PyCodeObject *code = _PyFrame_GetCode(frame);
                original_opcode =
                    code->_co_monitoring->lines[(int)(this_instr - _PyCode_CODE(code))]
                        .original_opcode;
                next_instr = this_instr;
            } else {
        ...
        inst(INSTRUMENTED_INSTRUCTION, (--)) {
            int next_opcode =
                _Py_call_instrumentation_instruction(tstate, frame, this_instr);
        ...
        macro(INSTRUMENTED_JUMP_BACKWARD) =
            unused / 1 + _CHECK_PERIODIC + _MONITOR_JUMP_BACKWARD;
...
#endif
            INSTRUMENTED_JUMP(
                this_instr, next_instr + offset, PY_MONITORING_EVENT_BRANCH
            );
        }
        ...
        op(_JUMP_TO_TOP, (--)) { JUMP_TO_JUMP_TARGET(); }
        ...
        tier2 op(_EXIT_TRACE, (exit_p / 4 --)) {
            ...
            if (exit->executor == NULL) {
                ...
                if (target->op.code == ENTER_EXECUTOR) {
                    ...
                    int optimized = _PyOptimizer_Optimize(
                        frame, target, stack_pointer, &executor, chain_depth
                    );
                    if (optimized <= 0) {
        ...
        tier2 op(_CHECK_VALIDITY, (--)) { DEOPT_IF(!current_executor->vm_data.valid); }
        ...
        op(_INTERNAL_INCREMENT_OPT_COUNTER, (opt--)) {
            _PyCounterOptimizerObject *exe =
                (_PyCounterOptimizerObject *)PyStackRef_AsPyObjectBorrow(opt);
            exe->count++;
            DEAD(opt);
        }
        ...
        tier2 op(_DYNAMIC_EXIT, (exit_p / 4 --)) {
            ...
            if (target->op.code == ENTER_EXECUTOR) {
                ...
                int optimized =
                    _PyOptimizer_Optimize(frame, target, stack_pointer, &executor, 0);
                if (optimized <= 0) {
        ...
        tier2 op(_DEOPT, (--)) { EXIT_TO_TIER1(); }

        tier2 op(_ERROR_POP_N, (target / 2, unused[oparg]--)) {
            frame->instr_ptr =
                ((_Py_CODEUNIT *)_PyFrame_GetCode(frame)->co_code_adaptive) + target;
            SYNC_SP();
            GOTO_UNWIND();
        }
        ...
        tier2 op(_TIER2_RESUME_CHECK, (--)) {
            ...
            assert(
                tstate->tracing ||
                eval_breaker == FT_ATOMIC_LOAD_UINTPTR_ACQUIRE(
                                    _PyFrame_GetCode(frame)->_co_instrumentation_version
                                )
            );
        }
