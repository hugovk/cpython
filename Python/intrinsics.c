...
#define INTRINSIC_FUNC_ENTRY(N, F) [N] = {F, #N},

const intrinsic_func1_info _PyIntrinsics_UnaryFunctions[] = {
    INTRINSIC_FUNC_ENTRY(INTRINSIC_1_INVALID, no_intrinsic1) INTRINSIC_FUNC_ENTRY(
...
make_typevar_with_bound(
    PyThreadState *Py_UNUSED(ignored), PyObject *name, PyObject *evaluate_bound
) {
...
make_typevar_with_constraints(
    PyThreadState *Py_UNUSED(ignored), PyObject *name, PyObject *evaluate_constraints
) {
    assert(PyUnicode_Check(name));
    return _Py_make_typevar(name, NULL, evaluate_constraints);
}

const intrinsic_func2_info _PyIntrinsics_BinaryFunctions[] = {
            ...
            INTRINSIC_FUNC_ENTRY(INTRINSIC_TYPEVAR_WITH_BOUND, make_typevar_with_bound)
                INTRINSIC_FUNC_ENTRY(
                    ...
                    INTRINSIC_FUNC_ENTRY(
                        ...
                        INTRINSIC_FUNC_ENTRY(
                            INTRINSIC_SET_TYPEPARAM_DEFAULT, _Py_set_typeparam_default
                        )
};
