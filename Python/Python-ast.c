...
static int
init_identifiers(struct ast_state *state) {
    ...
    if ((state->body = PyUnicode_InternFromString("body")) == NULL)
        return -1;
    if ((state->bound = PyUnicode_InternFromString("bound")) == NULL)
        return -1;
    ...
    if ((state->decorator_list = PyUnicode_InternFromString("decorator_list")) == NULL)
        return -1;
    if ((state->default_value = PyUnicode_InternFromString("default_value")) == NULL)
        return -1;
    ...
    if ((state->type_ignores = PyUnicode_InternFromString("type_ignores")) == NULL)
        return -1;
    if ((state->type_params = PyUnicode_InternFromString("type_params")) == NULL)
        return -1;
...
static PyObject *
ast2obj_mod(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_stmt(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_expr(struct ast_state *state, struct validator *vstate, void *);
...
ast2obj_expr_context(
    struct ast_state *state, struct validator *vstate, expr_context_ty
);
static PyObject *
ast2obj_boolop(struct ast_state *state, struct validator *vstate, boolop_ty);
static PyObject *
ast2obj_operator(struct ast_state *state, struct validator *vstate, operator_ty);
static PyObject *
ast2obj_unaryop(struct ast_state *state, struct validator *vstate, unaryop_ty);
static PyObject *
ast2obj_cmpop(struct ast_state *state, struct validator *vstate, cmpop_ty);
static PyObject *
...
static PyObject *
ast2obj_arguments(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_arg(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_keyword(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_alias(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_withitem(struct ast_state *state, struct validator *vstate, void *);
static const char *const withitem_fields[] = {
    "context_expr",
    "optional_vars",
};
static PyObject *
ast2obj_match_case(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_pattern(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_type_ignore(struct ast_state *state, struct validator *vstate, void *);
...
static PyObject *
ast2obj_type_param(struct ast_state *state, struct validator *vstate, void *);
...
add_ast_annotations(struct ast_state *state) {
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(Module_annotations, "type_ignores", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(Module_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Module_type, "_field_types", Module_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Module_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Module_type, "__annotations__", Module_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Module_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Interactive_type, "_field_types", Interactive_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Interactive_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Interactive_type, "__annotations__", Interactive_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Interactive_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Expression_type, "_field_types", Expression_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Expression_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Expression_type, "__annotations__", Expression_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Expression_annotations);
        return 0;
        ...
        return 0;
    {
        ...
        cond = PyDict_SetItemString(FunctionType_annotations, "argtypes", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(FunctionType_annotations);
            return 0;
    ...
    }
    {
        PyObject *type = state->expr_type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(FunctionType_annotations, "returns", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(FunctionType_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->FunctionType_type, "_field_types", FunctionType_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(FunctionType_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->FunctionType_type, "__annotations__", FunctionType_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(FunctionType_annotations);
        return 0;
    ...
    }
    {
        ...
        cond =
            PyDict_SetItemString(FunctionDef_annotations, "decorator_list", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(FunctionDef_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(FunctionDef_annotations, "returns", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(FunctionDef_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(FunctionDef_annotations, "type_comment", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(FunctionDef_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(FunctionDef_annotations, "type_params", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(FunctionDef_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->FunctionDef_type, "_field_types", FunctionDef_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(FunctionDef_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->FunctionDef_type, "__annotations__", FunctionDef_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(FunctionDef_annotations);
        return 0;
    ...
    if (!AsyncFunctionDef_annotations)
        return 0;
    {
        PyObject *type = (PyObject *)&PyUnicode_Type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(AsyncFunctionDef_annotations, "name", type) == 0;
        Py_DECREF(type);
        if (!cond) {
    ...
    }
    {
        PyObject *type = state->arguments_type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(AsyncFunctionDef_annotations, "args", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AsyncFunctionDef_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(AsyncFunctionDef_annotations, "body", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AsyncFunctionDef_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(
                   AsyncFunctionDef_annotations, "decorator_list", type
               ) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AsyncFunctionDef_annotations);
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(AsyncFunctionDef_annotations, "returns", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AsyncFunctionDef_annotations);
            return 0;
    ...
    }
    {
        ...
        cond =
            PyDict_SetItemString(AsyncFunctionDef_annotations, "type_comment", type) ==
            0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AsyncFunctionDef_annotations);
    ...
    }
    {
        ...
        cond =
            PyDict_SetItemString(AsyncFunctionDef_annotations, "type_params", type) ==
            0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AsyncFunctionDef_annotations);
    ...
    cond =
        PyObject_SetAttrString(
            state->AsyncFunctionDef_type, "_field_types", AsyncFunctionDef_annotations
        ) == 0;
    if (!cond) {
        Py_DECREF(AsyncFunctionDef_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AsyncFunctionDef_type,
               "__annotations__",
               AsyncFunctionDef_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AsyncFunctionDef_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(ClassDef_annotations, "keywords", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ClassDef_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(ClassDef_annotations, "decorator_list", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ClassDef_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(ClassDef_annotations, "type_params", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ClassDef_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ClassDef_type, "_field_types", ClassDef_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ClassDef_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ClassDef_type, "__annotations__", ClassDef_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ClassDef_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Return_type, "_field_types", Return_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Return_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Return_type, "__annotations__", Return_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Return_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Delete_type, "_field_types", Delete_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Delete_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Delete_type, "__annotations__", Delete_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Delete_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(Assign_annotations, "type_comment", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(Assign_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Assign_type, "_field_types", Assign_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Assign_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Assign_type, "__annotations__", Assign_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Assign_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(TypeAlias_annotations, "type_params", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(TypeAlias_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TypeAlias_type, "_field_types", TypeAlias_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TypeAlias_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TypeAlias_type, "__annotations__", TypeAlias_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TypeAlias_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AugAssign_type, "_field_types", AugAssign_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AugAssign_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AugAssign_type, "__annotations__", AugAssign_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AugAssign_annotations);
        return 0;
    ...
    }
    {
        PyObject *type = state->expr_type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(AnnAssign_annotations, "annotation", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AnnAssign_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AnnAssign_type, "_field_types", AnnAssign_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AnnAssign_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AnnAssign_type, "__annotations__", AnnAssign_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AnnAssign_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->For_type, "_field_types", For_annotations) == 0;
    if (!cond) {
        Py_DECREF(For_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->For_type, "__annotations__", For_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(For_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(AsyncFor_annotations, "type_comment", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AsyncFor_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AsyncFor_type, "_field_types", AsyncFor_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AsyncFor_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AsyncFor_type, "__annotations__", AsyncFor_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AsyncFor_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->While_type, "_field_types", While_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(While_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->While_type, "__annotations__", While_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(While_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(state->If_type, "_field_types", If_annotations) == 0;
    if (!cond) {
        Py_DECREF(If_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->If_type, "__annotations__", If_annotations) == 0;
    if (!cond) {
        Py_DECREF(If_annotations);
        return 0;
    }
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(With_annotations, "type_comment", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(With_annotations);
            return 0;
    ...
    cond =
        PyObject_SetAttrString(state->With_type, "_field_types", With_annotations) == 0;
    if (!cond) {
        Py_DECREF(With_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->With_type, "__annotations__", With_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(With_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(AsyncWith_annotations, "type_comment", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(AsyncWith_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AsyncWith_type, "_field_types", AsyncWith_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AsyncWith_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->AsyncWith_type, "__annotations__", AsyncWith_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(AsyncWith_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Match_type, "_field_types", Match_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Match_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Match_type, "__annotations__", Match_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Match_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Raise_type, "_field_types", Raise_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Raise_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Raise_type, "__annotations__", Raise_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Raise_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Try_type, "_field_types", Try_annotations) == 0;
    if (!cond) {
        Py_DECREF(Try_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Try_type, "__annotations__", Try_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Try_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(TryStar_annotations, "finalbody", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(TryStar_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TryStar_type, "_field_types", TryStar_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TryStar_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TryStar_type, "__annotations__", TryStar_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TryStar_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Assert_type, "_field_types", Assert_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Assert_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Assert_type, "__annotations__", Assert_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Assert_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Import_type, "_field_types", Import_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Import_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Import_type, "__annotations__", Import_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Import_annotations);
        return 0;
        ...
        return 0;
    {
        ...
        cond = PyDict_SetItemString(ImportFrom_annotations, "module", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ImportFrom_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ImportFrom_type, "_field_types", ImportFrom_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ImportFrom_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ImportFrom_type, "__annotations__", ImportFrom_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ImportFrom_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Global_type, "_field_types", Global_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Global_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Global_type, "__annotations__", Global_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Global_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Nonlocal_type, "_field_types", Nonlocal_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Nonlocal_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Nonlocal_type, "__annotations__", Nonlocal_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Nonlocal_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Expr_type, "_field_types", Expr_annotations) == 0;
    if (!cond) {
        Py_DECREF(Expr_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Expr_type, "__annotations__", Expr_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Expr_annotations);
        return 0;
    ...
    if (!Pass_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Pass_type, "_field_types", Pass_annotations) == 0;
    if (!cond) {
        Py_DECREF(Pass_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Pass_type, "__annotations__", Pass_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Pass_annotations);
        return 0;
    ...
    if (!Break_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Break_type, "_field_types", Break_annotations) ==
        0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->Break_type, "__annotations__", Break_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Break_annotations);
        return 0;
    ...
    if (!Continue_annotations)
        return 0;
    cond = PyObject_SetAttrString(
               state->Continue_type, "_field_types", Continue_annotations
           ) == 0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->Continue_type, "__annotations__", Continue_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Continue_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->BoolOp_type, "_field_types", BoolOp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(BoolOp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->BoolOp_type, "__annotations__", BoolOp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(BoolOp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->NamedExpr_type, "_field_types", NamedExpr_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(NamedExpr_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->NamedExpr_type, "__annotations__", NamedExpr_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(NamedExpr_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->BinOp_type, "_field_types", BinOp_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(BinOp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->BinOp_type, "__annotations__", BinOp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(BinOp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->UnaryOp_type, "_field_types", UnaryOp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(UnaryOp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->UnaryOp_type, "__annotations__", UnaryOp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(UnaryOp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Lambda_type, "_field_types", Lambda_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Lambda_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Lambda_type, "__annotations__", Lambda_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Lambda_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->IfExp_type, "_field_types", IfExp_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(IfExp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->IfExp_type, "__annotations__", IfExp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(IfExp_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Dict_type, "_field_types", Dict_annotations) == 0;
    if (!cond) {
        Py_DECREF(Dict_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Dict_type, "__annotations__", Dict_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Dict_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Set_type, "_field_types", Set_annotations) == 0;
    if (!cond) {
        Py_DECREF(Set_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Set_type, "__annotations__", Set_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Set_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(ListComp_annotations, "generators", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ListComp_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ListComp_type, "_field_types", ListComp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ListComp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ListComp_type, "__annotations__", ListComp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ListComp_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(SetComp_annotations, "generators", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(SetComp_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->SetComp_type, "_field_types", SetComp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(SetComp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->SetComp_type, "__annotations__", SetComp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(SetComp_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(DictComp_annotations, "generators", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(DictComp_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->DictComp_type, "_field_types", DictComp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(DictComp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->DictComp_type, "__annotations__", DictComp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(DictComp_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(GeneratorExp_annotations, "generators", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(GeneratorExp_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->GeneratorExp_type, "_field_types", GeneratorExp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(GeneratorExp_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->GeneratorExp_type, "__annotations__", GeneratorExp_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(GeneratorExp_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Await_type, "_field_types", Await_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Await_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Await_type, "__annotations__", Await_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Await_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Yield_type, "_field_types", Yield_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Yield_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Yield_type, "__annotations__", Yield_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Yield_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->YieldFrom_type, "_field_types", YieldFrom_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(YieldFrom_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->YieldFrom_type, "__annotations__", YieldFrom_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(YieldFrom_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(Compare_annotations, "comparators", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(Compare_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Compare_type, "_field_types", Compare_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Compare_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Compare_type, "__annotations__", Compare_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Compare_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Call_type, "_field_types", Call_annotations) == 0;
    if (!cond) {
        Py_DECREF(Call_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Call_type, "__annotations__", Call_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Call_annotations);
        return 0;
    ...
    if (!FormattedValue_annotations)
        return 0;
    {
        PyObject *type = state->expr_type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(FormattedValue_annotations, "value", type) == 0;
        Py_DECREF(type);
        if (!cond) {
    ...
    }
    {
        ...
        Py_INCREF(type);
        cond =
            PyDict_SetItemString(FormattedValue_annotations, "conversion", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(FormattedValue_annotations);
            return 0;
    ...
    }
    {
        ...
        cond =
            PyDict_SetItemString(FormattedValue_annotations, "format_spec", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(FormattedValue_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->FormattedValue_type, "_field_types", FormattedValue_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(FormattedValue_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->FormattedValue_type, "__annotations__", FormattedValue_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(FormattedValue_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->JoinedStr_type, "_field_types", JoinedStr_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(JoinedStr_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->JoinedStr_type, "__annotations__", JoinedStr_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(JoinedStr_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Constant_type, "_field_types", Constant_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Constant_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Constant_type, "__annotations__", Constant_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Constant_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Attribute_type, "_field_types", Attribute_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Attribute_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Attribute_type, "__annotations__", Attribute_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Attribute_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Subscript_type, "_field_types", Subscript_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Subscript_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Subscript_type, "__annotations__", Subscript_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Subscript_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Starred_type, "_field_types", Starred_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Starred_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Starred_type, "__annotations__", Starred_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Starred_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Name_type, "_field_types", Name_annotations) == 0;
    if (!cond) {
        Py_DECREF(Name_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Name_type, "__annotations__", Name_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Name_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->List_type, "_field_types", List_annotations) == 0;
    if (!cond) {
        Py_DECREF(List_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->List_type, "__annotations__", List_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(List_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Tuple_type, "_field_types", Tuple_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Tuple_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Tuple_type, "__annotations__", Tuple_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Tuple_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->Slice_type, "_field_types", Slice_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Slice_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->Slice_type, "__annotations__", Slice_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Slice_annotations);
        return 0;
    ...
    if (!Load_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Load_type, "_field_types", Load_annotations) == 0;
    if (!cond) {
        Py_DECREF(Load_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Load_type, "__annotations__", Load_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Load_annotations);
        return 0;
    ...
    if (!Store_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Store_type, "_field_types", Store_annotations) ==
        0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->Store_type, "__annotations__", Store_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Store_annotations);
        return 0;
    ...
    if (!Del_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Del_type, "_field_types", Del_annotations) == 0;
    if (!cond) {
        Py_DECREF(Del_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Del_type, "__annotations__", Del_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Del_annotations);
        return 0;
    ...
    if (!And_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->And_type, "_field_types", And_annotations) == 0;
    if (!cond) {
        Py_DECREF(And_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->And_type, "__annotations__", And_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(And_annotations);
        return 0;
    ...
    if (!Or_annotations)
        return 0;
    cond = PyObject_SetAttrString(state->Or_type, "_field_types", Or_annotations) == 0;
    if (!cond) {
        Py_DECREF(Or_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Or_type, "__annotations__", Or_annotations) == 0;
    if (!cond) {
        Py_DECREF(Or_annotations);
        return 0;
    }
    ...
    if (!Add_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Add_type, "_field_types", Add_annotations) == 0;
    if (!cond) {
        Py_DECREF(Add_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Add_type, "__annotations__", Add_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Add_annotations);
        return 0;
    ...
    if (!Sub_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Sub_type, "_field_types", Sub_annotations) == 0;
    if (!cond) {
        Py_DECREF(Sub_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Sub_type, "__annotations__", Sub_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Sub_annotations);
        return 0;
    ...
    if (!Mult_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Mult_type, "_field_types", Mult_annotations) == 0;
    if (!cond) {
        Py_DECREF(Mult_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Mult_type, "__annotations__", Mult_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Mult_annotations);
        return 0;
    ...
    if (!MatMult_annotations)
        return 0;
    cond = PyObject_SetAttrString(
               state->MatMult_type, "_field_types", MatMult_annotations
           ) == 0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->MatMult_type, "__annotations__", MatMult_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatMult_annotations);
        return 0;
    ...
    if (!Div_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Div_type, "_field_types", Div_annotations) == 0;
    if (!cond) {
        Py_DECREF(Div_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Div_type, "__annotations__", Div_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Div_annotations);
        return 0;
    ...
    if (!Mod_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Mod_type, "_field_types", Mod_annotations) == 0;
    if (!cond) {
        Py_DECREF(Mod_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Mod_type, "__annotations__", Mod_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Mod_annotations);
        return 0;
    ...
    if (!Pow_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Pow_type, "_field_types", Pow_annotations) == 0;
    if (!cond) {
        Py_DECREF(Pow_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Pow_type, "__annotations__", Pow_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Pow_annotations);
        return 0;
    ...
    if (!LShift_annotations)
        return 0;
    cond = PyObject_SetAttrString(
               state->LShift_type, "_field_types", LShift_annotations
           ) == 0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->LShift_type, "__annotations__", LShift_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(LShift_annotations);
        return 0;
    ...
    if (!RShift_annotations)
        return 0;
    cond = PyObject_SetAttrString(
               state->RShift_type, "_field_types", RShift_annotations
           ) == 0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->RShift_type, "__annotations__", RShift_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(RShift_annotations);
        return 0;
    ...
    if (!BitOr_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->BitOr_type, "_field_types", BitOr_annotations) ==
        0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->BitOr_type, "__annotations__", BitOr_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(BitOr_annotations);
        return 0;
    ...
    if (!BitXor_annotations)
        return 0;
    cond = PyObject_SetAttrString(
               state->BitXor_type, "_field_types", BitXor_annotations
           ) == 0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->BitXor_type, "__annotations__", BitXor_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(BitXor_annotations);
        return 0;
    ...
    if (!BitAnd_annotations)
        return 0;
    cond = PyObject_SetAttrString(
               state->BitAnd_type, "_field_types", BitAnd_annotations
           ) == 0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->BitAnd_type, "__annotations__", BitAnd_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(BitAnd_annotations);
        return 0;
    ...
    if (!FloorDiv_annotations)
        return 0;
    cond = PyObject_SetAttrString(
               state->FloorDiv_type, "_field_types", FloorDiv_annotations
           ) == 0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->FloorDiv_type, "__annotations__", FloorDiv_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(FloorDiv_annotations);
        return 0;
    ...
    if (!Invert_annotations)
        return 0;
    cond = PyObject_SetAttrString(
               state->Invert_type, "_field_types", Invert_annotations
           ) == 0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->Invert_type, "__annotations__", Invert_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(Invert_annotations);
        return 0;
    ...
    if (!Not_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->Not_type, "_field_types", Not_annotations) == 0;
    if (!cond) {
        Py_DECREF(Not_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Not_type, "__annotations__", Not_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(Not_annotations);
        return 0;
    ...
    if (!UAdd_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->UAdd_type, "_field_types", UAdd_annotations) == 0;
    if (!cond) {
        Py_DECREF(UAdd_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->UAdd_type, "__annotations__", UAdd_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(UAdd_annotations);
        return 0;
    ...
    if (!USub_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->USub_type, "_field_types", USub_annotations) == 0;
    if (!cond) {
        Py_DECREF(USub_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->USub_type, "__annotations__", USub_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(USub_annotations);
        return 0;
    ...
    if (!Eq_annotations)
        return 0;
    cond = PyObject_SetAttrString(state->Eq_type, "_field_types", Eq_annotations) == 0;
    if (!cond) {
        Py_DECREF(Eq_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Eq_type, "__annotations__", Eq_annotations) == 0;
    if (!cond) {
        Py_DECREF(Eq_annotations);
        return 0;
    }
    ...
    if (!NotEq_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->NotEq_type, "_field_types", NotEq_annotations) ==
        0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->NotEq_type, "__annotations__", NotEq_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(NotEq_annotations);
        return 0;
    ...
    if (!Lt_annotations)
        return 0;
    cond = PyObject_SetAttrString(state->Lt_type, "_field_types", Lt_annotations) == 0;
    if (!cond) {
        Py_DECREF(Lt_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Lt_type, "__annotations__", Lt_annotations) == 0;
    if (!cond) {
        Py_DECREF(Lt_annotations);
        return 0;
    }
    ...
    if (!LtE_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->LtE_type, "_field_types", LtE_annotations) == 0;
    if (!cond) {
        Py_DECREF(LtE_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->LtE_type, "__annotations__", LtE_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(LtE_annotations);
        return 0;
    ...
    if (!Gt_annotations)
        return 0;
    cond = PyObject_SetAttrString(state->Gt_type, "_field_types", Gt_annotations) == 0;
    if (!cond) {
        Py_DECREF(Gt_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Gt_type, "__annotations__", Gt_annotations) == 0;
    if (!cond) {
        Py_DECREF(Gt_annotations);
        return 0;
    }
    ...
    if (!GtE_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->GtE_type, "_field_types", GtE_annotations) == 0;
    if (!cond) {
        Py_DECREF(GtE_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->GtE_type, "__annotations__", GtE_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(GtE_annotations);
        return 0;
    ...
    if (!Is_annotations)
        return 0;
    cond = PyObject_SetAttrString(state->Is_type, "_field_types", Is_annotations) == 0;
    if (!cond) {
        Py_DECREF(Is_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->Is_type, "__annotations__", Is_annotations) == 0;
    if (!cond) {
        Py_DECREF(Is_annotations);
        return 0;
    }
    ...
    if (!IsNot_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->IsNot_type, "_field_types", IsNot_annotations) ==
        0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->IsNot_type, "__annotations__", IsNot_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(IsNot_annotations);
        return 0;
    ...
    if (!In_annotations)
        return 0;
    cond = PyObject_SetAttrString(state->In_type, "_field_types", In_annotations) == 0;
    if (!cond) {
        Py_DECREF(In_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->In_type, "__annotations__", In_annotations) == 0;
    if (!cond) {
        Py_DECREF(In_annotations);
        return 0;
    }
    ...
    if (!NotIn_annotations)
        return 0;
    cond =
        PyObject_SetAttrString(state->NotIn_type, "_field_types", NotIn_annotations) ==
        0;
    if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->NotIn_type, "__annotations__", NotIn_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(NotIn_annotations);
        return 0;
    ...
    if (!comprehension_annotations)
        return 0;
    {
        PyObject *type = state->expr_type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(comprehension_annotations, "target", type) == 0;
        Py_DECREF(type);
        if (!cond) {
    ...
    }
    {
        PyObject *type = state->expr_type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(comprehension_annotations, "iter", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(comprehension_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(comprehension_annotations, "ifs", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(comprehension_annotations);
            return 0;
    ...
    }
    {
        PyObject *type = (PyObject *)&PyLong_Type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(comprehension_annotations, "is_async", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(comprehension_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->comprehension_type, "_field_types", comprehension_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(comprehension_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->comprehension_type, "__annotations__", comprehension_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(comprehension_annotations);
        return 0;
        ...
        return 0;
    {
        ...
        cond = PyDict_SetItemString(ExceptHandler_annotations, "type", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ExceptHandler_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(ExceptHandler_annotations, "name", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ExceptHandler_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(ExceptHandler_annotations, "body", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ExceptHandler_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ExceptHandler_type, "_field_types", ExceptHandler_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ExceptHandler_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ExceptHandler_type, "__annotations__", ExceptHandler_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ExceptHandler_annotations);
        return 0;
        ...
        return 0;
    {
        ...
        cond = PyDict_SetItemString(arguments_annotations, "posonlyargs", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(arguments_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(arguments_annotations, "kwonlyargs", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(arguments_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(arguments_annotations, "kw_defaults", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(arguments_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(arguments_annotations, "defaults", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(arguments_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->arguments_type, "_field_types", arguments_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(arguments_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->arguments_type, "__annotations__", arguments_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(arguments_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->arg_type, "_field_types", arg_annotations) == 0;
    if (!cond) {
        Py_DECREF(arg_annotations);
        return 0;
    }
    cond =
        PyObject_SetAttrString(state->arg_type, "__annotations__", arg_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(arg_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->keyword_type, "_field_types", keyword_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(keyword_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->keyword_type, "__annotations__", keyword_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(keyword_annotations);
        return 0;
    ...
    cond =
        PyObject_SetAttrString(state->alias_type, "_field_types", alias_annotations) ==
        0;
    if (!cond) {
        Py_DECREF(alias_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->alias_type, "__annotations__", alias_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(alias_annotations);
        return 0;
    ...
    if (!withitem_annotations)
        return 0;
    {
        PyObject *type = state->expr_type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(withitem_annotations, "context_expr", type) == 0;
        Py_DECREF(type);
        if (!cond) {
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(withitem_annotations, "optional_vars", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(withitem_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->withitem_type, "_field_types", withitem_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(withitem_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->withitem_type, "__annotations__", withitem_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(withitem_annotations);
        return 0;
    ...
    if (!match_case_annotations)
        return 0;
    {
        PyObject *type = state->pattern_type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(match_case_annotations, "pattern", type) == 0;
        Py_DECREF(type);
        if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->match_case_type, "_field_types", match_case_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(match_case_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->match_case_type, "__annotations__", match_case_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(match_case_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchValue_type, "_field_types", MatchValue_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchValue_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchValue_type, "__annotations__", MatchValue_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchValue_annotations);
        return 0;
    ...
    if (!MatchSingleton_annotations)
        return 0;
    {
        PyObject *type = (PyObject *)&PyBaseObject_Type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(MatchSingleton_annotations, "value", type) == 0;
        Py_DECREF(type);
        if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->MatchSingleton_type, "_field_types", MatchSingleton_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchSingleton_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchSingleton_type, "__annotations__", MatchSingleton_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchSingleton_annotations);
        return 0;
        ...
        return 0;
    {
        ...
        cond = PyDict_SetItemString(MatchSequence_annotations, "patterns", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(MatchSequence_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchSequence_type, "_field_types", MatchSequence_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchSequence_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchSequence_type, "__annotations__", MatchSequence_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchSequence_annotations);
        return 0;
        ...
        return 0;
    {
        ...
        cond = PyDict_SetItemString(MatchMapping_annotations, "keys", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(MatchMapping_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(MatchMapping_annotations, "patterns", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(MatchMapping_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(MatchMapping_annotations, "rest", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(MatchMapping_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchMapping_type, "_field_types", MatchMapping_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchMapping_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchMapping_type, "__annotations__", MatchMapping_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchMapping_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(MatchClass_annotations, "patterns", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(MatchClass_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(MatchClass_annotations, "kwd_attrs", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(MatchClass_annotations);
            return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(MatchClass_annotations, "kwd_patterns", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(MatchClass_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchClass_type, "_field_types", MatchClass_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchClass_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchClass_type, "__annotations__", MatchClass_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchClass_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchStar_type, "_field_types", MatchStar_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchStar_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchStar_type, "__annotations__", MatchStar_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchStar_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchAs_type, "_field_types", MatchAs_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchAs_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchAs_type, "__annotations__", MatchAs_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchAs_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchOr_type, "_field_types", MatchOr_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchOr_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->MatchOr_type, "__annotations__", MatchOr_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(MatchOr_annotations);
        return 0;
    ...
    if (!TypeIgnore_annotations)
        return 0;
    {
        PyObject *type = (PyObject *)&PyLong_Type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(TypeIgnore_annotations, "lineno", type) == 0;
        Py_DECREF(type);
        if (!cond) {
    ...
    cond = PyObject_SetAttrString(
               state->TypeIgnore_type, "_field_types", TypeIgnore_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TypeIgnore_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TypeIgnore_type, "__annotations__", TypeIgnore_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TypeIgnore_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(TypeVar_annotations, "default_value", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(TypeVar_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TypeVar_type, "_field_types", TypeVar_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TypeVar_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TypeVar_type, "__annotations__", TypeVar_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TypeVar_annotations);
        return 0;
    ...
    }
    {
        ...
        cond = PyDict_SetItemString(ParamSpec_annotations, "default_value", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(ParamSpec_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ParamSpec_type, "_field_types", ParamSpec_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ParamSpec_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->ParamSpec_type, "__annotations__", ParamSpec_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(ParamSpec_annotations);
        return 0;
    ...
    if (!TypeVarTuple_annotations)
        return 0;
    {
        PyObject *type = (PyObject *)&PyUnicode_Type;
        Py_INCREF(type);
        cond = PyDict_SetItemString(TypeVarTuple_annotations, "name", type) == 0;
        Py_DECREF(type);
        if (!cond) {
    ...
    }
    {
        ...
        cond =
            PyDict_SetItemString(TypeVarTuple_annotations, "default_value", type) == 0;
        Py_DECREF(type);
        if (!cond) {
            Py_DECREF(TypeVarTuple_annotations);
            return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TypeVarTuple_type, "_field_types", TypeVarTuple_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TypeVarTuple_annotations);
        return 0;
    ...
    cond = PyObject_SetAttrString(
               state->TypeVarTuple_type, "__annotations__", TypeVarTuple_annotations
           ) == 0;
    if (!cond) {
        Py_DECREF(TypeVarTuple_annotations);
        return 0;
...
ast_type_init(PyObject *self, PyObject *args, PyObject *kw) {
    ...
    if (PyObject_GetOptionalAttr((PyObject *)Py_TYPE(self), state->_fields, &fields) <
        0) {
        goto cleanup;
    }
    if (fields) {
    ...
    if (numfields < PyTuple_GET_SIZE(args)) {
        PyErr_Format(
            PyExc_TypeError,
            "%.400s constructor takes at most "
    ...
    if (kw) {
        ...
        while (PyDict_Next(kw, &i, &key, &value)) {
            ...
            if (contains == -1) {
                ...
                if (attributes == NULL) {
                    attributes =
                        PyObject_GetAttr((PyObject *)Py_TYPE(self), state->_attributes);
                    if (attributes == NULL) {
                        res = -1;
                        goto cleanup;
                    }
    ...
    if (size > 0) {
        if (PyObject_GetOptionalAttr(
                (PyObject *)Py_TYPE(self), &_Py_ID(_field_types), &field_types
            ) < 0) {
            res = -1;
            goto cleanup;
        }
...
ast_type_reduce(PyObject *self, PyObject *unused) {
    ...
    if (dict) {
        ...
        //   or the unpickling or deepcopying of the object will trigger
        //   DeprecationWarnings.
        ...
        if (PyObject_GetOptionalAttr(
                (PyObject *)Py_TYPE(self), state->_fields, &fields
            ) < 0) {
            goto cleanup;
        }
        if (fields) {
...
ast_type_replace_check(
    ...
    if (dict) {
        ...
        if (attributes) {
            ...
            PyObject *unused = PyObject_CallMethodOneArg(
                expecting, &_Py_ID(difference_update), attributes
            );
            if (unused == NULL) {
                Py_DECREF(expecting);
                return -1;
 ...
 */
static inline int
ast_type_replace_update_payload(PyObject *payload, PyObject *keys, PyObject *dict) {
    assert(dict != NULL);
    if (keys == NULL) {
        return 0;
    }
...
static PyMethodDef ast_type_methods[] = {
    ...
    {"__replace__",
     _PyCFunction_CAST(ast_type_replace),
...
static int
add_attributes(
    struct ast_state *state, PyObject *type, const char *const *attrs, int num_fields
) {
    int i, result;
...
static PyObject *
ast2obj_object(
    struct ast_state *Py_UNUSED(state), struct validator *Py_UNUSED(vstate), void *o
) {
...
static PyObject *
ast2obj_int(
    struct ast_state *Py_UNUSED(state), struct validator *Py_UNUSED(vstate), long b
) {
...
static int
obj2ast_object(
    struct ast_state *Py_UNUSED(state), PyObject *obj, PyObject **out, PyArena *arena
) {
    if (obj == Py_None)
        obj = NULL;
    if (obj) {
...
static int
obj2ast_identifier(
    struct ast_state *state, PyObject *obj, PyObject **out, PyArena *arena
) {
...
static int
obj2ast_string(struct ast_state *state, PyObject *obj, PyObject **out, PyArena *arena) {
...
static int
obj2ast_int(
    struct ast_state *Py_UNUSED(state), PyObject *obj, int *out, PyArena *arena
) {
    int i;
    if (!PyLong_Check(obj)) {
...
static int
add_ast_fields(struct ast_state *state) {
...
init_types(void *arg) {
    ...
    if (!state->mod_type)
        return -1;
    if (add_attributes(state, state->mod_type, NULL, 0) < 0)
        return -1;
    state->Module_type = make_type(
        state,
        "Module",
        state->mod_type,
        Module_fields,
    ...
    if (!state->Module_type)
        return -1;
    state->Interactive_type = make_type(
        state,
        "Interactive",
        state->mod_type,
        Interactive_fields,
    ...
    if (!state->Interactive_type)
        return -1;
    state->Expression_type = make_type(
        state,
        "Expression",
        state->mod_type,
        Expression_fields,
    ...
    if (!state->Expression_type)
        return -1;
    state->FunctionType_type = make_type(
        state,
        "FunctionType",
        state->mod_type,
        FunctionType_fields,
    ...
    if (!state->FunctionType_type)
        return -1;
    state->stmt_type = make_type(
        state,
        "stmt",
        state->AST_type,
        NULL,
        0,
        "stmt = FunctionDef(identifier name, arguments args, stmt* body, expr* "
        "decorator_list, expr? returns, string? type_comment, type_param* "
        "type_params)\n"
    ...
    if (!state->stmt_type)
        return -1;
    if (add_attributes(state, state->stmt_type, stmt_attributes, 4) < 0)
        return -1;
    if (PyObject_SetAttr(state->stmt_type, state->end_lineno, Py_None) == -1)
        return -1;
    if (PyObject_SetAttr(state->stmt_type, state->end_col_offset, Py_None) == -1)
        return -1;
    state->FunctionDef_type = make_type(
        state,
        "FunctionDef",
        state->stmt_type,
        FunctionDef_fields,
    ...
    if (!state->FunctionDef_type)
        return -1;
    if (PyObject_SetAttr(state->FunctionDef_type, state->returns, Py_None) == -1)
        return -1;
    if (PyObject_SetAttr(state->FunctionDef_type, state->type_comment, Py_None) == -1)
        return -1;
    state->AsyncFunctionDef_type = make_type(
        state,
        "AsyncFunctionDef",
        state->stmt_type,
    ...
    if (!state->AsyncFunctionDef_type)
        return -1;
    if (PyObject_SetAttr(state->AsyncFunctionDef_type, state->returns, Py_None) == -1)
        return -1;
    if (PyObject_SetAttr(state->AsyncFunctionDef_type, state->type_comment, Py_None) ==
        -1)
        return -1;
    state->ClassDef_type = make_type(
        state,
        "ClassDef",
        state->stmt_type,
        ClassDef_fields,
    ...
    if (!state->ClassDef_type)
        return -1;
    state->Return_type = make_type(
        state, "Return", state->stmt_type, Return_fields, 1, "Return(expr? value)"
    );
    if (!state->Return_type)
        return -1;
    if (PyObject_SetAttr(state->Return_type, state->value, Py_None) == -1)
        return -1;
    state->Delete_type = make_type(
        state, "Delete", state->stmt_type, Delete_fields, 1, "Delete(expr* targets)"
    );
    if (!state->Delete_type)
        return -1;
    state->Assign_type = make_type(
        state,
        "Assign",
        state->stmt_type,
        Assign_fields,
    ...
    if (!state->Assign_type)
        return -1;
    if (PyObject_SetAttr(state->Assign_type, state->type_comment, Py_None) == -1)
        return -1;
    state->TypeAlias_type = make_type(
        state,
        "TypeAlias",
        state->stmt_type,
        TypeAlias_fields,
    ...
    if (!state->TypeAlias_type)
        return -1;
    state->AugAssign_type = make_type(
        state,
        "AugAssign",
        state->stmt_type,
        AugAssign_fields,
    ...
    if (!state->AugAssign_type)
        return -1;
    state->AnnAssign_type = make_type(
        state,
        "AnnAssign",
        state->stmt_type,
        AnnAssign_fields,
    ...
    if (!state->AsyncFor_type)
        return -1;
    if (PyObject_SetAttr(state->AsyncFor_type, state->type_comment, Py_None) == -1)
        return -1;
    state->While_type = make_type(
        state,
        "While",
        state->stmt_type,
        While_fields,
    ...
    if (PyObject_SetAttr(state->With_type, state->type_comment, Py_None) == -1)
        return -1;
    state->AsyncWith_type = make_type(
        state,
        "AsyncWith",
        state->stmt_type,
        AsyncWith_fields,
    ...
    if (!state->AsyncWith_type)
        return -1;
    if (PyObject_SetAttr(state->AsyncWith_type, state->type_comment, Py_None) == -1)
        return -1;
    state->Match_type = make_type(
        state,
        "Match",
        state->stmt_type,
        Match_fields,
    ...
    if (PyObject_SetAttr(state->Assert_type, state->msg, Py_None) == -1)
        return -1;
    state->Import_type = make_type(
        state, "Import", state->stmt_type, Import_fields, 1, "Import(alias* names)"
    );
    if (!state->Import_type)
        return -1;
    state->ImportFrom_type = make_type(
        state,
        "ImportFrom",
        state->stmt_type,
        ImportFrom_fields,
    ...
    if (PyObject_SetAttr(state->ImportFrom_type, state->level, Py_None) == -1)
        return -1;
    state->Global_type = make_type(
        state, "Global", state->stmt_type, Global_fields, 1, "Global(identifier* names)"
    );
    if (!state->Global_type)
        return -1;
    state->Nonlocal_type = make_type(
        state,
        "Nonlocal",
        state->stmt_type,
        Nonlocal_fields,
    ...
    if (!state->Nonlocal_type)
        return -1;
    state->Expr_type =
        make_type(state, "Expr", state->stmt_type, Expr_fields, 1, "Expr(expr value)");
    if (!state->Expr_type)
        return -1;
    state->Pass_type = make_type(state, "Pass", state->stmt_type, NULL, 0, "Pass");
    if (!state->Pass_type)
        return -1;
    state->Break_type = make_type(state, "Break", state->stmt_type, NULL, 0, "Break");
    if (!state->Break_type)
        return -1;
    state->Continue_type =
        make_type(state, "Continue", state->stmt_type, NULL, 0, "Continue");
    if (!state->Continue_type)
        return -1;
    state->expr_type = make_type(
        state,
        "expr",
        state->AST_type,
        NULL,
    ...
    if (!state->expr_type)
        return -1;
    if (add_attributes(state, state->expr_type, expr_attributes, 4) < 0)
        return -1;
    if (PyObject_SetAttr(state->expr_type, state->end_lineno, Py_None) == -1)
        return -1;
    if (PyObject_SetAttr(state->expr_type, state->end_col_offset, Py_None) == -1)
        return -1;
    state->BoolOp_type = make_type(
        state,
        "BoolOp",
        state->expr_type,
        BoolOp_fields,
    ...
    if (!state->BoolOp_type)
        return -1;
    state->NamedExpr_type = make_type(
        state,
        "NamedExpr",
        state->expr_type,
        NamedExpr_fields,
    ...
    if (!state->Dict_type)
        return -1;
    state->Set_type =
        make_type(state, "Set", state->expr_type, Set_fields, 1, "Set(expr* elts)");
    if (!state->Set_type)
        return -1;
    state->ListComp_type = make_type(
        state,
        "ListComp",
        state->expr_type,
        ListComp_fields,
    ...
    if (!state->DictComp_type)
        return -1;
    state->GeneratorExp_type = make_type(
        state,
        "GeneratorExp",
        state->expr_type,
        GeneratorExp_fields,
    ...
    if (!state->GeneratorExp_type)
        return -1;
    state->Await_type = make_type(
        state, "Await", state->expr_type, Await_fields, 1, "Await(expr value)"
    );
    if (!state->Await_type)
        return -1;
    state->Yield_type = make_type(
        state, "Yield", state->expr_type, Yield_fields, 1, "Yield(expr? value)"
    );
    if (!state->Yield_type)
        return -1;
    if (PyObject_SetAttr(state->Yield_type, state->value, Py_None) == -1)
        return -1;
    state->YieldFrom_type = make_type(
        state,
        "YieldFrom",
        state->expr_type,
        YieldFrom_fields,
    ...
    if (!state->Call_type)
        return -1;
    state->FormattedValue_type = make_type(
        state,
        "FormattedValue",
        state->expr_type,
    ...
    if (!state->FormattedValue_type)
        return -1;
    if (PyObject_SetAttr(state->FormattedValue_type, state->format_spec, Py_None) == -1)
        return -1;
    state->JoinedStr_type = make_type(
        state,
        "JoinedStr",
        state->expr_type,
        JoinedStr_fields,
    ...
    if (PyObject_SetAttr(state->Constant_type, state->kind, Py_None) == -1)
        return -1;
    state->Attribute_type = make_type(
        state,
        "Attribute",
        state->expr_type,
        Attribute_fields,
    ...
    if (!state->Attribute_type)
        return -1;
    state->Subscript_type = make_type(
        state,
        "Subscript",
        state->expr_type,
        Subscript_fields,
    ...
    if (PyObject_SetAttr(state->Slice_type, state->step, Py_None) == -1)
        return -1;
    state->expr_context_type = make_type(
        state,
        "expr_context",
        state->AST_type,
        NULL,
    ...
    if (!state->expr_context_type)
        return -1;
    if (add_attributes(state, state->expr_context_type, NULL, 0) < 0)
        return -1;
    state->Load_type =
        make_type(state, "Load", state->expr_context_type, NULL, 0, "Load");
    if (!state->Load_type)
        return -1;
    state->Load_singleton =
        PyType_GenericNew((PyTypeObject *)state->Load_type, NULL, NULL);
    if (!state->Load_singleton)
        return -1;
    state->Store_type =
        make_type(state, "Store", state->expr_context_type, NULL, 0, "Store");
    if (!state->Store_type)
        return -1;
    state->Store_singleton =
        PyType_GenericNew((PyTypeObject *)state->Store_type, NULL, NULL);
    if (!state->Store_singleton)
        return -1;
    state->Del_type = make_type(state, "Del", state->expr_context_type, NULL, 0, "Del");
    if (!state->Del_type)
        return -1;
    state->Del_singleton =
        PyType_GenericNew((PyTypeObject *)state->Del_type, NULL, NULL);
    if (!state->Del_singleton)
        return -1;
    state->boolop_type =
        make_type(state, "boolop", state->AST_type, NULL, 0, "boolop = And | Or");
    if (!state->boolop_type)
        return -1;
    if (add_attributes(state, state->boolop_type, NULL, 0) < 0)
        return -1;
    state->And_type = make_type(state, "And", state->boolop_type, NULL, 0, "And");
    if (!state->And_type)
        return -1;
    state->And_singleton =
        PyType_GenericNew((PyTypeObject *)state->And_type, NULL, NULL);
    if (!state->And_singleton)
        return -1;
    state->Or_type = make_type(state, "Or", state->boolop_type, NULL, 0, "Or");
    if (!state->Or_type)
        return -1;
    state->Or_singleton = PyType_GenericNew((PyTypeObject *)state->Or_type, NULL, NULL);
    if (!state->Or_singleton)
        return -1;
    state->operator_type = make_type(
        state,
        "operator",
        state->AST_type,
        NULL,
    ...
    if (!state->operator_type)
        return -1;
    if (add_attributes(state, state->operator_type, NULL, 0) < 0)
        return -1;
    state->Add_type = make_type(state, "Add", state->operator_type, NULL, 0, "Add");
    if (!state->Add_type)
        return -1;
    state->Add_singleton =
        PyType_GenericNew((PyTypeObject *)state->Add_type, NULL, NULL);
    if (!state->Add_singleton)
        return -1;
    state->Sub_type = make_type(state, "Sub", state->operator_type, NULL, 0, "Sub");
    if (!state->Sub_type)
        return -1;
    state->Sub_singleton =
        PyType_GenericNew((PyTypeObject *)state->Sub_type, NULL, NULL);
    if (!state->Sub_singleton)
        return -1;
    state->Mult_type = make_type(state, "Mult", state->operator_type, NULL, 0, "Mult");
    if (!state->Mult_type)
        return -1;
    state->Mult_singleton =
        PyType_GenericNew((PyTypeObject *)state->Mult_type, NULL, NULL);
    if (!state->Mult_singleton)
        return -1;
    state->MatMult_type =
        make_type(state, "MatMult", state->operator_type, NULL, 0, "MatMult");
    if (!state->MatMult_type)
        return -1;
    state->MatMult_singleton =
        PyType_GenericNew((PyTypeObject *)state->MatMult_type, NULL, NULL);
    if (!state->MatMult_singleton)
        return -1;
    state->Div_type = make_type(state, "Div", state->operator_type, NULL, 0, "Div");
    if (!state->Div_type)
        return -1;
    state->Div_singleton =
        PyType_GenericNew((PyTypeObject *)state->Div_type, NULL, NULL);
    if (!state->Div_singleton)
        return -1;
    state->Mod_type = make_type(state, "Mod", state->operator_type, NULL, 0, "Mod");
    if (!state->Mod_type)
        return -1;
    state->Mod_singleton =
        PyType_GenericNew((PyTypeObject *)state->Mod_type, NULL, NULL);
    if (!state->Mod_singleton)
        return -1;
    state->Pow_type = make_type(state, "Pow", state->operator_type, NULL, 0, "Pow");
    if (!state->Pow_type)
        return -1;
    state->Pow_singleton =
        PyType_GenericNew((PyTypeObject *)state->Pow_type, NULL, NULL);
    if (!state->Pow_singleton)
        return -1;
    state->LShift_type =
        make_type(state, "LShift", state->operator_type, NULL, 0, "LShift");
    if (!state->LShift_type)
        return -1;
    state->LShift_singleton =
        PyType_GenericNew((PyTypeObject *)state->LShift_type, NULL, NULL);
    if (!state->LShift_singleton)
        return -1;
    state->RShift_type =
        make_type(state, "RShift", state->operator_type, NULL, 0, "RShift");
    if (!state->RShift_type)
        return -1;
    state->RShift_singleton =
        PyType_GenericNew((PyTypeObject *)state->RShift_type, NULL, NULL);
    if (!state->RShift_singleton)
        return -1;
    state->BitOr_type =
        make_type(state, "BitOr", state->operator_type, NULL, 0, "BitOr");
    if (!state->BitOr_type)
        return -1;
    state->BitOr_singleton =
        PyType_GenericNew((PyTypeObject *)state->BitOr_type, NULL, NULL);
    if (!state->BitOr_singleton)
        return -1;
    state->BitXor_type =
        make_type(state, "BitXor", state->operator_type, NULL, 0, "BitXor");
    if (!state->BitXor_type)
        return -1;
    state->BitXor_singleton =
        PyType_GenericNew((PyTypeObject *)state->BitXor_type, NULL, NULL);
    if (!state->BitXor_singleton)
        return -1;
    state->BitAnd_type =
        make_type(state, "BitAnd", state->operator_type, NULL, 0, "BitAnd");
    if (!state->BitAnd_type)
        return -1;
    state->BitAnd_singleton =
        PyType_GenericNew((PyTypeObject *)state->BitAnd_type, NULL, NULL);
    if (!state->BitAnd_singleton)
        return -1;
    state->FloorDiv_type =
        make_type(state, "FloorDiv", state->operator_type, NULL, 0, "FloorDiv");
    if (!state->FloorDiv_type)
        return -1;
    state->FloorDiv_singleton =
        PyType_GenericNew((PyTypeObject *)state->FloorDiv_type, NULL, NULL);
    ...
    if (!state->unaryop_type)
        return -1;
    if (add_attributes(state, state->unaryop_type, NULL, 0) < 0)
        return -1;
    state->Invert_type =
        make_type(state, "Invert", state->unaryop_type, NULL, 0, "Invert");
    if (!state->Invert_type)
        return -1;
    state->Invert_singleton =
        PyType_GenericNew((PyTypeObject *)state->Invert_type, NULL, NULL);
    if (!state->Invert_singleton)
        return -1;
    state->Not_type = make_type(state, "Not", state->unaryop_type, NULL, 0, "Not");
    if (!state->Not_type)
        return -1;
    state->Not_singleton =
        PyType_GenericNew((PyTypeObject *)state->Not_type, NULL, NULL);
    if (!state->Not_singleton)
        return -1;
    state->UAdd_type = make_type(state, "UAdd", state->unaryop_type, NULL, 0, "UAdd");
    if (!state->UAdd_type)
        return -1;
    state->UAdd_singleton =
        PyType_GenericNew((PyTypeObject *)state->UAdd_type, NULL, NULL);
    if (!state->UAdd_singleton)
        return -1;
    state->USub_type = make_type(state, "USub", state->unaryop_type, NULL, 0, "USub");
    if (!state->USub_type)
        return -1;
    state->USub_singleton =
        PyType_GenericNew((PyTypeObject *)state->USub_type, NULL, NULL);
    if (!state->USub_singleton)
        return -1;
    state->cmpop_type = make_type(
        state,
        "cmpop",
        state->AST_type,
        NULL,
    ...
    if (!state->cmpop_type)
        return -1;
    if (add_attributes(state, state->cmpop_type, NULL, 0) < 0)
        return -1;
    state->Eq_type = make_type(state, "Eq", state->cmpop_type, NULL, 0, "Eq");
    if (!state->Eq_type)
        return -1;
    state->Eq_singleton = PyType_GenericNew((PyTypeObject *)state->Eq_type, NULL, NULL);
    if (!state->Eq_singleton)
        return -1;
    state->NotEq_type = make_type(state, "NotEq", state->cmpop_type, NULL, 0, "NotEq");
    if (!state->NotEq_type)
        return -1;
    state->NotEq_singleton =
        PyType_GenericNew((PyTypeObject *)state->NotEq_type, NULL, NULL);
    if (!state->NotEq_singleton)
        return -1;
    state->Lt_type = make_type(state, "Lt", state->cmpop_type, NULL, 0, "Lt");
    if (!state->Lt_type)
        return -1;
    state->Lt_singleton = PyType_GenericNew((PyTypeObject *)state->Lt_type, NULL, NULL);
    if (!state->Lt_singleton)
        return -1;
    state->LtE_type = make_type(state, "LtE", state->cmpop_type, NULL, 0, "LtE");
    if (!state->LtE_type)
        return -1;
    state->LtE_singleton =
        PyType_GenericNew((PyTypeObject *)state->LtE_type, NULL, NULL);
    if (!state->LtE_singleton)
        return -1;
    state->Gt_type = make_type(state, "Gt", state->cmpop_type, NULL, 0, "Gt");
    if (!state->Gt_type)
        return -1;
    state->Gt_singleton = PyType_GenericNew((PyTypeObject *)state->Gt_type, NULL, NULL);
    if (!state->Gt_singleton)
        return -1;
    state->GtE_type = make_type(state, "GtE", state->cmpop_type, NULL, 0, "GtE");
    if (!state->GtE_type)
        return -1;
    state->GtE_singleton =
        PyType_GenericNew((PyTypeObject *)state->GtE_type, NULL, NULL);
    if (!state->GtE_singleton)
        return -1;
    state->Is_type = make_type(state, "Is", state->cmpop_type, NULL, 0, "Is");
    if (!state->Is_type)
        return -1;
    state->Is_singleton = PyType_GenericNew((PyTypeObject *)state->Is_type, NULL, NULL);
    if (!state->Is_singleton)
        return -1;
    state->IsNot_type = make_type(state, "IsNot", state->cmpop_type, NULL, 0, "IsNot");
    if (!state->IsNot_type)
        return -1;
    state->IsNot_singleton =
        PyType_GenericNew((PyTypeObject *)state->IsNot_type, NULL, NULL);
    if (!state->IsNot_singleton)
        return -1;
    state->In_type = make_type(state, "In", state->cmpop_type, NULL, 0, "In");
    if (!state->In_type)
        return -1;
    state->In_singleton = PyType_GenericNew((PyTypeObject *)state->In_type, NULL, NULL);
    if (!state->In_singleton)
        return -1;
    state->NotIn_type = make_type(state, "NotIn", state->cmpop_type, NULL, 0, "NotIn");
    if (!state->NotIn_type)
        return -1;
    state->NotIn_singleton =
        PyType_GenericNew((PyTypeObject *)state->NotIn_type, NULL, NULL);
    if (!state->NotIn_singleton)
        return -1;
    state->comprehension_type = make_type(
        state,
        "comprehension",
        state->AST_type,
    ...
    if (!state->comprehension_type)
        return -1;
    if (add_attributes(state, state->comprehension_type, NULL, 0) < 0)
        return -1;
    state->excepthandler_type = make_type(
        state,
        "excepthandler",
        state->AST_type,
        NULL,
    ...
    if (!state->excepthandler_type)
        return -1;
    if (add_attributes(state, state->excepthandler_type, excepthandler_attributes, 4) <
        0)
        return -1;
    if (PyObject_SetAttr(state->excepthandler_type, state->end_lineno, Py_None) == -1)
        return -1;
    if (PyObject_SetAttr(state->excepthandler_type, state->end_col_offset, Py_None) ==
        -1)
        return -1;
    state->ExceptHandler_type = make_type(
        state,
    ...
    if (PyObject_SetAttr(state->ExceptHandler_type, state->name, Py_None) == -1)
        return -1;
    state->arguments_type = make_type(
        state,
        "arguments",
        state->AST_type,
        arguments_fields,
    ...
    if (!state->arguments_type)
        return -1;
    if (add_attributes(state, state->arguments_type, NULL, 0) < 0)
        return -1;
    ...
    if (!state->arg_type)
        return -1;
    if (add_attributes(state, state->arg_type, arg_attributes, 4) < 0)
        return -1;
    ...
    if (PyObject_SetAttr(state->keyword_type, state->end_lineno, Py_None) == -1)
        return -1;
    if (PyObject_SetAttr(state->keyword_type, state->end_col_offset, Py_None) == -1)
        return -1;
    state->alias_type = make_type(
        state,
        "alias",
        state->AST_type,
        alias_fields,
    ...
    if (PyObject_SetAttr(state->alias_type, state->end_lineno, Py_None) == -1)
        return -1;
    if (PyObject_SetAttr(state->alias_type, state->end_col_offset, Py_None) == -1)
        return -1;
    state->withitem_type = make_type(
        state,
        "withitem",
        state->AST_type,
        withitem_fields,
    ...
    if (!state->withitem_type)
        return -1;
    if (add_attributes(state, state->withitem_type, NULL, 0) < 0)
        return -1;
    if (PyObject_SetAttr(state->withitem_type, state->optional_vars, Py_None) == -1)
        return -1;
    state->match_case_type = make_type(
        state,
        "match_case",
        state->AST_type,
        match_case_fields,
    ...
    if (!state->match_case_type)
        return -1;
    if (add_attributes(state, state->match_case_type, NULL, 0) < 0)
        return -1;
    if (PyObject_SetAttr(state->match_case_type, state->guard, Py_None) == -1)
        return -1;
    state->pattern_type = make_type(
        state,
        "pattern",
        state->AST_type,
        NULL,
    ...
    if (add_attributes(state, state->pattern_type, pattern_attributes, 4) < 0)
        return -1;
    state->MatchValue_type = make_type(
        state,
        "MatchValue",
        state->pattern_type,
        MatchValue_fields,
    ...
    if (!state->MatchValue_type)
        return -1;
    state->MatchSingleton_type = make_type(
        state,
        "MatchSingleton",
        state->pattern_type,
        MatchSingleton_fields,
        1,
        "MatchSingleton(constant value)"
    );
    if (!state->MatchSingleton_type)
        return -1;
    state->MatchSequence_type = make_type(
        state,
        "MatchSequence",
        state->pattern_type,
        MatchSequence_fields,
        1,
        "MatchSequence(pattern* patterns)"
    );
    if (!state->MatchSequence_type)
        return -1;
    state->MatchMapping_type = make_type(
        state,
        "MatchMapping",
        state->pattern_type,
        MatchMapping_fields,
    ...
    if (PyObject_SetAttr(state->MatchMapping_type, state->rest, Py_None) == -1)
        return -1;
    state->MatchClass_type = make_type(
        state,
        "MatchClass",
        state->pattern_type,
        MatchClass_fields,
    ...
    if (!state->MatchClass_type)
        return -1;
    state->MatchStar_type = make_type(
        state,
        "MatchStar",
        state->pattern_type,
        MatchStar_fields,
    ...
    if (!state->MatchOr_type)
        return -1;
    state->type_ignore_type = make_type(
        state,
        "type_ignore",
        state->AST_type,
        NULL,
    ...
    if (!state->type_ignore_type)
        return -1;
    if (add_attributes(state, state->type_ignore_type, NULL, 0) < 0)
        return -1;
    ...
    if (!state->TypeIgnore_type)
        return -1;
    state->type_param_type = make_type(
        state,
        "type_param",
        state->AST_type,
        NULL,
    ...
    if (!state->type_param_type)
        return -1;
    if (add_attributes(state, state->type_param_type, type_param_attributes, 4) < 0)
        return -1;
    state->TypeVar_type = make_type(
        state,
        "TypeVar",
    ...
    if (!state->TypeVar_type)
        return -1;
    if (PyObject_SetAttr(state->TypeVar_type, state->bound, Py_None) == -1)
        return -1;
    if (PyObject_SetAttr(state->TypeVar_type, state->default_value, Py_None) == -1)
        return -1;
    state->ParamSpec_type = make_type(
        state,
        "ParamSpec",
        state->type_param_type,
        ParamSpec_fields,
    ...
    if (!state->ParamSpec_type)
        return -1;
    if (PyObject_SetAttr(state->ParamSpec_type, state->default_value, Py_None) == -1)
        return -1;
    state->TypeVarTuple_type = make_type(
        state,
        "TypeVarTuple",
        state->type_param_type,
        TypeVarTuple_fields,
    ...
    if (!state->TypeVarTuple_type)
        return -1;
    if (PyObject_SetAttr(state->TypeVarTuple_type, state->default_value, Py_None) == -1)
        return -1;
...
static int
obj2ast_stmt(struct ast_state *state, PyObject *obj, stmt_ty *out, PyArena *arena);
static int
obj2ast_expr(struct ast_state *state, PyObject *obj, expr_ty *out, PyArena *arena);
static int
obj2ast_expr_context(
    struct ast_state *state, PyObject *obj, expr_context_ty *out, PyArena *arena
);
static int
obj2ast_boolop(struct ast_state *state, PyObject *obj, boolop_ty *out, PyArena *arena);
static int
obj2ast_operator(
    struct ast_state *state, PyObject *obj, operator_ty *out, PyArena *arena
);
static int
obj2ast_unaryop(
    struct ast_state *state, PyObject *obj, unaryop_ty *out, PyArena *arena
);
static int
obj2ast_cmpop(struct ast_state *state, PyObject *obj, cmpop_ty *out, PyArena *arena);
static int
obj2ast_comprehension(
    struct ast_state *state, PyObject *obj, comprehension_ty *out, PyArena *arena
);
static int
obj2ast_excepthandler(
    struct ast_state *state, PyObject *obj, excepthandler_ty *out, PyArena *arena
);
static int
obj2ast_arguments(
    struct ast_state *state, PyObject *obj, arguments_ty *out, PyArena *arena
);
static int
obj2ast_arg(struct ast_state *state, PyObject *obj, arg_ty *out, PyArena *arena);
static int
obj2ast_keyword(
    struct ast_state *state, PyObject *obj, keyword_ty *out, PyArena *arena
);
static int
obj2ast_alias(struct ast_state *state, PyObject *obj, alias_ty *out, PyArena *arena);
static int
obj2ast_withitem(
    struct ast_state *state, PyObject *obj, withitem_ty *out, PyArena *arena
);
static int
obj2ast_match_case(
    struct ast_state *state, PyObject *obj, match_case_ty *out, PyArena *arena
);
static int
obj2ast_pattern(
    struct ast_state *state, PyObject *obj, pattern_ty *out, PyArena *arena
);
static int
obj2ast_type_ignore(
    struct ast_state *state, PyObject *obj, type_ignore_ty *out, PyArena *arena
);
static int
obj2ast_type_param(
    struct ast_state *state, PyObject *obj, type_param_ty *out, PyArena *arena
);

mod_ty
_PyAST_Module(asdl_stmt_seq *body, asdl_type_ignore_seq *type_ignores, PyArena *arena) {
    mod_ty p;
...
_PyAST_Expression(expr_ty body, PyArena *arena) {
    mod_ty p;
    if (!body) {
        PyErr_SetString(PyExc_ValueError, "field 'body' is required for Expression");
        return NULL;
    }
    p = (mod_ty)_PyArena_Malloc(arena, sizeof(*p));
    if (!p)
...
_PyAST_FunctionType(asdl_expr_seq *argtypes, expr_ty returns, PyArena *arena) {
    ...
    if (!returns) {
        PyErr_SetString(
            PyExc_ValueError, "field 'returns' is required for FunctionType"
        );
        return NULL;
    }
    p = (mod_ty)_PyArena_Malloc(arena, sizeof(*p));
...
_PyAST_FunctionDef(
    ...
    stmt_ty p;
    if (!name) {
        PyErr_SetString(PyExc_ValueError, "field 'name' is required for FunctionDef");
        return NULL;
    }
    if (!args) {
        PyErr_SetString(PyExc_ValueError, "field 'args' is required for FunctionDef");
        return NULL;
    }
...
_PyAST_AsyncFunctionDef(
    ...
    if (!name) {
        PyErr_SetString(
            PyExc_ValueError, "field 'name' is required for AsyncFunctionDef"
        );
        return NULL;
    }
    if (!args) {
        PyErr_SetString(
            PyExc_ValueError, "field 'args' is required for AsyncFunctionDef"
        );
        return NULL;
    }
    p = (stmt_ty)_PyArena_Malloc(arena, sizeof(*p));
...
_PyAST_TypeAlias(
    ...
    if (!value) {
        PyErr_SetString(PyExc_ValueError, "field 'value' is required for TypeAlias");
        return NULL;
    }
    p = (stmt_ty)_PyArena_Malloc(arena, sizeof(*p));
    if (!p)
...
_PyAST_AugAssign(
    ...
    stmt_ty p;
    if (!target) {
        PyErr_SetString(PyExc_ValueError, "field 'target' is required for AugAssign");
        return NULL;
    }
    if (!op) {
    ...
    if (!value) {
        PyErr_SetString(PyExc_ValueError, "field 'value' is required for AugAssign");
        return NULL;
    }
    p = (stmt_ty)_PyArena_Malloc(arena, sizeof(*p));
    if (!p)
...
_PyAST_AnnAssign(
    ...
    stmt_ty p;
    if (!target) {
        PyErr_SetString(PyExc_ValueError, "field 'target' is required for AnnAssign");
        return NULL;
    }
    if (!annotation) {
        PyErr_SetString(
            PyExc_ValueError, "field 'annotation' is required for AnnAssign"
        );
        return NULL;
    }
    p = (stmt_ty)_PyArena_Malloc(arena, sizeof(*p));
...
_PyAST_NamedExpr(
    ...
    expr_ty p;
    if (!target) {
        PyErr_SetString(PyExc_ValueError, "field 'target' is required for NamedExpr");
        return NULL;
    }
    if (!value) {
        PyErr_SetString(PyExc_ValueError, "field 'value' is required for NamedExpr");
        return NULL;
    }
    p = (expr_ty)_PyArena_Malloc(arena, sizeof(*p));
    if (!p)
...
_PyAST_UnaryOp(
    ...
    if (!operand) {
        PyErr_SetString(PyExc_ValueError, "field 'operand' is required for UnaryOp");
        return NULL;
    }
    p = (expr_ty)_PyArena_Malloc(arena, sizeof(*p));
    if (!p)
...
_PyAST_GeneratorExp(
    ...
    expr_ty p;
    if (!elt) {
        PyErr_SetString(PyExc_ValueError, "field 'elt' is required for GeneratorExp");
        return NULL;
    }
    p = (expr_ty)_PyArena_Malloc(arena, sizeof(*p));
    if (!p)
...
_PyAST_YieldFrom(
    ...
    expr_ty p;
    if (!value) {
        PyErr_SetString(PyExc_ValueError, "field 'value' is required for YieldFrom");
        return NULL;
    }
    p = (expr_ty)_PyArena_Malloc(arena, sizeof(*p));
    if (!p)
...
_PyAST_FormattedValue(
    ...
    if (!value) {
        PyErr_SetString(
            PyExc_ValueError, "field 'value' is required for FormattedValue"
        );
        return NULL;
    }
    p = (expr_ty)_PyArena_Malloc(arena, sizeof(*p));
...
_PyAST_Attribute(
    ...
    expr_ty p;
    if (!value) {
        PyErr_SetString(PyExc_ValueError, "field 'value' is required for Attribute");
        return NULL;
    }
    if (!attr) {
...
_PyAST_Subscript(
    ...
    expr_ty p;
    if (!value) {
        PyErr_SetString(PyExc_ValueError, "field 'value' is required for Subscript");
        return NULL;
    }
    if (!slice) {
        PyErr_SetString(PyExc_ValueError, "field 'slice' is required for Subscript");
        return NULL;
    }
    if (!ctx) {
...
_PyAST_comprehension(
    expr_ty target, expr_ty iter, asdl_expr_seq *ifs, int is_async, PyArena *arena
) {
    comprehension_ty p;
    if (!target) {
        PyErr_SetString(
            PyExc_ValueError, "field 'target' is required for comprehension"
        );
        return NULL;
    }
    if (!iter) {
        PyErr_SetString(PyExc_ValueError, "field 'iter' is required for comprehension");
        return NULL;
    }
...
_PyAST_withitem(expr_ty context_expr, expr_ty optional_vars, PyArena *arena) {
    ...
    if (!context_expr) {
        PyErr_SetString(
            PyExc_ValueError, "field 'context_expr' is required for withitem"
        );
        return NULL;
    }
...
match_case_ty
_PyAST_match_case(
    pattern_ty pattern, expr_ty guard, asdl_stmt_seq *body, PyArena *arena
) {
    match_case_ty p;
    if (!pattern) {
        PyErr_SetString(PyExc_ValueError, "field 'pattern' is required for match_case");
        return NULL;
    }
...
_PyAST_MatchValue(
    ...
    pattern_ty p;
    if (!value) {
        PyErr_SetString(PyExc_ValueError, "field 'value' is required for MatchValue");
        return NULL;
    }
...
_PyAST_MatchSingleton(
    ...
    if (!value) {
        PyErr_SetString(
            PyExc_ValueError, "field 'value' is required for MatchSingleton"
        );
        return NULL;
    }
    p = (pattern_ty)_PyArena_Malloc(arena, sizeof(*p));
...
_PyAST_TypeIgnore(int lineno, string tag, PyArena *arena) {
    type_ignore_ty p;
    if (!tag) {
        PyErr_SetString(PyExc_ValueError, "field 'tag' is required for TypeIgnore");
        return NULL;
    }
...
_PyAST_TypeVarTuple(
    ...
    type_param_ty p;
    if (!name) {
        PyErr_SetString(PyExc_ValueError, "field 'name' is required for TypeVarTuple");
        return NULL;
    }
    p = (type_param_ty)_PyArena_Malloc(arena, sizeof(*p));
    if (!p)
    ...
    switch (o->kind) {
        case Module_kind:
            ...
            if (!result)
                goto failed;
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.Module.body, ast2obj_stmt);
            if (!value)
                goto failed;
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Module.type_ignores, ast2obj_type_ignore
            );
            if (!value)
                goto failed;
        ...
        case Interactive_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Interactive.body, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
        ...
        case FunctionType_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.FunctionType.argtypes, ast2obj_expr
            );
            if (!value)
                goto failed;
...
ast2obj_stmt(struct ast_state *state, struct validator *vstate, void *_o) {
    ...
    switch (o->kind) {
        case FunctionDef_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.FunctionDef.body, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.FunctionDef.decorator_list, ast2obj_expr
            );
            if (!value)
                goto failed;
        ...
        case AsyncFunctionDef_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.AsyncFunctionDef.body, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
        ...
        case ClassDef_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.ClassDef.bases, ast2obj_expr
            );
            if (!value)
                goto failed;
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.ClassDef.keywords, ast2obj_keyword
            );
            if (!value)
                goto failed;
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.ClassDef.body, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.ClassDef.decorator_list, ast2obj_expr
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->decorator_list, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.ClassDef.type_params, ast2obj_type_param
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->type_params, value) == -1)
        ...
        case Delete_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Delete.targets, ast2obj_expr
            );
            if (!value)
                goto failed;
        ...
        case Assign_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Assign.targets, ast2obj_expr
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->targets, value) == -1)
        ...
        case For_kind:
            ...
            Py_DECREF(value);
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.For.body, ast2obj_stmt);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
                goto failed;
            Py_DECREF(value);
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.For.orelse, ast2obj_stmt);
            if (!value)
                goto failed;
        ...
        case AsyncFor_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.AsyncFor.body, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.AsyncFor.orelse, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->orelse, value) == -1)
        ...
        case While_kind:
            ...
            Py_DECREF(value);
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.While.body, ast2obj_stmt);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
                goto failed;
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.While.orelse, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->orelse, value) == -1)
        ...
        case If_kind:
            ...
            if (PyObject_SetAttr(result, state->test, value) == -1)
                goto failed;
            Py_DECREF(value);
            value = ast2obj_list(state, vstate, (asdl_seq *)o->v.If.body, ast2obj_stmt);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
                goto failed;
            Py_DECREF(value);
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.If.orelse, ast2obj_stmt);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->orelse, value) == -1)
                goto failed;
        ...
        case With_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.With.items, ast2obj_withitem
            );
            if (!value)
                goto failed;
            ...
            Py_DECREF(value);
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.With.body, ast2obj_stmt);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
                goto failed;
        ...
        case AsyncWith_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.AsyncWith.items, ast2obj_withitem
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->items, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.AsyncWith.body, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
        ...
        case Match_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Match.cases, ast2obj_match_case
            );
            if (!value)
                goto failed;
        ...
        case Try_kind:
            ...
            if (!result)
                goto failed;
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.Try.body, ast2obj_stmt);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
                goto failed;
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Try.handlers, ast2obj_excepthandler
            );
            if (!value)
                goto failed;
            ...
            Py_DECREF(value);
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.Try.orelse, ast2obj_stmt);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->orelse, value) == -1)
                goto failed;
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Try.finalbody, ast2obj_stmt
            );
            if (!value)
                goto failed;
        ...
        case TryStar_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.TryStar.body, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.TryStar.handlers, ast2obj_excepthandler
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->handlers, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.TryStar.orelse, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->orelse, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.TryStar.finalbody, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->finalbody, value) == -1)
        ...
        case Import_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Import.names, ast2obj_alias
            );
            if (!value)
                goto failed;
        ...
        case ImportFrom_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.ImportFrom.names, ast2obj_alias
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->names, value) == -1)
        ...
        case Global_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Global.names, ast2obj_identifier
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->names, value) == -1)
        ...
        case Nonlocal_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Nonlocal.names, ast2obj_identifier
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->names, value) == -1)
...
ast2obj_expr(struct ast_state *state, struct validator *vstate, void *_o) {
    ...
    switch (o->kind) {
        case BoolOp_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.BoolOp.values, ast2obj_expr
            );
            if (!value)
                goto failed;
        ...
        case Dict_kind:
            ...
            if (!result)
                goto failed;
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.Dict.keys, ast2obj_expr);
            if (!value)
                goto failed;
            ...
            Py_DECREF(value);
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.Dict.values, ast2obj_expr);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->values, value) == -1)
                goto failed;
        ...
        case Set_kind:
            ...
            if (!result)
                goto failed;
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.Set.elts, ast2obj_expr);
            if (!value)
                goto failed;
        ...
        case SetComp_kind:
            ...
            value = ast2obj_list(
                state,
                vstate,
                (asdl_seq *)o->v.SetComp.generators,
                ast2obj_comprehension
            );
            if (!value)
                goto failed;
        ...
        case Compare_kind:
            ...
            Py_DECREF(value);
            {
                ...
                for (i = 0; i < n; i++)
                    PyList_SET_ITEM(
                        ...
                        i,
                        ast2obj_cmpop(
                            state, vstate, (cmpop_ty)asdl_seq_GET(o->v.Compare.ops, i)
                        )
                    );
            }
            if (!value)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Compare.comparators, ast2obj_expr
            );
            if (!value)
                goto failed;
        ...
        case Call_kind:
            ...
            Py_DECREF(value);
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.Call.args, ast2obj_expr);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->args, value) == -1)
                goto failed;
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.Call.keywords, ast2obj_keyword
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->keywords, value) == -1)
        ...
        case JoinedStr_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.JoinedStr.values, ast2obj_expr
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->values, value) == -1)
        ...
        case List_kind:
            ...
            if (!result)
                goto failed;
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.List.elts, ast2obj_expr);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->elts, value) == -1)
                goto failed;
        ...
        case Tuple_kind:
            ...
            if (!result)
                goto failed;
            value =
                ast2obj_list(state, vstate, (asdl_seq *)o->v.Tuple.elts, ast2obj_expr);
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->elts, value) == -1)
                goto failed;
...
PyObject *
ast2obj_expr_context(
    struct ast_state *state, struct validator *vstate, expr_context_ty o
) {
    switch (o) {
        case Load:
...
PyObject *
ast2obj_boolop(struct ast_state *state, struct validator *vstate, boolop_ty o) {
    switch (o) {
        case And:
...
PyObject *
ast2obj_operator(struct ast_state *state, struct validator *vstate, operator_ty o) {
    switch (o) {
        case Add:
...
PyObject *
ast2obj_unaryop(struct ast_state *state, struct validator *vstate, unaryop_ty o) {
    switch (o) {
        case Invert:
...
PyObject *
ast2obj_cmpop(struct ast_state *state, struct validator *vstate, cmpop_ty o) {
    switch (o) {
        case Eq:
...
PyObject *
ast2obj_comprehension(struct ast_state *state, struct validator *vstate, void *_o) {
...
PyObject *
ast2obj_excepthandler(struct ast_state *state, struct validator *vstate, void *_o) {
    ...
    switch (o->kind) {
        case ExceptHandler_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.ExceptHandler.body, ast2obj_stmt
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->body, value) == -1)
    ...
    switch (o->kind) {
        ...
        case MatchSequence_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.MatchSequence.patterns, ast2obj_pattern
            );
            if (!value)
                goto failed;
        ...
        case MatchMapping_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.MatchMapping.keys, ast2obj_expr
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->keys, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.MatchMapping.patterns, ast2obj_pattern
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->patterns, value) == -1)
        ...
        case MatchClass_kind:
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.MatchClass.patterns, ast2obj_pattern
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->patterns, value) == -1)
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.MatchClass.kwd_attrs, ast2obj_identifier
            );
            if (!value)
                goto failed;
            ...
            Py_DECREF(value);
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.MatchClass.kwd_patterns, ast2obj_pattern
            );
            if (!value)
                goto failed;
        ...
        case MatchOr_kind:
            ...
            if (!result)
                goto failed;
            value = ast2obj_list(
                state, vstate, (asdl_seq *)o->v.MatchOr.patterns, ast2obj_pattern
            );
            if (!value)
                goto failed;
            if (PyObject_SetAttr(result, state->patterns, value) == -1)
...
obj2ast_mod(struct ast_state *state, PyObject *obj, mod_ty *out, PyArena *arena) {
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"body\" missing from Expression"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"returns\" missing from FunctionType"
            );
            return -1;
        } else {
            int res;
...
obj2ast_stmt(struct ast_state *state, PyObject *obj, stmt_ty *out, PyArena *arena) {
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"col_offset\" missing from stmt"
        );
        return -1;
    } else {
        int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"name\" missing from FunctionDef"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"args\" missing from FunctionDef"
            );
            return -1;
        } else {
            int res;
        ...
        }
        {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "FunctionDef field \"decorator_list\" changed size during "
                        "iteration"
                    );
                    goto failed;
                }
        ...
        }
        {
            ...
            if (!PyList_Check(tmp)) {
                PyErr_Format(
                    PyExc_TypeError,
                    "FunctionDef field \"type_params\" must be a list, not a %.200s",
                    _PyType_Name(Py_TYPE(tmp))
                );
                goto failed;
            }
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "FunctionDef field \"type_params\" changed size during "
                        "iteration"
                    );
                    goto failed;
                }
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"name\" missing from AsyncFunctionDef"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"args\" missing from AsyncFunctionDef"
            );
            return -1;
        } else {
            int res;
        ...
        }
        {
            ...
            if (!PyList_Check(tmp)) {
                PyErr_Format(
                    PyExc_TypeError,
                    "AsyncFunctionDef field \"decorator_list\" must be a list, not a "
                    "%.200s",
                    _PyType_Name(Py_TYPE(tmp))
                );
                goto failed;
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "AsyncFunctionDef field \"decorator_list\" changed size during "
                        "iteration"
                    );
                    goto failed;
                }
        ...
        }
        {
            ...
            if (!PyList_Check(tmp)) {
                PyErr_Format(
                    PyExc_TypeError,
                    "AsyncFunctionDef field \"type_params\" must be a list, not a "
                    "%.200s",
                    _PyType_Name(Py_TYPE(tmp))
                );
                goto failed;
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "AsyncFunctionDef field \"type_params\" changed size during "
                        "iteration"
                    );
                    goto failed;
                }
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"name\" missing from ClassDef"
            );
            return -1;
        } else {
            int res;
        ...
        }
        {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "ClassDef field \"decorator_list\" changed size during "
                        "iteration"
                    );
                    goto failed;
                }
        ...
        }
        {
            ...
            if (!PyList_Check(tmp)) {
                PyErr_Format(
                    PyExc_TypeError,
                    "ClassDef field \"type_params\" must be a list, not a %.200s",
                    _PyType_Name(Py_TYPE(tmp))
                );
                goto failed;
            }
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "ClassDef field \"type_params\" changed size during iteration"
                    );
                    goto failed;
                }
                asdl_seq_SET(type_params, i, val);
    ...
    if (isinstance) {
        ...
        *out =
            _PyAST_Return(value, lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = _PyAST_Delete(
            targets, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from Assign"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"name\" missing from TypeAlias"
            );
            return -1;
        } else {
            int res;
        ...
        }
        {
            ...
            if (!PyList_Check(tmp)) {
                PyErr_Format(
                    PyExc_TypeError,
                    "TypeAlias field \"type_params\" must be a list, not a %.200s",
                    _PyType_Name(Py_TYPE(tmp))
                );
                goto failed;
            }
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "TypeAlias field \"type_params\" changed size during iteration"
                    );
                    goto failed;
                }
                asdl_seq_SET(type_params, i, val);
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from TypeAlias"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"target\" missing from AugAssign"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"op\" missing from AugAssign"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from AugAssign"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_AugAssign(
            target, op, value, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"annotation\" missing from AnnAssign"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"target\" missing from For"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"iter\" missing from For"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"target\" missing from AsyncFor"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"iter\" missing from AsyncFor"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"test\" missing from While"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_While(
            test, body, orelse, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"subject\" missing from Match"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_Match(
            subject, cases, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_Raise(
            exc, cause, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"test\" missing from Assert"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_Assert(
            test, msg, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        *out =
            _PyAST_Import(names, lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = _PyAST_ImportFrom(
            module, names, level, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        *out =
            _PyAST_Global(names, lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = _PyAST_Nonlocal(
            names, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from Expr"
            );
            return -1;
        } else {
            int res;
        ...
        *out =
            _PyAST_Expr(value, lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        *out = _PyAST_Pass(lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        *out = _PyAST_Break(lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        *out = _PyAST_Continue(lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
...
obj2ast_expr(struct ast_state *state, PyObject *obj, expr_ty *out, PyArena *arena) {
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"col_offset\" missing from expr"
        );
        return -1;
    } else {
        int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"op\" missing from BoolOp"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_BoolOp(
            op, values, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"target\" missing from NamedExpr"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from NamedExpr"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_NamedExpr(
            target, value, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"left\" missing from BinOp"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"op\" missing from BinOp"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"right\" missing from BinOp"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_BinOp(
            left, op, right, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"op\" missing from UnaryOp"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"operand\" missing from UnaryOp"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_UnaryOp(
            op, operand, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"args\" missing from Lambda"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"body\" missing from Lambda"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_Lambda(
            args, body, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"test\" missing from IfExp"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"body\" missing from IfExp"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"orelse\" missing from IfExp"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_Dict(
            keys, values, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_Set(elts, lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"elt\" missing from ListComp"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_ListComp(
            elt, generators, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"elt\" missing from SetComp"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"key\" missing from DictComp"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from DictComp"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"elt\" missing from GeneratorExp"
            );
            return -1;
        } else {
            int res;
        ...
        }
        {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "GeneratorExp field \"generators\" changed size during "
                        "iteration"
                    );
                    goto failed;
                }
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from Await"
            );
            return -1;
        } else {
            int res;
        ...
        *out =
            _PyAST_Await(value, lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out =
            _PyAST_Yield(value, lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from YieldFrom"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_YieldFrom(
            value, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"left\" missing from Compare"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"func\" missing from Call"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_Call(
            func, args, keywords, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from FormattedValue"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_JoinedStr(
            values, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from Constant"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_Constant(
            value, kind, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from Attribute"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"attr\" missing from Attribute"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"ctx\" missing from Attribute"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_Attribute(
            value, attr, ctx, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from Subscript"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"slice\" missing from Subscript"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"ctx\" missing from Subscript"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_Subscript(
            value, slice, ctx, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from Starred"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"ctx\" missing from Starred"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_Starred(
            value, ctx, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"ctx\" missing from Name"
            );
            return -1;
        } else {
            int res;
        ...
        *out =
            _PyAST_Name(id, ctx, lineno, col_offset, end_lineno, end_col_offset, arena);
        if (*out == NULL)
            goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"ctx\" missing from List"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_List(
            elts, ctx, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"ctx\" missing from Tuple"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_Slice(
            lower, upper, step, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
...
obj2ast_comprehension(
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"target\" missing from comprehension"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"iter\" missing from comprehension"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"is_async\" missing from comprehension"
        );
        return -1;
    } else {
        int res;
...
obj2ast_excepthandler(
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"lineno\" missing from excepthandler"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"col_offset\" missing from excepthandler"
        );
        return -1;
    } else {
        int res;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_ExceptHandler(
            type, name, body, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
...
obj2ast_arguments(
    ...
    *out = _PyAST_arguments(
        posonlyargs, args, vararg, kwonlyargs, kw_defaults, kwarg, defaults, arena
    );
    if (*out == NULL)
        goto failed;
    return 0;
...
obj2ast_arg(struct ast_state *state, PyObject *obj, arg_ty *out, PyArena *arena) {
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"col_offset\" missing from arg"
        );
        return -1;
    } else {
        int res;
...
obj2ast_keyword(
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"value\" missing from keyword"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"lineno\" missing from keyword"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"col_offset\" missing from keyword"
        );
        return -1;
    } else {
        int res;
    ...
    *out = _PyAST_keyword(
        arg, value, lineno, col_offset, end_lineno, end_col_offset, arena
    );
    if (*out == NULL)
        goto failed;
    return 0;
...
obj2ast_alias(struct ast_state *state, PyObject *obj, alias_ty *out, PyArena *arena) {
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"lineno\" missing from alias"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"col_offset\" missing from alias"
        );
        return -1;
    } else {
        int res;
    ...
    *out = _PyAST_alias(
        name, asname, lineno, col_offset, end_lineno, end_col_offset, arena
    );
    if (*out == NULL)
        goto failed;
    return 0;
...
obj2ast_withitem(
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"context_expr\" missing from withitem"
        );
        return -1;
    } else {
        int res;
...
obj2ast_match_case(
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"pattern\" missing from match_case"
        );
        return -1;
    } else {
        int res;
...
obj2ast_pattern(
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"lineno\" missing from pattern"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"col_offset\" missing from pattern"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"end_lineno\" missing from pattern"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"end_col_offset\" missing from pattern"
        );
        return -1;
    } else {
        int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from MatchValue"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"value\" missing from MatchSingleton"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_MatchSequence(
            patterns, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_MatchMapping(
            keys, patterns, rest, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"cls\" missing from MatchClass"
            );
            return -1;
        } else {
            int res;
        ...
        }
        {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (len != PyList_GET_SIZE(tmp)) {
                    PyErr_SetString(
                        PyExc_RuntimeError,
                        "MatchClass field \"kwd_patterns\" changed size during "
                        "iteration"
                    );
                    goto failed;
                }
    ...
    if (isinstance) {
        ...
        *out = _PyAST_MatchStar(
            name, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        *out = _PyAST_MatchAs(
            pattern, name, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
...
obj2ast_type_ignore(
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"lineno\" missing from TypeIgnore"
            );
            return -1;
        } else {
            int res;
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"tag\" missing from TypeIgnore"
            );
            return -1;
        } else {
            int res;
...
obj2ast_type_param(
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"lineno\" missing from type_param"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"col_offset\" missing from type_param"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"end_lineno\" missing from type_param"
        );
        return -1;
    } else {
        int res;
    ...
    if (tmp == NULL) {
        PyErr_SetString(
            PyExc_TypeError, "required field \"end_col_offset\" missing from type_param"
        );
        return -1;
    } else {
        int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"name\" missing from TypeVar"
            );
            return -1;
        } else {
            int res;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"name\" missing from ParamSpec"
            );
            return -1;
        } else {
            int res;
        ...
        *out = _PyAST_ParamSpec(
            name, default_value, lineno, col_offset, end_lineno, end_col_offset, arena
        );
        if (*out == NULL)
            goto failed;
        return 0;
    ...
    if (isinstance) {
        ...
        if (tmp == NULL) {
            PyErr_SetString(
                PyExc_TypeError, "required field \"name\" missing from TypeVarTuple"
            );
            return -1;
        } else {
            int res;
...
astmodule_exec(PyObject *m) {
    ...
    if (PyModule_AddObjectRef(m, "AsyncFunctionDef", state->AsyncFunctionDef_type) <
        0) {
        return -1;
    }
    ...
    if (PyModule_AddObjectRef(m, "FormattedValue", state->FormattedValue_type) < 0) {
        return -1;
    }
    ...
    if (PyModule_AddObjectRef(m, "comprehension", state->comprehension_type) < 0) {
        return -1;
    }
    if (PyModule_AddObjectRef(m, "excepthandler", state->excepthandler_type) < 0) {
        return -1;
    }
    if (PyModule_AddObjectRef(m, "ExceptHandler", state->ExceptHandler_type) < 0) {
        return -1;
    ...
    if (PyModule_AddObjectRef(m, "MatchSingleton", state->MatchSingleton_type) < 0) {
        return -1;
    }
    if (PyModule_AddObjectRef(m, "MatchSequence", state->MatchSequence_type) < 0) {
        return -1;
    }
