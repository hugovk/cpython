...
#define MONITORING_USE_TOOL_ID_METHODDEF        \
    {"use_tool_id",                             \
     _PyCFunction_CAST(monitoring_use_tool_id), \
     METH_FASTCALL,                             \
     monitoring_use_tool_id__doc__},
...
#define MONITORING_CLEAR_TOOL_ID_METHODDEF  \
    {"clear_tool_id",                       \
     (PyCFunction)monitoring_clear_tool_id, \
     METH_O,                                \
     monitoring_clear_tool_id__doc__},
...
PyDoc_STRVAR(
    monitoring_free_tool_id__doc__,
...
#define MONITORING_FREE_TOOL_ID_METHODDEF  \
    {"free_tool_id",                       \
     (PyCFunction)monitoring_free_tool_id, \
     METH_O,                               \
     monitoring_free_tool_id__doc__},
...
PyDoc_STRVAR(
    monitoring_register_callback__doc__,
...
#define MONITORING_REGISTER_CALLBACK_METHODDEF        \
    {"register_callback",                             \
     _PyCFunction_CAST(monitoring_register_callback), \
     METH_FASTCALL,                                   \
     monitoring_register_callback__doc__},
...
#define MONITORING_GET_EVENTS_METHODDEF  \
    {"get_events",                       \
     (PyCFunction)monitoring_get_events, \
     METH_O,                             \
     monitoring_get_events__doc__},
...
#define MONITORING_SET_EVENTS_METHODDEF        \
    {"set_events",                             \
     _PyCFunction_CAST(monitoring_set_events), \
     METH_FASTCALL,                            \
     monitoring_set_events__doc__},
...
PyDoc_STRVAR(
    monitoring_get_local_events__doc__,
...
#define MONITORING_GET_LOCAL_EVENTS_METHODDEF        \
    {"get_local_events",                             \
     _PyCFunction_CAST(monitoring_get_local_events), \
     METH_FASTCALL,                                  \
     monitoring_get_local_events__doc__},
...
PyDoc_STRVAR(
    monitoring_set_local_events__doc__,
...
#define MONITORING_SET_LOCAL_EVENTS_METHODDEF        \
    {"set_local_events",                             \
     _PyCFunction_CAST(monitoring_set_local_events), \
     METH_FASTCALL,                                  \
     monitoring_set_local_events__doc__},
...
#define MONITORING_RESTART_EVENTS_METHODDEF  \
    {"restart_events",                       \
     (PyCFunction)monitoring_restart_events, \
     METH_NOARGS,                            \
     monitoring_restart_events__doc__},
...
#define MONITORING__ALL_EVENTS_METHODDEF  \
    {"_all_events",                       \
     (PyCFunction)monitoring__all_events, \
     METH_NOARGS,                         \
     monitoring__all_events__doc__},
