...
#define _IMP__FIX_CO_FILENAME_METHODDEF        \
    {"_fix_co_filename",                       \
     _PyCFunction_CAST(_imp__fix_co_filename), \
     METH_FASTCALL,                            \
     _imp__fix_co_filename__doc__},
...
_imp__fix_co_filename(PyObject *module, PyObject *const *args, Py_ssize_t nargs) {
    ...
    if (!PyObject_TypeCheck(args[0], &PyCode_Type)) {
        _PyArg_BadArgument(
            "_fix_co_filename", "argument 1", (&PyCode_Type)->tp_name, args[0]
        );
        goto exit;
    }
...
#define _IMP_CREATE_BUILTIN_METHODDEF  \
    {"create_builtin",                 \
     (PyCFunction)_imp_create_builtin, \
     METH_O,                           \
     _imp_create_builtin__doc__},
...
#define _IMP_EXTENSION_SUFFIXES_METHODDEF  \
    {"extension_suffixes",                 \
     (PyCFunction)_imp_extension_suffixes, \
     METH_NOARGS,                          \
     _imp_extension_suffixes__doc__},
...
#define _IMP_FIND_FROZEN_METHODDEF        \
    {"find_frozen",                       \
     _PyCFunction_CAST(_imp_find_frozen), \
...
#define _IMP_GET_FROZEN_OBJECT_METHODDEF        \
    {"get_frozen_object",                       \
     _PyCFunction_CAST(_imp_get_frozen_object), \
     METH_FASTCALL,                             \
     _imp_get_frozen_object__doc__},
...
#define _IMP_IS_FROZEN_PACKAGE_METHODDEF  \
    {"is_frozen_package",                 \
     (PyCFunction)_imp_is_frozen_package, \
     METH_O,                              \
     _imp_is_frozen_package__doc__},
...
PyDoc_STRVAR(
    _imp__frozen_module_names__doc__,
...
#define _IMP__FROZEN_MODULE_NAMES_METHODDEF  \
    {"_frozen_module_names",                 \
     (PyCFunction)_imp__frozen_module_names, \
     METH_NOARGS,                            \
     _imp__frozen_module_names__doc__},
...
PyDoc_STRVAR(
    _imp__override_frozen_modules_for_tests__doc__,
...
PyDoc_STRVAR(
    _imp__override_multi_interp_extensions_check__doc__,
...
#define _IMP__OVERRIDE_MULTI_INTERP_EXTENSIONS_CHECK_METHODDEF  \
    {"_override_multi_interp_extensions_check",                 \
     (PyCFunction)_imp__override_multi_interp_extensions_check, \
     METH_O,                                                    \
     _imp__override_multi_interp_extensions_check__doc__},
...
#define _IMP_CREATE_DYNAMIC_METHODDEF        \
    {"create_dynamic",                       \
     _PyCFunction_CAST(_imp_create_dynamic), \
     METH_FASTCALL,                          \
     _imp_create_dynamic__doc__},
...
#define _IMP_SOURCE_HASH_METHODDEF        \
    {"source_hash",                       \
     _PyCFunction_CAST(_imp_source_hash), \
     METH_FASTCALL | METH_KEYWORDS,       \
     _imp_source_hash__doc__},
