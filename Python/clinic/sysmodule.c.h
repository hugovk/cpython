...
#define SYS_ADDAUDITHOOK_METHODDEF        \
    {"addaudithook",                      \
     _PyCFunction_CAST(sys_addaudithook), \
...
#define SYS_EXCEPTHOOK_METHODDEF        \
    {"excepthook",                      \
     _PyCFunction_CAST(sys_excepthook), \
     METH_FASTCALL,                     \
     sys_excepthook__doc__},
...
#define SYS_UNRAISABLEHOOK_METHODDEF  \
    {"unraisablehook",                \
     (PyCFunction)sys_unraisablehook, \
     METH_O,                          \
     sys_unraisablehook__doc__},
...
PyDoc_STRVAR(
    sys_getfilesystemencoding__doc__,
...
#define SYS_GETFILESYSTEMENCODING_METHODDEF  \
    {"getfilesystemencoding",                \
     (PyCFunction)sys_getfilesystemencoding, \
     METH_NOARGS,                            \
     sys_getfilesystemencoding__doc__},
...
PyDoc_STRVAR(
    sys_getfilesystemencodeerrors__doc__,
...
#define SYS_GETFILESYSTEMENCODEERRORS_METHODDEF  \
    {"getfilesystemencodeerrors",                \
     (PyCFunction)sys_getfilesystemencodeerrors, \
     METH_NOARGS,                                \
     sys_getfilesystemencodeerrors__doc__},
...
PyDoc_STRVAR(
    ...
    "--\n"
    "\n"
    "Set the global debug tracing function in all running threads belonging to the "
    "current interpreter.\n"
    "\n"
    "It will be called on each function call. See the debugger chapter\n"
    "in the library manual."
...
#define SYS__SETTRACEALLTHREADS_METHODDEF  \
    {"_settraceallthreads",                \
     (PyCFunction)sys__settraceallthreads, \
     METH_O,                               \
     sys__settraceallthreads__doc__},
...
PyDoc_STRVAR(
    sys__setprofileallthreads__doc__,
    "_setprofileallthreads($module, function, /)\n"
    "--\n"
    "\n"
    "Set the profiling function in all running threads belonging to the current "
    "interpreter.\n"
    "\n"
    "It will be called on each function call and return.  See the profiler\n"
    "chapter in the library manual."
...
#define SYS__SETPROFILEALLTHREADS_METHODDEF  \
    {"_setprofileallthreads",                \
     (PyCFunction)sys__setprofileallthreads, \
     METH_O,                                 \
     sys__setprofileallthreads__doc__},

PyDoc_STRVAR(
    sys_getprofile__doc__,
    "getprofile($module, /)\n"
    "--\n"
    "\n"
...
#define SYS_GETSWITCHINTERVAL_METHODDEF  \
    {"getswitchinterval",                \
     (PyCFunction)sys_getswitchinterval, \
     METH_NOARGS,                        \
     sys_getswitchinterval__doc__},
...
#define SYS_SETRECURSIONLIMIT_METHODDEF  \
    {"setrecursionlimit",                \
     (PyCFunction)sys_setrecursionlimit, \
     METH_O,                             \
     sys_setrecursionlimit__doc__},
...
#define SYS_SET_COROUTINE_ORIGIN_TRACKING_DEPTH_METHODDEF        \
    {"set_coroutine_origin_tracking_depth",                      \
     _PyCFunction_CAST(sys_set_coroutine_origin_tracking_depth), \
     METH_FASTCALL | METH_KEYWORDS,                              \
     sys_set_coroutine_origin_tracking_depth__doc__},
...
#define SYS_GET_COROUTINE_ORIGIN_TRACKING_DEPTH_METHODDEF  \
    {"get_coroutine_origin_tracking_depth",                \
     (PyCFunction)sys_get_coroutine_origin_tracking_depth, \
     METH_NOARGS,                                          \
     sys_get_coroutine_origin_tracking_depth__doc__},
...
#define SYS_GET_ASYNCGEN_HOOKS_METHODDEF  \
    {"get_asyncgen_hooks",                \
     (PyCFunction)sys_get_asyncgen_hooks, \
     METH_NOARGS,                         \
     sys_get_asyncgen_hooks__doc__},
...
#define SYS_GETRECURSIONLIMIT_METHODDEF  \
    {"getrecursionlimit",                \
     (PyCFunction)sys_getrecursionlimit, \
     METH_NOARGS,                        \
     sys_getrecursionlimit__doc__},
...
#define SYS_GETWINDOWSVERSION_METHODDEF  \
    {"getwindowsversion",                \
     (PyCFunction)sys_getwindowsversion, \
     METH_NOARGS,                        \
     sys_getwindowsversion__doc__},
...
PyDoc_STRVAR(
    sys__enablelegacywindowsfsencoding__doc__,
...
#define SYS__ENABLELEGACYWINDOWSFSENCODING_METHODDEF  \
    {"_enablelegacywindowsfsencoding",                \
     (PyCFunction)sys__enablelegacywindowsfsencoding, \
     METH_NOARGS,                                     \
     sys__enablelegacywindowsfsencoding__doc__},
...
#define SYS_SETDLOPENFLAGS_METHODDEF  \
    {"setdlopenflags",                \
     (PyCFunction)sys_setdlopenflags, \
     METH_O,                          \
     sys_setdlopenflags__doc__},
...
#define SYS_GETDLOPENFLAGS_METHODDEF  \
    {"getdlopenflags",                \
     (PyCFunction)sys_getdlopenflags, \
     METH_NOARGS,                     \
     sys_getdlopenflags__doc__},
...
PyDoc_STRVAR(
    sys_get_int_max_str_digits__doc__,
...
#define SYS_GET_INT_MAX_STR_DIGITS_METHODDEF  \
    {"get_int_max_str_digits",                \
     (PyCFunction)sys_get_int_max_str_digits, \
     METH_NOARGS,                             \
     sys_get_int_max_str_digits__doc__},
...
PyDoc_STRVAR(
    sys_set_int_max_str_digits__doc__,
...
#define SYS_GETTOTALREFCOUNT_METHODDEF  \
    {"gettotalrefcount",                \
     (PyCFunction)sys_gettotalrefcount, \
     METH_NOARGS,                       \
     sys_gettotalrefcount__doc__},
...
#define SYS_GETUNICODEINTERNEDSIZE_METHODDEF        \
    {"getunicodeinternedsize",                      \
     _PyCFunction_CAST(sys_getunicodeinternedsize), \
     METH_FASTCALL | METH_KEYWORDS,                 \
     sys_getunicodeinternedsize__doc__},
...
#define SYS__GETFRAME_METHODDEF        \
    {"_getframe",                      \
     _PyCFunction_CAST(sys__getframe), \
     METH_FASTCALL,                    \
     sys__getframe__doc__},
...
PyDoc_STRVAR(
    sys__current_exceptions__doc__,
...
#define SYS__CURRENT_EXCEPTIONS_METHODDEF  \
    {"_current_exceptions",                \
     (PyCFunction)sys__current_exceptions, \
     METH_NOARGS,                          \
     sys__current_exceptions__doc__},
...
#define SYS_CALL_TRACING_METHODDEF        \
    {"call_tracing",                      \
     _PyCFunction_CAST(sys_call_tracing), \
     METH_FASTCALL,                       \
     sys_call_tracing__doc__},
...
#define SYS__DEBUGMALLOCSTATS_METHODDEF  \
    {"_debugmallocstats",                \
     (PyCFunction)sys__debugmallocstats, \
     METH_NOARGS,                        \
     sys__debugmallocstats__doc__},
...
#define SYS__CLEAR_TYPE_CACHE_METHODDEF  \
    {"_clear_type_cache",                \
     (PyCFunction)sys__clear_type_cache, \
     METH_NOARGS,                        \
     sys__clear_type_cache__doc__},
...
PyDoc_STRVAR(
    sys__clear_internal_caches__doc__,
...
#define SYS__CLEAR_INTERNAL_CACHES_METHODDEF  \
    {"_clear_internal_caches",                \
     (PyCFunction)sys__clear_internal_caches, \
     METH_NOARGS,                             \
     sys__clear_internal_caches__doc__},
...
#define SYS_GETANDROIDAPILEVEL_METHODDEF  \
    {"getandroidapilevel",                \
     (PyCFunction)sys_getandroidapilevel, \
     METH_NOARGS,                         \
     sys_getandroidapilevel__doc__},
...
#define SYS_ACTIVATE_STACK_TRAMPOLINE_METHODDEF  \
    {"activate_stack_trampoline",                \
     (PyCFunction)sys_activate_stack_trampoline, \
     METH_O,                                     \
     sys_activate_stack_trampoline__doc__},
...
PyDoc_STRVAR(
    sys_deactivate_stack_trampoline__doc__,
...
#define SYS_DEACTIVATE_STACK_TRAMPOLINE_METHODDEF  \
    {"deactivate_stack_trampoline",                \
     (PyCFunction)sys_deactivate_stack_trampoline, \
     METH_NOARGS,                                  \
     sys_deactivate_stack_trampoline__doc__},
...
PyDoc_STRVAR(
    sys_is_stack_trampoline_active__doc__,
...
#define SYS_IS_STACK_TRAMPOLINE_ACTIVE_METHODDEF  \
    {"is_stack_trampoline_active",                \
     (PyCFunction)sys_is_stack_trampoline_active, \
     METH_NOARGS,                                 \
     sys_is_stack_trampoline_active__doc__},
...
PyDoc_STRVAR(
    sys__getframemodulename__doc__,
...
#define SYS__GETFRAMEMODULENAME_METHODDEF        \
    {"_getframemodulename",                      \
     _PyCFunction_CAST(sys__getframemodulename), \
     METH_FASTCALL | METH_KEYWORDS,              \
     sys__getframemodulename__doc__},
...
PyDoc_STRVAR(
    sys__get_cpu_count_config__doc__,
...
#define SYS__GET_CPU_COUNT_CONFIG_METHODDEF  \
    {"_get_cpu_count_config",                \
     (PyCFunction)sys__get_cpu_count_config, \
     METH_NOARGS,                            \
     sys__get_cpu_count_config__doc__},
...
#define SYS__IS_GIL_ENABLED_METHODDEF  \
    {"_is_gil_enabled",                \
     (PyCFunction)sys__is_gil_enabled, \
     METH_NOARGS,                      \
     sys__is_gil_enabled__doc__},
