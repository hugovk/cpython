...
PyDoc_STRVAR(
    InstructionSequenceType_use_label__doc__,
...
#define INSTRUCTIONSEQUENCETYPE_USE_LABEL_METHODDEF        \
    {"use_label",                                          \
     _PyCFunction_CAST(InstructionSequenceType_use_label), \
     METH_FASTCALL | METH_KEYWORDS,                        \
     InstructionSequenceType_use_label__doc__},

static PyObject *
InstructionSequenceType_use_label_impl(_PyInstructionSequence *self, int label);

static PyObject *
InstructionSequenceType_use_label(
...
#define INSTRUCTIONSEQUENCETYPE_ADDOP_METHODDEF        \
    {"addop",                                          \
     _PyCFunction_CAST(InstructionSequenceType_addop), \
     METH_FASTCALL | METH_KEYWORDS,                    \
     InstructionSequenceType_addop__doc__},

static PyObject *
InstructionSequenceType_addop_impl(
    _PyInstructionSequence *self,
    int opcode,
    int oparg,
    int lineno,
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "opcode", "oparg", "lineno", "col_offset", "end_lineno", "end_col_offset", NULL
    };
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .fname = "addop",
...
#undef KWTUPLE
    ...
    return_value = InstructionSequenceType_addop_impl(
        self, opcode, oparg, lineno, col_offset, end_lineno, end_col_offset
    );
...
#define INSTRUCTIONSEQUENCETYPE_NEW_LABEL_METHODDEF  \
    {"new_label",                                    \
     (PyCFunction)InstructionSequenceType_new_label, \
     METH_NOARGS,                                    \
     InstructionSequenceType_new_label__doc__},
...
static PyObject *
InstructionSequenceType_new_label(
    _PyInstructionSequence *self, PyObject *Py_UNUSED(ignored)
) {
    PyObject *return_value = NULL;
    int _return_value;
...
#define INSTRUCTIONSEQUENCETYPE_ADD_NESTED_METHODDEF        \
    {"add_nested",                                          \
     _PyCFunction_CAST(InstructionSequenceType_add_nested), \
     METH_FASTCALL | METH_KEYWORDS,                         \
     InstructionSequenceType_add_nested__doc__},

static PyObject *
InstructionSequenceType_add_nested_impl(_PyInstructionSequence *self, PyObject *nested);

static PyObject *
InstructionSequenceType_add_nested(
    _PyInstructionSequence *self,
    PyObject *const *args,
    Py_ssize_t nargs,
    PyObject *kwnames
...
PyDoc_STRVAR(
    InstructionSequenceType_get_nested__doc__,
    "get_nested($self, /)\n"
    "--\n"
    "\n"
    "Add a nested sequence."
...
#define INSTRUCTIONSEQUENCETYPE_GET_NESTED_METHODDEF  \
    {"get_nested",                                    \
     (PyCFunction)InstructionSequenceType_get_nested, \
     METH_NOARGS,                                     \
     InstructionSequenceType_get_nested__doc__},
...
static PyObject *
InstructionSequenceType_get_nested(
    _PyInstructionSequence *self, PyObject *Py_UNUSED(ignored)
) {
...
#define INSTRUCTIONSEQUENCETYPE_GET_INSTRUCTIONS_METHODDEF  \
    {"get_instructions",                                    \
     (PyCFunction)InstructionSequenceType_get_instructions, \
     METH_NOARGS,                                           \
     InstructionSequenceType_get_instructions__doc__},
...
static PyObject *
InstructionSequenceType_get_instructions(
    _PyInstructionSequence *self, PyObject *Py_UNUSED(ignored)
) {
