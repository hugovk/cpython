...
#define _CONTEXTVARS_CONTEXT_GET_METHODDEF        \
    {"get",                                       \
     _PyCFunction_CAST(_contextvars_Context_get), \
     METH_FASTCALL,                               \
     _contextvars_Context_get__doc__},
...
PyDoc_STRVAR(
    _contextvars_Context_items__doc__,
    "items($self, /)\n"
    "--\n"
    "\n"
...
#define _CONTEXTVARS_CONTEXT_ITEMS_METHODDEF  \
    {"items",                                 \
     (PyCFunction)_contextvars_Context_items, \
     METH_NOARGS,                             \
     _contextvars_Context_items__doc__},
...
PyDoc_STRVAR(
    _contextvars_Context_keys__doc__,
    "keys($self, /)\n"
    "--\n"
    "\n"
...
#define _CONTEXTVARS_CONTEXT_KEYS_METHODDEF  \
    {"keys",                                 \
     (PyCFunction)_contextvars_Context_keys, \
     METH_NOARGS,                            \
     _contextvars_Context_keys__doc__},
...
#define _CONTEXTVARS_CONTEXT_VALUES_METHODDEF  \
    {"values",                                 \
     (PyCFunction)_contextvars_Context_values, \
     METH_NOARGS,                              \
     _contextvars_Context_values__doc__},
...
PyDoc_STRVAR(
    _contextvars_Context_copy__doc__,
    "copy($self, /)\n"
    "--\n"
    "\n"
...
#define _CONTEXTVARS_CONTEXT_COPY_METHODDEF  \
    {"copy",                                 \
     (PyCFunction)_contextvars_Context_copy, \
     METH_NOARGS,                            \
     _contextvars_Context_copy__doc__},
...
PyDoc_STRVAR(
    _contextvars_ContextVar_get__doc__,
...
#define _CONTEXTVARS_CONTEXTVAR_GET_METHODDEF        \
    {"get",                                          \
     _PyCFunction_CAST(_contextvars_ContextVar_get), \
     METH_FASTCALL,                                  \
     _contextvars_ContextVar_get__doc__},
...
_contextvars_ContextVar_get(
    PyContextVar *self, PyObject *const *args, Py_ssize_t nargs
) {
    PyObject *return_value = NULL;
...
#define _CONTEXTVARS_CONTEXTVAR_SET_METHODDEF  \
    {"set",                                    \
     (PyCFunction)_contextvars_ContextVar_set, \
     METH_O,                                   \
     _contextvars_ContextVar_set__doc__},
...
#define _CONTEXTVARS_CONTEXTVAR_RESET_METHODDEF  \
    {"reset",                                    \
     (PyCFunction)_contextvars_ContextVar_reset, \
     METH_O,                                     \
     _contextvars_ContextVar_reset__doc__},
