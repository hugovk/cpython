...
#define BUILTIN___IMPORT___METHODDEF        \
    {"__import__",                          \
     _PyCFunction_CAST(builtin___import__), \
...
#define KWTUPLE NULL
    ...
    static const char *const _keywords[] = {
        "name", "globals", "locals", "fromlist", "level", NULL
    };
...
skip_optional_pos:
    return_value =
        builtin___import___impl(module, name, globals, locals, fromlist, level);
...
skip_optional_kwonly:
    return_value = builtin_compile_impl(
        module, source, filename, mode, flags, dont_inherit, optimize, feature_version
    );
...
#define BUILTIN_EVAL_METHODDEF        \
    {"eval",                          \
     _PyCFunction_CAST(builtin_eval), \
     METH_FASTCALL | METH_KEYWORDS,   \
     builtin_eval__doc__},
...
#define BUILTIN_EXEC_METHODDEF        \
    {"exec",                          \
     _PyCFunction_CAST(builtin_exec), \
     METH_FASTCALL | METH_KEYWORDS,   \
     builtin_exec__doc__},
...
#define BUILTIN_HASATTR_METHODDEF        \
    {"hasattr",                          \
     _PyCFunction_CAST(builtin_hasattr), \
     METH_FASTCALL,                      \
     builtin_hasattr__doc__},
...
#define BUILTIN_ID_METHODDEF {"id", (PyCFunction)builtin_id, METH_O, builtin_id__doc__},

PyDoc_STRVAR(
    builtin_setattr__doc__,
...
#define BUILTIN_SETATTR_METHODDEF        \
    {"setattr",                          \
     _PyCFunction_CAST(builtin_setattr), \
     METH_FASTCALL,                      \
     builtin_setattr__doc__},
...
#define BUILTIN_DELATTR_METHODDEF        \
    {"delattr",                          \
     _PyCFunction_CAST(builtin_delattr), \
     METH_FASTCALL,                      \
     builtin_delattr__doc__},
...
#define BUILTIN_PRINT_METHODDEF        \
    {"print",                          \
     _PyCFunction_CAST(builtin_print), \
     METH_FASTCALL | METH_KEYWORDS,    \
     builtin_print__doc__},
...
#define BUILTIN_ROUND_METHODDEF        \
    {"round",                          \
     _PyCFunction_CAST(builtin_round), \
     METH_FASTCALL | METH_KEYWORDS,    \
     builtin_round__doc__},
...
#define BUILTIN_ISINSTANCE_METHODDEF        \
    {"isinstance",                          \
     _PyCFunction_CAST(builtin_isinstance), \
     METH_FASTCALL,                         \
     builtin_isinstance__doc__},
...
#define BUILTIN_ISSUBCLASS_METHODDEF        \
    {"issubclass",                          \
     _PyCFunction_CAST(builtin_issubclass), \
     METH_FASTCALL,                         \
     builtin_issubclass__doc__},
