/* This is built as a stand-alone executable by the Makefile, and helps turn
   ...
   This is used directly by Tools/build/freeze_modules.py, and indirectly by "make
   regen-frozen".
...
static const char header[] = "/* Auto-generated by Programs/_freeze_module.c */";
...
runtime_init(void) {
    ...
    PyStatus status;
    status = PyConfig_SetString(&config, &config.program_name, L"./_freeze_module");
...
static int
write_frozen(
    const char *outpath, const char *inpath, const char *name, PyObject *marshalled
) {
